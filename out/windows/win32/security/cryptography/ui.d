...
enum uint CRYTPDLG_FLAGS_MASK = 0xff000000;

enum : uint
{
    CRYPTDLG_REVOCATION_DEFAULT = 0x00000000,
    CRYPTDLG_REVOCATION_ONLINE  = 0x80000000,
    CRYPTDLG_REVOCATION_CACHE   = 0x40000000,
    CRYPTDLG_REVOCATION_NONE    = 0x20000000,
}

enum uint CRYPTDLG_CACHE_ONLY_URL_RETRIEVAL = 0x10000000;

enum : uint
{
    CRYPTDLG_DISABLE_AIA = 0x08000000,
    CRYPTDLG_POLICY_MASK = 0x0000ffff,
}

enum uint POLICY_IGNORE_NON_CRITICAL_BC = 0x00000001;
enum uint CRYPTDLG_ACTION_MASK = 0xffff0000;

enum : uint
{
    ACTION_REVOCATION_DEFAULT_ONLINE = 0x00010000,
    ACTION_REVOCATION_DEFAULT_CACHE  = 0x00020000,
}

enum : uint
{
    CERT_DISPWELL_SELECT                 = 0x00000001,
    CERT_DISPWELL_TRUST_CA_CERT          = 0x00000002,
    CERT_DISPWELL_TRUST_LEAF_CERT        = 0x00000003,
    CERT_DISPWELL_TRUST_ADD_CA_CERT      = 0x00000004,
    CERT_DISPWELL_TRUST_ADD_LEAF_CERT    = 0x00000005,
    CERT_DISPWELL_DISTRUST_CA_CERT       = 0x00000006,
    CERT_DISPWELL_DISTRUST_LEAF_CERT     = 0x00000007,
    CERT_DISPWELL_DISTRUST_ADD_CA_CERT   = 0x00000008,
    CERT_DISPWELL_DISTRUST_ADD_LEAF_CERT = 0x00000009,
}

enum uint CSS_SELECTCERT_MASK = 0x00ffffff;

enum : uint
{
    SELCERT_PROPERTIES = 0x00000064,
    SELCERT_FINEPRINT  = 0x00000065,
    SELCERT_CERTLIST   = 0x00000066,
    SELCERT_ISSUED_TO  = 0x00000067,
    SELCERT_VALIDITY   = 0x00000068,
    SELCERT_ALGORITHM  = 0x00000069,
    SELCERT_SERIAL_NUM = 0x0000006a,
    SELCERT_THUMBPRINT = 0x0000006b,
}

enum uint CM_VIEWFLAGS_MASK = 0x00ffffff;
enum uint CERTVIEW_CRYPTUI_LPARAM = 0x00800000;

enum : uint
{
    CERT_FILTER_OP_EXISTS         = 0x00000001,
    CERT_FILTER_OP_NOT_EXISTS     = 0x00000002,
    CERT_FILTER_OP_EQUALITY       = 0x00000003,
    CERT_FILTER_INCLUDE_V1_CERTS  = 0x00000001,
    CERT_FILTER_VALID_TIME_RANGE  = 0x00000002,
    CERT_FILTER_VALID_SIGNATURE   = 0x00000004,
    CERT_FILTER_LEAF_CERTS_ONLY   = 0x00000008,
    CERT_FILTER_ISSUER_CERTS_ONLY = 0x00000010,
    CERT_FILTER_KEY_EXISTS        = 0x00000020,
}
...
enum : uint
{
    CERT_VALIDITY_BEFORE_START          = 0x00000001,
    CERT_VALIDITY_AFTER_END             = 0x00000002,
    CERT_VALIDITY_SIGNATURE_FAILS       = 0x00000004,
    CERT_VALIDITY_CERTIFICATE_REVOKED   = 0x00000008,
    CERT_VALIDITY_KEY_USAGE_EXT_FAILURE = 0x00000010,
}

enum uint CERT_VALIDITY_EXTENDED_USAGE_FAILURE = 0x00000020;
enum uint CERT_VALIDITY_NAME_CONSTRAINTS_FAILURE = 0x00000040;
enum uint CERT_VALIDITY_UNKNOWN_CRITICAL_EXTENSION = 0x00000080;

enum : uint
{
    CERT_VALIDITY_ISSUER_INVALID          = 0x00000100,
    CERT_VALIDITY_OTHER_EXTENSION_FAILURE = 0x00000200,
}

enum uint CERT_VALIDITY_PERIOD_NESTING_FAILURE = 0x00000400;

enum : uint
{
    CERT_VALIDITY_OTHER_ERROR           = 0x00000800,
    CERT_VALIDITY_ISSUER_DISTRUST       = 0x02000000,
    CERT_VALIDITY_EXPLICITLY_DISTRUSTED = 0x01000000,
}

enum : uint
{
    CERT_VALIDITY_NO_ISSUER_CERT_FOUND = 0x10000000,
    CERT_VALIDITY_NO_CRL_FOUND         = 0x20000000,
    CERT_VALIDITY_CRL_OUT_OF_DATE      = 0x40000000,
    CERT_VALIDITY_NO_TRUST_DATA        = 0x80000000,
    CERT_VALIDITY_MASK_TRUST           = 0xffff0000,
    CERT_VALIDITY_MASK_VALIDITY        = 0x0000ffff,
}

enum : uint
{
    CERT_TRUST_MASK                = 0x00ffffff,
    CERT_TRUST_DO_FULL_SEARCH      = 0x00000001,
    CERT_TRUST_PERMIT_MISSING_CRLS = 0x00000002,
}

enum uint CERT_TRUST_DO_FULL_TRUST = 0x00000005;
enum int CERT_CREDENTIAL_PROVIDER_ID = 0xfffffe03;

enum : ulong
{
    CRYPTUI_SELECT_ISSUEDTO_COLUMN     = 0x0000000000000001,
    CRYPTUI_SELECT_ISSUEDBY_COLUMN     = 0x0000000000000002,
    CRYPTUI_SELECT_INTENDEDUSE_COLUMN  = 0x0000000000000004,
    CRYPTUI_SELECT_FRIENDLYNAME_COLUMN = 0x0000000000000008,
    CRYPTUI_SELECT_LOCATION_COLUMN     = 0x0000000000000010,
    CRYPTUI_SELECT_EXPIRATION_COLUMN   = 0x0000000000000020,
}

enum : uint
{
    CRYPTUI_CERT_MGR_TAB_MASK        = 0x0000000f,
    CRYPTUI_CERT_MGR_PUBLISHER_TAB   = 0x00000004,
    CRYPTUI_CERT_MGR_SINGLE_TAB_FLAG = 0x00008000,
}

enum : uint
{
    CRYPTUI_WIZ_DIGITAL_SIGN_EXCLUDE_PAGE_HASHES = 0x00000002,
    CRYPTUI_WIZ_DIGITAL_SIGN_INCLUDE_PAGE_HASHES = 0x00000004,
}

enum uint CRYPTUI_WIZ_EXPORT_FORMAT_SERIALIZED_CERT_STORE = 0x00000005;
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/cryptdlg/ns-cryptdlg-cert_select_struct_a))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/cryptdlg/ns-cryptdlg-cert_select_struct_w))], [])
...
//STRUCT ATTR: AnsiAttribute : CustomAttributeSig([], [])
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/cryptdlg/ns-cryptdlg-cert_viewproperties_struct_a))], [])
...
//STRUCT ATTR: UnicodeAttribute : CustomAttributeSig([], [])
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/cryptdlg/ns-cryptdlg-cert_viewproperties_struct_w))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/cryptdlg/ns-cryptdlg-ctl_modify_request))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/cryptuiapi/ns-cryptuiapi-cert_selectui_input))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/cryptuiapi/ns-cryptuiapi-cryptui_cert_mgr_struct))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/cryptuiapi/ns-cryptuiapi-cryptui_wiz_digital_sign_blob_info))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/cryptuiapi/ns-cryptuiapi-cryptui_wiz_digital_sign_store_info))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/cryptuiapi/ns-cryptuiapi-cryptui_wiz_digital_sign_pvk_file_info))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/cryptuiapi/ns-cryptuiapi-cryptui_wiz_digital_sign_cert_pvk_info))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/cryptuiapi/ns-cryptuiapi-cryptui_wiz_digital_sign_extended_info))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/cryptuiapi/ns-cryptuiapi-cryptui_wiz_digital_sign_info))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/cryptuiapi/ns-cryptuiapi-cryptui_wiz_digital_sign_context))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/cryptuiapi/ns-cryptuiapi-cryptui_initdialog_struct))], [])
...
//STRUCT ATTR: UnicodeAttribute : CustomAttributeSig([], [])
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/cryptuiapi/ns-cryptuiapi-cryptui_viewcertificate_structw))], [])
...
//STRUCT ATTR: AnsiAttribute : CustomAttributeSig([], [])
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/cryptuiapi/ns-cryptuiapi-cryptui_viewcertificate_structa))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/cryptuiapi/ns-cryptuiapi-cryptui_wiz_export_info))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/cryptuiapi/ns-cryptuiapi-cryptui_wiz_export_certcontext_info))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/cryptuiapi/ns-cryptuiapi-cryptui_wiz_import_src_info))], [])
