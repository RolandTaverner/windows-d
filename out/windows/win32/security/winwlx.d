...
enum : uint
{
    WLX_VERSION_1_0 = 0x00010000,
    WLX_VERSION_1_1 = 0x00010001,
    WLX_VERSION_1_2 = 0x00010002,
    WLX_VERSION_1_3 = 0x00010003,
    WLX_VERSION_1_4 = 0x00010004,
}

enum uint WLX_CURRENT_VERSION = 0x00010004;

enum : uint
{
    WLX_SAS_TYPE_TIMEOUT                 = 0x00000000,
    WLX_SAS_TYPE_CTRL_ALT_DEL            = 0x00000001,
    WLX_SAS_TYPE_SCRNSVR_TIMEOUT         = 0x00000002,
    WLX_SAS_TYPE_SCRNSVR_ACTIVITY        = 0x00000003,
    WLX_SAS_TYPE_USER_LOGOFF             = 0x00000004,
    WLX_SAS_TYPE_SC_INSERT               = 0x00000005,
    WLX_SAS_TYPE_SC_REMOVE               = 0x00000006,
    WLX_SAS_TYPE_AUTHENTICATED           = 0x00000007,
    WLX_SAS_TYPE_SC_FIRST_READER_ARRIVED = 0x00000008,
    WLX_SAS_TYPE_SC_LAST_READER_REMOVED  = 0x00000009,
}

enum : uint
{
    WLX_SAS_TYPE_SWITCHUSER     = 0x0000000a,
    WLX_SAS_TYPE_MAX_MSFT_VALUE = 0x0000007f,
}

enum uint WLX_LOGON_OPT_NO_PROFILE = 0x00000001;

enum : uint
{
    WLX_PROFILE_TYPE_V1_0 = 0x00000001,
    WLX_PROFILE_TYPE_V2_0 = 0x00000002,
}

enum : uint
{
    WLX_SAS_ACTION_LOGON                = 0x00000001,
    WLX_SAS_ACTION_NONE                 = 0x00000002,
    WLX_SAS_ACTION_LOCK_WKSTA           = 0x00000003,
    WLX_SAS_ACTION_LOGOFF               = 0x00000004,
    WLX_SAS_ACTION_PWD_CHANGED          = 0x00000006,
    WLX_SAS_ACTION_TASKLIST             = 0x00000007,
    WLX_SAS_ACTION_UNLOCK_WKSTA         = 0x00000008,
    WLX_SAS_ACTION_FORCE_LOGOFF         = 0x00000009,
    WLX_SAS_ACTION_SHUTDOWN_SLEEP       = 0x0000000c,
    WLX_SAS_ACTION_SHUTDOWN_SLEEP2      = 0x0000000d,
    WLX_SAS_ACTION_SHUTDOWN_HIBERNATE   = 0x0000000e,
    WLX_SAS_ACTION_RECONNECTED          = 0x0000000f,
    WLX_SAS_ACTION_DELAYED_FORCE_LOGOFF = 0x00000010,
    WLX_SAS_ACTION_SWITCH_CONSOLE       = 0x00000011,
}

enum uint WLX_WM_SAS = 0x00000659;

enum : uint
{
    WLX_DLG_SAS           = 0x00000065,
    WLX_DLG_INPUT_TIMEOUT = 0x00000066,
}

enum uint WLX_DLG_SCREEN_SAVER_TIMEOUT = 0x00000067;
enum uint WLX_DLG_USER_LOGOFF = 0x00000068;
enum uint WLX_DIRECTORY_LENGTH = 0x00000100;

enum : uint
{
    WLX_CREDENTIAL_TYPE_V1_0 = 0x00000001,
    WLX_CREDENTIAL_TYPE_V2_0 = 0x00000002,
}

enum uint WLX_CONSOLESWITCHCREDENTIAL_TYPE_V1_0 = 0x00000001;

enum : uint
{
    STATUSMSG_OPTION_NOANIMATION   = 0x00000001,
    STATUSMSG_OPTION_SETFOREGROUND = 0x00000002,
}

enum : uint
{
    WLX_DESKTOP_NAME   = 0x00000001,
    WLX_DESKTOP_HANDLE = 0x00000002,
}

enum : uint
{
    WLX_CREATE_INSTANCE_ONLY = 0x00000001,
    WLX_CREATE_USER          = 0x00000002,
}

enum : uint
{
    WLX_OPTION_USE_CTRL_ALT_DEL  = 0x00000001,
    WLX_OPTION_CONTEXT_POINTER   = 0x00000002,
    WLX_OPTION_USE_SMART_CARD    = 0x00000003,
    WLX_OPTION_FORCE_LOGOFF_TIME = 0x00000004,
}

enum uint WLX_OPTION_IGNORE_AUTO_LOGON = 0x00000008;

enum : uint
{
    WLX_OPTION_NO_SWITCH_ON_SAS    = 0x00000009,
    WLX_OPTION_SMART_CARD_PRESENT  = 0x00010001,
    WLX_OPTION_SMART_CARD_INFO     = 0x00010002,
    WLX_OPTION_DISPATCH_TABLE_SIZE = 0x00010003,
}
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winwlx/ns-winwlx-wlx_profile_v1_0))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winwlx/ns-winwlx-wlx_profile_v2_0))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winwlx/ns-winwlx-wlx_mpr_notify_info))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winwlx/ns-winwlx-wlx_terminal_services_data))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winwlx/ns-winwlx-wlx_client_credentials_info_v1_0))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winwlx/ns-winwlx-wlx_client_credentials_info_v2_0))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winwlx/ns-winwlx-wlx_consoleswitch_credentials_info_v1_0))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winwlx/ns-winwlx-wlx_desktop))], [])
struct WLX_DESKTOP
{
    uint  Size;
    uint  Flags;
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winwlx/ns-winwlx-wlx_dispatch_version_1_0))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winwlx/ns-winwlx-wlx_dispatch_version_1_1))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winwlx/ns-winwlx-wlx_dispatch_version_1_2))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winwlx/ns-winwlx-wlx_dispatch_version_1_3))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winwlx/ns-winwlx-wlx_dispatch_version_1_4))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winwlx/ns-winwlx-wlx_notification_info))], [])
