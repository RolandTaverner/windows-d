...
enum : uint
{
    SAFER_TOKEN_NULL_IF_EQUAL = 0x00000001U,
    SAFER_TOKEN_COMPARE_ONLY  = 0x00000002U,
    SAFER_TOKEN_MAKE_INERT    = 0x00000004U,
    SAFER_TOKEN_WANT_FLAGS    = 0x00000008U,
}

// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/winsafer/ne-winsafer-safer_policy_info_class
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/winsafer/ne-winsafer-safer_object_info_class
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/winsafer/ne-winsafer-safer_identification_types
...
enum : uint
{
    SAFER_SCOPEID_MACHINE = 0x00000001U,
    SAFER_SCOPEID_USER    = 0x00000002U,
}

enum : uint
{
    SAFER_LEVELID_FULLYTRUSTED = 0x00040000U,
    SAFER_LEVELID_NORMALUSER   = 0x00020000U,
    SAFER_LEVELID_CONSTRAINED  = 0x00010000U,
    SAFER_LEVELID_UNTRUSTED    = 0x00001000U,
    SAFER_LEVELID_DISALLOWED   = 0x00000000U,
    SAFER_LEVEL_OPEN           = 0x00000001U,
}

enum uint SAFER_MAX_FRIENDLYNAME_SIZE = 0x00000100U;
enum uint SAFER_MAX_DESCRIPTION_SIZE = 0x00000100U;
enum uint SAFER_MAX_HASH_SIZE = 0x00000040U;

enum : uint
{
    SAFER_CRITERIA_IMAGEPATH    = 0x00000001U,
    SAFER_CRITERIA_NOSIGNEDHASH = 0x00000002U,
    SAFER_CRITERIA_IMAGEHASH    = 0x00000004U,
    SAFER_CRITERIA_AUTHENTICODE = 0x00000008U,
    SAFER_CRITERIA_URLZONE      = 0x00000010U,
    SAFER_CRITERIA_APPX_PACKAGE = 0x00000020U,
    SAFER_CRITERIA_IMAGEPATH_NT = 0x00001000U,
}

enum : uint
{
    SAFER_POLICY_JOBID_MASK                 = 0xff000000U,
    SAFER_POLICY_JOBID_CONSTRAINED          = 0x04000000U,
    SAFER_POLICY_JOBID_UNTRUSTED            = 0x03000000U,
    SAFER_POLICY_ONLY_EXES                  = 0x00010000U,
    SAFER_POLICY_SANDBOX_INERT              = 0x00020000U,
    SAFER_POLICY_HASH_DUPLICATE             = 0x00040000U,
    SAFER_POLICY_ONLY_AUDIT                 = 0x00001000U,
    SAFER_POLICY_BLOCK_CLIENT_UI            = 0x00002000U,
    SAFER_POLICY_UIFLAGS_MASK               = 0x000000ffU,
    SAFER_POLICY_UIFLAGS_INFORMATION_PROMPT = 0x00000001U,
    SAFER_POLICY_UIFLAGS_OPTION_PROMPT      = 0x00000002U,
    SAFER_POLICY_UIFLAGS_HIDDEN             = 0x00000004U,
}
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/winsafer/ns-winsafer-safer_code_properties_v1
...
//STRUCT ATTR: StructSizeFieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(cbSize))], [])
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/winsafer/ns-winsafer-safer_code_properties_v2
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/winsafer/ns-winsafer-safer_identification_header
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/winsafer/ns-winsafer-safer_pathname_identification
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/winsafer/ns-winsafer-safer_hash_identification
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/winsafer/ns-winsafer-safer_urlzone_identification
