...
enum : ushort
{
    ...
    COMPRESSION_FORMAT_LZ4         = 0x0006,
    COMPRESSION_FORMAT_DEFLATE     = 0x0007,
    COMPRESSION_FORMAT_ZLIB        = 0x0008,
}
...
enum uint CLFS_FLAG_NON_REENTRANT_FILTER = 0x00000010;
enum uint CLFS_FLAG_REENTRANT_FILTER = 0x00000020;
enum uint CLFS_FLAG_IGNORE_SHARE_ACCESS = 0x00000040;
enum uint CLFS_FLAG_READ_IN_PROGRESS = 0x00000080;
enum uint CLFS_FLAG_MINIFILTER_LEVEL = 0x00000100;
...
enum uint CRM_PROTOCOL_EXPLICIT_MARSHAL_ONLY = 0x00000001;
enum uint CRM_PROTOCOL_DYNAMIC_MARSHAL_INFO = 0x00000002;
enum uint CRM_PROTOCOL_MAXIMUM_OPTION = 0x00000003;
...
enum uint TRANSACTION_NOTIFICATION_TM_ONLINE_FLAG_IS_CLUSTERED = 0x00000001;
...
enum uint MAX_TRANSACTION_DESCRIPTION_LENGTH = 0x00000040;
...
enum uint IOCTL_VOLUME_QUERY_ALLOCATION_HINT = 0x00564052;
...
enum uint CSV_BLOCK_CACHE_CALLBACK_VERSION = 0x00000001;
...
enum uint _FT_TYPES_DEFINITION_ = 0x00000001;
...
enum uint CLFS_MGMT_CLIENT_REGISTRATION_VERSION = 0x00000001;
...
enum uint INVALID_FILE_ATTRIBUTES = 0xffffffff;
enum uint SHARE_NETNAME_PARMNUM = 0x00000001;
enum uint SHARE_TYPE_PARMNUM = 0x00000003;
enum uint SHARE_REMARK_PARMNUM = 0x00000004;
enum uint SHARE_PERMISSIONS_PARMNUM = 0x00000005;
enum uint SHARE_MAX_USES_PARMNUM = 0x00000006;
enum uint SHARE_CURRENT_USES_PARMNUM = 0x00000007;
...
enum uint SHARE_FILE_SD_PARMNUM = 0x000001f5;
enum uint SHARE_SERVER_PARMNUM = 0x000001f7;
enum uint SHARE_QOS_POLICY_PARMNUM = 0x000001f8;
enum uint SHI1_NUM_ELEMENTS = 0x00000004;
enum uint SHI2_NUM_ELEMENTS = 0x0000000a;
...
enum uint SHI_USES_UNLIMITED = 0xffffffff;
...
enum uint SHI1005_FLAGS_RESTRICT_EXCLUSIVE_OPENS = 0x00000100;
...
enum uint SESI1_NUM_ELEMENTS = 0x00000008;
enum uint SESI2_NUM_ELEMENTS = 0x00000009;
enum uint STATSOPT_CLR = 0x00000001;
...
enum uint NTMS_OBJECTNAME_LENGTH = 0x00000040;
enum uint NTMS_DESCRIPTION_LENGTH = 0x0000007f;
enum uint NTMS_DEVICENAME_LENGTH = 0x00000040;
enum uint NTMS_SERIALNUMBER_LENGTH = 0x00000020;
enum uint NTMS_REVISION_LENGTH = 0x00000020;
enum uint NTMS_BARCODE_LENGTH = 0x00000040;
enum uint NTMS_SEQUENCE_LENGTH = 0x00000020;
enum uint NTMS_VENDORNAME_LENGTH = 0x00000080;
enum uint NTMS_PRODUCTNAME_LENGTH = 0x00000080;
enum uint NTMS_USERNAME_LENGTH = 0x00000040;
enum uint NTMS_APPLICATIONNAME_LENGTH = 0x00000040;
enum uint NTMS_COMPUTERNAME_LENGTH = 0x00000040;
enum uint NTMS_I1_MESSAGE_LENGTH = 0x0000007f;
enum uint NTMS_MESSAGE_LENGTH = 0x00000100;
enum uint NTMS_POOLHIERARCHY_LENGTH = 0x00000200;
...
enum uint VS_VERSION_INFO = 0x00000001;
...
enum uint EFS_SUBVER_UNKNOWN = 0x00000000;
...
enum uint MAX_SID_SIZE = 0x00000100;
...
enum uint WIM_PROVIDER_HASH_SIZE = 0x00000014;
...
enum uint CLFS_MAX_CONTAINER_INFO = 0x00000100;
