...
enum : uint
{
    CERT_TYPE_EMPTY  = 0x00000000,
    CERT_TYPE_ASCm   = 0x00000001,
    CERT_TYPE_PCp    = 0x00000002,
    CERT_TYPE_ASCh   = 0x00000003,
    CERT_TYPE_HCh    = 0x00000004,
    CERT_TYPE_SIGNER = 0x00000006,
}
...
enum : uint
{
    CERT_VALIDATION_POLICY_RESERVED = 0x00000000,
    CERT_VALIDATION_POLICY_NONE     = 0x00000001,
    CERT_VALIDATION_POLICY_BASIC    = 0x00000002,
    CERT_VALIDATION_POLICY_EXTENDED = 0x00000003,
}
...
enum : uint
{
    CERT_CAPABILITY_HASH_ALG                    = 0x00000001,
    CERT_CAPABILITY_ASYMMETRIC_KEY_CRYPTOGRAPHY = 0x00000002,
}

enum : uint
{
    CERT_CAPABILITY_SIGNATURE_ALG       = 0x00000003,
    CERT_CAPABILITY_CERTIFICATE_SUPPORT = 0x00000004,
    CERT_CAPABILITY_OPTIONAL_FEATURES   = 0x00000005,
}

enum uint CERT_MAX_CAPABILITY = 0x000000ff;
...
enum : uint
{
    AUDIO_CHANNELCOUNT_MONO   = 0x00000001,
    AUDIO_CHANNELCOUNT_STEREO = 0x00000002,
}
...
enum : uint
{
    CREATOROPENWITHUIOPTION_HIDDEN  = 0x00000000,
    CREATOROPENWITHUIOPTION_VISIBLE = 0x00000001,
}
...
enum : uint
{
    ISDEFAULTSAVE_NONE     = 0x00000000,
    ISDEFAULTSAVE_OWNER    = 0x00000001,
    ISDEFAULTSAVE_NONOWNER = 0x00000002,
    ISDEFAULTSAVE_BOTH     = 0x00000003,
}
...
enum : uint
{
    FILEOFFLINEAVAILABILITYSTATUS_NOTAVAILABLEOFFLINE = 0x00000000,
    FILEOFFLINEAVAILABILITYSTATUS_PARTIAL             = 0x00000001,
    FILEOFFLINEAVAILABILITYSTATUS_COMPLETE            = 0x00000002,
    FILEOFFLINEAVAILABILITYSTATUS_COMPLETE_PINNED     = 0x00000003,
    FILEOFFLINEAVAILABILITYSTATUS_EXCLUDED            = 0x00000004,
    FILEOFFLINEAVAILABILITYSTATUS_FOLDER_EMPTY        = 0x00000005,
}
...
enum : uint
{
    OFFLINEAVAILABILITY_NOT_AVAILABLE    = 0x00000000,
    OFFLINEAVAILABILITY_AVAILABLE        = 0x00000001,
    OFFLINEAVAILABILITY_ALWAYS_AVAILABLE = 0x00000002,
}
...
enum : uint
{
    OFFLINESTATUS_ONLINE                        = 0x00000000,
    OFFLINESTATUS_OFFLINE                       = 0x00000001,
    OFFLINESTATUS_OFFLINE_FORCED                = 0x00000002,
    OFFLINESTATUS_OFFLINE_SLOW                  = 0x00000003,
    OFFLINESTATUS_OFFLINE_ERROR                 = 0x00000004,
    OFFLINESTATUS_OFFLINE_ITEM_VERSION_CONFLICT = 0x00000005,
    OFFLINESTATUS_OFFLINE_SUSPENDED             = 0x00000006,
}
...
enum : uint
{
    RATING_ONE_STAR_MIN = 0x00000001,
    RATING_ONE_STAR_SET = 0x00000001,
    RATING_ONE_STAR_MAX = 0x0000000c,
}

enum : uint
{
    RATING_TWO_STARS_MIN = 0x0000000d,
    RATING_TWO_STARS_SET = 0x00000019,
    RATING_TWO_STARS_MAX = 0x00000025,
}

enum : uint
{
    RATING_THREE_STARS_MIN = 0x00000026,
    RATING_THREE_STARS_SET = 0x00000032,
    RATING_THREE_STARS_MAX = 0x0000003e,
}

enum : uint
{
    RATING_FOUR_STARS_MIN = 0x0000003f,
    RATING_FOUR_STARS_SET = 0x0000004b,
    RATING_FOUR_STARS_MAX = 0x00000057,
}

enum : uint
{
    RATING_FIVE_STARS_MIN = 0x00000058,
    RATING_FIVE_STARS_SET = 0x00000063,
    RATING_FIVE_STARS_MAX = 0x00000063,
}
...
enum : uint
{
    SHARINGSTATUS_NOTSHARED = 0x00000000,
    SHARINGSTATUS_SHARED    = 0x00000001,
    SHARINGSTATUS_PRIVATE   = 0x00000002,
}
...
enum uint STORAGEPROVIDERCUSTOM_ICON_PHONE = 0x00000000;
...
enum : uint
{
    STORAGE_PROVIDER_SHARINGSTATUS_NOTSHARED      = 0x00000000,
    STORAGE_PROVIDER_SHARINGSTATUS_SHARED         = 0x00000001,
    STORAGE_PROVIDER_SHARINGSTATUS_PRIVATE        = 0x00000002,
    STORAGE_PROVIDER_SHARINGSTATUS_PUBLIC         = 0x00000003,
    STORAGE_PROVIDER_SHARINGSTATUS_SHARED_OWNED   = 0x00000004,
    STORAGE_PROVIDER_SHARINGSTATUS_SHARED_COOWNED = 0x00000005,
    STORAGE_PROVIDER_SHARINGSTATUS_PUBLIC_OWNED   = 0x00000006,
    STORAGE_PROVIDER_SHARINGSTATUS_PUBLIC_COOWNED = 0x00000007,
}
...
enum : uint
{
    STORAGEPROVIDERUSERACCOUNTKIND_UNKNOWN  = 0x00000000,
    STORAGEPROVIDERUSERACCOUNTKIND_CONSUMER = 0x00000001,
    STORAGEPROVIDERUSERACCOUNTKIND_BUSINESS = 0x00000002,
}
...
enum : uint
{
    BLUETOOTH_ADDRESS_TYPE_PUBLIC = 0x00000000,
    BLUETOOTH_ADDRESS_TYPE_RANDOM = 0x00000001,
}
...
enum : uint
{
    BLUETOOTH_CACHE_MODE_CACHED    = 0x00000000,
    BLUETOOTH_CACHED_MODE_UNCACHED = 0x00000001,
}
...
enum : uint
{
    PLAYBACKSTATE_UNKNOWN         = 0x00000000,
    PLAYBACKSTATE_STOPPED         = 0x00000001,
    PLAYBACKSTATE_PLAYING         = 0x00000002,
    PLAYBACKSTATE_TRANSITIONING   = 0x00000003,
    PLAYBACKSTATE_PAUSED          = 0x00000004,
    PLAYBACKSTATE_RECORDINGPAUSED = 0x00000005,
    PLAYBACKSTATE_RECORDING       = 0x00000006,
    PLAYBACKSTATE_NOMEDIA         = 0x00000007,
}
...
enum : uint
{
    PHOTO_CONTRAST_NORMAL = 0x00000000,
    PHOTO_CONTRAST_SOFT   = 0x00000001,
    PHOTO_CONTRAST_HARD   = 0x00000002,
}
...
enum : uint
{
    PHOTO_EXPOSUREPROGRAM_UNKNOWN   = 0x00000000,
    PHOTO_EXPOSUREPROGRAM_MANUAL    = 0x00000001,
    PHOTO_EXPOSUREPROGRAM_NORMAL    = 0x00000002,
    PHOTO_EXPOSUREPROGRAM_APERTURE  = 0x00000003,
    PHOTO_EXPOSUREPROGRAM_SHUTTER   = 0x00000004,
    PHOTO_EXPOSUREPROGRAM_CREATIVE  = 0x00000005,
    PHOTO_EXPOSUREPROGRAM_ACTION    = 0x00000006,
    PHOTO_EXPOSUREPROGRAM_PORTRAIT  = 0x00000007,
    PHOTO_EXPOSUREPROGRAM_LANDSCAPE = 0x00000008,
}
...
enum : uint
{
    PHOTO_FLASH_NONE                           = 0x00000000,
    PHOTO_FLASH_FLASH                          = 0x00000001,
    PHOTO_FLASH_WITHOUTSTROBE                  = 0x00000005,
    PHOTO_FLASH_WITHSTROBE                     = 0x00000007,
    PHOTO_FLASH_FLASH_COMPULSORY               = 0x00000009,
    PHOTO_FLASH_FLASH_COMPULSORY_NORETURNLIGHT = 0x0000000d,
    PHOTO_FLASH_FLASH_COMPULSORY_RETURNLIGHT   = 0x0000000f,
}

enum : uint
{
    PHOTO_FLASH_NONE_COMPULSORY          = 0x00000010,
    PHOTO_FLASH_NONE_AUTO                = 0x00000018,
    PHOTO_FLASH_FLASH_AUTO               = 0x00000019,
    PHOTO_FLASH_FLASH_AUTO_NORETURNLIGHT = 0x0000001d,
    PHOTO_FLASH_FLASH_AUTO_RETURNLIGHT   = 0x0000001f,
}

enum : uint
{
    PHOTO_FLASH_NOFUNCTION                            = 0x00000020,
    PHOTO_FLASH_FLASH_REDEYE                          = 0x00000041,
    PHOTO_FLASH_FLASH_REDEYE_NORETURNLIGHT            = 0x00000045,
    PHOTO_FLASH_FLASH_REDEYE_RETURNLIGHT              = 0x00000047,
    PHOTO_FLASH_FLASH_COMPULSORY_REDEYE               = 0x00000049,
    PHOTO_FLASH_FLASH_COMPULSORY_REDEYE_NORETURNLIGHT = 0x0000004d,
    PHOTO_FLASH_FLASH_COMPULSORY_REDEYE_RETURNLIGHT   = 0x0000004f,
}

enum : uint
{
    PHOTO_FLASH_FLASH_AUTO_REDEYE               = 0x00000059,
    PHOTO_FLASH_FLASH_AUTO_REDEYE_NORETURNLIGHT = 0x0000005d,
    PHOTO_FLASH_FLASH_AUTO_REDEYE_RETURNLIGHT   = 0x0000005f,
}
...
enum : uint
{
    PHOTO_LIGHTSOURCE_UNKNOWN     = 0x00000000,
    PHOTO_LIGHTSOURCE_DAYLIGHT    = 0x00000001,
    PHOTO_LIGHTSOURCE_FLUORESCENT = 0x00000002,
    PHOTO_LIGHTSOURCE_TUNGSTEN    = 0x00000003,
    PHOTO_LIGHTSOURCE_STANDARD_A  = 0x00000011,
    PHOTO_LIGHTSOURCE_STANDARD_B  = 0x00000012,
    PHOTO_LIGHTSOURCE_STANDARD_C  = 0x00000013,
    PHOTO_LIGHTSOURCE_D55         = 0x00000014,
    PHOTO_LIGHTSOURCE_D65         = 0x00000015,
    PHOTO_LIGHTSOURCE_D75         = 0x00000016,
}
...
enum : uint
{
    PHOTO_PROGRAMMODE_NOTDEFINED = 0x00000000,
    PHOTO_PROGRAMMODE_MANUAL     = 0x00000001,
    PHOTO_PROGRAMMODE_NORMAL     = 0x00000002,
    PHOTO_PROGRAMMODE_APERTURE   = 0x00000003,
    PHOTO_PROGRAMMODE_SHUTTER    = 0x00000004,
    PHOTO_PROGRAMMODE_CREATIVE   = 0x00000005,
    PHOTO_PROGRAMMODE_ACTION     = 0x00000006,
    PHOTO_PROGRAMMODE_PORTRAIT   = 0x00000007,
    PHOTO_PROGRAMMODE_LANDSCAPE  = 0x00000008,
}
...
enum : uint
{
    PHOTO_SATURATION_NORMAL = 0x00000000,
    PHOTO_SATURATION_LOW    = 0x00000001,
    PHOTO_SATURATION_HIGH   = 0x00000002,
}
...
enum : uint
{
    PHOTO_SHARPNESS_NORMAL = 0x00000000,
    PHOTO_SHARPNESS_SOFT   = 0x00000001,
    PHOTO_SHARPNESS_HARD   = 0x00000002,
}
...
enum : uint
{
    PHOTO_WHITEBALANCE_AUTO   = 0x00000000,
    PHOTO_WHITEBALANCE_MANUAL = 0x00000001,
}
...
enum : uint
{
    HOMEGROUPING_UNSPECIFIED     = 0x00000000,
    HOMEGROUPING_FREQUENT        = 0x00000001,
    HOMEGROUPING_PINNED          = 0x00000002,
    HOMEGROUPING_RECENT          = 0x00000003,
    HOMEGROUPING_RECOMMENDATIONS = 0x00000004,
    HOMEGROUPING_SHARED          = 0x00000005,
}
...
enum : uint
{
    STORAGEPROVIDERSTATE_NONE                = 0x00000000,
    STORAGEPROVIDERSTATE_SPARSE              = 0x00000001,
    STORAGEPROVIDERSTATE_IN_SYNC             = 0x00000002,
    STORAGEPROVIDERSTATE_PINNED              = 0x00000003,
    STORAGEPROVIDERSTATE_PENDING_UPLOAD      = 0x00000004,
    STORAGEPROVIDERSTATE_PENDING_DOWNLOAD    = 0x00000005,
    STORAGEPROVIDERSTATE_TRANSFERRING        = 0x00000006,
    STORAGEPROVIDERSTATE_ERROR               = 0x00000007,
    STORAGEPROVIDERSTATE_WARNING             = 0x00000008,
    STORAGEPROVIDERSTATE_EXCLUDED            = 0x00000009,
    STORAGEPROVIDERSTATE_PENDING_UNSPECIFIED = 0x0000000a,
}
...
enum : uint
{
    APPUSERMODEL_STARTPINOPTION_DEFAULT        = 0x00000000,
    APPUSERMODEL_STARTPINOPTION_NOPINONINSTALL = 0x00000001,
    APPUSERMODEL_STARTPINOPTION_USERPINNED     = 0x00000002,
}
...
enum : uint
{
    SYNC_HANDLERTYPE_OTHER       = 0x00000000,
    SYNC_HANDLERTYPE_PROGRAMS    = 0x00000001,
    SYNC_HANDLERTYPE_DEVICES     = 0x00000002,
    SYNC_HANDLERTYPE_FOLDERS     = 0x00000003,
    SYNC_HANDLERTYPE_WEBSERVICES = 0x00000004,
    SYNC_HANDLERTYPE_COMPUTERS   = 0x00000005,
}
...
enum : uint
{
    SYNC_STATE_NOTSETUP   = 0x00000000,
    SYNC_STATE_SYNCNOTRUN = 0x00000001,
    SYNC_STATE_IDLE       = 0x00000002,
    SYNC_STATE_ERROR      = 0x00000003,
    SYNC_STATE_PENDING    = 0x00000004,
    SYNC_STATE_SYNCING    = 0x00000005,
}
...
enum : uint
{
    ES_RESERVED_COM_ERROR_START = 0x00000000,
    ES_RESERVED_COM_ERROR_END   = 0x000001ff,
}

enum : uint
{
    ES_GENERAL_ERROR_START = 0x00000200,
    ES_GENERAL_ERROR_END   = 0x000003ff,
}

enum : uint
{
    ES_AUTHN_ERROR_START = 0x00000400,
    ES_AUTHN_ERROR_END   = 0x000004ff,
}

enum : uint
{
    ES_RESERVED_SILO_ERROR_START = 0x00000500,
    ES_RESERVED_SILO_ERROR_END   = 0x00000fff,
}

enum : uint
{
    ES_PW_SILO_ERROR_START = 0x00001100,
    ES_PW_SILO_ERROR_END   = 0x000011ff,
}

enum : uint
{
    ES_RESERVED_SILO_SPECIFIC_ERROR_START = 0x00001200,
    ES_RESERVED_SILO_SPECIFIC_ERROR_END   = 0x0000bfff,
}

enum : uint
{
    ES_VENDOR_ERROR_START = 0x0000c000,
    ES_VENDOR_ERROR_END   = 0x0000ffff,
}

enum uint FACILITY_ENHANCED_STORAGE = 0x00000004;
enum uint ES_E_INVALID_RESPONSE = 0xc0040200;
enum uint ES_E_UNPROVISIONED_HARDWARE = 0xc0040204;
enum uint ES_E_UNSUPPORTED_HARDWARE = 0xc0040205;
enum uint ES_E_INCOMPLETE_COMMAND = 0xc0040206;
enum uint ES_E_BAD_SEQUENCE = 0xc0040207;
enum uint ES_E_NO_PROBE = 0xc0040208;
...
enum uint ES_E_INCONSISTENT_PARAM_LENGTH = 0xc004020f;
enum uint ES_E_NO_AUTHENTICATION_REQUIRED = 0xc0040400;
enum uint ES_E_INVALID_FIELD_IDENTIFIER = 0xc0041100;
...
enum uint ES_E_FRIENDLY_NAME_TOO_LONG = 0xc0041103;
enum uint ES_E_SILO_NAME_TOO_LONG = 0xc0041104;
...
enum uint ES_E_OTHER_SECURITY_PROTOCOL_ACTIVE = 0xc0041107;
enum uint ES_E_DEVICE_DIGEST_MISSING = 0xc0041108;
enum uint ES_E_NOT_AUTHORIZED_UNEXPECTED = 0xc0041109;
enum uint ES_E_AUTHORIZED_UNEXPECTED = 0xc004110a;
enum uint ES_E_PROVISIONED_UNEXPECTED = 0xc004110b;
enum uint ES_E_UNKNOWN_DIGEST_ALGORITHM = 0xc004110c;

// Structs


//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorextensions/ns-ehstorextensions-enhanced_storage_password_silo_information))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/ns-ehstorapi-act_authorization_state))], [])
struct ACT_AUTHORIZATION_STATE
{
    uint ulState;
}

//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/ns-ehstorapi-silo_info))], [])
struct SILO_INFO
{
    uint  ulSTID;
...
//INTERFACEF ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nn-ehstorapi-ienumenhancedstorageact))], [])
interface IEnumEnhancedStorageACT : IUnknown
{
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nf-ehstorapi-ienumenhancedstorageact-getacts))], [])
    HRESULT GetACTs(IEnhancedStorageACT** pppIEnhancedStorageACTs, uint* pcEnhancedStorageACTs);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nf-ehstorapi-ienumenhancedstorageact-getmatchingact))], [])
...
//INTERFACEF ATTR: SupportedOSPlatformAttribute : CustomAttributeSig([FixedArgSig(ElementSig(windows6.0.6000))], [])
//INTERFACEF ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nn-ehstorapi-ienhancedstorageact))], [])
interface IEnhancedStorageACT : IUnknown
{
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nf-ehstorapi-ienhancedstorageact-authorize))], [])
    HRESULT Authorize(uint hwndParent, uint dwFlags);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nf-ehstorapi-ienhancedstorageact-unauthorize))], [])
    HRESULT Unauthorize();
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nf-ehstorapi-ienhancedstorageact-getauthorizationstate))], [])
    HRESULT GetAuthorizationState(ACT_AUTHORIZATION_STATE* pState);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nf-ehstorapi-ienhancedstorageact-getmatchingvolume))], [])
    HRESULT GetMatchingVolume(PWSTR* ppwszVolume);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nf-ehstorapi-ienhancedstorageact-getuniqueidentity))], [])
    HRESULT GetUniqueIdentity(PWSTR* ppwszIdentity);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nf-ehstorapi-ienhancedstorageact-getsilos))], [])
...
//INTERFACEF ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nn-ehstorapi-ienhancedstorageact2))], [])
interface IEnhancedStorageACT2 : IEnhancedStorageACT
{
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nf-ehstorapi-ienhancedstorageact2-getdevicename))], [])
    HRESULT GetDeviceName(PWSTR* ppwszDeviceName);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nf-ehstorapi-ienhancedstorageact2-isdeviceremovable))], [])
...
//INTERFACEF ATTR: SupportedOSPlatformAttribute : CustomAttributeSig([FixedArgSig(ElementSig(windows6.0.6000))], [])
//INTERFACEF ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nn-ehstorapi-ienhancedstoragesilo))], [])
interface IEnhancedStorageSilo : IUnknown
{
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nf-ehstorapi-ienhancedstoragesilo-getinfo))], [])
    HRESULT GetInfo(SILO_INFO* pSiloInfo);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nf-ehstorapi-ienhancedstoragesilo-getactions))], [])
    HRESULT GetActions(IEnhancedStorageSiloAction** pppIEnhancedStorageSiloActions, 
                       uint* pcEnhancedStorageSiloActions);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nf-ehstorapi-ienhancedstoragesilo-sendcommand))], [])
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nf-ehstorapi-ienhancedstoragesilo-getportabledevice))], [])
    HRESULT GetPortableDevice(IPortableDevice* ppIPortableDevice);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nf-ehstorapi-ienhancedstoragesilo-getdevicepath))], [])
    HRESULT GetDevicePath(PWSTR* ppwszSiloDevicePath);
}

@GUID("b6f7f311-206f-4ff8-9c4b-27efee77a86f")
//INTERFACEF ATTR: SupportedOSPlatformAttribute : CustomAttributeSig([FixedArgSig(ElementSig(windows6.0.6000))], [])
//INTERFACEF ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nn-ehstorapi-ienhancedstoragesiloaction))], [])
interface IEnhancedStorageSiloAction : IUnknown
{
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nf-ehstorapi-ienhancedstoragesiloaction-getname))], [])
    HRESULT GetName(PWSTR* ppwszActionName);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nf-ehstorapi-ienhancedstoragesiloaction-getdescription))], [])
    HRESULT GetDescription(PWSTR* ppwszActionDescription);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ehstorapi/nf-ehstorapi-ienhancedstoragesiloaction-invoke))], [])
    HRESULT Invoke();
}
