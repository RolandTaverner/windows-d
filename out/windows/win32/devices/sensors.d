...
enum : PROPERTYKEY
{
    SENSOR_EVENT_PARAMETER_EVENT_ID = PROPERTYKEY(GUID("64346E30-8728-4B34-BDF6-4F52442C5C28"), 2),
    SENSOR_EVENT_PARAMETER_STATE    = PROPERTYKEY(GUID("64346E30-8728-4B34-BDF6-4F52442C5C28"), 3),
}
...
enum : PROPERTYKEY
{
    SENSOR_PROPERTY_TYPE                      = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 2),
    SENSOR_PROPERTY_STATE                     = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 3),
    SENSOR_PROPERTY_PERSISTENT_UNIQUE_ID      = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 5),
    SENSOR_PROPERTY_MANUFACTURER              = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 6),
    SENSOR_PROPERTY_MODEL                     = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 7),
    SENSOR_PROPERTY_SERIAL_NUMBER             = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 8),
    SENSOR_PROPERTY_FRIENDLY_NAME             = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 9),
    SENSOR_PROPERTY_DESCRIPTION               = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 10),
    SENSOR_PROPERTY_CONNECTION_TYPE           = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 11),
    SENSOR_PROPERTY_MIN_REPORT_INTERVAL       = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 12),
    SENSOR_PROPERTY_CURRENT_REPORT_INTERVAL   = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 13),
    SENSOR_PROPERTY_CHANGE_SENSITIVITY        = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 14),
    SENSOR_PROPERTY_DEVICE_PATH               = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 15),
    SENSOR_PROPERTY_LIGHT_RESPONSE_CURVE      = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 16),
    SENSOR_PROPERTY_ACCURACY                  = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 17),
    SENSOR_PROPERTY_RESOLUTION                = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 18),
    SENSOR_PROPERTY_LOCATION_DESIRED_ACCURACY = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 19),
}

enum : PROPERTYKEY
{
    SENSOR_PROPERTY_RANGE_MINIMUM        = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 20),
    SENSOR_PROPERTY_RANGE_MAXIMUM        = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 21),
    SENSOR_PROPERTY_HID_USAGE            = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 22),
    SENSOR_PROPERTY_RADIO_STATE          = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 23),
    SENSOR_PROPERTY_RADIO_STATE_PREVIOUS = PROPERTYKEY(GUID("7F8383EC-D3EC-495C-A8CF-B8BBE85C2920"), 24),
}
...
enum PROPERTYKEY SENSOR_DATA_TYPE_TIMESTAMP = PROPERTYKEY(GUID("DB5E0CF2-CF1F-4C18-B46C-D86011D62150"), 2);
enum GUID SENSOR_DATA_TYPE_LOCATION_GUID = GUID("055c74d8-ca6f-47d6-95c6-1ed3637a0ff4");

enum : PROPERTYKEY
{
    SENSOR_DATA_TYPE_LATITUDE_DEGREES               = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 2),
    SENSOR_DATA_TYPE_LONGITUDE_DEGREES              = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 3),
    SENSOR_DATA_TYPE_ALTITUDE_SEALEVEL_METERS       = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 4),
    SENSOR_DATA_TYPE_ALTITUDE_ELLIPSOID_METERS      = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 5),
    SENSOR_DATA_TYPE_SPEED_KNOTS                    = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 6),
    SENSOR_DATA_TYPE_TRUE_HEADING_DEGREES           = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 7),
    SENSOR_DATA_TYPE_MAGNETIC_HEADING_DEGREES       = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 8),
    SENSOR_DATA_TYPE_MAGNETIC_VARIATION             = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 9),
    SENSOR_DATA_TYPE_FIX_QUALITY                    = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 10),
    SENSOR_DATA_TYPE_FIX_TYPE                       = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 11),
    SENSOR_DATA_TYPE_POSITION_DILUTION_OF_PRECISION = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 12),
}

enum PROPERTYKEY SENSOR_DATA_TYPE_HORIZONAL_DILUTION_OF_PRECISION = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 13);
enum PROPERTYKEY SENSOR_DATA_TYPE_VERTICAL_DILUTION_OF_PRECISION = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 14);

enum : PROPERTYKEY
{
    SENSOR_DATA_TYPE_SATELLITES_USED_COUNT        = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 15),
    SENSOR_DATA_TYPE_SATELLITES_USED_PRNS         = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 16),
    SENSOR_DATA_TYPE_SATELLITES_IN_VIEW           = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 17),
    SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_PRNS      = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 18),
    SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_ELEVATION = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 19),
    SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_AZIMUTH   = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 20),
    SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_STN_RATIO = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 21),
}

enum : PROPERTYKEY
{
    SENSOR_DATA_TYPE_ERROR_RADIUS_METERS             = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 22),
    SENSOR_DATA_TYPE_ADDRESS1                        = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 23),
    SENSOR_DATA_TYPE_ADDRESS2                        = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 24),
    SENSOR_DATA_TYPE_CITY                            = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 25),
    SENSOR_DATA_TYPE_STATE_PROVINCE                  = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 26),
    SENSOR_DATA_TYPE_POSTALCODE                      = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 27),
    SENSOR_DATA_TYPE_COUNTRY_REGION                  = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 28),
    SENSOR_DATA_TYPE_ALTITUDE_ELLIPSOID_ERROR_METERS = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 29),
    SENSOR_DATA_TYPE_ALTITUDE_SEALEVEL_ERROR_METERS  = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 30),
}

enum : PROPERTYKEY
{
    SENSOR_DATA_TYPE_GPS_SELECTION_MODE               = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 31),
    SENSOR_DATA_TYPE_GPS_OPERATION_MODE               = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 32),
    SENSOR_DATA_TYPE_GPS_STATUS                       = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 33),
    SENSOR_DATA_TYPE_GEOIDAL_SEPARATION               = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 34),
    SENSOR_DATA_TYPE_DGPS_DATA_AGE                    = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 35),
    SENSOR_DATA_TYPE_ALTITUDE_ANTENNA_SEALEVEL_METERS = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 36),
}

enum PROPERTYKEY SENSOR_DATA_TYPE_DIFFERENTIAL_REFERENCE_STATION_ID = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 37);

enum : PROPERTYKEY
{
    SENSOR_DATA_TYPE_NMEA_SENTENCE                           = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 38),
    SENSOR_DATA_TYPE_SATELLITES_IN_VIEW_ID                   = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 39),
    SENSOR_DATA_TYPE_LOCATION_SOURCE                         = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 40),
    SENSOR_DATA_TYPE_SATELLITES_USED_PRNS_AND_CONSTELLATIONS = PROPERTYKEY(GUID("055C74D8-CA6F-47D6-95C6-1ED3637A0FF4"), 41),
}
...
enum : PROPERTYKEY
{
    SENSOR_DATA_TYPE_TEMPERATURE_CELSIUS                  = PROPERTYKEY(GUID("8B0AA2F1-2D57-42EE-8CC0-4D27622B46C4"), 2),
    SENSOR_DATA_TYPE_RELATIVE_HUMIDITY_PERCENT            = PROPERTYKEY(GUID("8B0AA2F1-2D57-42EE-8CC0-4D27622B46C4"), 3),
    SENSOR_DATA_TYPE_ATMOSPHERIC_PRESSURE_BAR             = PROPERTYKEY(GUID("8B0AA2F1-2D57-42EE-8CC0-4D27622B46C4"), 4),
    SENSOR_DATA_TYPE_WIND_DIRECTION_DEGREES_ANTICLOCKWISE = PROPERTYKEY(GUID("8B0AA2F1-2D57-42EE-8CC0-4D27622B46C4"), 5),
    SENSOR_DATA_TYPE_WIND_SPEED_METERS_PER_SECOND         = PROPERTYKEY(GUID("8B0AA2F1-2D57-42EE-8CC0-4D27622B46C4"), 6),
}
...
enum : PROPERTYKEY
{
    SENSOR_DATA_TYPE_ACCELERATION_X_G                                  = PROPERTYKEY(GUID("3F8A69A2-07C5-4E48-A965-CD797AAB56D5"), 2),
    SENSOR_DATA_TYPE_ACCELERATION_Y_G                                  = PROPERTYKEY(GUID("3F8A69A2-07C5-4E48-A965-CD797AAB56D5"), 3),
    SENSOR_DATA_TYPE_ACCELERATION_Z_G                                  = PROPERTYKEY(GUID("3F8A69A2-07C5-4E48-A965-CD797AAB56D5"), 4),
    SENSOR_DATA_TYPE_ANGULAR_ACCELERATION_X_DEGREES_PER_SECOND_SQUARED = PROPERTYKEY(GUID("3F8A69A2-07C5-4E48-A965-CD797AAB56D5"), 5),
    SENSOR_DATA_TYPE_ANGULAR_ACCELERATION_Y_DEGREES_PER_SECOND_SQUARED = PROPERTYKEY(GUID("3F8A69A2-07C5-4E48-A965-CD797AAB56D5"), 6),
    SENSOR_DATA_TYPE_ANGULAR_ACCELERATION_Z_DEGREES_PER_SECOND_SQUARED = PROPERTYKEY(GUID("3F8A69A2-07C5-4E48-A965-CD797AAB56D5"), 7),
}

enum : PROPERTYKEY
{
    SENSOR_DATA_TYPE_SPEED_METERS_PER_SECOND               = PROPERTYKEY(GUID("3F8A69A2-07C5-4E48-A965-CD797AAB56D5"), 8),
    SENSOR_DATA_TYPE_MOTION_STATE                          = PROPERTYKEY(GUID("3F8A69A2-07C5-4E48-A965-CD797AAB56D5"), 9),
    SENSOR_DATA_TYPE_ANGULAR_VELOCITY_X_DEGREES_PER_SECOND = PROPERTYKEY(GUID("3F8A69A2-07C5-4E48-A965-CD797AAB56D5"), 10),
    SENSOR_DATA_TYPE_ANGULAR_VELOCITY_Y_DEGREES_PER_SECOND = PROPERTYKEY(GUID("3F8A69A2-07C5-4E48-A965-CD797AAB56D5"), 11),
    SENSOR_DATA_TYPE_ANGULAR_VELOCITY_Z_DEGREES_PER_SECOND = PROPERTYKEY(GUID("3F8A69A2-07C5-4E48-A965-CD797AAB56D5"), 12),
}
...
enum : PROPERTYKEY
{
    SENSOR_DATA_TYPE_TILT_X_DEGREES             = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 2),
    SENSOR_DATA_TYPE_TILT_Y_DEGREES             = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 3),
    SENSOR_DATA_TYPE_TILT_Z_DEGREES             = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 4),
    SENSOR_DATA_TYPE_MAGNETIC_HEADING_X_DEGREES = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 5),
    SENSOR_DATA_TYPE_MAGNETIC_HEADING_Y_DEGREES = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 6),
    SENSOR_DATA_TYPE_MAGNETIC_HEADING_Z_DEGREES = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 7),
}

enum : PROPERTYKEY
{
    SENSOR_DATA_TYPE_DISTANCE_X_METERS                                   = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 8),
    SENSOR_DATA_TYPE_DISTANCE_Y_METERS                                   = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 9),
    SENSOR_DATA_TYPE_DISTANCE_Z_METERS                                   = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 10),
    SENSOR_DATA_TYPE_MAGNETIC_HEADING_COMPENSATED_MAGNETIC_NORTH_DEGREES = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 11),
    SENSOR_DATA_TYPE_MAGNETIC_HEADING_COMPENSATED_TRUE_NORTH_DEGREES     = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 12),
    SENSOR_DATA_TYPE_MAGNETIC_HEADING_MAGNETIC_NORTH_DEGREES             = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 13),
    SENSOR_DATA_TYPE_MAGNETIC_HEADING_TRUE_NORTH_DEGREES                 = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 14),
}

enum : PROPERTYKEY
{
    SENSOR_DATA_TYPE_QUADRANT_ANGLE_DEGREES               = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 15),
    SENSOR_DATA_TYPE_ROTATION_MATRIX                      = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 16),
    SENSOR_DATA_TYPE_QUATERNION                           = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 17),
    SENSOR_DATA_TYPE_SIMPLE_DEVICE_ORIENTATION            = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 18),
    SENSOR_DATA_TYPE_MAGNETIC_FIELD_STRENGTH_X_MILLIGAUSS = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 19),
    SENSOR_DATA_TYPE_MAGNETIC_FIELD_STRENGTH_Y_MILLIGAUSS = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 20),
    SENSOR_DATA_TYPE_MAGNETIC_FIELD_STRENGTH_Z_MILLIGAUSS = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 21),
    SENSOR_DATA_TYPE_MAGNETOMETER_ACCURACY                = PROPERTYKEY(GUID("1637D8A2-4248-4275-865D-558DE84AEDFD"), 22),
}
...
enum : PROPERTYKEY
{
    SENSOR_DATA_TYPE_BOOLEAN_SWITCH_STATE        = PROPERTYKEY(GUID("38564A7C-F2F2-49BB-9B2B-BA60F66A58DF"), 2),
    SENSOR_DATA_TYPE_MULTIVALUE_SWITCH_STATE     = PROPERTYKEY(GUID("38564A7C-F2F2-49BB-9B2B-BA60F66A58DF"), 3),
    SENSOR_DATA_TYPE_FORCE_NEWTONS               = PROPERTYKEY(GUID("38564A7C-F2F2-49BB-9B2B-BA60F66A58DF"), 4),
    SENSOR_DATA_TYPE_ABSOLUTE_PRESSURE_PASCAL    = PROPERTYKEY(GUID("38564A7C-F2F2-49BB-9B2B-BA60F66A58DF"), 5),
    SENSOR_DATA_TYPE_GAUGE_PRESSURE_PASCAL       = PROPERTYKEY(GUID("38564A7C-F2F2-49BB-9B2B-BA60F66A58DF"), 6),
    SENSOR_DATA_TYPE_STRAIN                      = PROPERTYKEY(GUID("38564A7C-F2F2-49BB-9B2B-BA60F66A58DF"), 7),
    SENSOR_DATA_TYPE_WEIGHT_KILOGRAMS            = PROPERTYKEY(GUID("38564A7C-F2F2-49BB-9B2B-BA60F66A58DF"), 8),
    SENSOR_DATA_TYPE_BOOLEAN_SWITCH_ARRAY_STATES = PROPERTYKEY(GUID("38564A7C-F2F2-49BB-9B2B-BA60F66A58DF"), 10),
}
...
enum : PROPERTYKEY
{
    SENSOR_DATA_TYPE_HUMAN_PRESENCE         = PROPERTYKEY(GUID("2299288A-6D9E-4B0B-B7EC-3528F89E40AF"), 2),
    SENSOR_DATA_TYPE_HUMAN_PROXIMITY_METERS = PROPERTYKEY(GUID("2299288A-6D9E-4B0B-B7EC-3528F89E40AF"), 3),
    SENSOR_DATA_TYPE_TOUCH_STATE            = PROPERTYKEY(GUID("2299288A-6D9E-4B0B-B7EC-3528F89E40AF"), 4),
}
...
enum : PROPERTYKEY
{
    SENSOR_DATA_TYPE_LIGHT_LEVEL_LUX          = PROPERTYKEY(GUID("E4C77CE2-DCB7-46E9-8439-4FEC548833A6"), 2),
    SENSOR_DATA_TYPE_LIGHT_TEMPERATURE_KELVIN = PROPERTYKEY(GUID("E4C77CE2-DCB7-46E9-8439-4FEC548833A6"), 3),
    SENSOR_DATA_TYPE_LIGHT_CHROMACITY         = PROPERTYKEY(GUID("E4C77CE2-DCB7-46E9-8439-4FEC548833A6"), 4),
}

enum GUID SENSOR_DATA_TYPE_SCANNER_GUID = GUID("d7a59a3c-3421-44ab-8d3a-9de8ab6c4cae");
enum PROPERTYKEY SENSOR_DATA_TYPE_RFID_TAG_40_BIT = PROPERTYKEY(GUID("D7A59A3C-3421-44AB-8D3A-9DE8AB6C4CAE"), 2);
enum GUID SENSOR_DATA_TYPE_ELECTRICAL_GUID = GUID("bbb246d1-e242-4780-a2d3-cded84f35842");

enum : PROPERTYKEY
{
    SENSOR_DATA_TYPE_VOLTAGE_VOLTS               = PROPERTYKEY(GUID("BBB246D1-E242-4780-A2D3-CDED84F35842"), 2),
    SENSOR_DATA_TYPE_CURRENT_AMPS                = PROPERTYKEY(GUID("BBB246D1-E242-4780-A2D3-CDED84F35842"), 3),
    SENSOR_DATA_TYPE_CAPACITANCE_FARAD           = PROPERTYKEY(GUID("BBB246D1-E242-4780-A2D3-CDED84F35842"), 4),
    SENSOR_DATA_TYPE_RESISTANCE_OHMS             = PROPERTYKEY(GUID("BBB246D1-E242-4780-A2D3-CDED84F35842"), 5),
    SENSOR_DATA_TYPE_INDUCTANCE_HENRY            = PROPERTYKEY(GUID("BBB246D1-E242-4780-A2D3-CDED84F35842"), 6),
    SENSOR_DATA_TYPE_ELECTRICAL_POWER_WATTS      = PROPERTYKEY(GUID("BBB246D1-E242-4780-A2D3-CDED84F35842"), 7),
    SENSOR_DATA_TYPE_ELECTRICAL_PERCENT_OF_RANGE = PROPERTYKEY(GUID("BBB246D1-E242-4780-A2D3-CDED84F35842"), 8),
    SENSOR_DATA_TYPE_ELECTRICAL_FREQUENCY_HERTZ  = PROPERTYKEY(GUID("BBB246D1-E242-4780-A2D3-CDED84F35842"), 9),
}
...
enum : PROPERTYKEY
{
    SENSOR_DATA_TYPE_CUSTOM_USAGE         = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 5),
    SENSOR_DATA_TYPE_CUSTOM_BOOLEAN_ARRAY = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 6),
    SENSOR_DATA_TYPE_CUSTOM_VALUE1        = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 7),
    SENSOR_DATA_TYPE_CUSTOM_VALUE2        = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 8),
    SENSOR_DATA_TYPE_CUSTOM_VALUE3        = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 9),
    SENSOR_DATA_TYPE_CUSTOM_VALUE4        = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 10),
    SENSOR_DATA_TYPE_CUSTOM_VALUE5        = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 11),
    SENSOR_DATA_TYPE_CUSTOM_VALUE6        = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 12),
    SENSOR_DATA_TYPE_CUSTOM_VALUE7        = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 13),
    SENSOR_DATA_TYPE_CUSTOM_VALUE8        = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 14),
    SENSOR_DATA_TYPE_CUSTOM_VALUE9        = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 15),
    SENSOR_DATA_TYPE_CUSTOM_VALUE10       = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 16),
    SENSOR_DATA_TYPE_CUSTOM_VALUE11       = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 17),
    SENSOR_DATA_TYPE_CUSTOM_VALUE12       = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 18),
    SENSOR_DATA_TYPE_CUSTOM_VALUE13       = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 19),
    SENSOR_DATA_TYPE_CUSTOM_VALUE14       = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 20),
    SENSOR_DATA_TYPE_CUSTOM_VALUE15       = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 21),
    SENSOR_DATA_TYPE_CUSTOM_VALUE16       = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 22),
    SENSOR_DATA_TYPE_CUSTOM_VALUE17       = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 23),
    SENSOR_DATA_TYPE_CUSTOM_VALUE18       = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 24),
    SENSOR_DATA_TYPE_CUSTOM_VALUE19       = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 25),
    SENSOR_DATA_TYPE_CUSTOM_VALUE20       = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 26),
    SENSOR_DATA_TYPE_CUSTOM_VALUE21       = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 27),
    SENSOR_DATA_TYPE_CUSTOM_VALUE22       = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 28),
    SENSOR_DATA_TYPE_CUSTOM_VALUE23       = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 29),
    SENSOR_DATA_TYPE_CUSTOM_VALUE24       = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 30),
    SENSOR_DATA_TYPE_CUSTOM_VALUE25       = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 31),
    SENSOR_DATA_TYPE_CUSTOM_VALUE26       = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 32),
    SENSOR_DATA_TYPE_CUSTOM_VALUE27       = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 33),
    SENSOR_DATA_TYPE_CUSTOM_VALUE28       = PROPERTYKEY(GUID("B14C764F-07CF-41E8-9D82-EBE3D0776A6F"), 34),
}
...
enum : PROPERTYKEY
{
    SENSOR_PROPERTY_CLEAR_ASSISTANCE_DATA = PROPERTYKEY(GUID("E1E962F4-6E65-45F7-9C36-D487B7B1BD34"), 2),
    SENSOR_PROPERTY_TURN_ON_OFF_NMEA      = PROPERTYKEY(GUID("E1E962F4-6E65-45F7-9C36-D487B7B1BD34"), 3),
}
...
struct SENSOR_COLLECTION_LIST
{
    ...
    uint                 Count;
    SENSOR_VALUE_PAIR[1] List; // Flexible array
}
...
struct SENSOR_PROPERTY_LIST
{
    uint           AllocatedSizeInBytes;
    uint           Count;
    PROPERTYKEY[1] List; // Flexible array
}
