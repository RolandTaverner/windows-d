...
enum : uint
{
    IOCTL_NFCDTA_CONFIG_RF_DISCOVERY       = 0x00221400U,
    IOCTL_NFCDTA_REMOTE_DEV_GET_NEXT       = 0x00221404U,
    IOCTL_NFCDTA_REMOTE_DEV_CONNECT        = 0x00221408U,
    IOCTL_NFCDTA_REMOTE_DEV_DISCONNECT     = 0x0022140cU,
    IOCTL_NFCDTA_REMOTE_DEV_TRANSCEIVE     = 0x00221410U,
    IOCTL_NFCDTA_REMOTE_DEV_RECV           = 0x00221414U,
    IOCTL_NFCDTA_REMOTE_DEV_SEND           = 0x00221418U,
    IOCTL_NFCDTA_REMOTE_DEV_CHECK_PRESENCE = 0x0022141cU,
}

enum : uint
{
    IOCTL_NFCDTA_CONFIG_P2P_PARAM                  = 0x00221420U,
    IOCTL_NFCDTA_SET_RF_CONFIG                     = 0x00221424U,
    IOCTL_NFCDTA_REMOTE_DEV_NDEF_WRITE             = 0x00221440U,
    IOCTL_NFCDTA_REMOTE_DEV_NDEF_READ              = 0x00221444U,
    IOCTL_NFCDTA_REMOTE_DEV_NDEF_CONVERT_READ_ONLY = 0x00221448U,
    IOCTL_NFCDTA_REMOTE_DEV_NDEF_CHECK             = 0x0022144cU,
}

enum : uint
{
    IOCTL_NFCDTA_LLCP_CONFIG                = 0x00221480U,
    IOCTL_NFCDTA_LLCP_ACTIVATE              = 0x00221484U,
    IOCTL_NFCDTA_LLCP_DEACTIVATE            = 0x00221488U,
    IOCTL_NFCDTA_LLCP_DISCOVER_SERVICES     = 0x0022148cU,
    IOCTL_NFCDTA_LLCP_LINK_STATUS_CHECK     = 0x00221490U,
    IOCTL_NFCDTA_LLCP_GET_NEXT_LINK_STATUS  = 0x00221494U,
    IOCTL_NFCDTA_LLCP_SOCKET_CREATE         = 0x00221498U,
    IOCTL_NFCDTA_LLCP_SOCKET_CLOSE          = 0x0022149cU,
    IOCTL_NFCDTA_LLCP_SOCKET_BIND           = 0x002214a0U,
    IOCTL_NFCDTA_LLCP_SOCKET_LISTEN         = 0x002214a4U,
    IOCTL_NFCDTA_LLCP_SOCKET_ACCEPT         = 0x002214a8U,
    IOCTL_NFCDTA_LLCP_SOCKET_CONNECT        = 0x002214acU,
    IOCTL_NFCDTA_LLCP_SOCKET_DISCONNECT     = 0x002214b0U,
    IOCTL_NFCDTA_LLCP_SOCKET_RECV           = 0x002214b4U,
    IOCTL_NFCDTA_LLCP_SOCKET_RECV_FROM      = 0x002214b8U,
    IOCTL_NFCDTA_LLCP_SOCKET_SEND           = 0x002214bcU,
    IOCTL_NFCDTA_LLCP_SOCKET_SNED_TO        = 0x002214c0U,
    IOCTL_NFCDTA_LLCP_SOCKET_GET_NEXT_ERROR = 0x002214c4U,
}

enum : uint
{
    IOCTL_NFCDTA_SNEP_INIT_SERVER                = 0x00221500U,
    IOCTL_NFCDTA_SNEP_DEINIT_SERVER              = 0x00221504U,
    IOCTL_NFCDTA_SNEP_SERVER_GET_NEXT_CONNECTION = 0x00221508U,
    IOCTL_NFCDTA_SNEP_SERVER_ACCEPT              = 0x0022150cU,
    IOCTL_NFCDTA_SNEP_SERVER_GET_NEXT_REQUEST    = 0x00221510U,
    IOCTL_NFCDTA_SNEP_SERVER_SEND_RESPONSE       = 0x00221514U,
    IOCTL_NFCDTA_SNEP_INIT_CLIENT                = 0x00221540U,
    IOCTL_NFCDTA_SNEP_DEINIT_CLIENT              = 0x00221544U,
    IOCTL_NFCDTA_SNEP_CLIENT_PUT                 = 0x00221548U,
    IOCTL_NFCDTA_SNEP_CLIENT_GET                 = 0x0022154cU,
    IOCTL_NFCDTA_SE_ENUMERATE                    = 0x00221580U,
    IOCTL_NFCDTA_SE_SET_EMULATION_MODE           = 0x00221584U,
    IOCTL_NFCDTA_SE_SET_ROUTING_TABLE            = 0x00221588U,
    IOCTL_NFCDTA_SE_GET_NEXT_EVENT               = 0x0022158cU,
}

enum uint MAX_ATR_LENGTH = 0x00000030U;
enum uint MAX_UID_SIZE = 0x00000010U;
enum uint MAX_LLCP_SERVICE_NAME_SIZE = 0x00000100U;
enum uint MAX_SNEP_SERVER_NAME_SIZE = 0x00000100U;
...
enum uint NFCRMDDI_IOCTL_BASE = 0x00000050U;

enum : uint
{
    IOCTL_NFCRM_SET_RADIO_STATE   = 0x00510184U,
    IOCTL_NFCRM_QUERY_RADIO_STATE = 0x00510188U,
}

enum : uint
{
    IOCTL_NFCSERM_SET_RADIO_STATE   = 0x0051018cU,
    IOCTL_NFCSERM_QUERY_RADIO_STATE = 0x00510190U,
}
...
enum : uint
{
    IOCTL_NFCSE_ENUM_ENDPOINTS      = 0x00220800U,
    IOCTL_NFCSE_SUBSCRIBE_FOR_EVENT = 0x00220804U,
}

enum : uint
{
    IOCTL_NFCSE_GET_NEXT_EVENT          = 0x00220808U,
    IOCTL_NFCSE_SET_CARD_EMULATION_MODE = 0x0022080cU,
}

enum : uint
{
    IOCTL_NFCSE_GET_NFCC_CAPABILITIES = 0x00220810U,
    IOCTL_NFCSE_GET_ROUTING_TABLE     = 0x00220814U,
    IOCTL_NFCSE_SET_ROUTING_TABLE     = 0x00220818U,
    IOCTL_NFCSE_HCE_REMOTE_RECV       = 0x00220940U,
    IOCTL_NFCSE_HCE_REMOTE_SEND       = 0x00220944U,
    IOCTL_NFCSE_SET_POWER_MODE        = 0x00220948U,
}

enum : uint
{
    EVT_TRANSACTION_TAG_AID           = 0x00000081U,
    EVT_TRANSACTION_TAG_PARAMETERS    = 0x00000082U,
    EVT_TRANSACTION_PARAMETER_MAX_LEN = 0x000000ffU,
}

enum uint ISO_7816_MINIMUM_AID_LENGTH = 0x00000005U;
enum uint ISO_7816_MAXIMUM_AID_LENGTH = 0x00000010U;
