...
enum : ubyte
{
    ALLJOYN_MEMBER_ANNOTATE_NO_REPLY         = 0x01,
...
alias alljoyn_keystorelistener_loadrequest_ptr = QStatus function(const(void)* context, 
                                                                  alljoyn_keystorelistener listener, 
                                                                  alljoyn_keystore keyStore);
...
alias alljoyn_keystorelistener_releaseexclusivelock_ptr = void function(const(void)* context, 
                                                                        alljoyn_keystorelistener listener);
alias alljoyn_authlistener_requestcredentials_ptr = int function(const(void)* context, const(PSTR) authMechanism, 
                                                                 const(PSTR) peerName, ushort authCount, 
                                                                 const(PSTR) userName, ushort credMask, 
...
alias alljoyn_authlistener_requestcredentialsasync_ptr = QStatus function(const(void)* context, 
                                                                          ...
                                                                          const(PSTR) userName, ushort credMask, 
                                                                          void* authContext);
alias alljoyn_authlistener_verifycredentials_ptr = int function(const(void)* context, const(PSTR) authMechanism, 
                                                                const(PSTR) peerName, 
...
alias alljoyn_buslistener_found_advertised_name_ptr = void function(const(void)* context, const(PSTR) name, 
                                                                    ushort transport, const(PSTR) namePrefix);
alias alljoyn_buslistener_lost_advertised_name_ptr = void function(const(void)* context, const(PSTR) name, 
                                                                   ushort transport, const(PSTR) namePrefix);
alias alljoyn_buslistener_name_owner_changed_ptr = void function(const(void)* context, const(PSTR) busName, 
                                                                 const(PSTR) previousOwner, const(PSTR) newOwner);
...
alias alljoyn_buslistener_bus_prop_changed_ptr = void function(const(void)* context, const(PSTR) prop_name, 
                                                               alljoyn_msgarg prop_value);
alias alljoyn_interfacedescription_translation_callback_ptr = PSTR function(const(PSTR) sourceLanguage, 
                                                                            const(PSTR) targetLanguage, 
                                                                            const(PSTR) sourceText);
alias alljoyn_messagereceiver_methodhandler_ptr = void function(alljoyn_busobject bus, 
...
alias alljoyn_messagereceiver_signalhandler_ptr = void function(const(alljoyn_interfacedescription_member)* member, 
                                                                const(PSTR) srcPath, alljoyn_message message);
alias alljoyn_busobject_prop_get_ptr = QStatus function(const(void)* context, const(PSTR) ifcName, 
                                                        const(PSTR) propName, alljoyn_msgarg val);
alias alljoyn_busobject_prop_set_ptr = QStatus function(const(void)* context, const(PSTR) ifcName, 
                                                        const(PSTR) propName, alljoyn_msgarg val);
alias alljoyn_busobject_object_registration_ptr = void function(const(void)* context);
alias alljoyn_proxybusobject_listener_introspectcb_ptr = void function(QStatus status, alljoyn_proxybusobject obj, 
                                                                       void* context);
alias alljoyn_proxybusobject_listener_getpropertycb_ptr = void function(QStatus status, alljoyn_proxybusobject obj, 
                                                                        const(alljoyn_msgarg) value, void* context);
alias alljoyn_proxybusobject_listener_getallpropertiescb_ptr = void function(QStatus status, 
                                                                             alljoyn_proxybusobject obj, 
                                                                             const(alljoyn_msgarg) values, 
                                                                             void* context);
alias alljoyn_proxybusobject_listener_setpropertycb_ptr = void function(QStatus status, alljoyn_proxybusobject obj, 
                                                                        void* context);
alias alljoyn_proxybusobject_listener_propertieschanged_ptr = void function(alljoyn_proxybusobject obj, 
                                                                            const(PSTR) ifaceName, 
                                                                            const(alljoyn_msgarg) changed, 
                                                                            const(alljoyn_msgarg) invalidated, 
                                                                            void* context);
...
alias alljoyn_sessionportlistener_sessionjoined_ptr = void function(const(void)* context, ushort sessionPort, 
                                                                    uint id, const(PSTR) joiner);
alias alljoyn_about_announced_ptr = void function(const(void)* context, const(PSTR) busName, ushort version_, 
                                                  ushort port, const(alljoyn_msgarg) objectDescriptionArg, 
...
alias alljoyn_busattachment_joinsessioncb_ptr = void function(QStatus status, uint sessionId, 
                                                              const(alljoyn_sessionopts) opts, void* context);
alias alljoyn_busattachment_setlinktimeoutcb_ptr = void function(QStatus status, uint timeout, void* context);
alias alljoyn_aboutdatalistener_getaboutdata_ptr = QStatus function(const(void)* context, alljoyn_msgarg msgArg, 
                                                                    const(PSTR) language);
alias alljoyn_aboutdatalistener_getannouncedaboutdata_ptr = QStatus function(const(void)* context, 
                                                                             alljoyn_msgarg msgArg);
alias alljoyn_autopinger_destination_lost_ptr = void function(const(void)* context, const(PSTR) group, 
                                                              const(PSTR) destination);
alias alljoyn_autopinger_destination_found_ptr = void function(const(void)* context, const(PSTR) group, 
                                                               const(PSTR) destination);
...
struct alljoyn_interfacedescription_member
{
    ...
    const(PSTR)         name;
    const(PSTR)         signature;
    const(PSTR)         returnSignature;
    const(PSTR)         argNames;
...
struct alljoyn_abouticonobj
{
    ptrdiff_t Value;
}

struct alljoyn_abouticonproxy
{
    ptrdiff_t Value;
}
...
//METH ATTR: SupportedOSPlatformAttribute : CustomAttributeSig([FixedArgSig(ElementSig(windows10.0.10240))], [])
@DllImport("MSAJApi.dll")
BOOL AllJoynSendToBus(HANDLE connectedBusHandle, 
                      /*PARAM ATTR: MemorySizeAttribute : CustomAttributeSig([], [NamedArgSig("BytesParamIndex", FixedArgSig(ElementSig(2)))])*/const(void)* buffer, 
                      uint bytesToWrite, uint* bytesTransferred, void* reserved);

//METH ATTR: SupportedOSPlatformAttribute : CustomAttributeSig([FixedArgSig(ElementSig(windows10.0.10240))], [])
@DllImport("MSAJApi.dll")
BOOL AllJoynReceiveFromBus(HANDLE connectedBusHandle, 
                           /*PARAM ATTR: MemorySizeAttribute : CustomAttributeSig([], [NamedArgSig("BytesParamIndex", FixedArgSig(ElementSig(2)))])*/void* buffer, 
                           uint bytesToRead, uint* bytesTransferred, void* reserved);
...
@DllImport("MSAJApi.dll")
alljoyn_msgarg alljoyn_msgarg_create_and_set(const(PSTR) signature);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_set(alljoyn_msgarg arg, const(PSTR) signature);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_get(alljoyn_msgarg arg, const(PSTR) signature);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_array_set(alljoyn_msgarg args, size_t* numArgs, const(PSTR) signature);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_array_get(const(alljoyn_msgarg) args, size_t numArgs, const(PSTR) signature);

@DllImport("MSAJApi.dll")
size_t alljoyn_msgarg_tostring(alljoyn_msgarg arg, PSTR str, size_t buf, size_t indent);

@DllImport("MSAJApi.dll")
size_t alljoyn_msgarg_array_tostring(const(alljoyn_msgarg) args, size_t numArgs, PSTR str, size_t buf, 
                                     size_t indent);

@DllImport("MSAJApi.dll")
size_t alljoyn_msgarg_signature(alljoyn_msgarg arg, PSTR str, size_t buf);

@DllImport("MSAJApi.dll")
size_t alljoyn_msgarg_array_signature(alljoyn_msgarg values, size_t numValues, PSTR str, size_t buf);

@DllImport("MSAJApi.dll")
int alljoyn_msgarg_hassignature(alljoyn_msgarg arg, const(PSTR) signature);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_getdictelement(alljoyn_msgarg arg, const(PSTR) elemSig);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_array_set_offset(alljoyn_msgarg args, size_t argOffset, size_t* numArgs, 
                                        const(PSTR) signature);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_set_and_stabilize(alljoyn_msgarg arg, const(PSTR) signature);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_set_string(alljoyn_msgarg arg, const(PSTR) s);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_set_objectpath(alljoyn_msgarg arg, const(PSTR) o);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_set_signature(alljoyn_msgarg arg, const(PSTR) g);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_set_uint8_array(alljoyn_msgarg arg, size_t length, ubyte* ay);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_set_bool_array(alljoyn_msgarg arg, size_t length, int* ab);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_set_int16_array(alljoyn_msgarg arg, size_t length, short* an);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_set_uint16_array(alljoyn_msgarg arg, size_t length, ushort* aq);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_set_int32_array(alljoyn_msgarg arg, size_t length, int* ai);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_set_uint32_array(alljoyn_msgarg arg, size_t length, uint* au);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_set_int64_array(alljoyn_msgarg arg, size_t length, long* ax);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_set_uint64_array(alljoyn_msgarg arg, size_t length, ulong* at);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_set_double_array(alljoyn_msgarg arg, size_t length, double* ad);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_set_string_array(alljoyn_msgarg arg, size_t length, const(byte)** as);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_set_objectpath_array(alljoyn_msgarg arg, size_t length, const(byte)** ao);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_set_signature_array(alljoyn_msgarg arg, size_t length, const(byte)** ag);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_get_uint8_array(const(alljoyn_msgarg) arg, size_t* length, ubyte* ay);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_get_bool_array(const(alljoyn_msgarg) arg, size_t* length, int* ab);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_get_int16_array(const(alljoyn_msgarg) arg, size_t* length, short* an);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_get_uint16_array(const(alljoyn_msgarg) arg, size_t* length, ushort* aq);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_get_int32_array(const(alljoyn_msgarg) arg, size_t* length, int* ai);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_get_uint32_array(const(alljoyn_msgarg) arg, size_t* length, uint* au);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_get_int64_array(const(alljoyn_msgarg) arg, size_t* length, long* ax);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_get_uint64_array(const(alljoyn_msgarg) arg, size_t* length, ulong* at);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_get_double_array(const(alljoyn_msgarg) arg, size_t* length, double* ad);

@DllImport("MSAJApi.dll")
QStatus alljoyn_msgarg_get_variant_array(const(alljoyn_msgarg) arg, const(PSTR) signature, size_t* length, 
                                         alljoyn_msgarg* av);
...
@DllImport("MSAJApi.dll")
PSTR alljoyn_msgarg_get_array_elementsignature(const(alljoyn_msgarg) arg, size_t index);
...
@DllImport("MSAJApi.dll")
alljoyn_aboutdata alljoyn_aboutdata_create(const(PSTR) defaultLanguage);

@DllImport("MSAJApi.dll")
alljoyn_aboutdata alljoyn_aboutdata_create_full(const(alljoyn_msgarg) arg, const(PSTR) language);

@DllImport("MSAJApi.dll")
void alljoyn_aboutdata_destroy(alljoyn_aboutdata data);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_createfromxml(alljoyn_aboutdata data, const(PSTR) aboutDataXml);

@DllImport("MSAJApi.dll")
ubyte alljoyn_aboutdata_isvalid(alljoyn_aboutdata data, const(PSTR) language);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_createfrommsgarg(alljoyn_aboutdata data, const(alljoyn_msgarg) arg, const(PSTR) language);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_setappid(alljoyn_aboutdata data, const(ubyte)* appId, const(size_t) num);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_setappid_fromstring(alljoyn_aboutdata data, const(PSTR) appId);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_getappid(alljoyn_aboutdata data, ubyte** appId, size_t* num);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_setdefaultlanguage(alljoyn_aboutdata data, const(PSTR) defaultLanguage);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_getdefaultlanguage(alljoyn_aboutdata data, byte** defaultLanguage);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_setdevicename(alljoyn_aboutdata data, const(PSTR) deviceName, const(PSTR) language);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_getdevicename(alljoyn_aboutdata data, byte** deviceName, const(PSTR) language);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_setdeviceid(alljoyn_aboutdata data, const(PSTR) deviceId);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_getdeviceid(alljoyn_aboutdata data, byte** deviceId);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_setappname(alljoyn_aboutdata data, const(PSTR) appName, const(PSTR) language);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_getappname(alljoyn_aboutdata data, byte** appName, const(PSTR) language);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_setmanufacturer(alljoyn_aboutdata data, const(PSTR) manufacturer, const(PSTR) language);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_getmanufacturer(alljoyn_aboutdata data, byte** manufacturer, const(PSTR) language);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_setmodelnumber(alljoyn_aboutdata data, const(PSTR) modelNumber);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_getmodelnumber(alljoyn_aboutdata data, byte** modelNumber);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_setsupportedlanguage(alljoyn_aboutdata data, const(PSTR) language);

@DllImport("MSAJApi.dll")
size_t alljoyn_aboutdata_getsupportedlanguages(alljoyn_aboutdata data, const(byte)** languageTags, size_t num);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_setdescription(alljoyn_aboutdata data, const(PSTR) description, const(PSTR) language);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_getdescription(alljoyn_aboutdata data, byte** description, const(PSTR) language);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_setdateofmanufacture(alljoyn_aboutdata data, const(PSTR) dateOfManufacture);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_getdateofmanufacture(alljoyn_aboutdata data, byte** dateOfManufacture);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_setsoftwareversion(alljoyn_aboutdata data, const(PSTR) softwareVersion);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_sethardwareversion(alljoyn_aboutdata data, const(PSTR) hardwareVersion);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_gethardwareversion(alljoyn_aboutdata data, byte** hardwareVersion);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_setsupporturl(alljoyn_aboutdata data, const(PSTR) supportUrl);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_getsupporturl(alljoyn_aboutdata data, byte** supportUrl);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_setfield(alljoyn_aboutdata data, const(PSTR) name, alljoyn_msgarg value, 
                                   const(PSTR) language);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_getfield(alljoyn_aboutdata data, const(PSTR) name, alljoyn_msgarg* value, 
                                   const(PSTR) language);

@DllImport("MSAJApi.dll")
size_t alljoyn_aboutdata_getfields(alljoyn_aboutdata data, const(byte)** fields, size_t num_fields);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_getaboutdata(alljoyn_aboutdata data, alljoyn_msgarg msgArg, const(PSTR) language);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutdata_getannouncedaboutdata(alljoyn_aboutdata data, alljoyn_msgarg msgArg);

@DllImport("MSAJApi.dll")
ubyte alljoyn_aboutdata_isfieldrequired(alljoyn_aboutdata data, const(PSTR) fieldName);

@DllImport("MSAJApi.dll")
ubyte alljoyn_aboutdata_isfieldannounced(alljoyn_aboutdata data, const(PSTR) fieldName);

@DllImport("MSAJApi.dll")
ubyte alljoyn_aboutdata_isfieldlocalized(alljoyn_aboutdata data, const(PSTR) fieldName);

@DllImport("MSAJApi.dll")
PSTR alljoyn_aboutdata_getfieldsignature(alljoyn_aboutdata data, const(PSTR) fieldName);
...
@DllImport("MSAJApi.dll")
void alljoyn_abouticon_getcontent(alljoyn_abouticon icon, const(ubyte)** data, size_t* size);

@DllImport("MSAJApi.dll")
QStatus alljoyn_abouticon_setcontent(alljoyn_abouticon icon, const(PSTR) type, ubyte* data, size_t csize, 
                                     ubyte ownsData);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_abouticon_seturl(alljoyn_abouticon icon, const(PSTR) type, const(PSTR) url);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_permissionconfigurator_getapplicationstate(const(alljoyn_permissionconfigurator) configurator, 
                                                           alljoyn_applicationstate* state);

@DllImport("MSAJApi.dll")
QStatus alljoyn_permissionconfigurator_setapplicationstate(alljoyn_permissionconfigurator configurator, 
                                                           alljoyn_applicationstate state);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_permissionconfigurator_getmanifesttemplate(alljoyn_permissionconfigurator configurator, 
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_permissionconfigurator_setmanifesttemplatefromxml(alljoyn_permissionconfigurator configurator, 
                                                                  byte* manifestTemplateXml);

@DllImport("MSAJApi.dll")
QStatus alljoyn_permissionconfigurator_getclaimcapabilities(const(alljoyn_permissionconfigurator) configurator, 
                                                            ushort* claimCapabilities);

@DllImport("MSAJApi.dll")
QStatus alljoyn_permissionconfigurator_setclaimcapabilities(alljoyn_permissionconfigurator configurator, 
                                                            ushort claimCapabilities);

@DllImport("MSAJApi.dll")
QStatus alljoyn_permissionconfigurator_getclaimcapabilitiesadditionalinfo(const(alljoyn_permissionconfigurator) configurator, 
                                                                          ushort* additionalInfo);

@DllImport("MSAJApi.dll")
QStatus alljoyn_permissionconfigurator_setclaimcapabilitiesadditionalinfo(alljoyn_permissionconfigurator configurator, 
                                                                          ushort additionalInfo);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_permissionconfigurator_claim(alljoyn_permissionconfigurator configurator, byte* caKey, 
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_permissionconfigurator_updateidentity(alljoyn_permissionconfigurator configurator, 
                                                      byte* identityCertificateChain, byte** manifestsXmls, 
                                                      size_t manifestsCount);

@DllImport("MSAJApi.dll")
QStatus alljoyn_permissionconfigurator_getidentity(alljoyn_permissionconfigurator configurator, 
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_permissionconfigurator_getmanifests(alljoyn_permissionconfigurator configurator, 
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_permissionconfigurator_installmanifests(alljoyn_permissionconfigurator configurator, 
                                                        byte** manifestsXmls, size_t manifestsCount, int append);

@DllImport("MSAJApi.dll")
QStatus alljoyn_permissionconfigurator_getidentitycertificateid(alljoyn_permissionconfigurator configurator, 
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_permissionconfigurator_getdefaultpolicy(alljoyn_permissionconfigurator configurator, 
                                                        byte** policyXml);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_permissionconfigurator_getmembershipsummaries(alljoyn_permissionconfigurator configurator, 
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_permissionconfigurator_installmembership(alljoyn_permissionconfigurator configurator, 
                                                         byte* membershipCertificateChain);

@DllImport("MSAJApi.dll")
QStatus alljoyn_permissionconfigurator_removemembership(alljoyn_permissionconfigurator configurator, 
...
@DllImport("MSAJApi.dll")
alljoyn_applicationstatelistener alljoyn_applicationstatelistener_create(const(alljoyn_applicationstatelistener_callbacks)* callbacks, 
                                                                         void* context);
...
@DllImport("MSAJApi.dll")
alljoyn_keystorelistener alljoyn_keystorelistener_create(const(alljoyn_keystorelistener_callbacks)* callbacks, 
                                                         const(void)* context);

@DllImport("MSAJApi.dll")
alljoyn_keystorelistener alljoyn_keystorelistener_with_synchronization_create(const(alljoyn_keystorelistener_with_synchronization_callbacks)* callbacks, 
                                                                              void* context);
...
QStatus alljoyn_keystorelistener_putkeys(alljoyn_keystorelistener listener, alljoyn_keystore keyStore, 
                                         const(PSTR) source, const(PSTR) password);

@DllImport("MSAJApi.dll")
QStatus alljoyn_keystorelistener_getkeys(alljoyn_keystorelistener listener, alljoyn_keystore keyStore, PSTR sink, 
                                         size_t* sink_sz);
...
@DllImport("MSAJApi.dll")
alljoyn_msgarg alljoyn_message_getarg(alljoyn_message msg, size_t argN);

@DllImport("MSAJApi.dll")
QStatus alljoyn_message_parseargs(alljoyn_message msg, const(PSTR) signature);
...
@DllImport("MSAJApi.dll")
PSTR alljoyn_message_geterrorname(alljoyn_message msg, PSTR errorMessage, size_t* errorMessage_size);

@DllImport("MSAJApi.dll")
size_t alljoyn_message_tostring(alljoyn_message msg, PSTR str, size_t buf);

@DllImport("MSAJApi.dll")
size_t alljoyn_message_description(alljoyn_message msg, PSTR str, size_t buf);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_authlistener_requestcredentialsresponse(alljoyn_authlistener listener, void* authContext, 
                                                        int accept, alljoyn_credentials credentials);

@DllImport("MSAJApi.dll")
QStatus alljoyn_authlistener_verifycredentialsresponse(alljoyn_authlistener listener, void* authContext, 
                                                       int accept);

@DllImport("MSAJApi.dll")
alljoyn_authlistener alljoyn_authlistener_create(const(alljoyn_authlistener_callbacks)* callbacks, 
                                                 const(void)* context);

@DllImport("MSAJApi.dll")
alljoyn_authlistener alljoyn_authlistenerasync_create(const(alljoyn_authlistenerasync_callbacks)* callbacks, 
                                                      const(void)* context);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_authlistener_setsharedsecret(alljoyn_authlistener listener, const(ubyte)* sharedSecret, 
...
@DllImport("MSAJApi.dll")
void alljoyn_credentials_setpassword(alljoyn_credentials cred, const(PSTR) pwd);

@DllImport("MSAJApi.dll")
void alljoyn_credentials_setusername(alljoyn_credentials cred, const(PSTR) userName);

@DllImport("MSAJApi.dll")
void alljoyn_credentials_setcertchain(alljoyn_credentials cred, const(PSTR) certChain);

@DllImport("MSAJApi.dll")
void alljoyn_credentials_setprivatekey(alljoyn_credentials cred, const(PSTR) pk);

@DllImport("MSAJApi.dll")
void alljoyn_credentials_setlogonentry(alljoyn_credentials cred, const(PSTR) logonEntry);
...
@DllImport("MSAJApi.dll")
alljoyn_buslistener alljoyn_buslistener_create(const(alljoyn_buslistener_callbacks)* callbacks, 
                                               const(void)* context);
...
void alljoyn_interfacedescription_member_getannotationatindex(alljoyn_interfacedescription_member member, 
                                                              size_t index, PSTR name, size_t* name_size, PSTR value, 
                                                              size_t* value_size);

@DllImport("MSAJApi.dll")
int alljoyn_interfacedescription_member_getannotation(alljoyn_interfacedescription_member member, const(PSTR) name, 
                                                      PSTR value, size_t* value_size);
...
void alljoyn_interfacedescription_member_getargannotationatindex(alljoyn_interfacedescription_member member, 
                                                                 const(PSTR) argName, size_t index, PSTR name, 
                                                                 size_t* name_size, PSTR value, size_t* value_size);

@DllImport("MSAJApi.dll")
int alljoyn_interfacedescription_member_getargannotation(alljoyn_interfacedescription_member member, 
                                                         const(PSTR) argName, const(PSTR) name, PSTR value, 
                                                         size_t* value_size);
...
void alljoyn_interfacedescription_property_getannotationatindex(alljoyn_interfacedescription_property property, 
                                                                size_t index, PSTR name, size_t* name_size, 
                                                                PSTR value, size_t* value_size);

@DllImport("MSAJApi.dll")
int alljoyn_interfacedescription_property_getannotation(alljoyn_interfacedescription_property property, 
                                                        const(PSTR) name, PSTR value, size_t* value_size);

@DllImport("MSAJApi.dll")
void alljoyn_interfacedescription_activate(alljoyn_interfacedescription iface);

@DllImport("MSAJApi.dll")
QStatus alljoyn_interfacedescription_addannotation(alljoyn_interfacedescription iface, const(PSTR) name, 
                                                   const(PSTR) value);

@DllImport("MSAJApi.dll")
int alljoyn_interfacedescription_getannotation(alljoyn_interfacedescription iface, const(PSTR) name, PSTR value, 
                                               size_t* value_size);
...
@DllImport("MSAJApi.dll")
void alljoyn_interfacedescription_getannotationatindex(alljoyn_interfacedescription iface, size_t index, PSTR name, 
                                                       size_t* name_size, PSTR value, size_t* value_size);

@DllImport("MSAJApi.dll")
int alljoyn_interfacedescription_getmember(const(alljoyn_interfacedescription) iface, const(PSTR) name, 
                                           alljoyn_interfacedescription_member* member);

@DllImport("MSAJApi.dll")
QStatus alljoyn_interfacedescription_addmember(alljoyn_interfacedescription iface, alljoyn_messagetype type, 
                                               const(PSTR) name, const(PSTR) inputSig, const(PSTR) outSig, 
                                               const(PSTR) argNames, ubyte annotation);

@DllImport("MSAJApi.dll")
QStatus alljoyn_interfacedescription_addmemberannotation(alljoyn_interfacedescription iface, const(PSTR) member, 
                                                         const(PSTR) name, const(PSTR) value);

@DllImport("MSAJApi.dll")
int alljoyn_interfacedescription_getmemberannotation(alljoyn_interfacedescription iface, const(PSTR) member, 
                                                     const(PSTR) name, PSTR value, size_t* value_size);
...
@DllImport("MSAJApi.dll")
int alljoyn_interfacedescription_hasmember(alljoyn_interfacedescription iface, const(PSTR) name, const(PSTR) inSig, 
                                           const(PSTR) outSig);

@DllImport("MSAJApi.dll")
QStatus alljoyn_interfacedescription_addmethod(alljoyn_interfacedescription iface, const(PSTR) name, 
                                               const(PSTR) inputSig, const(PSTR) outSig, const(PSTR) argNames, 
                                               ubyte annotation, const(PSTR) accessPerms);

@DllImport("MSAJApi.dll")
int alljoyn_interfacedescription_getmethod(alljoyn_interfacedescription iface, const(PSTR) name, 
                                           alljoyn_interfacedescription_member* member);

@DllImport("MSAJApi.dll")
QStatus alljoyn_interfacedescription_addsignal(alljoyn_interfacedescription iface, const(PSTR) name, 
                                               const(PSTR) sig, const(PSTR) argNames, ubyte annotation, 
                                               const(PSTR) accessPerms);

@DllImport("MSAJApi.dll")
int alljoyn_interfacedescription_getsignal(alljoyn_interfacedescription iface, const(PSTR) name, 
                                           alljoyn_interfacedescription_member* member);

@DllImport("MSAJApi.dll")
int alljoyn_interfacedescription_getproperty(const(alljoyn_interfacedescription) iface, const(PSTR) name, 
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_interfacedescription_addproperty(alljoyn_interfacedescription iface, const(PSTR) name, 
                                                 const(PSTR) signature, ubyte access);

@DllImport("MSAJApi.dll")
QStatus alljoyn_interfacedescription_addpropertyannotation(alljoyn_interfacedescription iface, 
                                                           const(PSTR) property, const(PSTR) name, const(PSTR) value);

@DllImport("MSAJApi.dll")
int alljoyn_interfacedescription_getpropertyannotation(alljoyn_interfacedescription iface, const(PSTR) property, 
                                                       const(PSTR) name, PSTR value, size_t* str_size);

@DllImport("MSAJApi.dll")
int alljoyn_interfacedescription_hasproperty(const(alljoyn_interfacedescription) iface, const(PSTR) name);
...
@DllImport("MSAJApi.dll")
size_t alljoyn_interfacedescription_introspect(const(alljoyn_interfacedescription) iface, PSTR str, size_t buf, 
                                               size_t indent);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_interfacedescription_setdescriptionforlanguage(alljoyn_interfacedescription iface, 
                                                               const(PSTR) description, const(PSTR) languageTag);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_interfacedescription_setmemberdescriptionforlanguage(alljoyn_interfacedescription iface, 
                                                                     const(PSTR) member, const(PSTR) description, 
                                                                     const(PSTR) languageTag);

@DllImport("MSAJApi.dll")
size_t alljoyn_interfacedescription_getmemberdescriptionforlanguage(alljoyn_interfacedescription iface, 
                                                                    const(PSTR) member, PSTR description, 
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_interfacedescription_setargdescriptionforlanguage(alljoyn_interfacedescription iface, 
                                                                  const(PSTR) member, const(PSTR) arg, 
                                                                  const(PSTR) description, const(PSTR) languageTag);

@DllImport("MSAJApi.dll")
size_t alljoyn_interfacedescription_getargdescriptionforlanguage(alljoyn_interfacedescription iface, 
                                                                 const(PSTR) member, const(PSTR) arg, 
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_interfacedescription_setpropertydescriptionforlanguage(alljoyn_interfacedescription iface, 
                                                                       const(PSTR) name, const(PSTR) description, 
                                                                       const(PSTR) languageTag);

@DllImport("MSAJApi.dll")
size_t alljoyn_interfacedescription_getpropertydescriptionforlanguage(alljoyn_interfacedescription iface, 
                                                                      const(PSTR) property, PSTR description, 
                                                                      size_t maxLanguageLength, 
                                                                      const(PSTR) languageTag);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_interfacedescription_addargannotation(alljoyn_interfacedescription iface, const(PSTR) member, 
                                                      const(PSTR) argName, const(PSTR) name, const(PSTR) value);

@DllImport("MSAJApi.dll")
int alljoyn_interfacedescription_getmemberargannotation(const(alljoyn_interfacedescription) iface, 
                                                        const(PSTR) member, const(PSTR) argName, const(PSTR) name, 
                                                        PSTR value, size_t* value_size);

@DllImport("MSAJApi.dll")
int alljoyn_interfacedescription_eql(const(alljoyn_interfacedescription) one, 
...
@DllImport("MSAJApi.dll")
alljoyn_busobject alljoyn_busobject_create(const(PSTR) path, int isPlaceholder, 
...
@DllImport("MSAJApi.dll")
void alljoyn_busobject_emitpropertychanged(alljoyn_busobject bus, const(PSTR) ifcName, const(PSTR) propName, 
                                           alljoyn_msgarg val, uint id);

@DllImport("MSAJApi.dll")
void alljoyn_busobject_emitpropertieschanged(alljoyn_busobject bus, const(PSTR) ifcName, const(byte)** propNames, 
                                             size_t numProps, uint id);

@DllImport("MSAJApi.dll")
size_t alljoyn_busobject_getname(alljoyn_busobject bus, PSTR buffer, size_t bufferSz);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busobject_addinterface(alljoyn_busobject bus, const(alljoyn_interfacedescription) iface);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busobject_addmethodhandler(alljoyn_busobject bus, 
                                           const(alljoyn_interfacedescription_member) member, 
                                           alljoyn_messagereceiver_methodhandler_ptr handler, void* context);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busobject_addmethodhandlers(alljoyn_busobject bus, const(alljoyn_busobject_methodentry)* entries, 
                                            size_t numEntries);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busobject_methodreply_args(alljoyn_busobject bus, alljoyn_message msg, const(alljoyn_msgarg) args, 
                                           size_t numArgs);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busobject_methodreply_err(alljoyn_busobject bus, alljoyn_message msg, const(PSTR) error, 
                                          const(PSTR) errorMessage);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_busobject_signal(alljoyn_busobject bus, const(PSTR) destination, uint sessionId, 
                                 const(alljoyn_interfacedescription_member) signal, const(alljoyn_msgarg) args, 
                                 size_t numArgs, ushort timeToLive, ubyte flags, alljoyn_message msg);
...
@DllImport("MSAJApi.dll")
size_t alljoyn_busobject_getannouncedinterfacenames(alljoyn_busobject bus, const(byte)** interfaces, 
                                                    size_t numInterfaces);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busobject_setannounceflag(alljoyn_busobject bus, const(alljoyn_interfacedescription) iface, 
...
@DllImport("MSAJApi.dll")
alljoyn_proxybusobject alljoyn_proxybusobject_create(alljoyn_busattachment bus, const(PSTR) service, 
                                                     const(PSTR) path, uint sessionId);

@DllImport("MSAJApi.dll")
alljoyn_proxybusobject alljoyn_proxybusobject_create_secure(alljoyn_busattachment bus, const(PSTR) service, 
                                                            const(PSTR) path, uint sessionId);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_proxybusobject_addinterface(alljoyn_proxybusobject proxyObj, 
                                            const(alljoyn_interfacedescription) iface);

@DllImport("MSAJApi.dll")
QStatus alljoyn_proxybusobject_addinterface_by_name(alljoyn_proxybusobject proxyObj, const(PSTR) name);

@DllImport("MSAJApi.dll")
size_t alljoyn_proxybusobject_getchildren(alljoyn_proxybusobject proxyObj, alljoyn_proxybusobject* children, 
                                          size_t numChildren);

@DllImport("MSAJApi.dll")
alljoyn_proxybusobject alljoyn_proxybusobject_getchild(alljoyn_proxybusobject proxyObj, const(PSTR) path);

@DllImport("MSAJApi.dll")
QStatus alljoyn_proxybusobject_addchild(alljoyn_proxybusobject proxyObj, const(alljoyn_proxybusobject) child);

@DllImport("MSAJApi.dll")
QStatus alljoyn_proxybusobject_removechild(alljoyn_proxybusobject proxyObj, const(PSTR) path);

@DllImport("MSAJApi.dll")
QStatus alljoyn_proxybusobject_introspectremoteobject(alljoyn_proxybusobject proxyObj);

@DllImport("MSAJApi.dll")
QStatus alljoyn_proxybusobject_introspectremoteobjectasync(alljoyn_proxybusobject proxyObj, 
                                                           alljoyn_proxybusobject_listener_introspectcb_ptr callback, 
                                                           void* context);

@DllImport("MSAJApi.dll")
QStatus alljoyn_proxybusobject_getproperty(alljoyn_proxybusobject proxyObj, const(PSTR) iface, 
                                           const(PSTR) property, alljoyn_msgarg value);

@DllImport("MSAJApi.dll")
QStatus alljoyn_proxybusobject_getpropertyasync(alljoyn_proxybusobject proxyObj, const(PSTR) iface, 
                                                const(PSTR) property, 
                                                alljoyn_proxybusobject_listener_getpropertycb_ptr callback, 
                                                uint timeout, void* context);

@DllImport("MSAJApi.dll")
QStatus alljoyn_proxybusobject_getallproperties(alljoyn_proxybusobject proxyObj, const(PSTR) iface, 
                                                alljoyn_msgarg values);

@DllImport("MSAJApi.dll")
QStatus alljoyn_proxybusobject_getallpropertiesasync(alljoyn_proxybusobject proxyObj, const(PSTR) iface, 
                                                     alljoyn_proxybusobject_listener_getallpropertiescb_ptr callback, 
                                                     uint timeout, void* context);

@DllImport("MSAJApi.dll")
QStatus alljoyn_proxybusobject_setproperty(alljoyn_proxybusobject proxyObj, const(PSTR) iface, 
                                           const(PSTR) property, alljoyn_msgarg value);

@DllImport("MSAJApi.dll")
QStatus alljoyn_proxybusobject_registerpropertieschangedlistener(alljoyn_proxybusobject proxyObj, 
                                                                 const(PSTR) iface, const(byte)** properties, 
                                                                 size_t numProperties, 
                                                                 alljoyn_proxybusobject_listener_propertieschanged_ptr callback, 
                                                                 void* context);

@DllImport("MSAJApi.dll")
QStatus alljoyn_proxybusobject_unregisterpropertieschangedlistener(alljoyn_proxybusobject proxyObj, 
                                                                   const(PSTR) iface, 
                                                                   alljoyn_proxybusobject_listener_propertieschanged_ptr callback);

@DllImport("MSAJApi.dll")
QStatus alljoyn_proxybusobject_setpropertyasync(alljoyn_proxybusobject proxyObj, const(PSTR) iface, 
                                                const(PSTR) property, alljoyn_msgarg value, 
                                                alljoyn_proxybusobject_listener_setpropertycb_ptr callback, 
                                                uint timeout, void* context);

@DllImport("MSAJApi.dll")
QStatus alljoyn_proxybusobject_methodcall(alljoyn_proxybusobject proxyObj, const(PSTR) ifaceName, 
                                          const(PSTR) methodName, const(alljoyn_msgarg) args, size_t numArgs, 
                                          alljoyn_message replyMsg, uint timeout, ubyte flags);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_proxybusobject_methodcall_noreply(alljoyn_proxybusobject proxyObj, const(PSTR) ifaceName, 
                                                  const(PSTR) methodName, const(alljoyn_msgarg) args, size_t numArgs, 
                                                  ubyte flags);
...
QStatus alljoyn_proxybusobject_methodcall_member_noreply(alljoyn_proxybusobject proxyObj, 
                                                         const(alljoyn_interfacedescription_member) method, 
                                                         const(alljoyn_msgarg) args, size_t numArgs, ubyte flags);

@DllImport("MSAJApi.dll")
QStatus alljoyn_proxybusobject_methodcallasync(alljoyn_proxybusobject proxyObj, const(PSTR) ifaceName, 
                                               const(PSTR) methodName, 
                                               alljoyn_messagereceiver_replyhandler_ptr replyFunc, 
                                               const(alljoyn_msgarg) args, size_t numArgs, void* context, 
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_proxybusobject_parsexml(alljoyn_proxybusobject proxyObj, const(PSTR) xml, const(PSTR) identifier);
...
@DllImport("MSAJApi.dll")
alljoyn_interfacedescription alljoyn_proxybusobject_getinterface(alljoyn_proxybusobject proxyObj, 
                                                                 const(PSTR) iface);

@DllImport("MSAJApi.dll")
size_t alljoyn_proxybusobject_getinterfaces(alljoyn_proxybusobject proxyObj, 
...
@DllImport("MSAJApi.dll")
int alljoyn_proxybusobject_implementsinterface(alljoyn_proxybusobject proxyObj, const(PSTR) iface);
...
@DllImport("MSAJApi.dll")
alljoyn_permissionconfigurationlistener alljoyn_permissionconfigurationlistener_create(const(alljoyn_permissionconfigurationlistener_callbacks)* callbacks, 
                                                                                       const(void)* context);
...
@DllImport("MSAJApi.dll")
alljoyn_sessionportlistener alljoyn_sessionportlistener_create(const(alljoyn_sessionportlistener_callbacks)* callbacks, 
                                                               const(void)* context);
...
@DllImport("MSAJApi.dll")
alljoyn_aboutlistener alljoyn_aboutlistener_create(const(alljoyn_aboutlistener_callback)* callback, 
                                                   const(void)* context);
...
@DllImport("MSAJApi.dll")
alljoyn_busattachment alljoyn_busattachment_create(const(PSTR) applicationName, int allowRemoteMessages);

@DllImport("MSAJApi.dll")
alljoyn_busattachment alljoyn_busattachment_create_concurrency(const(PSTR) applicationName, 
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_createinterface(alljoyn_busattachment bus, const(PSTR) name, 
                                              alljoyn_interfacedescription* iface);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_createinterface_secure(alljoyn_busattachment bus, const(PSTR) name, 
                                                     alljoyn_interfacedescription* iface, 
                                                     alljoyn_interfacedescription_securitypolicy secPolicy);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_connect(alljoyn_busattachment bus, const(PSTR) connectSpec);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_findadvertisedname(alljoyn_busattachment bus, const(PSTR) namePrefix);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_findadvertisednamebytransport(alljoyn_busattachment bus, const(PSTR) namePrefix, 
                                                            ushort transports);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_cancelfindadvertisedname(alljoyn_busattachment bus, const(PSTR) namePrefix);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_cancelfindadvertisednamebytransport(alljoyn_busattachment bus, 
                                                                  const(PSTR) namePrefix, ushort transports);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_advertisename(alljoyn_busattachment bus, const(PSTR) name, ushort transports);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_canceladvertisename(alljoyn_busattachment bus, const(PSTR) name, ushort transports);

@DllImport("MSAJApi.dll")
alljoyn_interfacedescription alljoyn_busattachment_getinterface(alljoyn_busattachment bus, const(PSTR) name);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_joinsession(alljoyn_busattachment bus, const(PSTR) sessionHost, ushort sessionPort, 
                                          alljoyn_sessionlistener listener, uint* sessionId, 
                                          alljoyn_sessionopts opts);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_joinsessionasync(alljoyn_busattachment bus, const(PSTR) sessionHost, 
                                               ushort sessionPort, alljoyn_sessionlistener listener, 
                                               const(alljoyn_sessionopts) opts, 
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_requestname(alljoyn_busattachment bus, const(PSTR) requestedName, uint flags);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_releasename(alljoyn_busattachment bus, const(PSTR) name);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_bindsessionport(alljoyn_busattachment bus, ushort* sessionPort, 
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_enablepeersecurity(alljoyn_busattachment bus, const(PSTR) authMechanisms, 
                                                 alljoyn_authlistener listener, const(PSTR) keyStoreFileName, 
                                                 int isShared);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_enablepeersecuritywithpermissionconfigurationlistener(alljoyn_busattachment bus, 
                                                                                    const(PSTR) authMechanisms, 
                                                                                    alljoyn_authlistener authListener, 
                                                                                    const(PSTR) keyStoreFileName, 
                                                                                    int isShared, 
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_createinterfacesfromxml(alljoyn_busattachment bus, const(PSTR) xml);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_disconnect(alljoyn_busattachment bus, const(PSTR) unused);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_registersignalhandlerwithrule(alljoyn_busattachment bus, 
                                                            alljoyn_messagereceiver_signalhandler_ptr signal_handler, 
                                                            const(alljoyn_interfacedescription_member) member, 
                                                            const(PSTR) matchRule);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_unregistersignalhandlerwithrule(alljoyn_busattachment bus, 
                                                              alljoyn_messagereceiver_signalhandler_ptr signal_handler, 
                                                              const(alljoyn_interfacedescription_member) member, 
                                                              const(PSTR) matchRule);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_registerkeystorelistener(alljoyn_busattachment bus, 
                                                       alljoyn_keystorelistener listener);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_clearkeys(alljoyn_busattachment bus, const(PSTR) guid);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_setkeyexpiration(alljoyn_busattachment bus, const(PSTR) guid, uint timeout);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_getkeyexpiration(alljoyn_busattachment bus, const(PSTR) guid, uint* timeout);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_addlogonentry(alljoyn_busattachment bus, const(PSTR) authMechanism, 
                                            const(PSTR) userName, const(PSTR) password);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_addmatch(alljoyn_busattachment bus, const(PSTR) rule);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_removematch(alljoyn_busattachment bus, const(PSTR) rule);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_setsessionlistener(alljoyn_busattachment bus, uint sessionId, 
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_secureconnection(alljoyn_busattachment bus, const(PSTR) name, int forceAuth);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_secureconnectionasync(alljoyn_busattachment bus, const(PSTR) name, int forceAuth);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_removesessionmember(alljoyn_busattachment bus, uint sessionId, 
                                                  const(PSTR) memberName);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_setlinktimeout(alljoyn_busattachment bus, uint sessionid, uint* linkTimeout);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_setlinktimeoutasync(alljoyn_busattachment bus, uint sessionid, uint linkTimeout, 
                                                  alljoyn_busattachment_setlinktimeoutcb_ptr callback, void* context);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_namehasowner(alljoyn_busattachment bus, const(PSTR) name, int* hasOwner);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_getpeerguid(alljoyn_busattachment bus, const(PSTR) name, PSTR guid, size_t* guidSz);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_setdaemondebug(alljoyn_busattachment bus, const(PSTR) module_, uint level);

@DllImport("MSAJApi.dll")
uint alljoyn_busattachment_gettimestamp();

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_ping(alljoyn_busattachment bus, const(PSTR) name, uint timeout);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_whoimplements_interfaces(alljoyn_busattachment bus, 
                                                       const(byte)** implementsInterfaces, size_t numberInterfaces);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_whoimplements_interface(alljoyn_busattachment bus, const(PSTR) implementsInterface);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_cancelwhoimplements_interfaces(alljoyn_busattachment bus, 
                                                             const(byte)** implementsInterfaces, 
                                                             size_t numberInterfaces);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_cancelwhoimplements_interface(alljoyn_busattachment bus, 
                                                            const(PSTR) implementsInterface);

@DllImport("MSAJApi.dll")
alljoyn_permissionconfigurator alljoyn_busattachment_getpermissionconfigurator(alljoyn_busattachment bus);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_registerapplicationstatelistener(alljoyn_busattachment bus, 
                                                               alljoyn_applicationstatelistener listener);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_unregisterapplicationstatelistener(alljoyn_busattachment bus, 
                                                                 alljoyn_applicationstatelistener listener);

@DllImport("MSAJApi.dll")
QStatus alljoyn_busattachment_deletedefaultkeystore(const(PSTR) applicationName);
...
@DllImport("MSAJApi.dll")
alljoyn_abouticonproxy alljoyn_abouticonproxy_create(alljoyn_busattachment bus, const(PSTR) busName, 
                                                     uint sessionId);
...
@DllImport("MSAJApi.dll")
alljoyn_aboutdatalistener alljoyn_aboutdatalistener_create(const(alljoyn_aboutdatalistener_callbacks)* callbacks, 
                                                           const(void)* context);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutobj_announce_using_datalistener(alljoyn_aboutobj obj, ushort sessionPort, 
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutobjectdescription_createfrommsgarg(alljoyn_aboutobjectdescription description, 
...
@DllImport("MSAJApi.dll")
size_t alljoyn_aboutobjectdescription_getpaths(alljoyn_aboutobjectdescription description, const(byte)** paths, 
                                               size_t numPaths);

@DllImport("MSAJApi.dll")
size_t alljoyn_aboutobjectdescription_getinterfaces(alljoyn_aboutobjectdescription description, const(PSTR) path, 
                                                    const(byte)** interfaces, size_t numInterfaces);

@DllImport("MSAJApi.dll")
size_t alljoyn_aboutobjectdescription_getinterfacepaths(alljoyn_aboutobjectdescription description, 
                                                        const(PSTR) interfaceName, const(byte)** paths, 
                                                        size_t numPaths);
...
@DllImport("MSAJApi.dll")
ubyte alljoyn_aboutobjectdescription_haspath(alljoyn_aboutobjectdescription description, const(PSTR) path);

@DllImport("MSAJApi.dll")
ubyte alljoyn_aboutobjectdescription_hasinterface(alljoyn_aboutobjectdescription description, 
                                                  const(PSTR) interfaceName);

@DllImport("MSAJApi.dll")
ubyte alljoyn_aboutobjectdescription_hasinterfaceatpath(alljoyn_aboutobjectdescription description, 
                                                        const(PSTR) path, const(PSTR) interfaceName);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutobjectdescription_getmsgarg(alljoyn_aboutobjectdescription description, alljoyn_msgarg msgArg);

@DllImport("MSAJApi.dll")
alljoyn_aboutproxy alljoyn_aboutproxy_create(alljoyn_busattachment bus, const(PSTR) busName, uint sessionId);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutproxy_getaboutdata(alljoyn_aboutproxy proxy, const(PSTR) language, alljoyn_msgarg data);

@DllImport("MSAJApi.dll")
QStatus alljoyn_aboutproxy_getversion(alljoyn_aboutproxy proxy, ushort* version_);

@DllImport("MSAJApi.dll")
alljoyn_pinglistener alljoyn_pinglistener_create(const(alljoyn_pinglistener_callback)* callback, 
                                                 const(void)* context);
...
@DllImport("MSAJApi.dll")
void alljoyn_autopinger_addpinggroup(alljoyn_autopinger autopinger, const(PSTR) group, 
                                     alljoyn_pinglistener listener, uint pinginterval);

@DllImport("MSAJApi.dll")
void alljoyn_autopinger_removepinggroup(alljoyn_autopinger autopinger, const(PSTR) group);

@DllImport("MSAJApi.dll")
QStatus alljoyn_autopinger_setpinginterval(alljoyn_autopinger autopinger, const(PSTR) group, uint pinginterval);

@DllImport("MSAJApi.dll")
QStatus alljoyn_autopinger_adddestination(alljoyn_autopinger autopinger, const(PSTR) group, 
                                          const(PSTR) destination);

@DllImport("MSAJApi.dll")
QStatus alljoyn_autopinger_removedestination(alljoyn_autopinger autopinger, const(PSTR) group, 
                                             const(PSTR) destination, int removeall);
...
@DllImport("MSAJApi.dll")
alljoyn_observerlistener alljoyn_observerlistener_create(const(alljoyn_observerlistener_callback)* callback, 
                                                         const(void)* context);
...
@DllImport("MSAJApi.dll")
alljoyn_observer alljoyn_observer_create(alljoyn_busattachment bus, const(byte)** mandatoryInterfaces, 
...
@DllImport("MSAJApi.dll")
void alljoyn_observer_registerlistener(alljoyn_observer observer, alljoyn_observerlistener listener, 
                                       int triggerOnExisting);
...
@DllImport("MSAJApi.dll")
alljoyn_proxybusobject_ref alljoyn_observer_get(alljoyn_observer observer, const(PSTR) uniqueBusName, 
                                                const(PSTR) objectPath);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_passwordmanager_setcredentials(const(PSTR) authMechanism, const(PSTR) password);

@DllImport("MSAJApi.dll")
ushort alljoyn_securityapplicationproxy_getpermissionmanagementsessionport();

@DllImport("MSAJApi.dll")
alljoyn_securityapplicationproxy alljoyn_securityapplicationproxy_create(alljoyn_busattachment bus, 
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_securityapplicationproxy_claim(alljoyn_securityapplicationproxy proxy, byte* caKey, 
                                               byte* identityCertificateChain, const(ubyte)* groupId, 
                                               size_t groupSize, byte* groupAuthority, byte** manifestsXmls, 
                                               size_t manifestsCount);

@DllImport("MSAJApi.dll")
QStatus alljoyn_securityapplicationproxy_getmanifesttemplate(alljoyn_securityapplicationproxy proxy, 
                                                             byte** manifestTemplateXml);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_securityapplicationproxy_getapplicationstate(alljoyn_securityapplicationproxy proxy, 
                                                             alljoyn_applicationstate* applicationState);

@DllImport("MSAJApi.dll")
QStatus alljoyn_securityapplicationproxy_getclaimcapabilities(alljoyn_securityapplicationproxy proxy, 
                                                              ushort* capabilities);

@DllImport("MSAJApi.dll")
QStatus alljoyn_securityapplicationproxy_getclaimcapabilitiesadditionalinfo(alljoyn_securityapplicationproxy proxy, 
                                                                            ushort* additionalInfo);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_securityapplicationproxy_updateidentity(alljoyn_securityapplicationproxy proxy, 
                                                        byte* identityCertificateChain, byte** manifestsXmls, 
                                                        size_t manifestsCount);

@DllImport("MSAJApi.dll")
QStatus alljoyn_securityapplicationproxy_installmembership(alljoyn_securityapplicationproxy proxy, 
                                                           byte* membershipCertificateChain);
...
@DllImport("MSAJApi.dll")
QStatus alljoyn_securityapplicationproxy_geteccpublickey(alljoyn_securityapplicationproxy proxy, 
                                                         byte** eccPublicKey);
