...
enum uint DIRECTINPUT_VERSION = 0x00000800;

enum : uint
{
    JOY_HW_NONE          = 0x00000000,
    JOY_HW_CUSTOM        = 0x00000001,
    JOY_HW_2A_2B_GENERIC = 0x00000002,
    JOY_HW_2A_4B_GENERIC = 0x00000003,
}

enum : uint
{
    JOY_HW_2B_GAMEPAD            = 0x00000004,
    JOY_HW_2B_FLIGHTYOKE         = 0x00000005,
    JOY_HW_2B_FLIGHTYOKETHROTTLE = 0x00000006,
}

enum : uint
{
    JOY_HW_3A_2B_GENERIC = 0x00000007,
    JOY_HW_3A_4B_GENERIC = 0x00000008,
}

enum : uint
{
    JOY_HW_4B_GAMEPAD            = 0x00000009,
    JOY_HW_4B_FLIGHTYOKE         = 0x0000000a,
    JOY_HW_4B_FLIGHTYOKETHROTTLE = 0x0000000b,
}

enum uint JOY_HW_TWO_2A_2B_WITH_Y = 0x0000000c;
enum uint JOY_HW_LASTENTRY = 0x0000000d;
...
enum : uint
{
    JOY_POV_NUMDIRS     = 0x00000004,
    JOY_POVVAL_FORWARD  = 0x00000000,
    JOY_POVVAL_BACKWARD = 0x00000001,
    JOY_POVVAL_LEFT     = 0x00000002,
    JOY_POVVAL_RIGHT    = 0x00000003,
}
...
enum : uint
{
    MAX_JOYSTRING          = 0x00000100,
    MAX_JOYSTICKOEMVXDNAME = 0x00000104,
}

enum uint DITC_REGHWSETTINGS = 0x00000001;
enum uint DITC_CLSIDCONFIG = 0x00000002;
enum uint DITC_DISPLAYNAME = 0x00000004;

enum : uint
{
    DITC_CALLOUT    = 0x00000008,
    DITC_HARDWAREID = 0x00000010,
}

enum : uint
{
    DITC_FLAGS1  = 0x00000020,
    DITC_FLAGS2  = 0x00000040,
    DITC_MAPFILE = 0x00000080,
}

enum uint DIJC_GUIDINSTANCE = 0x00000001;
enum uint DIJC_REGHWCONFIGTYPE = 0x00000002;

enum : uint
{
    DIJC_GAIN        = 0x00000004,
    DIJC_CALLOUT     = 0x00000008,
    DIJC_WDMGAMEPORT = 0x00000010,
}

enum uint DIJU_USERVALUES = 0x00000001;
enum uint DIJU_GLOBALDRIVER = 0x00000002;
enum uint DIJU_GAMEPORTEMULATOR = 0x00000004;
...
enum : uint
{
    DIMSGWP_NEWAPPSTART       = 0x00000001,
    DIMSGWP_DX8APPSTART       = 0x00000002,
    DIMSGWP_DX8MAPPERAPPSTART = 0x00000003,
}

enum : uint
{
    DIAPPIDFLAG_NOTIME = 0x00000001,
    DIAPPIDFLAG_NOSIZE = 0x00000002,
}
...
enum uint DIDIFT_DELETE = 0x01000000;
...
enum uint HID_REVISION = 0x00000001;
...
enum uint KEYBOARD_OVERRUN_MAKE_CODE = 0x000000ff;

enum : uint
{
    KEY_MAKE             = 0x00000000,
    KEY_BREAK            = 0x00000001,
    KEY_E0               = 0x00000002,
    KEY_E1               = 0x00000004,
    KEY_TERMSRV_SET_LED  = 0x00000008,
    KEY_TERMSRV_SHADOW   = 0x00000010,
    KEY_TERMSRV_VKPACKET = 0x00000020,
}

enum uint KEY_RIM_VKEY = 0x00000040;
enum uint KEY_FROM_KEYBOARD_OVERRIDER = 0x00000080;

enum : uint
{
    KEY_UNICODE_SEQUENCE_ITEM = 0x00000100,
    KEY_UNICODE_SEQUENCE_END  = 0x00000200,
}

enum uint KEYBOARD_EXTENDED_ATTRIBUTES_STRUCT_VERSION_1 = 0x00000001;

enum : uint
{
    KEYBOARD_LED_INJECTED   = 0x00008000,
    KEYBOARD_SHADOW         = 0x00004000,
    KEYBOARD_KANA_LOCK_ON   = 0x00000008,
    KEYBOARD_CAPS_LOCK_ON   = 0x00000004,
    KEYBOARD_NUM_LOCK_ON    = 0x00000002,
    KEYBOARD_SCROLL_LOCK_ON = 0x00000001,
}

enum uint KEYBOARD_ERROR_VALUE_BASE = 0x00002710;
...
enum : uint
{
    MOUSE_LEFT_BUTTON_DOWN = 0x00000001,
    MOUSE_LEFT_BUTTON_UP   = 0x00000002,
}

enum : uint
{
    MOUSE_RIGHT_BUTTON_DOWN = 0x00000004,
    MOUSE_RIGHT_BUTTON_UP   = 0x00000008,
}

enum : uint
{
    MOUSE_MIDDLE_BUTTON_DOWN = 0x00000010,
    MOUSE_MIDDLE_BUTTON_UP   = 0x00000020,
}

enum : uint
{
    MOUSE_BUTTON_1_DOWN = 0x00000001,
    MOUSE_BUTTON_1_UP   = 0x00000002,
    MOUSE_BUTTON_2_DOWN = 0x00000004,
    MOUSE_BUTTON_2_UP   = 0x00000008,
    MOUSE_BUTTON_3_DOWN = 0x00000010,
    MOUSE_BUTTON_3_UP   = 0x00000020,
    MOUSE_BUTTON_4_DOWN = 0x00000040,
    MOUSE_BUTTON_4_UP   = 0x00000080,
    MOUSE_BUTTON_5_DOWN = 0x00000100,
    MOUSE_BUTTON_5_UP   = 0x00000200,
}

enum : uint
{
    MOUSE_WHEEL              = 0x00000400,
    MOUSE_HWHEEL             = 0x00000800,
    MOUSE_TERMSRV_SRC_SHADOW = 0x00000100,
}

enum uint MOUSE_INPORT_HARDWARE = 0x00000001;
enum uint MOUSE_I8042_HARDWARE = 0x00000002;
enum uint MOUSE_SERIAL_HARDWARE = 0x00000004;

enum : uint
{
    BALLPOINT_I8042_HARDWARE  = 0x00000008,
    BALLPOINT_SERIAL_HARDWARE = 0x00000010,
}

enum : uint
{
    WHEELMOUSE_I8042_HARDWARE  = 0x00000020,
    WHEELMOUSE_SERIAL_HARDWARE = 0x00000040,
}

enum uint MOUSE_HID_HARDWARE = 0x00000080;
enum uint WHEELMOUSE_HID_HARDWARE = 0x00000100;
enum uint HORIZONTAL_WHEEL_PRESENT = 0x00008000;
enum uint MOUSE_ERROR_VALUE_BASE = 0x00004e20;
enum uint DIRECTINPUT_HEADER_VERSION = 0x00000800;
...
enum uint DIEFT_RAMPFORCE = 0x00000002;
...
enum uint DI_DEGREES = 0x00000064;
enum uint DI_FFNOMINALMAX = 0x00002710;
enum uint DI_SECONDS = 0x000f4240;
...
enum uint DIEFF_CARTESIAN = 0x00000010;
...
enum uint DIEP_DURATION = 0x00000001;
enum uint DIEP_SAMPLEPERIOD = 0x00000002;
...
enum uint DIEP_ENVELOPE = 0x00000080;
enum uint DIEP_TYPESPECIFICPARAMS = 0x00000100;
enum uint DIEP_STARTDELAY = 0x00000200;
...
enum uint DIEB_NOTRIGGER = 0xffffffff;
...
enum : uint
{
    ...
    DIDEVTYPEMOUSE_UNKNOWN     = 0x00000001,
    DIDEVTYPEMOUSE_TRADITIONAL = 0x00000002,
    DIDEVTYPEMOUSE_FINGERSTICK = 0x00000003,
    DIDEVTYPEMOUSE_TOUCHPAD    = 0x00000004,
    DIDEVTYPEMOUSE_TRACKBALL   = 0x00000005,
}

enum : uint
{
    DIDEVTYPEKEYBOARD_UNKNOWN     = 0x00000000,
    DIDEVTYPEKEYBOARD_PCXT        = 0x00000001,
    DIDEVTYPEKEYBOARD_OLIVETTI    = 0x00000002,
    DIDEVTYPEKEYBOARD_PCAT        = 0x00000003,
    DIDEVTYPEKEYBOARD_PCENH       = 0x00000004,
    DIDEVTYPEKEYBOARD_NOKIA1050   = 0x00000005,
    DIDEVTYPEKEYBOARD_NOKIA9140   = 0x00000006,
    DIDEVTYPEKEYBOARD_NEC98       = 0x00000007,
    DIDEVTYPEKEYBOARD_NEC98LAPTOP = 0x00000008,
    DIDEVTYPEKEYBOARD_NEC98106    = 0x00000009,
    DIDEVTYPEKEYBOARD_JAPAN106    = 0x0000000a,
    DIDEVTYPEKEYBOARD_JAPANAX     = 0x0000000b,
    DIDEVTYPEKEYBOARD_J3100       = 0x0000000c,
}

enum : uint
{
    DIDEVTYPEJOYSTICK_UNKNOWN     = 0x00000001,
    DIDEVTYPEJOYSTICK_TRADITIONAL = 0x00000002,
    DIDEVTYPEJOYSTICK_FLIGHTSTICK = 0x00000003,
    DIDEVTYPEJOYSTICK_GAMEPAD     = 0x00000004,
    DIDEVTYPEJOYSTICK_RUDDER      = 0x00000005,
    DIDEVTYPEJOYSTICK_WHEEL       = 0x00000006,
    DIDEVTYPEJOYSTICK_HEADTRACKER = 0x00000007,
}

enum : uint
{
    DI8DEVTYPEMOUSE_UNKNOWN        = 0x00000001,
    DI8DEVTYPEMOUSE_TRADITIONAL    = 0x00000002,
    DI8DEVTYPEMOUSE_FINGERSTICK    = 0x00000003,
    DI8DEVTYPEMOUSE_TOUCHPAD       = 0x00000004,
    DI8DEVTYPEMOUSE_TRACKBALL      = 0x00000005,
    DI8DEVTYPEMOUSE_ABSOLUTE       = 0x00000006,
    DI8DEVTYPEKEYBOARD_UNKNOWN     = 0x00000000,
    DI8DEVTYPEKEYBOARD_PCXT        = 0x00000001,
    DI8DEVTYPEKEYBOARD_OLIVETTI    = 0x00000002,
    DI8DEVTYPEKEYBOARD_PCAT        = 0x00000003,
    DI8DEVTYPEKEYBOARD_PCENH       = 0x00000004,
    DI8DEVTYPEKEYBOARD_NOKIA1050   = 0x00000005,
    DI8DEVTYPEKEYBOARD_NOKIA9140   = 0x00000006,
    DI8DEVTYPEKEYBOARD_NEC98       = 0x00000007,
    DI8DEVTYPEKEYBOARD_NEC98LAPTOP = 0x00000008,
    DI8DEVTYPEKEYBOARD_NEC98106    = 0x00000009,
    DI8DEVTYPEKEYBOARD_JAPAN106    = 0x0000000a,
    DI8DEVTYPEKEYBOARD_JAPANAX     = 0x0000000b,
    DI8DEVTYPEKEYBOARD_J3100       = 0x0000000c,
    DI8DEVTYPE_LIMITEDGAMESUBTYPE  = 0x00000001,
}

enum : uint
{
    DI8DEVTYPEJOYSTICK_LIMITED  = 0x00000001,
    DI8DEVTYPEJOYSTICK_STANDARD = 0x00000002,
}

enum : uint
{
    DI8DEVTYPEGAMEPAD_LIMITED        = 0x00000001,
    DI8DEVTYPEGAMEPAD_STANDARD       = 0x00000002,
    DI8DEVTYPEGAMEPAD_TILT           = 0x00000003,
    DI8DEVTYPEDRIVING_LIMITED        = 0x00000001,
    DI8DEVTYPEDRIVING_COMBINEDPEDALS = 0x00000002,
    DI8DEVTYPEDRIVING_DUALPEDALS     = 0x00000003,
    DI8DEVTYPEDRIVING_THREEPEDALS    = 0x00000004,
    DI8DEVTYPEDRIVING_HANDHELD       = 0x00000005,
}

enum : uint
{
    DI8DEVTYPEFLIGHT_LIMITED    = 0x00000001,
    DI8DEVTYPEFLIGHT_STICK      = 0x00000002,
    DI8DEVTYPEFLIGHT_YOKE       = 0x00000003,
    DI8DEVTYPEFLIGHT_RC         = 0x00000004,
    DI8DEVTYPE1STPERSON_LIMITED = 0x00000001,
    DI8DEVTYPE1STPERSON_UNKNOWN = 0x00000002,
    DI8DEVTYPE1STPERSON_SIXDOF  = 0x00000003,
    DI8DEVTYPE1STPERSON_SHOOTER = 0x00000004,
}

enum : uint
{
    DI8DEVTYPESCREENPTR_UNKNOWN  = 0x00000002,
    DI8DEVTYPESCREENPTR_LIGHTGUN = 0x00000003,
    DI8DEVTYPESCREENPTR_LIGHTPEN = 0x00000004,
    DI8DEVTYPESCREENPTR_TOUCH    = 0x00000005,
}

enum : uint
{
    DI8DEVTYPEREMOTE_UNKNOWN                      = 0x00000002,
    DI8DEVTYPEDEVICECTRL_UNKNOWN                  = 0x00000002,
    DI8DEVTYPEDEVICECTRL_COMMSSELECTION           = 0x00000003,
    DI8DEVTYPEDEVICECTRL_COMMSSELECTION_HARDWIRED = 0x00000004,
}

enum : uint
{
    DI8DEVTYPESUPPLEMENTAL_UNKNOWN           = 0x00000002,
    DI8DEVTYPESUPPLEMENTAL_2NDHANDCONTROLLER = 0x00000003,
    DI8DEVTYPESUPPLEMENTAL_HEADTRACKER       = 0x00000004,
    DI8DEVTYPESUPPLEMENTAL_HANDTRACKER       = 0x00000005,
    DI8DEVTYPESUPPLEMENTAL_SHIFTSTICKGATE    = 0x00000006,
    DI8DEVTYPESUPPLEMENTAL_SHIFTER           = 0x00000007,
    DI8DEVTYPESUPPLEMENTAL_THROTTLE          = 0x00000008,
    DI8DEVTYPESUPPLEMENTAL_SPLITTHROTTLE     = 0x00000009,
    DI8DEVTYPESUPPLEMENTAL_COMBINEDPEDALS    = 0x0000000a,
    DI8DEVTYPESUPPLEMENTAL_DUALPEDALS        = 0x0000000b,
    DI8DEVTYPESUPPLEMENTAL_THREEPEDALS       = 0x0000000c,
    DI8DEVTYPESUPPLEMENTAL_RUDDERPEDALS      = 0x0000000d,
}

enum uint DIDC_ATTACHED = 0x00000001;
enum uint DIDC_POLLEDDEVICE = 0x00000002;
enum uint DIDC_EMULATED = 0x00000004;
enum uint DIDC_POLLEDDATAFORMAT = 0x00000008;
enum uint DIDC_FORCEFEEDBACK = 0x00000100;
...
enum uint DIDC_DEADBAND = 0x00004000;
enum uint DIDC_STARTDELAY = 0x00008000;
...
enum uint DIDFT_TGLBUTTON = 0x00000008;
...
enum uint DIDFT_INSTANCEMASK = 0x00ffff00;
...
enum uint DIA_FORCEFEEDBACK = 0x00000001;
...
enum uint DIA_NORANGE = 0x00000008;
enum uint DIA_APPFIXED = 0x00000010;
...
enum uint DIAH_APPREQUESTED = 0x00000002;
...
enum uint DIDIFT_CONFIGURATION = 0x00000001;
enum uint DIDIFT_OVERLAY = 0x00000002;
...
enum uint DIDAL_RIGHTALIGNED = 0x00000002;
...
enum uint DIDAL_BOTTOMALIGNED = 0x00000008;
...
enum uint DIDOI_GUIDISUSAGE = 0x00010000;
...
enum uint MAXCPOINTSNUM = 0x00000008;
...
enum uint DIGDD_PEEK = 0x00000001;
enum uint DISCL_EXCLUSIVE = 0x00000001;
enum uint DISCL_NONEXCLUSIVE = 0x00000002;
enum uint DISCL_FOREGROUND = 0x00000004;
enum uint DISCL_BACKGROUND = 0x00000008;
enum uint DISCL_NOWINKEY = 0x00000010;
...
enum uint DIGFFS_DEVICELOST = 0x80000000;
enum uint DISDD_CONTINUE = 0x00000001;
...
enum uint DIFEF_MODIFYIFNEEDED = 0x00000010;
enum uint DIK_ESCAPE = 0x00000001;
...
enum uint DIK_LCONTROL = 0x0000001d;
...
enum uint DIK_APOSTROPHE = 0x00000028;
...
enum uint DIK_BACKSLASH = 0x0000002b;
...
enum uint DIK_MULTIPLY = 0x00000037;
...
enum uint DIK_SCROLL = 0x00000046;
...
enum uint DIK_SUBTRACT = 0x0000004a;
...
enum uint DIK_DECIMAL = 0x00000053;
enum uint DIK_OEM_102 = 0x00000056;
...
enum uint DIK_CONVERT = 0x00000079;
enum uint DIK_NOCONVERT = 0x0000007b;
...
enum uint DIK_NUMPADEQUALS = 0x0000008d;
enum uint DIK_PREVTRACK = 0x00000090;
...
enum uint DIK_NEXTTRACK = 0x00000099;
enum uint DIK_NUMPADENTER = 0x0000009c;
enum uint DIK_RCONTROL = 0x0000009d;
...
enum uint DIK_PLAYPAUSE = 0x000000a2;
enum uint DIK_MEDIASTOP = 0x000000a4;
...
enum uint DIK_WEBHOME = 0x000000b2;
enum uint DIK_NUMPADCOMMA = 0x000000b3;
enum uint DIK_DIVIDE = 0x000000b5;
...
enum uint DIK_DELETE = 0x000000d3;
...
enum uint DIK_MYCOMPUTER = 0x000000eb;
...
enum uint DIK_BACKSPACE = 0x0000000e;
enum uint DIK_NUMPADSTAR = 0x00000037;
...
enum uint DIK_RIGHTARROW = 0x000000cd;
enum uint DIK_DOWNARROW = 0x000000d0;
...
enum : uint
{
    DIENUM_STOP     = 0x00000000,
    DIENUM_CONTINUE = 0x00000001,
}
...
enum uint DIEDFL_FORCEFEEDBACK = 0x00000100;
...
enum uint DIEDBS_NEWDEVICE = 0x00000020;
...
enum uint DIEDBSFL_MULTIMICEKEYBOARDS = 0x00002000;
enum uint DIEDBSFL_NONGAMINGDEVICES = 0x00004000;
enum uint DIEDBSFL_VALID = 0x00007110;
...
enum uint DIVIRTUAL_DRIVING_RACE = 0x01000000;
...
enum uint DIAXIS_DRIVINGR_ACCEL_AND_BRAKE = 0x01014a04;
enum uint DIHATSWITCH_DRIVINGR_GLANCE = 0x01004601;
...
enum uint DIVIRTUAL_DRIVING_COMBAT = 0x02000000;
...
enum uint DIAXIS_DRIVINGC_ACCEL_AND_BRAKE = 0x02014a04;
enum uint DIHATSWITCH_DRIVINGC_GLANCE = 0x02004601;
...
enum uint DIVIRTUAL_DRIVING_TANK = 0x03000000;
...
enum uint DIHATSWITCH_DRIVINGT_GLANCE = 0x03004601;
...
enum uint DIVIRTUAL_FLYING_CIVILIAN = 0x04000000;
...
enum uint DIHATSWITCH_FLYINGC_GLANCE = 0x04004601;
...
enum uint DIVIRTUAL_FLYING_MILITARY = 0x05000000;
...
enum uint DIHATSWITCH_FLYINGM_GLANCE = 0x05004601;
enum uint DIBUTTON_FLYINGM_COUNTER = 0x05005c04;
...
enum uint DIAXIS_FLYINGM_FLAPS = 0x05055206;
...
enum uint DIVIRTUAL_FLYING_HELICOPTER = 0x06000000;
...
enum uint DIHATSWITCH_FLYINGH_GLANCE = 0x06004601;
...
enum uint DIVIRTUAL_SPACESIM = 0x07000000;
...
enum uint DIHATSWITCH_SPACESIM_GLANCE = 0x07004601;
...
enum uint DIVIRTUAL_FIGHTING_HAND2HAND = 0x08000000;
...
enum uint DIHATSWITCH_FIGHTINGH_SLIDE = 0x08004601;
enum uint DIBUTTON_FIGHTINGH_DISPLAY = 0x08004409;
enum uint DIAXIS_FIGHTINGH_ROTATE = 0x08024203;
...
enum uint DIVIRTUAL_FIGHTING_FPS = 0x09000000;
...
enum uint DIAXIS_FPS_LOOKUPDOWN = 0x09018203;
...
enum uint DIHATSWITCH_FPS_GLANCE = 0x09004601;
enum uint DIBUTTON_FPS_DISPLAY = 0x09004408;
enum uint DIAXIS_FPS_SIDESTEP = 0x09024204;
...
enum uint DIVIRTUAL_FIGHTING_THIRDPERSON = 0x0a000000;
...
enum uint DIHATSWITCH_TPS_GLANCE = 0x0a004601;
...
enum uint DIAXIS_TPS_STEP = 0x0a00c203;
...
enum uint DIVIRTUAL_STRATEGY_ROLEPLAYING = 0x0b000000;
...
enum uint DIHATSWITCH_STRATEGYR_GLANCE = 0x0b004601;
...
enum uint DIAXIS_STRATEGYR_ROTATE = 0x0b024203;
...
enum uint DIVIRTUAL_STRATEGY_TURN = 0x0c000000;
...
enum uint DIVIRTUAL_SPORTS_HUNTING = 0x0d000000;
...
enum uint DIHATSWITCH_HUNTING_GLANCE = 0x0d004601;
enum uint DIBUTTON_HUNTING_DISPLAY = 0x0d004408;
enum uint DIAXIS_HUNTING_ROTATE = 0x0d024203;
...
enum uint DIVIRTUAL_SPORTS_FISHING = 0x0e000000;
...
enum uint DIHATSWITCH_FISHING_GLANCE = 0x0e004601;
enum uint DIBUTTON_FISHING_DISPLAY = 0x0e004406;
enum uint DIAXIS_FISHING_ROTATE = 0x0e024203;
...
enum uint DIVIRTUAL_SPORTS_BASEBALL_BAT = 0x0f000000;
...
enum uint DIVIRTUAL_SPORTS_BASEBALL_PITCH = 0x10000000;
...
enum uint DIVIRTUAL_SPORTS_BASEBALL_FIELD = 0x11000000;
...
enum uint DIVIRTUAL_SPORTS_BASKETBALL_OFFENSE = 0x12000000;
...
enum uint DIHATSWITCH_BBALLO_GLANCE = 0x12004601;
...
enum uint DIVIRTUAL_SPORTS_BASKETBALL_DEFENSE = 0x13000000;
...
enum uint DIHATSWITCH_BBALLD_GLANCE = 0x13004601;
...
enum uint DIVIRTUAL_SPORTS_FOOTBALL_FIELD = 0x14000000;
...
enum uint DIVIRTUAL_SPORTS_FOOTBALL_QBCK = 0x15000000;
...
enum uint DIVIRTUAL_SPORTS_FOOTBALL_OFFENSE = 0x16000000;
...
enum uint DIVIRTUAL_SPORTS_FOOTBALL_DEFENSE = 0x17000000;
...
enum uint DIVIRTUAL_SPORTS_GOLF = 0x18000000;
...
enum uint DIHATSWITCH_GOLF_SCROLL = 0x18004601;
...
enum uint DIVIRTUAL_SPORTS_HOCKEY_OFFENSE = 0x19000000;
...
enum uint DIHATSWITCH_HOCKEYO_SCROLL = 0x19004601;
...
enum uint DIVIRTUAL_SPORTS_HOCKEY_DEFENSE = 0x1a000000;
...
enum uint DIHATSWITCH_HOCKEYD_SCROLL = 0x1a004601;
...
enum uint DIVIRTUAL_SPORTS_HOCKEY_GOALIE = 0x1b000000;
...
enum uint DIHATSWITCH_HOCKEYG_SCROLL = 0x1b004601;
...
enum uint DIVIRTUAL_SPORTS_BIKING_MOUNTAIN = 0x1c000000;
...
enum uint DIHATSWITCH_BIKINGM_SCROLL = 0x1c004601;
enum uint DIBUTTON_BIKINGM_ZOOM = 0x1c004406;
enum uint DIAXIS_BIKINGM_BRAKE = 0x1c044203;
...
enum uint DIVIRTUAL_SPORTS_SKIING = 0x1d000000;
...
enum uint DIHATSWITCH_SKIING_GLANCE = 0x1d004601;
...
enum uint DIVIRTUAL_SPORTS_SOCCER_OFFENSE = 0x1e000000;
...
enum uint DIHATSWITCH_SOCCERO_GLANCE = 0x1e004601;
...
enum uint DIVIRTUAL_SPORTS_SOCCER_DEFENSE = 0x1f000000;
...
enum uint DIHATSWITCH_SOCCERD_GLANCE = 0x1f004601;
...
enum uint DIVIRTUAL_SPORTS_RACQUET = 0x20000000;
...
enum uint DIHATSWITCH_RACQUET_GLANCE = 0x20004601;
...
enum uint DIVIRTUAL_ARCADE_SIDE2SIDE = 0x21000000;
...
enum uint DIHATSWITCH_ARCADES_VIEW = 0x21004601;
...
enum uint DIVIRTUAL_ARCADE_PLATFORM = 0x22000000;
...
enum uint DIHATSWITCH_ARCADEP_VIEW = 0x22004601;
...
enum uint DIVIRTUAL_CAD_2DCONTROL = 0x23000000;
...
enum uint DIHATSWITCH_2DCONTROL_HATSWITCH = 0x23004601;
enum uint DIAXIS_2DCONTROL_ROTATEZ = 0x23024204;
...
enum uint DIVIRTUAL_CAD_3DCONTROL = 0x24000000;
...
enum uint DIHATSWITCH_3DCONTROL_HATSWITCH = 0x24004601;
...
enum uint DIVIRTUAL_CAD_FLYBY = 0x25000000;
...
enum uint DIHATSWITCH_CADF_HATSWITCH = 0x25004601;
...
enum uint DIVIRTUAL_CAD_MODEL = 0x26000000;
...
enum uint DIHATSWITCH_CADM_HATSWITCH = 0x26004601;
...
enum uint DIVIRTUAL_REMOTE_CONTROL = 0x27000000;
enum uint DIAXIS_REMOTE_SLIDER = 0x27050201;
...
enum uint DIAXIS_REMOTE_SLIDER2 = 0x27054202;
...
enum uint DIVIRTUAL_BROWSER_CONTROL = 0x28000000;
...
enum uint DIBUTTON_BROWSER_SELECT = 0x28000401;
enum uint DIAXIS_BROWSER_VIEW = 0x28018203;
...
enum uint DIVIRTUAL_DRIVING_MECHA = 0x29000000;
...
enum uint DIHATSWITCH_MECHA_GLANCE = 0x29004601;
...
enum uint JOY_OEMPOLL_PASSDRIVERDATA = 0x00000007;

enum : uint
{
    BUTTON_BIT_POWER          = 0x00000001,
    BUTTON_BIT_WINDOWS        = 0x00000002,
    BUTTON_BIT_VOLUMEUP       = 0x00000004,
    BUTTON_BIT_VOLUMEDOWN     = 0x00000008,
    BUTTON_BIT_ROTATION_LOCK  = 0x00000010,
    BUTTON_BIT_BACK           = 0x00000020,
    BUTTON_BIT_SEARCH         = 0x00000040,
    BUTTON_BIT_CAMERAFOCUS    = 0x00000080,
    BUTTON_BIT_CAMERASHUTTER  = 0x00000100,
    BUTTON_BIT_RINGERTOGGLE   = 0x00000200,
    BUTTON_BIT_HEADSET        = 0x00000400,
    BUTTON_BIT_HWKBDEPLOY     = 0x00000800,
    BUTTON_BIT_CAMERALENS     = 0x00001000,
    BUTTON_BIT_OEMCUSTOM      = 0x00002000,
    BUTTON_BIT_OEMCUSTOM2     = 0x00004000,
    BUTTON_BIT_OEMCUSTOM3     = 0x00008000,
    BUTTON_BIT_ALLBUTTONSMASK = 0x00003fff,
}
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinput/ns-dinput-dieffescape))], [])
struct DIEFFESCAPE
{
    uint  dwSize;
    uint  dwCommand;
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/ns-dinputd-diobjectattributes))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/ns-dinputd-diffobjectattributes))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/ns-dinputd-diobjectcalibration))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/ns-dinputd-dieffectattributes))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/ns-dinputd-diffdeviceattributes))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/ns-dinputd-didriverversions))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/ns-dinputd-didevicestate))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/ns-dinputd-dihidffinitinfo))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/ns-dinputd-joyreghwvalues))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/ns-dinputd-dijoytypeinfo))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/ns-dinputd-dijoyconfig))], [])
struct DIJOYCONFIG
{
    uint           dwSize;
    GUID           guidInstance;
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/ns-dinputd-dijoyuservalues))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ntddkbd/ns-ntddkbd-keyboard_input_data))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ntddkbd/ns-ntddkbd-keyboard_typematic_parameters))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ntddkbd/ns-ntddkbd-keyboard_attributes))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ntddkbd/ns-ntddkbd-keyboard_extended_attributes))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ntddkbd/ns-ntddkbd-keyboard_indicator_parameters))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ntddkbd/ns-ntddkbd-keyboard_indicator_translation))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ntddkbd/ns-ntddkbd-keyboard_unit_id_parameter))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ntddmou/ns-ntddmou-mouse_input_data))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ntddmou/ns-ntddmou-mouse_attributes))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ntddmou/ns-ntddmou-mouse_unit_id_parameter))], [])
...
align (4):
    ...
    ushort NextSibling;
    ushort FirstChild;
    /*FIELD ATTR: NativeBitfieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(Reserved)), FixedArgSig(ElementSig(9)), FixedArgSig(ElementSig(23))], [])*/uint _bitfield21;
    void*  UserContext;
}
...
//INTERFACEF ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nn-dinputd-idirectinputeffectdriver))], [])
interface IDirectInputEffectDriver : IUnknown
{
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputeffectdriver-deviceid))], [])
    HRESULT DeviceID(uint param0, uint param1, uint param2, uint param3, void* param4);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputeffectdriver-getversions))], [])
    HRESULT GetVersions(DIDRIVERVERSIONS* param0);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputeffectdriver-escape))], [])
    HRESULT Escape(uint param0, uint param1, DIEFFESCAPE* param2);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputeffectdriver-setgain))], [])
    HRESULT SetGain(uint param0, uint param1);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputeffectdriver-sendforcefeedbackcommand))], [])
    HRESULT SendForceFeedbackCommand(uint param0, uint param1);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputeffectdriver-getforcefeedbackstate))], [])
    HRESULT GetForceFeedbackState(uint param0, DIDEVICESTATE* param1);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputeffectdriver-downloadeffect))], [])
    HRESULT DownloadEffect(uint param0, uint param1, uint* param2, DIEFFECT* param3, uint param4);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputeffectdriver-destroyeffect))], [])
    HRESULT DestroyEffect(uint param0, uint param1);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputeffectdriver-starteffect))], [])
    HRESULT StartEffect(uint param0, uint param1, uint param2, uint param3);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputeffectdriver-stopeffect))], [])
    HRESULT StopEffect(uint param0, uint param1);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputeffectdriver-geteffectstatus))], [])
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputjoyconfig-openconfigkey))], [])
    HRESULT OpenConfigKey(uint param0, uint param1, HKEY* param2);
}

@GUID("eb0d7dfa-1990-4f27-b4d6-edf2eec4a44c")
//INTERFACEF ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nn-dinputd-idirectinputjoyconfig8))], [])
interface IDirectInputJoyConfig8 : IUnknown
{
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputjoyconfig8-acquire))], [])
    HRESULT Acquire();
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputjoyconfig8-unacquire))], [])
    HRESULT Unacquire();
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputjoyconfig8-setcooperativelevel))], [])
    HRESULT SetCooperativeLevel(HWND param0, uint param1);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputjoyconfig8-sendnotify))], [])
    HRESULT SendNotify();
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputjoyconfig8-enumtypes))], [])
    HRESULT EnumTypes(LPDIJOYTYPECALLBACK param0, void* param1);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputjoyconfig8-gettypeinfo))], [])
    HRESULT GetTypeInfo(const(PWSTR) param0, DIJOYTYPEINFO* param1, uint param2);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputjoyconfig8-settypeinfo))], [])
    HRESULT SetTypeInfo(const(PWSTR) param0, DIJOYTYPEINFO* param1, uint param2, PWSTR param3);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputjoyconfig8-deletetype))], [])
    HRESULT DeleteType(const(PWSTR) param0);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputjoyconfig8-getconfig))], [])
    HRESULT GetConfig(uint param0, DIJOYCONFIG* param1, uint param2);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputjoyconfig8-setconfig))], [])
    HRESULT SetConfig(uint param0, DIJOYCONFIG* param1, uint param2);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputjoyconfig8-deleteconfig))], [])
    HRESULT DeleteConfig(uint param0);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputjoyconfig8-getuservalues))], [])
    HRESULT GetUserValues(DIJOYUSERVALUES* param0, uint param1);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputjoyconfig8-setuservalues))], [])
    HRESULT SetUserValues(DIJOYUSERVALUES* param0, uint param1);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputjoyconfig8-addnewhardware))], [])
    HRESULT AddNewHardware(HWND param0, const(GUID)* param1);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputjoyconfig8-opentypekey))], [])
    HRESULT OpenTypeKey(const(PWSTR) param0, uint param1, HKEY* param2);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/dinputd/nf-dinputd-idirectinputjoyconfig8-openappstatuskey))], [])
