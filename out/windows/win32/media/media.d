...
module windows.win32.media.media;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Multimedia/mm-joy2buttondown))], [])*/uint MM_JOY2BUTTONDOWN = 0x000003b6U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Multimedia/mm-joy1buttonup))], [])*/uint MM_JOY1BUTTONUP = 0x000003b7U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Multimedia/mm-joy2buttonup))], [])*/uint MM_JOY2BUTTONUP = 0x000003b8U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Multimedia/mm-mcinotify))], [])*/uint MM_MCINOTIFY = 0x000003b9U;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Multimedia/mm-mom-positioncb))], [])*/uint MM_MOM_POSITIONCB = 0x000003caU;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Multimedia/mm-mcisignal))], [])*/uint MM_MCISIGNAL = 0x000003cbU;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Multimedia/mm-mim-moredata))], [])*/uint MM_MIM_MOREDATA = 0x000003ccU;
