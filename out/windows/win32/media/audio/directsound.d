...
enum uint DIRECTSOUND_VERSION = 0x00000700;
enum uint _FACDS = 0x00000878;
...
enum : uint
{
    DSFXCHORUS_WAVE_TRIANGLE = 0x00000000,
    DSFXCHORUS_WAVE_SIN      = 0x00000001,
}
...
enum : uint
{
    DSFXCHORUS_PHASE_MIN     = 0x00000000,
    DSFXCHORUS_PHASE_MAX     = 0x00000004,
    DSFXCHORUS_PHASE_NEG_180 = 0x00000000,
    DSFXCHORUS_PHASE_NEG_90  = 0x00000001,
    DSFXCHORUS_PHASE_ZERO    = 0x00000002,
    DSFXCHORUS_PHASE_90      = 0x00000003,
    DSFXCHORUS_PHASE_180     = 0x00000004,
}

enum : uint
{
    DSFXFLANGER_WAVE_TRIANGLE = 0x00000000,
    DSFXFLANGER_WAVE_SIN      = 0x00000001,
}
...
enum : uint
{
    DSFXFLANGER_PHASE_MIN = 0x00000000,
    DSFXFLANGER_PHASE_MAX = 0x00000004,
}
...
enum : uint
{
    DSFXFLANGER_PHASE_NEG_180 = 0x00000000,
    DSFXFLANGER_PHASE_NEG_90  = 0x00000001,
    DSFXFLANGER_PHASE_ZERO    = 0x00000002,
    DSFXFLANGER_PHASE_90      = 0x00000003,
    DSFXFLANGER_PHASE_180     = 0x00000004,
}
...
enum : uint
{
    DSFXECHO_PANDELAY_MIN = 0x00000000,
    DSFXECHO_PANDELAY_MAX = 0x00000001,
}
...
enum uint DSFX_I3DL2REVERB_ROOM_MAX = 0x00000000;
...
enum uint DSFX_I3DL2REVERB_ROOMHF_MAX = 0x00000000;
...
enum uint DSFX_I3DL2REVERB_REFLECTIONS_MAX = 0x000003e8;
...
enum : uint
{
    ...
    DSFX_I3DL2REVERB_REVERB_DEFAULT = 0x000000c8,
}
...
enum : uint
{
    DSCFX_AEC_MODE_PASS_THROUGH = 0x00000000,
    DSCFX_AEC_MODE_HALF_DUPLEX  = 0x00000001,
    DSCFX_AEC_MODE_FULL_DUPLEX  = 0x00000002,
}

enum : uint
{
    DSCFX_AEC_STATUS_HISTORY_UNINITIALIZED          = 0x00000000,
    DSCFX_AEC_STATUS_HISTORY_CONTINUOUSLY_CONVERGED = 0x00000001,
    DSCFX_AEC_STATUS_HISTORY_PREVIOUSLY_DIVERGED    = 0x00000002,
}

enum uint DSCFX_AEC_STATUS_CURRENTLY_CONVERGED = 0x00000008;
...
enum uint DSCAPS_CONTINUOUSRATE = 0x00000010;
...
enum uint DSSCL_WRITEPRIMARY = 0x00000004;
...
enum uint DSSPEAKER_5POINT1_SURROUND = 0x00000009;
...
enum uint DSBCAPS_PRIMARYBUFFER = 0x00000001;
...
enum uint DSBCAPS_MUTE3DATMAXDISTANCE = 0x00020000;
...
enum : ulong
{
    DSBPLAY_TERMINATEBY_DISTANCE = 0x0000000000000010,
    DSBPLAY_TERMINATEBY_PRIORITY = 0x0000000000000020,
}
...
enum uint DSBLOCK_FROMWRITECURSOR = 0x00000001;
enum uint DSBLOCK_ENTIREBUFFER = 0x00000002;

enum : uint
{
    DSBFREQUENCY_ORIGINAL = 0x00000000,
    DSBFREQUENCY_MIN      = 0x00000064,
    DSBFREQUENCY_MAX      = 0x00030d40,
}
...
enum uint DSBVOLUME_MAX = 0x00000000;

enum : uint
{
    DSBSIZE_MIN    = 0x00000004,
    DSBSIZE_MAX    = 0x0fffffff,
    DSBSIZE_FX_MIN = 0x00000096,
}

enum uint DSBNOTIFICATIONS_MAX = 0x000186a0;
...
enum uint DS3D_IMMEDIATE = 0x00000000;
enum uint DS3D_DEFERRED = 0x00000001;
...
enum uint DS3D_MINCONEANGLE = 0x00000000;
enum uint DS3D_MAXCONEANGLE = 0x00000168;
...
enum uint DSCBLOCK_ENTIREBUFFER = 0x00000001;
...
enum uint DSCBSTART_LOOPING = 0x00000001;
enum uint DSBPN_OFFSETSTOP = 0xffffffff;
enum uint DS_CERTIFIED = 0x00000000;
enum uint DS_UNCERTIFIED = 0x00000001;
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/DevNotes/directsoundfullduplexcreate))], [])
@DllImport("DSOUND.dll")
