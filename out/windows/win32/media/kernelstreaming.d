...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/devicetopology/ne-devicetopology-ksjack_sink_connectiontype))], [])
...
enum uint KSMEDIUM_TYPE_ANYINSTANCE = 0x00000000;
enum uint KSMEDIUM_STANDARD_DEVIO = 0x00000000;

enum : uint
{
    KSPROPERTY_PIN_FLAGS_ATTRIBUTE_RANGE_AWARE = 0x00000001,
    KSPROPERTY_PIN_FLAGS_MASK                  = 0x00000001,
}
...
enum uint KSATTRIBUTE_REQUIRED = 0x00000001;
...
enum uint KSSTREAM_HEADER_TRACK_COMPLETION_NUMBERS = 0x00020000;
...
enum uint KSSTREAM_UVC_SECURE_ATTRIBUTE_SIZE = 0x00002000;
enum uint KSFRAMETIME_VARIABLESIZE = 0x00000001;
...
enum uint NANOSECONDS = 0x00989680;
...
enum uint KSPROBE_SYSTEMADDRESS = 0x00000040;
...
enum : uint
{
    KSSTREAM_READ             = 0x00000000,
    KSSTREAM_WRITE            = 0x00000001,
...
enum uint KSDISPATCH_FASTIO = 0x80000000;
...
enum uint BUS_INTERFACE_REFERENCE_VERSION = 0x00000100;
enum uint IOCTL_KS_HANDSHAKE = 0x002f001f;
enum uint MIN_DEV_VER_FOR_QI = 0x00000100;
...
enum uint MIN_DEV_VER_FOR_FLAGS = 0x00000110;
...
enum uint KSFILTER_FLAG_DISPATCH_LEVEL_PROCESSING = 0x00000001;
...
enum uint KSFILTER_FLAG_RECEIVE_ZERO_LENGTH_SAMPLES = 0x00000008;
...
enum uint KSPIN_FLAG_DISPATCH_LEVEL_PROCESSING = 0x00000001;
enum uint KSPIN_FLAG_CRITICAL_PROCESSING = 0x00000002;
enum uint KSPIN_FLAG_HYPERCRITICAL_PROCESSING = 0x00000004;
enum uint KSPIN_FLAG_ASYNCHRONOUS_PROCESSING = 0x00000008;
enum uint KSPIN_FLAG_DO_NOT_INITIATE_PROCESSING = 0x00000010;
enum uint KSPIN_FLAG_INITIATE_PROCESSING_ON_EVERY_ARRIVAL = 0x00000020;
enum uint KSPIN_FLAG_FRAMES_NOT_REQUIRED_FOR_PROCESSING = 0x00000040;
...
enum uint KSPIN_FLAG_DISTINCT_TRAILING_EDGE = 0x00000200;
enum uint KSPIN_FLAG_PROCESS_IN_RUN_STATE_ONLY = 0x00010000;
...
enum uint KSPIN_FLAG_DO_NOT_USE_STANDARD_TRANSPORT = 0x00080000;
...
enum uint KSPIN_FLAG_PROCESS_IF_ANY_IN_RUN_STATE = 0x01000000;
enum uint KSPIN_FLAG_DENY_USERMODE_ACCESS = 0x80000000;
enum PWSTR RT_STRING = PWSTR(0x0006);
enum PWSTR RT_RCDATA = PWSTR(0x000a);
enum uint WAVE_FORMAT_EXTENSIBLE = 0x0000fffe;
...
enum : uint
{
    KSAUDIO_STEREO_SPEAKER_GEOMETRY_MIN    = 0x00000005,
    KSAUDIO_STEREO_SPEAKER_GEOMETRY_NARROW = 0x0000000a,
    KSAUDIO_STEREO_SPEAKER_GEOMETRY_WIDE   = 0x00000014,
    KSAUDIO_STEREO_SPEAKER_GEOMETRY_MAX    = 0x000000b4,
}
...
enum uint KSDSOUND_BUFFER_CTRL_HRTF_3D = 0x40000000;

enum : uint
{
    KSAUDIO_QUALITY_WORST    = 0x00000000,
    KSAUDIO_QUALITY_PC       = 0x00000001,
    KSAUDIO_QUALITY_BASIC    = 0x00000002,
    KSAUDIO_QUALITY_ADVANCED = 0x00000003,
}
...
enum uint SPEAKER_LOW_FREQUENCY = 0x00000008;
...
enum : uint
{
    KSAUDIO_SPEAKER_DIRECTOUT           = 0x00000000,
    KSAUDIO_SPEAKER_MONO                = 0x00000004,
    KSAUDIO_SPEAKER_GROUND_FRONT_LEFT   = 0x00000001,
    KSAUDIO_SPEAKER_GROUND_FRONT_CENTER = 0x00000004,
    KSAUDIO_SPEAKER_GROUND_FRONT_RIGHT  = 0x00000002,
    KSAUDIO_SPEAKER_GROUND_REAR_LEFT    = 0x00000010,
    KSAUDIO_SPEAKER_GROUND_REAR_RIGHT   = 0x00000020,
    KSAUDIO_SPEAKER_TOP_MIDDLE          = 0x00000800,
    KSAUDIO_SPEAKER_SUPER_WOOFER        = 0x00000008,
}

enum : uint
{
    KSNODEPIN_STANDARD_IN     = 0x00000001,
    KSNODEPIN_STANDARD_OUT    = 0x00000000,
    KSNODEPIN_SUM_MUX_IN      = 0x00000001,
    KSNODEPIN_SUM_MUX_OUT     = 0x00000000,
    KSNODEPIN_DEMUX_IN        = 0x00000000,
    KSNODEPIN_DEMUX_OUT       = 0x00000001,
    KSNODEPIN_AEC_RENDER_IN   = 0x00000001,
    KSNODEPIN_AEC_RENDER_OUT  = 0x00000000,
    KSNODEPIN_AEC_CAPTURE_IN  = 0x00000002,
    KSNODEPIN_AEC_CAPTURE_OUT = 0x00000003,
}

enum : uint
{
    AEC_STATUS_FD_HISTORY_UNINITIALIZED          = 0x00000000,
    AEC_STATUS_FD_HISTORY_CONTINUOUSLY_CONVERGED = 0x00000001,
    AEC_STATUS_FD_HISTORY_PREVIOUSLY_DIVERGED    = 0x00000002,
}

enum uint AEC_STATUS_FD_CURRENTLY_CONVERGED = 0x00000008;

enum : uint
{
    AEC_MODE_PASS_THROUGH = 0x00000000,
    AEC_MODE_HALF_DUPLEX  = 0x00000001,
    AEC_MODE_FULL_DUPLEX  = 0x00000002,
}

enum uint KSPROPERTY_WAVE_QUEUED_POSITION = 0x00000001;
enum uint KSMETHOD_WAVE_QUEUED_BREAKLOOP = 0x00000001;
...
enum : uint
{
    KSMPEGVIDMODE_PANSCAN = 0x00000001,
    KSMPEGVIDMODE_LTRBOX  = 0x00000002,
    KSMPEGVIDMODE_SCALE   = 0x00000004,
}

enum : uint
{
    KSAC3_ALTERNATE_AUDIO_1    = 0x00000001,
    KSAC3_ALTERNATE_AUDIO_2    = 0x00000002,
    KSAC3_ALTERNATE_AUDIO_BOTH = 0x00000003,
}

enum : uint
{
    KSAC3_SERVICE_MAIN_AUDIO        = 0x00000000,
    KSAC3_SERVICE_NO_DIALOG         = 0x00000001,
    KSAC3_SERVICE_VISUALLY_IMPAIRED = 0x00000002,
    KSAC3_SERVICE_HEARING_IMPAIRED  = 0x00000003,
    KSAC3_SERVICE_DIALOG_ONLY       = 0x00000004,
    KSAC3_SERVICE_COMMENTARY        = 0x00000005,
    KSAC3_SERVICE_EMERGENCY_FLASH   = 0x00000006,
    KSAC3_SERVICE_VOICE_OVER        = 0x00000007,
}

enum : uint
{
    KSAUDDECOUTMODE_STEREO_ANALOG = 0x00000001,
    KSAUDDECOUTMODE_PCM_51        = 0x00000002,
    KSAUDDECOUTMODE_SPDIFF        = 0x00000004,
}
...
enum uint KS_DVD_NOT_COPYRIGHTED = 0x00000000;
enum uint KS_DVD_COPYRIGHTED = 0x00000040;
...
enum uint KS_iPALETTE_COLORS = 0x00000100;
enum uint KS_iEGA_COLORS = 0x00000010;
enum uint KS_iMASK_COLORS = 0x00000003;
enum uint KS_iTRUECOLOR = 0x00000010;

enum : uint
{
    KS_iRED     = 0x00000000,
    KS_iGREEN   = 0x00000001,
    KS_iBLUE    = 0x00000002,
    KS_iPALETTE = 0x00000008,
}

enum uint KS_iMAXBITS = 0x00000008;
...
enum uint KS_COPYPROTECT_RestrictDuplication = 0x00000001;
...
enum uint KS_MPEG2_SourceIsLetterboxed = 0x00000008;
enum uint KS_MPEG2_FilmCameraMode = 0x00000010;
enum uint KS_MPEG2_LetterboxAnalogOut = 0x00000020;
...
enum uint KS_MAX_SIZE_MPEG1_SEQUENCE_INFO = 0x0000008c;
enum uint KS_MPEGAUDIOINFO_27MhzTimebase = 0x00000001;

enum : uint
{
    KS_VIDEOSTREAM_PREVIEW  = 0x00000001,
    KS_VIDEOSTREAM_CAPTURE  = 0x00000002,
    KS_VIDEOSTREAM_VBI      = 0x00000010,
    KS_VIDEOSTREAM_NABTS    = 0x00000020,
    KS_VIDEOSTREAM_CC       = 0x00000100,
    KS_VIDEOSTREAM_EDS      = 0x00000200,
    KS_VIDEOSTREAM_TELETEXT = 0x00000400,
    KS_VIDEOSTREAM_STILL    = 0x00001000,
    KS_VIDEOSTREAM_IS_VPE   = 0x00008000,
}

enum : uint
{
    KS_VIDEO_ALLOC_VPE_SYSTEM  = 0x00000001,
    KS_VIDEO_ALLOC_VPE_DISPLAY = 0x00000002,
    KS_VIDEO_ALLOC_VPE_AGP     = 0x00000004,
}
...
enum : uint
{
    KS_NABTS_GROUPID_ORIGINAL_CONTENT_BASE            = 0x00000800,
    KS_NABTS_GROUPID_ORIGINAL_CONTENT_ADVERTISER_BASE = 0x00000810,
}

enum : uint
{
    KS_NABTS_GROUPID_PRODUCTION_COMPANY_CONTENT_BASE    = 0x00000820,
    KS_NABTS_GROUPID_PRODUCTION_COMPANY_ADVERTISER_BASE = 0x00000830,
}

enum : uint
{
    KS_NABTS_GROUPID_SYNDICATED_SHOW_CONTENT_BASE    = 0x00000840,
    KS_NABTS_GROUPID_SYNDICATED_SHOW_ADVERTISER_BASE = 0x00000850,
}

enum : uint
{
    KS_NABTS_GROUPID_NETWORK_WIDE_CONTENT_BASE    = 0x00000860,
    KS_NABTS_GROUPID_NETWORK_WIDE_ADVERTISER_BASE = 0x00000870,
}

enum : uint
{
    KS_NABTS_GROUPID_TELEVISION_STATION_CONTENT_BASE    = 0x00000880,
    KS_NABTS_GROUPID_TELEVISION_STATION_ADVERTISER_BASE = 0x00000890,
}

enum : uint
{
    KS_NABTS_GROUPID_LOCAL_CABLE_SYSTEM_CONTENT_BASE    = 0x000008a0,
    KS_NABTS_GROUPID_LOCAL_CABLE_SYSTEM_ADVERTISER_BASE = 0x000008b0,
}

enum uint KS_NABTS_GROUPID_MICROSOFT_RESERVED_TEST_DATA_BASE = 0x000008f0;
enum uint MAX_NABTS_VBI_LINES_PER_FIELD = 0x0000000b;
enum uint NABTS_LINES_PER_BUNDLE = 0x00000010;
enum uint NABTS_PAYLOAD_PER_LINE = 0x0000001c;
enum uint NABTS_BYTES_PER_LINE = 0x00000024;
...
enum uint CC_MAX_HW_DECODE_LINES = 0x0000000c;
enum uint NABTS_BUFFER_PICTURENUMBER_SUPPORT = 0x00000001;
...
enum uint MAX_WST_VBI_LINES_PER_FIELD = 0x00000011;
enum uint WST_BYTES_PER_LINE = 0x0000002a;
...
enum uint KSCAMERA_EXTENDEDPROP_FILTERSCOPE = 0xffffffff;
...
enum : ulong
{
    ...
    KSCAMERA_EXTENDEDPROP_WARMSTART_MODE_DISABLED       = 0x0000000000000000,
    KSCAMERA_EXTENDEDPROP_WARMSTART_MODE_ENABLED        = 0x0000000000000001,
    KSCAMERA_EXTENDEDPROP_PHOTOTHUMBNAIL_DISABLE        = 0x0000000000000000,
    ...
    KSCAMERA_EXTENDEDPROP_SCENEMODE_CANDLELIGHT         = 0x0000000000000080,
    KSCAMERA_EXTENDEDPROP_SCENEMODE_LANDSCAPE           = 0x0000000000000100,
    KSCAMERA_EXTENDEDPROP_SCENEMODE_NIGHTPORTRAIT       = 0x0000000000000200,
    ...
    KSCAMERA_EXTENDEDPROP_VIDEOTORCH_ON_ADJUSTABLEPOWER = 0x0000000000000002,
    KSCAMERA_EXTENDEDPROP_FLASH_OFF                     = 0x0000000000000000,
    KSCAMERA_EXTENDEDPROP_FLASH_ON                      = 0x0000000000000001,
    KSCAMERA_EXTENDEDPROP_FLASH_ON_ADJUSTABLEPOWER      = 0x0000000000000002,
    KSCAMERA_EXTENDEDPROP_FLASH_AUTO                    = 0x0000000000000004,
    KSCAMERA_EXTENDEDPROP_FLASH_AUTO_ADJUSTABLEPOWER    = 0x0000000000000008,
    KSCAMERA_EXTENDEDPROP_FLASH_REDEYEREDUCTION         = 0x0000000000000010,
    KSCAMERA_EXTENDEDPROP_FLASH_SINGLEFLASH             = 0x0000000000000020,
    KSCAMERA_EXTENDEDPROP_FLASH_MULTIFLASHSUPPORTED     = 0x0000000000000040,
    KSCAMERA_EXTENDEDPROP_OPTIMIZATION_PHOTO            = 0x0000000000000001,
    KSCAMERA_EXTENDEDPROP_OPTIMIZATION_VIDEO            = 0x0000000000000002,
    KSCAMERA_EXTENDEDPROP_OPTIMIZATION_DEFAULT          = 0x0000000000000000,
    KSCAMERA_EXTENDEDPROP_OPTIMIZATION_QUALITY          = 0x0000000000000004,
    KSCAMERA_EXTENDEDPROP_OPTIMIZATION_LATENCY          = 0x0000000000000008,
    KSCAMERA_EXTENDEDPROP_OPTIMIZATION_POWER            = 0x0000000000000010,
    ...
    KSCAMERA_EXTENDEDPROP_FOCUS_RANGE_FULLRANGE         = 0x0000000000040000,
    KSCAMERA_EXTENDEDPROP_FOCUS_RANGE_INFINITY          = 0x0000000000080000,
    KSCAMERA_EXTENDEDPROP_FOCUS_RANGE_HYPERFOCAL        = 0x0000000000100000,
    KSCAMERA_EXTENDEDPROP_FOCUS_DISTANCE_INFINITY       = 0x0000000001000000,
    KSCAMERA_EXTENDEDPROP_FOCUS_DISTANCE_HYPERFOCAL     = 0x0000000002000000,
    KSCAMERA_EXTENDEDPROP_FOCUS_DISTANCE_NEAREST        = 0x0000000004000000,
    ...
    KSCAMERA_EXTENDEDPROP_FOCUS_CONTINUOUSLOCK          = 0x0000000000000200,
    KSCAMERA_EXTENDEDPROP_FOCUS_UNLOCK                  = 0x0000000000000400,
    KSCAMERA_EXTENDEDPROP_FOCUS_DRIVERFALLBACK_OFF      = 0x0000000000000800,
    KSCAMERA_EXTENDEDPROP_FOCUS_REGIONBASED             = 0x0000000000001000,
    KSCAMERA_EXTENDEDPROP_ISO_MANUAL                    = 0x0080000000000000,
    KSCAMERA_EXTENDEDPROP_FLASH_ASSISTANT_OFF           = 0x0000000000000000,
    KSCAMERA_EXTENDEDPROP_FLASH_ASSISTANT_ON            = 0x0000000000000080,
    KSCAMERA_EXTENDEDPROP_FLASH_ASSISTANT_AUTO          = 0x0000000000000100,
...
enum : ulong
{
    KSCAMERA_EXTENDEDPROP_METADATA_MEMORYTYPE_MASK   = 0x00000000000000ff,
    KSCAMERA_EXTENDEDPROP_METADATA_SYSTEMMEMORY      = 0x0000000000000001,
    KSCAMERA_EXTENDEDPROP_METADATA_ALIGNMENTREQUIRED = 0x0000000000000100,
}
...
enum : ulong
{
    KSCAMERA_EXTENDEDPROP_FOCUSPRIORITY_OFF     = 0x0000000000000000,
    KSCAMERA_EXTENDEDPROP_FOCUSPRIORITY_ON      = 0x0000000000000001,
    KSCAMERA_EXTENDEDPROP_PHOTOCONFIRMATION_OFF = 0x0000000000000000,
    KSCAMERA_EXTENDEDPROP_PHOTOCONFIRMATION_ON  = 0x0000000000000001,
}
...
enum : ulong
{
    KSCAMERA_EXTENDEDPROP_VIDEOSTABILIZATION_OFF                       = 0x0000000000000000,
    KSCAMERA_EXTENDEDPROP_VIDEOSTABILIZATION_ON                        = 0x0000000000000001,
    KSCAMERA_EXTENDEDPROP_VIDEOSTABILIZATION_AUTO                      = 0x0000000000000002,
    KSCAMERA_EXTENDEDPROP_VFR_OFF                                      = 0x0000000000000000,
    KSCAMERA_EXTENDEDPROP_VFR_ON                                       = 0x0000000000000001,
    KSCAMERA_EXTENDEDPROP_FACEDETECTION_OFF                            = 0x0000000000000000,
    KSCAMERA_EXTENDEDPROP_FACEDETECTION_ON                             = 0x0000000000000001,
    KSCAMERA_EXTENDEDPROP_FACEDETECTION_PREVIEW                        = 0x0000000000000001,
    KSCAMERA_EXTENDEDPROP_FACEDETECTION_VIDEO                          = 0x0000000000000002,
    KSCAMERA_EXTENDEDPROP_FACEDETECTION_PHOTO                          = 0x0000000000000004,
    KSCAMERA_EXTENDEDPROP_FACEDETECTION_BLINK                          = 0x0000000000000008,
    KSCAMERA_EXTENDEDPROP_FACEDETECTION_SMILE                          = 0x0000000000000010,
    ...
    KSCAMERA_EXTENDEDPROP_ADVANCEDPHOTO_OFF                            = 0x0000000000000000,
    KSCAMERA_EXTENDEDPROP_ADVANCEDPHOTO_AUTO                           = 0x0000000000000001,
    KSCAMERA_EXTENDEDPROP_ADVANCEDPHOTO_HDR                            = 0x0000000000000002,
    KSCAMERA_EXTENDEDPROP_ADVANCEDPHOTO_FNF                            = 0x0000000000000004,
    KSCAMERA_EXTENDEDPROP_ADVANCEDPHOTO_ULTRALOWLIGHT                  = 0x0000000000000008,
    ...
    KSCAMERA_EXTENDEDPROP_FACEAUTH_MODE_DISABLED                       = 0x0000000000000001,
    KSCAMERA_EXTENDEDPROP_FACEAUTH_MODE_ALTERNATIVE_FRAME_ILLUMINATION = 0x0000000000000002,
    KSCAMERA_EXTENDEDPROP_FACEAUTH_MODE_BACKGROUND_SUBTRACTION         = 0x0000000000000004,
}

enum : ulong
{
    KSCAMERA_EXTENDEDPROP_SECUREMODE_DISABLED                        = 0x0000000000000001,
    KSCAMERA_EXTENDEDPROP_SECUREMODE_ENABLED                         = 0x0000000000000002,
    KSCAMERA_EXTENDEDPROP_VIDEOTEMPORALDENOISING_AUTO                = 0x0000000000000001,
    KSCAMERA_EXTENDEDPROP_VIDEOTEMPORALDENOISING_OFF                 = 0x0000000000000002,
    KSCAMERA_EXTENDEDPROP_VIDEOTEMPORALDENOISING_ON                  = 0x0000000000000004,
    KSCAMERA_EXTENDEDPROP_IRTORCHMODE_OFF                            = 0x0000000000000001,
    KSCAMERA_EXTENDEDPROP_IRTORCHMODE_ALWAYS_ON                      = 0x0000000000000002,
    KSCAMERA_EXTENDEDPROP_IRTORCHMODE_ALTERNATING_FRAME_ILLUMINATION = 0x0000000000000004,
}

enum : ulong
{
    KSCAMERA_EXTENDEDPROP_RELATIVEPANELOPTIMIZATION_OFF     = 0x0000000000000000,
    KSCAMERA_EXTENDEDPROP_RELATIVEPANELOPTIMIZATION_ON      = 0x0000000000000001,
    KSCAMERA_EXTENDEDPROP_RELATIVEPANELOPTIMIZATION_DYNAMIC = 0x0000000000000002,
}
...
enum : ulong
{
    ...
    KSCAMERAPROFILE_FLAGS_PREVIEW_RES_MUSTMATCH = 0x0000000000000020,
}
...
enum : uint
{
    KSCameraProfileSensorType_RGB               = 0x00000001,
    KSCameraProfileSensorType_Infrared          = 0x00000002,
    KSCameraProfileSensorType_Depth             = 0x00000004,
    KSCameraProfileSensorType_PoseTracking      = 0x00000008,
    KSCameraProfileSensorType_ImageSegmentation = 0x00000010,
    KSCameraProfileSensorType_Custom            = 0x00000080,
}

enum : uint
{
    KS_TVAUDIO_MODE_MONO     = 0x00000001,
    KS_TVAUDIO_MODE_STEREO   = 0x00000002,
    KS_TVAUDIO_MODE_LANG_A   = 0x00000010,
    KS_TVAUDIO_MODE_LANG_B   = 0x00000020,
    KS_TVAUDIO_MODE_LANG_C   = 0x00000040,
    KS_TVAUDIO_PRESET_STEREO = 0x00000200,
    KS_TVAUDIO_PRESET_LANG_A = 0x00001000,
    KS_TVAUDIO_PRESET_LANG_B = 0x00002000,
    KS_TVAUDIO_PRESET_LANG_C = 0x00004000,
}

enum int KS_AM_UseNewCSSKey = 0x00000001;
enum uint MAX_SINK_DESCRIPTION_NAME_LENGTH = 0x00000020;
enum uint JACKDESC2_PRESENCE_DETECT_CAPABILITY = 0x00000001;
enum uint JACKDESC2_DYNAMIC_FORMAT_CHANGE_CAPABILITY = 0x00000002;
enum uint KSPROPERTY_AUDIO_BUFFER_DURATION = 0x00000001;

enum : uint
{
    AUDIOLOOPBACK_TAPPOINT_CAPS_PREVOLUMEMUTE  = 0x00000001,
    AUDIOLOOPBACK_TAPPOINT_CAPS_POSTVOLUMEMUTE = 0x00000002,
}

enum uint MAX_RESOURCEGROUPID_LENGTH = 0x00000100;

enum : uint
{
    AUDIOMODULE_MAX_DATA_SIZE     = 0x0000fa00,
    AUDIOMODULE_MAX_NAME_CCH_SIZE = 0x00000080,
}

enum : uint
{
    AllocatorStrategy_DontCare                   = 0x00000000,
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/DirectShow/ksmultiple-item))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/vidcap/ns-vidcap-kstopology_connection))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/devicetopology/ns-devicetopology-ksjack_description))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/devicetopology/ns-devicetopology-ksjack_sink_information))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/devicetopology/ns-devicetopology-ksjack_description2))], [])
...
//INTERFACEF ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/DirectShow/ikspropertyset))], [])
interface IKsPropertySet : IUnknown
{
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/DirectShow/ikspropertyset-set))], [])
    HRESULT Set(const(GUID)* guidPropSet, uint dwPropID, 
                ...
                uint cbPropData);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/DirectShow/ikspropertyset-get))], [])
    HRESULT Get(const(GUID)* guidPropSet, uint dwPropID, 
                /*PARAM ATTR: MemorySizeAttribute : CustomAttributeSig([], [NamedArgSig("BytesParamIndex", FixedArgSig(ElementSig(3)))])*/void* pInstanceData, 
                uint cbInstanceData, 
                /*PARAM ATTR: MemorySizeAttribute : CustomAttributeSig([], [NamedArgSig("BytesParamIndex", FixedArgSig(ElementSig(5)))])*/void* pPropData, 
                uint cbPropData, uint* pcbReturned);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/DirectShow/ikspropertyset-querysupported))], [])
    HRESULT QuerySupported(const(GUID)* guidPropSet, uint dwPropID, uint* pTypeSupport);
}

@GUID("720d4ac0-7533-11d0-a5d6-28db04c10000")
//INTERFACEF ATTR: SupportedOSPlatformAttribute : CustomAttributeSig([FixedArgSig(ElementSig(windows5.1.2600))], [])
//INTERFACEF ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/vidcap/nn-vidcap-ikstopologyinfo))], [])
interface IKsTopologyInfo : IUnknown
{
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/vidcap/nf-vidcap-ikstopologyinfo-get_numcategories))], [])
    HRESULT get_NumCategories(uint* pdwNumCategories);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/vidcap/nf-vidcap-ikstopologyinfo-get_category))], [])
    HRESULT get_Category(uint dwIndex, GUID* pCategory);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/vidcap/nf-vidcap-ikstopologyinfo-get_numconnections))], [])
    HRESULT get_NumConnections(uint* pdwNumConnections);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/vidcap/nf-vidcap-ikstopologyinfo-get_connectioninfo))], [])
    HRESULT get_ConnectionInfo(uint dwIndex, KSTOPOLOGY_CONNECTION* pConnectionInfo);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/vidcap/nf-vidcap-ikstopologyinfo-get_nodename))], [])
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/vidcap/nf-vidcap-ikstopologyinfo-get_numnodes))], [])
    HRESULT get_NumNodes(uint* pdwNumNodes);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/vidcap/nf-vidcap-ikstopologyinfo-get_nodetype))], [])
    HRESULT get_NodeType(uint dwNodeId, GUID* pNodeType);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/vidcap/nf-vidcap-ikstopologyinfo-createnodeinstance))], [])
    HRESULT CreateNodeInstance(uint dwNodeId, const(GUID)* iid, void** ppvObject);
}

@GUID("11737c14-24a7-4bb5-81a0-0d003813b0c4")
//INTERFACEF ATTR: SupportedOSPlatformAttribute : CustomAttributeSig([FixedArgSig(ElementSig(windows5.1.2600))], [])
//INTERFACEF ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/vidcap/nn-vidcap-iksnodecontrol))], [])
interface IKsNodeControl : IUnknown
{
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/vidcap/nf-vidcap-iksnodecontrol-put_nodeid))], [])
    HRESULT put_NodeId(uint dwNodeId);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/vidcap/nf-vidcap-iksnodecontrol-put_kscontrol))], [])
...
//INTERFACEF ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/devicetopology/nn-devicetopology-iksformatsupport))], [])
interface IKsFormatSupport : IUnknown
{
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/devicetopology/nf-devicetopology-iksformatsupport-isformatsupported))], [])
    HRESULT IsFormatSupported(KSDATAFORMAT* pKsFormat, uint cbFormat, BOOL* pbSupported);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/devicetopology/nf-devicetopology-iksformatsupport-getdevicepreferredformat))], [])
    HRESULT GetDevicePreferredFormat(KSDATAFORMAT** ppKsFormat);
}

@GUID("4509f757-2d46-4637-8e62-ce7db944f57b")
//INTERFACEF ATTR: SupportedOSPlatformAttribute : CustomAttributeSig([FixedArgSig(ElementSig(windows6.0.6000))], [])
//INTERFACEF ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/devicetopology/nn-devicetopology-iksjackdescription))], [])
interface IKsJackDescription : IUnknown
{
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/devicetopology/nf-devicetopology-iksjackdescription-getjackcount))], [])
    HRESULT GetJackCount(uint* pcJacks);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/devicetopology/nf-devicetopology-iksjackdescription-getjackdescription))], [])
...
//INTERFACEF ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/devicetopology/nn-devicetopology-iksjackdescription2))], [])
interface IKsJackDescription2 : IUnknown
{
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/devicetopology/nf-devicetopology-iksjackdescription2-getjackcount))], [])
    HRESULT GetJackCount(uint* pcJacks);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/devicetopology/nf-devicetopology-iksjackdescription2-getjackdescription2))], [])
...
//INTERFACEF ATTR: SupportedOSPlatformAttribute : CustomAttributeSig([FixedArgSig(ElementSig(windows6.1))], [])
//INTERFACEF ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/devicetopology/nn-devicetopology-iksjacksinkinformation))], [])
interface IKsJackSinkInformation : IUnknown
{
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/devicetopology/nf-devicetopology-iksjacksinkinformation-getjacksinkinformation))], [])
...
//INTERFACEF ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/DirectShow/ikspin))], [])
interface IKsPin : IUnknown
{
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/DirectShow/ikspin-ksquerymediums))], [])
