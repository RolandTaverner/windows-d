...
enum : uint
{
    NDIS_OBJECT_TYPE_DEFAULT                         = 0x00000080,
...
enum : uint
{
    NDIS_OBJECT_TYPE_FILTER_DRIVER_CHARACTERISTICS                  = 0x0000008b,
...
enum uint NDIS_OBJECT_TYPE_PROVIDER_CHIMNEY_OFFLOAD_GENERIC_CHARACTERISTICS = 0x0000008f;
...
enum uint NDIS_OBJECT_TYPE_MINIPORT_PNP_CHARACTERISTICS = 0x00000092;
enum uint NDIS_OBJECT_TYPE_CLIENT_CHIMNEY_OFFLOAD_CHARACTERISTICS = 0x00000093;
enum uint NDIS_OBJECT_TYPE_PROVIDER_CHIMNEY_OFFLOAD_CHARACTERISTICS = 0x00000094;
enum uint NDIS_OBJECT_TYPE_PROTOCOL_DRIVER_CHARACTERISTICS = 0x00000095;

enum : uint
{
    NDIS_OBJECT_TYPE_REQUEST_EX                                = 0x00000096,
...
enum uint NDIS_OBJECT_TYPE_RESTART_GENERAL_ATTRIBUTES = 0x000000a2;
enum uint NDIS_OBJECT_TYPE_PROTOCOL_RESTART_PARAMETERS = 0x000000a3;
enum uint NDIS_OBJECT_TYPE_MINIPORT_ADD_DEVICE_REGISTRATION_ATTRIBUTES = 0x000000a4;
...
enum : uint
{
    NDIS_OBJECT_TYPE_OFFLOAD                         = 0x000000a7,
...
enum uint NDIS_OBJECT_TYPE_MINIPORT_ADAPTER_HARDWARE_ASSIST_ATTRIBUTES = 0x000000af;
enum uint NDIS_OBJECT_TYPE_SHARED_MEMORY_PROVIDER_CHARACTERISTICS = 0x000000b0;

enum : uint
{
    NDIS_OBJECT_TYPE_RSS_PROCESSOR_INFO           = 0x000000b1,
    NDIS_OBJECT_TYPE_NDK_PROVIDER_CHARACTERISTICS = 0x000000b2,
}

enum : uint
{
    NDIS_OBJECT_TYPE_MINIPORT_ADAPTER_NDK_ATTRIBUTES = 0x000000b3,
    NDIS_OBJECT_TYPE_MINIPORT_SS_CHARACTERISTICS     = 0x000000b4,
}

enum : uint
{
    NDIS_OBJECT_TYPE_QOS_CAPABILITIES           = 0x000000b5,
...
enum : uint
{
    NDIS_OBJECT_TYPE_SWITCH_OPTIONAL_HANDLERS                  = 0x000000b8,
...
enum : uint
{
    NDIS_OBJECT_TYPE_RSS_PARAMETERS_V2           = 0x000000c8,
    NDIS_OBJECT_TYPE_RSS_SET_INDIRECTION_ENTRIES = 0x000000c9,
}
...
enum uint NDIS_STATISTICS_INFO_REVISION_1 = 0x00000001;
...
enum uint NDIS_TIMEOUT_DPC_REQUEST_CAPABILITIES_REVISION_1 = 0x00000001;
...
enum uint OID_GEN_SUPPORTED_LIST = 0x00010101;
...
enum uint OID_GEN_RECEIVE_BUFFER_SPACE = 0x00010109;
enum uint OID_GEN_TRANSMIT_BLOCK_SIZE = 0x0001010a;
enum uint OID_GEN_RECEIVE_BLOCK_SIZE = 0x0001010b;
...
enum uint OID_GEN_DRIVER_VERSION = 0x00010110;
enum uint OID_GEN_MAXIMUM_TOTAL_SIZE = 0x00010111;
enum uint OID_GEN_PROTOCOL_OPTIONS = 0x00010112;
...
enum uint OID_GEN_MAXIMUM_SEND_PACKETS = 0x00010115;
enum uint OID_GEN_VENDOR_DRIVER_VERSION = 0x00010116;
enum uint OID_GEN_SUPPORTED_GUIDS = 0x00010117;
enum uint OID_GEN_NETWORK_LAYER_ADDRESSES = 0x00010118;
enum uint OID_GEN_TRANSPORT_HEADER_OFFSET = 0x00010119;
enum uint OID_GEN_MEDIA_CAPABILITIES = 0x00010201;
enum uint OID_GEN_PHYSICAL_MEDIUM = 0x00010202;
...
enum uint OID_GEN_INTERRUPT_MODERATION = 0x00010209;
...
enum uint OID_GEN_ENUMERATE_PORTS = 0x0001020d;
...
enum uint OID_GEN_TIMEOUT_DPC_REQUEST_CAPABILITIES = 0x00010210;
enum uint OID_GEN_PCI_DEVICE_CUSTOM_PROPERTIES = 0x00010211;
enum uint OID_GEN_NDIS_RESERVED_6 = 0x00010212;
enum uint OID_GEN_PHYSICAL_MEDIUM_EX = 0x00010213;
enum uint OID_GEN_RECEIVE_SCALE_PARAMETERS_V2 = 0x00010214;
enum uint OID_GEN_MACHINE_NAME = 0x0001021a;
enum uint OID_GEN_RNDIS_CONFIG_PARAMETER = 0x0001021b;
...
enum uint OID_GEN_MINIPORT_RESTART_ATTRIBUTES = 0x0001021d;
...
enum uint OID_GEN_PROMISCUOUS_MODE = 0x00010280;
...
enum uint OID_GEN_OPERATIONAL_STATUS = 0x00010283;
enum uint OID_GEN_XMIT_LINK_SPEED = 0x00010284;
enum uint OID_GEN_RCV_LINK_SPEED = 0x00010285;
enum uint OID_GEN_UNKNOWN_PROTOS = 0x00010286;
enum uint OID_GEN_INTERFACE_INFO = 0x00010287;
...
enum uint OID_GEN_LINK_SPEED_EX = 0x0001028b;
enum uint OID_GEN_MEDIA_DUPLEX_STATE = 0x0001028c;
enum uint OID_GEN_IP_OPER_STATUS = 0x0001028d;
...
enum uint OID_WWAN_VISIBLE_PROVIDERS = 0x0e010108;
enum uint OID_WWAN_REGISTER_STATE = 0x0e010109;
enum uint OID_WWAN_PACKET_SERVICE = 0x0e01010a;
...
enum uint OID_WWAN_SERVICE_ACTIVATION = 0x0e01010e;
...
enum uint OID_WWAN_AUTH_CHALLENGE = 0x0e010115;
enum uint OID_WWAN_ENUMERATE_DEVICE_SERVICES = 0x0e010116;
enum uint OID_WWAN_SUBSCRIBE_DEVICE_SERVICE_EVENTS = 0x0e010117;
...
enum uint OID_WWAN_PREFERRED_MULTICARRIER_PROVIDERS = 0x0e010125;
...
enum uint OID_WWAN_SYS_SLOTMAPPINGS = 0x0e01012f;
enum uint OID_WWAN_SLOT_INFO_STATUS = 0x0e010130;
enum uint OID_WWAN_DEVICE_BINDINGS = 0x0e010131;
enum uint OID_WWAN_REGISTER_STATE_EX = 0x0e010132;
enum uint OID_WWAN_IMS_VOICE_STATE = 0x0e010133;
enum uint OID_WWAN_SIGNAL_STATE_EX = 0x0e010134;
enum uint OID_WWAN_LOCATION_STATE = 0x0e010135;
...
enum uint OID_WWAN_PS_MEDIA_CONFIG = 0x0e01013e;
...
enum uint OID_WWAN_NETWORK_BLACKLIST = 0x0e010141;
...
enum uint OID_WWAN_MODEM_CONFIG_INFO = 0x0e010144;
...
enum uint OID_WWAN_REGISTER_PARAMS = 0x0e01014c;
enum uint OID_WWAN_NETWORK_PARAMS = 0x0e01014d;
enum uint OID_WWAN_UE_POLICY = 0x0e01014e;
...
enum uint OID_GEN_RCV_CRC_ERROR = 0x0002020d;
...
enum uint OID_GEN_NETCARD_LOAD = 0x00020211;
enum uint OID_GEN_DEVICE_PROFILE = 0x00020212;
enum uint OID_GEN_INIT_TIME_MS = 0x00020213;
enum uint OID_GEN_RESET_COUNTS = 0x00020214;
enum uint OID_GEN_MEDIA_SENSE_COUNTS = 0x00020215;
...
enum uint OID_GEN_XMIT_DISCARDS = 0x0002021c;
enum uint OID_TCP_RSC_STATISTICS = 0x0002021d;
enum uint OID_GEN_NDIS_RESERVED_7 = 0x0002021e;
...
enum : uint
{
    OID_GEN_CO_XMIT_PDUS_OK          = 0x00020101,
...
enum : uint
{
    OID_GEN_CO_BYTES_XMIT             = 0x00020201,
...
enum uint NDIS_802_3_MAC_OPTION_PRIORITY = 0x00000001;
...
enum uint OID_802_3_ADD_MULTICAST_ADDRESS = 0x01010208;
enum uint OID_802_3_DELETE_MULTICAST_ADDRESS = 0x01010209;
enum uint OID_802_5_PERMANENT_ADDRESS = 0x02010101;
...
enum uint OID_FDDI_ATTACHMENT_TYPE = 0x03020101;
enum uint OID_FDDI_UPSTREAM_NODE_LONG = 0x03020102;
enum uint OID_FDDI_DOWNSTREAM_NODE_LONG = 0x03020103;
...
enum uint OID_FDDI_MAC_FRAME_STATUS_FUNCTIONS = 0x0303021f;
...
enum uint OID_FDDI_SMT_STATION_ACTION = 0x03030277;
...
enum uint OID_WAN_PERMANENT_ADDRESS = 0x04010101;
enum uint OID_WAN_CURRENT_ADDRESS = 0x04010102;
enum uint OID_WAN_QUALITY_OF_SERVICE = 0x04010103;
enum uint OID_WAN_PROTOCOL_TYPE = 0x04010104;
enum uint OID_WAN_MEDIUM_SUBTYPE = 0x04010105;
...
enum uint OID_WAN_GET_LINK_INFO = 0x04010109;
...
enum uint OID_WAN_GET_BRIDGE_INFO = 0x0401020a;
enum uint OID_WAN_SET_BRIDGE_INFO = 0x0401020b;
enum uint OID_WAN_GET_COMP_INFO = 0x0401020c;
enum uint OID_WAN_SET_COMP_INFO = 0x0401020d;
enum uint OID_WAN_GET_STATS_INFO = 0x0401020e;
...
enum uint OID_LTALK_CURRENT_NODE_ID = 0x05010102;
...
enum uint OID_LTALK_OUT_NO_HANDLERS = 0x05020201;
...
enum uint OID_LTALK_FCS_ERRORS = 0x05020206;
...
enum uint OID_ATM_HW_CURRENT_ADDRESS = 0x08010104;
...
enum uint OID_ATM_SIGNALING_VPIVCI = 0x08010201;
...
enum uint OID_ATM_RELEASE_ACCESS_NET_RESOURCES = 0x08010204;
...
enum uint OID_ATM_GET_NEAREST_FLOW = 0x08010207;
enum uint OID_ATM_ALIGNMENT_REQUIRED = 0x08010208;
enum uint OID_ATM_LECS_ADDRESS = 0x08010209;
...
enum uint OID_ATM_PARTY_ALERTING = 0x0801020d;
...
enum uint OID_ATM_RCV_CELLS_OK = 0x08020101;
...
enum uint OID_ATM_CELLS_HEC_ERROR = 0x08020202;
...
enum uint OID_802_11_FRAGMENTATION_THRESHOLD = 0x0d010209;
...
enum uint OID_802_11_RX_ANTENNA_SELECTED = 0x0d01020c;
...
enum uint OID_802_11_RADIO_STATUS = 0x0d010125;
...
enum : uint
{
    NDIS_802_11_LENGTH_SSID                 = 0x00000020,
...
enum uint NDIS_802_11_PMKID_CANDIDATE_PREAUTH_ENABLED = 0x00000001;
...
enum uint OID_IRDA_SUPPORTED_SPEEDS = 0x0a010102;
...
enum uint OID_1394_LOCAL_NODE_INFO = 0x0c010101;
...
enum uint OID_CO_ADD_ADDRESS = 0xfe000004;
enum uint OID_CO_DELETE_ADDRESS = 0xfe000005;
enum uint OID_CO_GET_ADDRESSES = 0xfe000006;
...
enum uint OID_CO_TAPI_GET_CALL_DIAGNOSTICS = 0xfe001007;
...
enum uint OID_PNP_CAPABILITIES = 0xfd010100;
...
enum uint OID_PNP_REMOVE_WAKE_UP_PATTERN = 0xfd010104;
enum uint OID_PNP_WAKE_UP_PATTERN_LIST = 0xfd010105;
enum uint OID_PNP_ENABLE_WAKE_UP = 0xfd010106;
...
enum uint OID_PM_CURRENT_CAPABILITIES = 0xfd010107;
...
enum uint OID_PM_REMOVE_WOL_PATTERN = 0xfd01010b;
enum uint OID_PM_WOL_PATTERN_LIST = 0xfd01010c;
enum uint OID_PM_ADD_PROTOCOL_OFFLOAD = 0xfd01010d;
enum uint OID_PM_GET_PROTOCOL_OFFLOAD = 0xfd01010e;
enum uint OID_PM_REMOVE_PROTOCOL_OFFLOAD = 0xfd01010f;
enum uint OID_PM_PROTOCOL_OFFLOAD_LIST = 0xfd010110;
enum uint OID_PM_RESERVED_1 = 0xfd010111;
...
enum uint OID_RECEIVE_FILTER_MOVE_FILTER = 0x00010230;
...
enum uint OID_PACKET_COALESCING_FILTER_MATCH_COUNT = 0x00010235;
...
enum uint OID_SRIOV_HARDWARE_CAPABILITIES = 0x00010249;
enum uint OID_SRIOV_CURRENT_CAPABILITIES = 0x00010250;
enum uint OID_SRIOV_READ_VF_CONFIG_SPACE = 0x00010251;
enum uint OID_SRIOV_WRITE_VF_CONFIG_SPACE = 0x00010252;
enum uint OID_SRIOV_READ_VF_CONFIG_BLOCK = 0x00010253;
...
enum uint OID_SRIOV_VF_VENDOR_DEVICE_ID = 0x00010257;
...
enum uint OID_SRIOV_OVERLYING_ADAPTER_INFO = 0x00010268;
...
enum uint OID_GEN_RSS_SET_INDIRECTION_TABLE_ENTRIES = 0x000102c0;
enum uint OID_GEN_ISOLATION_PARAMETERS = 0x00010300;
enum uint OID_GFT_HARDWARE_CAPABILITIES = 0x00010401;
enum uint OID_GFT_CURRENT_CAPABILITIES = 0x00010402;
enum uint OID_GFT_GLOBAL_PARAMETERS = 0x00010403;
enum uint OID_GFT_CREATE_TABLE = 0x00010404;
enum uint OID_GFT_DELETE_TABLE = 0x00010405;
...
enum uint OID_GFT_FREE_COUNTERS = 0x00010408;
enum uint OID_GFT_ENUM_COUNTERS = 0x00010409;
enum uint OID_GFT_COUNTER_VALUES = 0x0001040a;
...
enum uint OID_GFT_DELETE_FLOW_ENTRIES = 0x0001040d;
enum uint OID_GFT_ENUM_FLOW_ENTRIES = 0x0001040e;
enum uint OID_GFT_ACTIVATE_FLOW_ENTRIES = 0x0001040f;
enum uint OID_GFT_DEACTIVATE_FLOW_ENTRIES = 0x00010410;
enum uint OID_GFT_FLOW_ENTRY_PARAMETERS = 0x00010411;
enum uint OID_GFT_EXACT_MATCH_PROFILE = 0x00010412;
enum uint OID_GFT_HEADER_TRANSPOSITION_PROFILE = 0x00010413;
enum uint OID_GFT_WILDCARD_MATCH_PROFILE = 0x00010414;
enum uint OID_GFT_ENUM_PROFILES = 0x00010415;
enum uint OID_GFT_DELETE_PROFILE = 0x00010416;
enum uint OID_GFT_VPORT_PARAMETERS = 0x00010417;
enum uint OID_GFT_CREATE_LOGICAL_VPORT = 0x00010418;
enum uint OID_GFT_DELETE_LOGICAL_VPORT = 0x00010419;
enum uint OID_GFT_ENUM_LOGICAL_VPORTS = 0x0001041a;

enum : uint
{
    OID_QOS_OFFLOAD_HARDWARE_CAPABILITIES = 0x00010601,
...
enum uint OID_PD_OPEN_PROVIDER = 0x00010501;
enum uint OID_PD_CLOSE_PROVIDER = 0x00010502;
enum uint OID_PD_QUERY_CURRENT_CONFIG = 0x00010503;
...
enum uint OID_TCP4_OFFLOAD_STATS = 0xfc010207;
enum uint OID_TCP6_OFFLOAD_STATS = 0xfc010208;
enum uint OID_IP4_OFFLOAD_STATS = 0xfc010209;
...
enum uint OID_OFFLOAD_ENCAPSULATION = 0x0101010a;
...
enum uint OID_FFP_ADAPTER_STATS = 0xfc020211;
...
enum uint OID_XBOX_ACC_RESERVED0 = 0xfa000000;
...
enum : uint
{
    NDIS_PROTOCOL_ID_DEFAULT = 0x00000000,
...
enum uint READABLE_LOCAL_CLOCK = 0x00000001;
enum uint CLOCK_NETWORK_DERIVED = 0x00000002;
enum uint CLOCK_PRECISION = 0x00000004;
enum uint RECEIVE_TIME_INDICATION_CAPABLE = 0x00000008;
enum uint TIMED_SEND_CAPABLE = 0x00000010;
...
enum uint WAN_PROTOCOL_KEEPS_STATS = 0x00000001;
...
enum uint NDIS_RING_LOBE_WIRE_FAULT = 0x00000800;
enum uint NDIS_RING_AUTO_REMOVAL_ERROR = 0x00000400;
enum uint NDIS_RING_REMOVE_RECEIVED = 0x00000200;
...
enum uint NDIS_CO_MAC_OPTION_DYNAMIC_LINK_SPEED = 0x00000001;
enum uint NDIS_LINK_STATE_XMIT_LINK_SPEED_AUTO_NEGOTIATED = 0x00000001;
enum uint NDIS_LINK_STATE_RCV_LINK_SPEED_AUTO_NEGOTIATED = 0x00000002;
...
enum uint NDIS_LINK_STATE_REVISION_1 = 0x00000001;
enum uint NDIS_LINK_PARAMETERS_REVISION_1 = 0x00000001;
enum uint NDIS_OPER_STATE_REVISION_1 = 0x00000001;
enum uint MAXIMUM_IP_OPER_STATUS_ADDRESS_FAMILIES_SUPPORTED = 0x00000020;

enum : uint
{
    NDIS_IP_OPER_STATUS_INFO_REVISION_1 = 0x00000001,
    NDIS_IP_OPER_STATE_REVISION_1       = 0x00000001,
}

enum : uint
{
    NDIS_OFFLOAD_PARAMETERS_NO_CHANGE                  = 0x00000000,
...
enum : uint
{
    NDIS_OFFLOAD_PARAMETERS_CONNECTION_OFFLOAD_DISABLED = 0x00000001,
...
enum uint NDIS_TCP_RECV_SEG_COALESC_OFFLOAD_REVISION_1 = 0x00000001;
...
enum uint NDIS_OFFLOAD_FLAGS_GROUP_CHECKSUM_CAPABILITIES = 0x00000001;
...
enum : uint
{
    NDIS_OFFLOAD_REVISION_1 = 0x00000001,
...
enum : uint
{
    NDIS_TCP_CONNECTION_OFFLOAD_REVISION_1 = 0x00000001,
    NDIS_TCP_CONNECTION_OFFLOAD_REVISION_2 = 0x00000002,
}

enum uint NDIS_PORT_AUTHENTICATION_PARAMETERS_REVISION_1 = 0x00000001;
enum uint NDIS_WMI_DEFAULT_METHOD_ID = 0x00000001;

enum : uint
{
    NDIS_WMI_OBJECT_TYPE_SET          = 0x00000001,
...
enum uint NDIS_HD_SPLIT_ENABLE_HEADER_DATA_SPLIT = 0x00000001;
enum uint NDIS_PM_WOL_BITMAP_PATTERN_SUPPORTED = 0x00000001;
enum uint NDIS_PM_WOL_MAGIC_PACKET_SUPPORTED = 0x00000002;
...
enum uint NDIS_PM_WOL_IPV6_DEST_ADDR_WILDCARD_SUPPORTED = 0x00000800;
...
enum uint NDIS_WLAN_WAKE_ON_GTK_HANDSHAKE_ERROR_SUPPORTED = 0x00000004;
enum uint NDIS_WLAN_WAKE_ON_4WAY_HANDSHAKE_REQUEST_SUPPORTED = 0x00000008;
enum uint NDIS_WLAN_WAKE_ON_INCOMING_ACTION_FRAME_SUPPORTED = 0x00000010;
...
enum uint NDIS_PM_WAKE_PACKET_INDICATION_SUPPORTED = 0x00000001;
enum uint NDIS_PM_SELECTIVE_SUSPEND_SUPPORTED = 0x00000002;
enum uint NDIS_PM_WOL_BITMAP_PATTERN_ENABLED = 0x00000001;
...
enum uint NDIS_PM_WOL_IPV6_DEST_ADDR_WILDCARD_ENABLED = 0x00000800;
...
enum uint NDIS_PM_SELECTIVE_SUSPEND_ENABLED = 0x00000010;
...
enum uint NDIS_WLAN_WAKE_ON_GTK_HANDSHAKE_ERROR_ENABLED = 0x00000004;
enum uint NDIS_WLAN_WAKE_ON_4WAY_HANDSHAKE_REQUEST_ENABLED = 0x00000008;
enum uint NDIS_WLAN_WAKE_ON_INCOMING_ACTION_FRAME_ENABLED = 0x00000010;
...
enum uint NDIS_PM_MAX_STRING_SIZE = 0x00000040;
...
enum : uint
{
    NDIS_PM_PARAMETERS_REVISION_1 = 0x00000001,
    NDIS_PM_PARAMETERS_REVISION_2 = 0x00000002,
}

enum uint EAPOL_REQUEST_ID_WOL_FLAG_MUST_ENCRYPT = 0x00000001;
enum uint NDIS_PM_MAX_PATTERN_ID = 0x0000ffff;
enum uint NDIS_PM_PRIVATE_PATTERN_ID = 0x00000001;
...
enum : uint
{
    DOT11_RSN_KCK_LENGTH            = 0x00000010,
...
enum : uint
{
    NDIS_PM_PROTOCOL_OFFLOAD_REVISION_1 = 0x00000001,
    NDIS_PM_PROTOCOL_OFFLOAD_REVISION_2 = 0x00000002,
}

enum uint NDIS_SIZEOF_NDIS_PM_PROTOCOL_OFFLOAD_REVISION_1 = 0x000000f0;
...
enum uint NDIS_WMI_PM_ADMIN_CONFIG_REVISION_1 = 0x00000001;
...
enum uint NDIS_RECEIVE_FILTER_UDP_HEADER_DEST_PORT_SUPPORTED = 0x00000001;
...
enum uint NDIS_RECEIVE_FILTER_INTERRUPT_VECTOR_COALESCING_SUPPORTED = 0x00000010;
...
enum : uint
{
    ...
    NDIS_RECEIVE_FILTER_DYNAMIC_PROCESSOR_AFFINITY_CHANGE_FOR_DEFAULT_QUEUE_SUPPORTED = 0x00000040,
}
...
enum uint NDIS_NIC_SWITCH_CAPS_ASYMMETRIC_QUEUE_PAIRS_FOR_NONDEFAULT_VPORT_SUPPORTED = 0x00000004;
...
enum uint NDIS_NIC_SWITCH_CAPS_NIC_SWITCH_WITHOUT_IOV_SUPPORTED = 0x00000040;
...
enum : uint
{
    NDIS_NIC_SWITCH_CAPABILITIES_REVISION_1 = 0x00000001,
    NDIS_NIC_SWITCH_CAPABILITIES_REVISION_2 = 0x00000002,
    NDIS_NIC_SWITCH_CAPABILITIES_REVISION_3 = 0x00000003,
}

enum uint NDIS_RECEIVE_FILTER_GLOBAL_PARAMETERS_REVISION_1 = 0x00000001;
...
enum uint NDIS_RECEIVE_FILTER_FIELD_MAC_HEADER_VLAN_UNTAGGED_OR_ZERO = 0x00000001;
...
enum : uint
{
    NDIS_RECEIVE_FILTER_INFO_REVISION_1               = 0x00000001,
...
enum : uint
{
    NDIS_RECEIVE_QUEUE_ALLOCATION_COMPLETE_PARAMETERS_REVISION_1 = 0x00000001,
    NDIS_RECEIVE_QUEUE_ALLOCATION_COMPLETE_ARRAY_REVISION_1      = 0x00000001,
}

enum : uint
{
    NDIS_RECEIVE_SCALE_CAPABILITIES_REVISION_1 = 0x00000001,
...
enum uint NDIS_RSS_CAPS_MESSAGE_SIGNALED_INTERRUPTS = 0x01000000;
...
enum : uint
{
    NDIS_RSS_PARAM_FLAG_BASE_CPU_UNCHANGED          = 0x00000001,
...
enum uint NDIS_RSS_INDIRECTION_TABLE_SIZE_REVISION_1 = 0x00000080;
enum uint NDIS_RSS_HASH_SECRET_KEY_SIZE_REVISION_1 = 0x00000028;

enum : uint
{
    NDIS_RECEIVE_SCALE_PARAMETERS_REVISION_1 = 0x00000001,
    NDIS_RECEIVE_SCALE_PARAMETERS_REVISION_2 = 0x00000002,
    NDIS_RECEIVE_SCALE_PARAMETERS_REVISION_3 = 0x00000003,
}

enum uint NDIS_RSS_INDIRECTION_TABLE_MAX_SIZE_REVISION_1 = 0x00000080;
...
enum : uint
{
    NDIS_RECEIVE_SCALE_PARAMETERS_V2_REVISION_1        = 0x00000001,
...
enum : uint
{
    NDIS_RSS_SET_INDIRECTION_ENTRY_FLAG_PRIMARY_PROCESSOR = 0x00000001,
...
enum : uint
{
    NDIS_RSS_PROCESSOR_INFO_REVISION_1 = 0x00000001,
    NDIS_RSS_PROCESSOR_INFO_REVISION_2 = 0x00000002,
}

enum uint NDIS_SYSTEM_PROCESSOR_INFO_EX_REVISION_1 = 0x00000001;
...
enum : uint
{
    NDIS_WMI_RECEIVE_QUEUE_PARAMETERS_REVISION_1 = 0x00000001,
    NDIS_WMI_RECEIVE_QUEUE_INFO_REVISION_1       = 0x00000001,
}

enum uint NDIS_NDK_CAPABILITIES_REVISION_1 = 0x00000001;
...
enum uint NDIS_NDK_STATISTICS_INFO_REVISION_1 = 0x00000001;
enum uint NDIS_NDK_CONNECTIONS_REVISION_1 = 0x00000001;
enum uint NDIS_NDK_LOCAL_ENDPOINTS_REVISION_1 = 0x00000001;
enum uint OID_QOS_HARDWARE_CAPABILITIES = 0xfc050001;
enum uint OID_QOS_CURRENT_CAPABILITIES = 0xfc050002;
...
enum uint OID_QOS_REMOTE_PARAMETERS = 0xfc050005;
...
enum : uint
{
    NDIS_QOS_CLASSIFICATION_SET_BY_MINIPORT_MASK = 0xff000000,
    NDIS_QOS_CLASSIFICATION_ENFORCED_BY_MINIPORT = 0x01000000,
}

enum : uint
{
    NDIS_QOS_CONDITION_RESERVED        = 0x00000000,
...
enum : uint
{
    NDIS_QOS_ACTION_PRIORITY = 0x00000000,
    NDIS_QOS_ACTION_MAXIMUM  = 0x00000001,
}

enum uint NDIS_QOS_CLASSIFICATION_ELEMENT_REVISION_1 = 0x00000001;
...
enum : uint
{
    NDIS_QOS_TSA_STRICT            = 0x00000000,
...
enum : uint
{
    NDIS_DEFAULT_VPORT_ID  = 0x00000000,
    NDIS_DEFAULT_SWITCH_ID = 0x00000000,
}
...
enum : uint
{
    NDIS_NIC_SWITCH_PARAMETERS_REVISION_1               = 0x00000001,
...
enum : uint
{
    NDIS_NIC_SWITCH_INFO_REVISION_1                         = 0x00000001,
...
enum uint NDIS_NIC_SWITCH_DELETE_VPORT_PARAMETERS_REVISION_1 = 0x00000001;
...
enum uint NDIS_NIC_SWITCH_VF_PARAMETERS_REVISION_1 = 0x00000001;
enum uint NDIS_NIC_SWITCH_FREE_VF_PARAMETERS_REVISION_1 = 0x00000001;

enum : uint
{
    NDIS_NIC_SWITCH_VF_INFO_REVISION_1                    = 0x00000001,
...
enum uint NDIS_SRIOV_READ_VF_CONFIG_SPACE_PARAMETERS_REVISION_1 = 0x00000001;
enum uint NDIS_SRIOV_WRITE_VF_CONFIG_SPACE_PARAMETERS_REVISION_1 = 0x00000001;
enum uint NDIS_SRIOV_READ_VF_CONFIG_BLOCK_PARAMETERS_REVISION_1 = 0x00000001;
enum uint NDIS_SRIOV_WRITE_VF_CONFIG_BLOCK_PARAMETERS_REVISION_1 = 0x00000001;
enum uint NDIS_SRIOV_RESET_VF_PARAMETERS_REVISION_1 = 0x00000001;
enum uint NDIS_SRIOV_SET_VF_POWER_STATE_PARAMETERS_REVISION_1 = 0x00000001;
enum uint NDIS_SRIOV_CONFIG_STATE_PARAMETERS_REVISION_1 = 0x00000001;
enum uint NDIS_SRIOV_VF_VENDOR_DEVICE_ID_INFO_REVISION_1 = 0x00000001;
enum uint NDIS_SRIOV_PROBED_BARS_INFO_REVISION_1 = 0x00000001;
enum uint NDIS_RECEIVE_FILTER_MOVE_FILTER_PARAMETERS_REVISION_1 = 0x00000001;
enum uint NDIS_SRIOV_BAR_RESOURCES_INFO_REVISION_1 = 0x00000001;
enum uint NDIS_SRIOV_PF_LUID_INFO_REVISION_1 = 0x00000001;
enum uint NDIS_SRIOV_VF_SERIAL_NUMBER_INFO_REVISION_1 = 0x00000001;
enum uint NDIS_SRIOV_VF_INVALIDATE_CONFIG_BLOCK_INFO_REVISION_1 = 0x00000001;
enum uint NDIS_SRIOV_OVERLYING_ADAPTER_INFO_VERSION_1 = 0x00000001;
enum uint NDIS_ISOLATION_NAME_MAX_STRING_SIZE = 0x0000007f;

enum : uint
{
    NDIS_ROUTING_DOMAIN_ISOLATION_ENTRY_REVISION_1 = 0x00000001,
    NDIS_ROUTING_DOMAIN_ENTRY_REVISION_1           = 0x00000001,
}

enum uint NDIS_ISOLATION_PARAMETERS_REVISION_1 = 0x00000001;
enum uint NDIS_SWITCH_OBJECT_SERIALIZATION_VERSION_1 = 0x00000001;

enum : uint
{
    NDIS_SWITCH_PORT_PROPERTY_SECURITY_REVISION_1          = 0x00000001,
...
enum : uint
{
    NDIS_SWITCH_PORT_FEATURE_STATUS_PARAMETERS_REVISION_1 = 0x00000001,
    NDIS_SWITCH_PORT_FEATURE_STATUS_CUSTOM_REVISION_1     = 0x00000001,
}

enum : uint
{
    NDIS_SWITCH_PROPERTY_CUSTOM_REVISION_1            = 0x00000001,
...
enum : uint
{
    NDIS_SWITCH_FEATURE_STATUS_PARAMETERS_REVISION_1 = 0x00000001,
    NDIS_SWITCH_FEATURE_STATUS_CUSTOM_REVISION_1     = 0x00000001,
}

enum uint NDIS_SWITCH_PARAMETERS_REVISION_1 = 0x00000001;
...
enum uint NDIS_PORT_STATE_REVISION_1 = 0x00000001;
enum uint NDIS_PORT_CHAR_USE_DEFAULT_AUTH_SETTINGS = 0x00000001;
enum uint NDIS_PORT_CHARACTERISTICS_REVISION_1 = 0x00000001;
enum uint NDIS_PORT_ARRAY_REVISION_1 = 0x00000001;
enum uint ETHERNET_LENGTH_OF_ADDRESS = 0x00000006;
...
enum uint NDIS_GFP_UNDEFINED_PROFILE_ID = 0x00000000;
...
enum : uint
{
    ...
    NDIS_GFP_EXACT_MATCH_PROFILE_REVISION_1 = 0x00000001,
}
...
enum uint NDIS_GFP_WILDCARD_MATCH_PROFILE_REVISION_1 = 0x00000001;
...
enum uint NDIS_PD_CAPS_RECEIVE_FILTER_COUNTERS_SUPPORTED = 0x00000001;
enum uint NDIS_PD_CAPS_DRAIN_NOTIFICATIONS_SUPPORTED = 0x00000002;

enum : uint
{
    NDIS_PD_CAPS_NOTIFICATION_MODERATION_INTERVAL_SUPPORTED = 0x00000004,
    NDIS_PD_CAPS_NOTIFICATION_MODERATION_COUNT_SUPPORTED    = 0x00000008,
}

enum uint NDIS_PD_CAPABILITIES_REVISION_1 = 0x00000001;
enum uint NDIS_PD_CONFIG_REVISION_1 = 0x00000001;

enum : uint
{
    NDIS_GFT_UNDEFINED_FLOW_ENTRY_ID = 0x00000000,
    NDIS_GFT_UNDEFINED_TABLE_ID      = 0x00000000,
}

enum uint NDIS_GFT_TABLE_INCLUDE_EXTERNAL_VPPORT = 0x00000001;
...
enum uint NDIS_GFT_DELETE_TABLE_PARAMETERS_REVISION_1 = 0x00000001;
enum uint NDIS_GFT_UNDEFINED_COUNTER_ID = 0x00000000;
enum uint NDIS_GFT_MAX_COUNTER_OBJECTS_PER_FLOW_ENTRY = 0x00000008;
...
enum uint NDIS_GFT_FREE_COUNTER_PARAMETERS_REVISION_1 = 0x00000001;
...
enum uint NDIS_GFT_STATISTICS_REVISION_1 = 0x00000001;
...
enum uint NDIS_GFT_UNDEFINED_CUSTOM_ACTION = 0x00000000;
enum uint NDIS_GFT_RESERVED_CUSTOM_ACTIONS = 0x00000100;
enum uint NDIS_GFT_CUSTOM_ACTION_PROFILE_REVISION_1 = 0x00000001;
...
enum uint NDIS_GFT_HTP_CUSTOM_ACTION_PRESENT = 0x00000080;
enum uint NDIS_GFT_HTP_META_ACTION_BEFORE_HEADER_TRANSPOSITION = 0x00000100;
enum uint NDIS_GFT_HEADER_TRANSPOSITION_PROFILE_REVISION_1 = 0x00000001;
...
enum : uint
{
    ...
    NDIS_GFT_CUSTOM_ACTION_REVISION_1  = 0x00000001,
}

enum uint NDIS_GFT_EMFE_ADD_IN_ACTIVATED_STATE = 0x00000001;
...
enum uint NDIS_GFT_EMFE_META_ACTION_BEFORE_HEADER_TRANSPOSITION = 0x00100000;
...
enum uint NDIS_GFT_EMFE_ALL_VPORT_FLOW_ENTRIES = 0x02000000;
...
enum uint NDIS_GFT_EXACT_MATCH_FLOW_ENTRY_REVISION_1 = 0x00000001;
...
enum uint NDIS_GFT_WILDCARD_MATCH_FLOW_ENTRY_REVISION_1 = 0x00000001;
...
enum : uint
{
    ...
    NDIS_GFT_DELETE_PROFILE_PARAMETERS_REVISION_1 = 0x00000001,
}

enum : uint
{
    NDIS_GFT_FLOW_ENTRY_ARRAY_REVISION_1               = 0x00000001,
...
enum : uint
{
    NDIS_GFT_VPORT_MAX_DSCP_MASK_COUNTER_OBJECTS     = 0x00000040,
    NDIS_GFT_VPORT_MAX_PRIORITY_MASK_COUNTER_OBJECTS = 0x00000008,
}
...
enum : uint
{
    NDIS_QOS_DEFAULT_SQ_ID            = 0x00000000,
...
enum uint NDIS_QOS_SQ_RECEIVE_CAP_ENABLED = 0x00000004;
enum uint NDIS_QOS_SQ_PARAMETERS_ARRAY_REVISION_1 = 0x00000001;
enum uint NDIS_QOS_SQ_ARRAY_REVISION_1 = 0x00000001;
...
enum uint NDIS_QOS_SQ_STATS_REVISION_1 = 0x00000001;
enum uint NDIS_TIMESTAMP_CAPABILITIES_REVISION_1 = 0x00000001;

enum : uint
{
    OID_TIMESTAMP_CAPABILITY     = 0x00a00001,
    OID_TIMESTAMP_CURRENT_CONFIG = 0x00a00002,
}

enum uint NDIS_HARDWARE_CROSSTIMESTAMP_REVISION_1 = 0x00000001;
enum uint OID_TIMESTAMP_GET_CROSSTIMESTAMP = 0x00a00003;
enum uint OID_QUIC_CONNECTION_ENCRYPTION = 0xfc010215;
...
enum uint NDIS_OBJECT_REVISION_1 = 0x00000001;
...
enum uint NDIS_OBJECT_TYPE_OID_REQUEST = 0x00000096;
...
enum : uint
{
    NDK_ADAPTER_FLAG_IN_ORDER_DMA_SUPPORTED      = 0x00000001,
    NDK_ADAPTER_FLAG_RDMA_READ_SINK_NOT_REQUIRED = 0x00000002,
}

enum uint NDK_ADAPTER_FLAG_CQ_INTERRUPT_MODERATION_SUPPORTED = 0x00000004;
...
enum : uint
{
    NDK_ADAPTER_FLAG_CQ_RESIZE_SUPPORTED            = 0x00000100,
    NDK_ADAPTER_FLAG_LOOPBACK_CONNECTIONS_SUPPORTED = 0x00010000,
}
...
enum : uint
{
    NET_SITEID_UNSPECIFIED = 0x00000000,
    NET_SITEID_MAXUSER     = 0x07ffffff,
    NET_SITEID_MAXSYSTEM   = 0x0fffffff,
}

enum uint NET_IFLUID_UNSPECIFIED = 0x00000000;
enum uint NIIF_HARDWARE_INTERFACE = 0x00000001;
enum uint NIIF_FILTER_INTERFACE = 0x00000002;
...
enum uint NIIF_NDIS_ISCSI_INTERFACE = 0x00000080;
enum uint NIIF_NDIS_RESERVED4 = 0x00000100;
enum uint IF_MAX_STRING_SIZE = 0x00000100;
...
struct NDIS_TCP_CONNECTION_OFFLOAD
{
    NDIS_OBJECT_HEADER Header;
    uint               Encapsulation;
    /*FIELD ATTR: NativeBitfieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(SupportSack)), FixedArgSig(ElementSig(6)), FixedArgSig(ElementSig(2))], [])*/uint _bitfield56;
