...
enum HRESULT WCN_E_PEER_NOT_FOUND = HRESULT(0x80043c01);
enum HRESULT WCN_E_AUTHENTICATION_FAILED = HRESULT(0x80043c02);
enum HRESULT WCN_E_CONNECTION_REJECTED = HRESULT(0x80043c03);
enum HRESULT WCN_E_SESSION_TIMEDOUT = HRESULT(0x80043c04);
enum HRESULT WCN_E_PROTOCOL_ERROR = HRESULT(0x80043c05);
enum const(wchar)* WCN_QUERY_CONSTRAINT_USE_SOFTAP = "WCN.Discovery.SoftAP";
