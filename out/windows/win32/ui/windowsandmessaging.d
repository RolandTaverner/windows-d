...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/inputdev/wm-unichar))], [])*/uint WM_UNICHAR = 0x00000109;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/wm-notify))], [])*/uint WM_NOTIFY = 0x0000004e;
...
enum uint STRSAFE_NULL_ON_FAILURE = 0x00000800;
...
enum uint __WARNING_USING_UNINIT_VAR = 0x00001771;
...
enum uint __WARNING_INVALID_PARAM_VALUE_1 = 0x000018f3;
enum uint __WARNING_UNSAFE_STRING_FUNCTION = 0x000061c1;
enum uint __WARNING_INCORRECT_ANNOTATION = 0x00006597;
enum uint __WARNING_POTENTIAL_BUFFER_OVERFLOW_HIGH_PRIORITY = 0x0000659f;
enum uint __WARNING_PRECONDITION_NULLTERMINATION_VIOLATION = 0x000065b3;
enum uint __WARNING_POSTCONDITION_NULLTERMINATION_VIOLATION = 0x000065b4;
enum uint __WARNING_HIGH_PRIORITY_OVERFLOW_POSTCONDITION = 0x000065bd;
enum uint __WARNING_RANGE_POSTCONDITION_VIOLATION = 0x000065cd;
enum uint __WARNING_POTENTIAL_RANGE_POSTCONDITION_VIOLATION = 0x000065d7;
enum uint __WARNING_INVALID_PARAM_VALUE_3 = 0x00006e17;
enum uint __WARNING_RETURNING_BAD_RESULT = 0x00006e24;
enum uint __WARNING_BANNED_API_USAGE = 0x0000702f;
enum uint __WARNING_POST_EXPECTED = 0x00006e32;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/DevIO/dbt-devnodes-changed))], [])*/uint DBT_DEVNODES_CHANGED = 0x00000007;
...
enum uint DBT_MONITORCHANGE = 0x0000001b;
enum uint DBT_SHELLLOGGEDON = 0x00000020;
enum uint DBT_CONFIGMGAPI32 = 0x00000022;
...
enum uint LOCKP_ALLOW_WRITES = 0x00000001;
...
enum uint LOCKP_ALLOW_MEM_MAPPING = 0x00000000;
enum uint LOCKP_USER_MASK = 0x00000003;
enum uint LOCKP_LOCK_FOR_FORMAT = 0x00000004;
enum uint LOCKF_LOGICAL_LOCK = 0x00000000;
enum uint LOCKF_PHYSICAL_LOCK = 0x00000001;
enum uint DBT_NO_DISK_SPACE = 0x00000047;
enum uint DBT_LOW_DISK_SPACE = 0x00000048;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/DevIO/dbt-customevent))], [])*/uint DBT_CUSTOMEVENT = 0x00008006;
...
enum uint DBTF_RESOURCE = 0x00000001;
...
enum uint DBT_VPOWERDAPI = 0x00008100;
...
enum PWSTR RT_CURSOR = PWSTR(0x0001);
enum PWSTR RT_BITMAP = PWSTR(0x0002);

enum : PWSTR
{
    RT_ICON   = PWSTR(0x0003),
    RT_MENU   = PWSTR(0x0004),
    RT_DIALOG = PWSTR(0x0005),
}

enum : PWSTR
{
    RT_FONTDIR     = PWSTR(0x0007),
    RT_FONT        = PWSTR(0x0008),
    RT_ACCELERATOR = PWSTR(0x0009),
}

enum PWSTR RT_MESSAGETABLE = PWSTR(0x000b);
enum uint DIFFERENCE = 0x0000000b;
enum PWSTR RT_VERSION = PWSTR(0x0010);
enum PWSTR RT_DLGINCLUDE = PWSTR(0x0011);
enum PWSTR RT_PLUGPLAY = PWSTR(0x0013);

enum : PWSTR
{
    RT_VXD       = PWSTR(0x0014),
    RT_ANICURSOR = PWSTR(0x0015),
    RT_ANIICON   = PWSTR(0x0016),
}

enum PWSTR RT_HTML = PWSTR(0x0017);
...
enum uint HCBT_DESTROYWND = 0x00000004;
enum uint HCBT_ACTIVATE = 0x00000005;
enum uint HCBT_CLICKSKIPPED = 0x00000006;
enum uint HCBT_KEYSKIPPED = 0x00000007;
enum uint HCBT_SYSCOMMAND = 0x00000008;
...
enum uint MSGF_DIALOGBOX = 0x00000000;
...
enum uint MSGF_NEXTWINDOW = 0x00000006;
...
enum uint HSHELL_ACTIVATESHELLWINDOW = 0x00000003;
...
enum uint HSHELL_MONITORCHANGED = 0x00000010;
...
enum uint KL_NAMELENGTH = 0x00000009;
...
enum uint CWF_CREATE_ONLY = 0x00000001;
enum int WSF_VISIBLE = 0x00000001;
enum uint UOI_TIMERPROC_EXCEPTION_SUPPRESSION = 0x00000007;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/winmsg/wm-destroy))], [])*/uint WM_DESTROY = 0x00000002;
...
enum uint WA_INACTIVE = 0x00000000;
enum uint WA_ACTIVE = 0x00000001;
enum uint WA_CLICKACTIVE = 0x00000002;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/inputdev/wm-killfocus))], [])*/uint WM_KILLFOCUS = 0x00000008;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/gdi/wm-paint))], [])*/uint WM_PAINT = 0x0000000f;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Shutdown/wm-endsession))], [])*/uint WM_ENDSESSION = 0x00000016;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/gdi/wm-syscolorchange))], [])*/uint WM_SYSCOLORCHANGE = 0x00000015;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/winmsg/wm-wininichange))], [])*/uint WM_WININICHANGE = 0x0000001a;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/gdi/wm-devmodechange))], [])*/uint WM_DEVMODECHANGE = 0x0000001b;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/gdi/wm-fontchange))], [])*/uint WM_FONTCHANGE = 0x0000001d;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/winmsg/wm-cancelmode))], [])*/uint WM_CANCELMODE = 0x0000001f;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/inputdev/wm-mouseactivate))], [])*/uint WM_MOUSEACTIVATE = 0x00000021;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/winmsg/wm-queuesync))], [])*/uint WM_QUEUESYNC = 0x00000023;
...
enum uint WM_PAINTICON = 0x00000026;
enum uint WM_ICONERASEBKGND = 0x00000027;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dlgbox/wm-nextdlgctl))], [])*/uint WM_NEXTDLGCTL = 0x00000028;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/wm-drawitem))], [])*/uint WM_DRAWITEM = 0x0000002b;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/wm-deleteitem))], [])*/uint WM_DELETEITEM = 0x0000002d;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/wm-chartoitem))], [])*/uint WM_CHARTOITEM = 0x0000002f;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/winmsg/wm-getfont))], [])*/uint WM_GETFONT = 0x00000031;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/inputdev/wm-gethotkey))], [])*/uint WM_GETHOTKEY = 0x00000033;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/wm-compareitem))], [])*/uint WM_COMPAREITEM = 0x00000039;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Power/wm-power))], [])*/uint WM_POWER = 0x00000048;
...
enum uint PWR_CRITICALRESUME = 0x00000003;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/winmsg/wm-canceljournal))], [])*/uint WM_CANCELJOURNAL = 0x0000004b;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/wm-tcard))], [])*/uint WM_TCARD = 0x00000052;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/wm-notifyformat))], [])*/uint WM_NOTIFYFORMAT = 0x00000055;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/gdi/wm-displaychange))], [])*/uint WM_DISPLAYCHANGE = 0x0000007e;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/winmsg/wm-seticon))], [])*/uint WM_SETICON = 0x00000080;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dlgbox/wm-getdlgcode))], [])*/uint WM_GETDLGCODE = 0x00000087;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/inputdev/wm-ncmousemove))], [])*/uint WM_NCMOUSEMOVE = 0x000000a0;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/inputdev/wm-input-device-change))], [])*/uint WM_INPUT_DEVICE_CHANGE = 0x000000fe;
...
enum uint WM_KEYLAST = 0x00000109;
enum uint UNICODE_NOCHAR = 0x0000ffff;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Intl/wm-ime-startcomposition))], [])*/uint WM_IME_STARTCOMPOSITION = 0x0000010d;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Intl/wm-ime-composition))], [])*/uint WM_IME_COMPOSITION = 0x0000010f;
enum uint WM_IME_KEYLAST = 0x0000010f;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dlgbox/wm-initdialog))], [])*/uint WM_INITDIALOG = 0x00000110;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/menurc/wm-syscommand))], [])*/uint WM_SYSCOMMAND = 0x00000112;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/wm-hscroll))], [])*/uint WM_HSCROLL = 0x00000114;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dlgbox/wm-enteridle))], [])*/uint WM_ENTERIDLE = 0x00000121;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/menurc/wm-uninitmenupopup))], [])*/uint WM_UNINITMENUPOPUP = 0x00000125;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/menurc/wm-changeuistate))], [])*/uint WM_CHANGEUISTATE = 0x00000127;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/menurc/wm-queryuistate))], [])*/uint WM_QUERYUISTATE = 0x00000129;
...
enum uint UISF_ACTIVE = 0x00000004;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/winmsg/mn-gethmenu))], [])*/uint MN_GETHMENU = 0x000001e1;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/inputdev/wm-mousewheel))], [])*/uint WM_MOUSEWHEEL = 0x0000020a;
...
enum uint WHEEL_DELTA = 0x00000078;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/inputmsg/wm-parentnotify))], [])*/uint WM_PARENTNOTIFY = 0x00000210;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/menurc/wm-exitmenuloop))], [])*/uint WM_EXITMENULOOP = 0x00000212;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/winmsg/wm-sizing))], [])*/uint WM_SIZING = 0x00000214;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/winmsg/wm-moving))], [])*/uint WM_MOVING = 0x00000216;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Power/pbt-powersettingchange))], [])*/uint PBT_POWERSETTINGCHANGE = 0x00008013;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/winmsg/wm-mdigetactive))], [])*/uint WM_MDIGETACTIVE = 0x00000229;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/winmsg/wm-entersizemove))], [])*/uint WM_ENTERSIZEMOVE = 0x00000231;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/wm-dropfiles))], [])*/uint WM_DROPFILES = 0x00000233;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/wintouch/wm-touchdown))], [])*/uint WM_TOUCH = 0x00000240;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/inputmsg/wm-touchhittesting))], [])*/uint WM_TOUCHHITTESTING = 0x0000024d;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/inputmsg/dm-pointerhittest))], [])*/uint DM_POINTERHITTEST = 0x00000250;
...
enum uint WM_WTSSESSION_CHANGE = 0x000002b1;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/hidpi/wm-getdpiscaledsize))], [])*/uint WM_GETDPISCALEDSIZE = 0x000002e4;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dataxchg/wm-clear))], [])*/uint WM_CLEAR = 0x00000303;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dataxchg/wm-destroyclipboard))], [])*/uint WM_DESTROYCLIPBOARD = 0x00000307;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dataxchg/wm-paintclipboard))], [])*/uint WM_PAINTCLIPBOARD = 0x00000309;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dataxchg/wm-sizeclipboard))], [])*/uint WM_SIZECLIPBOARD = 0x0000030b;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dataxchg/wm-changecbchain))], [])*/uint WM_CHANGECBCHAIN = 0x0000030d;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/gdi/wm-querynewpalette))], [])*/uint WM_QUERYNEWPALETTE = 0x0000030f;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/inputdev/wm-hotkey))], [])*/uint WM_HOTKEY = 0x00000312;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/inputdev/wm-appcommand))], [])*/uint WM_APPCOMMAND = 0x00000319;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dataxchg/wm-clipboardupdate))], [])*/uint WM_CLIPBOARDUPDATE = 0x0000031d;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dwm/wm-dwmncrenderingchanged))], [])*/uint WM_DWMNCRENDERINGCHANGED = 0x0000031f;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dwm/wm-dwmwindowmaximizedchange))], [])*/uint WM_DWMWINDOWMAXIMIZEDCHANGE = 0x00000321;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/menurc/wm-gettitlebarinfoex))], [])*/uint WM_GETTITLEBARINFOEX = 0x0000033f;
...
enum uint HTNOWHERE = 0x00000000;
enum uint HTCLIENT = 0x00000001;
enum uint HTCAPTION = 0x00000002;
enum uint HTSYSMENU = 0x00000003;
enum uint HTGROWBOX = 0x00000004;
enum uint HTSIZE = 0x00000004;
enum uint HTMENU = 0x00000005;
enum uint HTHSCROLL = 0x00000006;
enum uint HTVSCROLL = 0x00000007;
enum uint HTMINBUTTON = 0x00000008;
enum uint HTMAXBUTTON = 0x00000009;
enum uint HTLEFT = 0x0000000a;
enum uint HTRIGHT = 0x0000000b;
...
enum uint HTBORDER = 0x00000012;
enum uint HTREDUCE = 0x00000008;
enum uint HTZOOM = 0x00000009;
...
enum uint HTOBJECT = 0x00000013;
enum uint HTCLOSE = 0x00000014;
enum uint HTHELP = 0x00000015;
...
enum uint SIZE_RESTORED = 0x00000000;
...
enum uint SIZENORMAL = 0x00000000;
enum uint SIZEICONIC = 0x00000001;
enum uint SIZEFULLSCREEN = 0x00000002;
...
enum uint WVR_HREDRAW = 0x00000100;
...
enum uint DLGWINDOWEXTRA = 0x0000001e;
...
enum uint TOUCH_FLAG_NONE = 0x00000000;
...
enum uint PA_ACTIVATE = 0x00000001;
enum uint PA_NOACTIVATE = 0x00000003;
enum uint MAX_TOUCH_COUNT = 0x00000100;
...
enum uint GWFS_INCLUDE_ANCESTORS = 0x00000001;
enum uint QS_TOUCH = 0x00000800;
enum uint QS_POINTER = 0x00001000;
...
enum uint TIMERV_DEFAULT_COALESCING = 0x00000000;
...
enum uint SM_CMETRICS = 0x0000004c;
enum uint SM_CARETBLINKINGENABLED = 0x00002002;

enum : uint
{
    MENU_GET_ITEM_INFO = 0x00000001,
...
enum : uint
{
    MENU_INSERT_MENU = 0x00000008,
    MENU_INSERT_ITEM = 0x00000010,
}

enum uint MENU_DELETE_MENU = 0x00000020;
enum uint MENU_SET_ITEM_INFO = 0x00000040;
enum uint MENU_ENABLE_ITEM = 0x00000080;
enum uint MENU_CHECK_ITEM = 0x00000100;

enum : uint
{
    MENU_SET_DEFAULT_ITEM = 0x00000200,
...
enum uint MNC_SELECT = 0x00000003;
enum uint MND_CONTINUE = 0x00000000;
enum uint MND_ENDMENU = 0x00000001;
...
enum uint DOF_EXECUTABLE = 0x00008001;
...
enum uint DOF_MULTIPLE = 0x00008004;
enum uint DOF_PROGMAN = 0x00000001;
enum uint DOF_SHELLDATA = 0x00000002;
...
enum uint SC_MAXIMIZE = 0x0000f030;
enum uint SC_NEXTWINDOW = 0x0000f040;
enum uint SC_PREVWINDOW = 0x0000f050;
enum uint SC_CLOSE = 0x0000f060;
enum uint SC_VSCROLL = 0x0000f070;
enum uint SC_HSCROLL = 0x0000f080;
enum uint SC_MOUSEMENU = 0x0000f090;
enum uint SC_KEYMENU = 0x0000f100;
enum uint SC_ARRANGE = 0x0000f110;
enum uint SC_RESTORE = 0x0000f120;
enum uint SC_TASKLIST = 0x0000f130;
enum uint SC_HOTKEY = 0x0000f150;
enum uint SC_DEFAULT = 0x0000f160;
enum uint SC_MONITORPOWER = 0x0000f170;
enum uint SC_CONTEXTHELP = 0x0000f180;
enum uint SC_SEPARATOR = 0x0000f00f;
enum uint SCF_ISSECURE = 0x00000001;
...
enum : PWSTR
{
    IDC_ARROW   = PWSTR(0x7f00),
    IDC_IBEAM   = PWSTR(0x7f01),
    IDC_WAIT    = PWSTR(0x7f02),
    IDC_CROSS   = PWSTR(0x7f03),
    IDC_UPARROW = PWSTR(0x7f04),
}

enum : PWSTR
{
    IDC_SIZE     = PWSTR(0x7f80),
    IDC_ICON     = PWSTR(0x7f81),
    IDC_SIZENWSE = PWSTR(0x7f82),
    IDC_SIZENESW = PWSTR(0x7f83),
    IDC_SIZEWE   = PWSTR(0x7f84),
    IDC_SIZENS   = PWSTR(0x7f85),
    IDC_SIZEALL  = PWSTR(0x7f86),
}

enum : PWSTR
{
    IDC_NO          = PWSTR(0x7f88),
    IDC_HAND        = PWSTR(0x7f89),
    IDC_APPSTARTING = PWSTR(0x7f8a),
}

enum : PWSTR
{
    IDC_HELP   = PWSTR(0x7f8b),
    IDC_PIN    = PWSTR(0x7f9f),
    IDC_PERSON = PWSTR(0x7fa0),
}
...
enum uint IMAGE_ENHMETAFILE = 0x00000003;
...
enum uint OBM_DNARROW = 0x00007ff0;
enum uint OBM_RGARROW = 0x00007fef;
enum uint OBM_LFARROW = 0x00007fee;
...
enum uint OBM_UPARROWD = 0x00007fe7;
enum uint OBM_DNARROWD = 0x00007fe6;
enum uint OBM_RGARROWD = 0x00007fe5;
enum uint OBM_LFARROWD = 0x00007fe4;
enum uint OBM_MNARROW = 0x00007fe3;
...
enum uint OBM_DNARROWI = 0x00007fe0;
enum uint OBM_RGARROWI = 0x00007fdf;
enum uint OBM_LFARROWI = 0x00007fde;
...
enum uint OBM_BTSIZE = 0x00007ff9;
...
enum uint OBM_BTNCORNERS = 0x00007ff6;
...
enum uint OIC_SAMPLE = 0x00007f00;
...
enum uint OIC_SHIELD = 0x00007f06;
enum uint ORD_LANGDRIVER = 0x00000001;
enum PWSTR IDI_APPLICATION = PWSTR(0x00007f00);

enum : PWSTR
{
    IDI_HAND     = PWSTR(0x00007f01),
    IDI_QUESTION = PWSTR(0x00007f02),
}

enum PWSTR IDI_EXCLAMATION = PWSTR(0x00007f03);
enum PWSTR IDI_ASTERISK = PWSTR(0x00007f04);
enum PWSTR IDI_WINLOGO = PWSTR(0x00007f05);
enum PWSTR IDI_SHIELD = PWSTR(0x00007f06);
enum PWSTR IDI_WARNING = PWSTR(0x00007f03);

enum : PWSTR
{
    IDI_ERROR       = PWSTR(0x00007f01),
    IDI_INFORMATION = PWSTR(0x00007f04),
}
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/en-killfocus))], [])*/uint EN_KILLFOCUS = 0x00000200;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/en-update))], [])*/uint EN_UPDATE = 0x00000400;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/en-maxtext))], [])*/uint EN_MAXTEXT = 0x00000501;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/en-vscroll))], [])*/uint EN_VSCROLL = 0x00000602;
...
enum uint EN_BEFORE_PASTE = 0x00000800;
enum uint EN_AFTER_PASTE = 0x00000801;
enum uint EC_LEFTMARGIN = 0x00000001;
enum uint EC_RIGHTMARGIN = 0x00000002;
enum uint EC_USEFONTINFO = 0x0000ffff;
enum uint EMSIS_COMPOSITIONSTRING = 0x00000001;
enum uint EIMES_GETCOMPSTRATONCE = 0x00000001;
enum uint EIMES_CANCELCOMPSTRINFOCUS = 0x00000002;
enum uint EIMES_COMPLETECOMPSTRKILLFOCUS = 0x00000004;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/bn-clicked))], [])*/uint BN_CLICKED = 0x00000000;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/bn-hilite))], [])*/uint BN_HILITE = 0x00000002;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/bn-disable))], [])*/uint BN_DISABLE = 0x00000004;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/bn-pushed))], [])*/uint BN_PUSHED = 0x00000002;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/bn-dblclk))], [])*/uint BN_DBLCLK = 0x00000005;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/bn-killfocus))], [])*/uint BN_KILLFOCUS = 0x00000007;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/bm-setcheck))], [])*/uint BM_SETCHECK = 0x000000f1;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/bm-click))], [])*/uint BM_CLICK = 0x000000f5;
...
enum uint BST_PUSHED = 0x00000004;
enum uint BST_FOCUS = 0x00000008;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/stm-seticon))], [])*/uint STM_SETICON = 0x00000170;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/stm-setimage))], [])*/uint STM_SETIMAGE = 0x00000172;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/stn-clicked))], [])*/uint STN_CLICKED = 0x00000000;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/stn-enable))], [])*/uint STN_ENABLE = 0x00000002;
...
enum uint STM_MSGMAX = 0x00000174;
enum uint DWL_MSGRESULT = 0x00000000;
enum uint DWL_DLGPROC = 0x00000004;
enum uint DWL_USER = 0x00000008;
enum uint DWLP_MSGRESULT = 0x00000000;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dlgbox/dm-getdefid))], [])*/uint DM_GETDEFID = 0x00000400;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dlgbox/dm-reposition))], [])*/uint DM_REPOSITION = 0x00000402;
...
enum uint DLGC_HASSETSEL = 0x00000008;
enum uint DLGC_DEFPUSHBUTTON = 0x00000010;
enum uint DLGC_UNDEFPUSHBUTTON = 0x00000020;
enum uint DLGC_RADIOBUTTON = 0x00000040;
enum uint DLGC_WANTCHARS = 0x00000080;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/lbn-dblclk))], [])*/uint LBN_DBLCLK = 0x00000002;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/lbn-killfocus))], [])*/uint LBN_KILLFOCUS = 0x00000005;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/lb-insertstring))], [])*/uint LB_INSERTSTRING = 0x00000181;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/lb-selitemrangeex))], [])*/uint LB_SELITEMRANGEEX = 0x00000183;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/lb-selectstring))], [])*/uint LB_SELECTSTRING = 0x0000018c;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/lb-findstring))], [])*/uint LB_FINDSTRING = 0x0000018f;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/lb-settabstops))], [])*/uint LB_SETTABSTOPS = 0x00000192;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/lb-sethorizontalextent))], [])*/uint LB_SETHORIZONTALEXTENT = 0x00000194;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/lb-addfile))], [])*/uint LB_ADDFILE = 0x00000196;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/lb-setitemdata))], [])*/uint LB_SETITEMDATA = 0x0000019a;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/lb-setanchorindex))], [])*/uint LB_SETANCHORINDEX = 0x0000019c;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/lb-setcaretindex))], [])*/uint LB_SETCARETINDEX = 0x0000019e;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/lb-setitemheight))], [])*/uint LB_SETITEMHEIGHT = 0x000001a0;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/lb-findstringexact))], [])*/uint LB_FINDSTRINGEXACT = 0x000001a2;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/lb-getlocale))], [])*/uint LB_GETLOCALE = 0x000001a6;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/lb-initstorage))], [])*/uint LB_INITSTORAGE = 0x000001a8;
...
enum uint LB_MULTIPLEADDSTRING = 0x000001b1;
...
enum uint LB_MSGMAX = 0x000001b3;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/cbn-dblclk))], [])*/uint CBN_DBLCLK = 0x00000002;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/cbn-killfocus))], [])*/uint CBN_KILLFOCUS = 0x00000004;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/cbn-dropdown))], [])*/uint CBN_DROPDOWN = 0x00000007;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/cb-geteditsel))], [])*/uint CB_GETEDITSEL = 0x00000140;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/cb-seteditsel))], [])*/uint CB_SETEDITSEL = 0x00000142;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/cb-deletestring))], [])*/uint CB_DELETESTRING = 0x00000144;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/cb-insertstring))], [])*/uint CB_INSERTSTRING = 0x0000014a;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/cb-findstring))], [])*/uint CB_FINDSTRING = 0x0000014c;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/cb-setcursel))], [])*/uint CB_SETCURSEL = 0x0000014e;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/cb-getitemdata))], [])*/uint CB_GETITEMDATA = 0x00000150;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/cb-getdroppedcontrolrect))], [])*/uint CB_GETDROPPEDCONTROLRECT = 0x00000152;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/cb-getitemheight))], [])*/uint CB_GETITEMHEIGHT = 0x00000154;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/cb-getextendedui))], [])*/uint CB_GETEXTENDEDUI = 0x00000156;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/cb-findstringexact))], [])*/uint CB_FINDSTRINGEXACT = 0x00000158;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/cb-settopindex))], [])*/uint CB_SETTOPINDEX = 0x0000015c;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/cb-sethorizontalextent))], [])*/uint CB_SETHORIZONTALEXTENT = 0x0000015e;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/cb-setdroppedwidth))], [])*/uint CB_SETDROPPEDWIDTH = 0x00000160;
...
enum uint CB_MULTIPLEADDSTRING = 0x00000163;
...
enum uint CB_MSGMAX = 0x00000165;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/sbm-setpos))], [])*/uint SBM_SETPOS = 0x000000e0;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/sbm-getrange))], [])*/uint SBM_GETRANGE = 0x000000e3;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/Controls/sbm-setscrollinfo))], [])*/uint SBM_SETSCROLLINFO = 0x000000e9;
...
enum uint MDIS_ALLCHILDSTYLES = 0x00000001;
...
enum uint HELP_CONTEXTMENU = 0x0000000a;
...
enum uint IDH_NO_HELP = 0x00006f18;
enum uint IDH_MISSING_CONTEXT = 0x00006f19;
enum uint IDH_GENERIC_HELP_BUTTON = 0x00006f1a;
...
enum uint MAX_LOGICALDPIOVERRIDE = 0x00000002;
...
enum uint HCF_LOGONDESKTOP = 0x00000100;
enum uint HCF_DEFAULTDESKTOP = 0x00000200;
enum uint EDD_GET_DEVICE_INTERFACE_NAME = 0x00000001;
...
enum uint WINEVENT_INCONTEXT = 0x00000004;
...
enum uint EVENT_SYSTEM_END = 0x000000ff;
...
enum uint CONSOLE_APPLICATION_16BIT = 0x00000000;
...
enum uint EVENT_CONSOLE_END = 0x000040ff;
...
enum uint EVENT_OBJECT_CONTENTSCROLLED = 0x00008015;
...
enum uint EVENT_OBJECT_END = 0x000080ff;
...
enum uint CSOUND_SYSTEM = 0x00000010;
enum uint CALERT_SYSTEM = 0x00000006;
enum uint GUI_16BITTASK = 0x00000000;
...
enum uint CURSOR_INVISIBLE = 0x00000000;
...
enum uint RIM_TYPEMAX = 0x00000002;
...
enum uint POINTER_DEVICE_PRODUCT_STRING_MAX = 0x00000208;
enum uint PDC_ARRIVAL = 0x00000001;
enum uint PDC_REMOVAL = 0x00000002;
...
enum uint PDC_MAPPING_CHANGE = 0x00000100;
enum uint PDC_RESOLUTION = 0x00000200;
enum uint PDC_ORIGIN = 0x00000400;
enum uint PDC_MODE_ASPECTRATIOPRESERVED = 0x00000800;

enum : uint
{
    TOUCHPAD_PARAMETERS_VERSION_1 = 0x00000001,
    TOUCHPAD_PARAMETERS_VERSION_2 = 0x00000002,
}

enum uint GF_BEGIN = 0x00000001;
enum uint GF_INERTIA = 0x00000002;
enum uint GF_END = 0x00000004;
enum uint GESTURECONFIGMAXCOUNT = 0x00000100;
enum uint GCF_INCLUDE_ANCESTORS = 0x00000001;
enum uint NID_INTEGRATED_TOUCH = 0x00000001;
enum uint NID_EXTERNAL_TOUCH = 0x00000002;
enum uint NID_INTEGRATED_PEN = 0x00000004;
enum uint NID_EXTERNAL_PEN = 0x00000008;
enum uint NID_MULTI_INPUT = 0x00000040;
enum uint NID_READY = 0x00000080;
enum uint MAX_STR_BLOCKREASON = 0x00000100;
enum uint WM_INTERCEPTED_WINDOW_ACTION = 0x00000346;
enum uint WM_TOOLTIPDISMISS = 0x00000345;
enum uint INVALID_MONITOR_TOPOLOGY_ID = 0x00000000;
...
enum : PWSTR
{
    RT_GROUP_CURSOR = PWSTR(0x000c),
    RT_GROUP_ICON   = PWSTR(0x000e),
}

enum PWSTR RT_MANIFEST = PWSTR(0x0018);
...
struct MENUBARINFO
{
    ...
    HMENU hMenu;
    HWND  hwndMenu;
    /*FIELD ATTR: NativeBitfieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(fUnused)), FixedArgSig(ElementSig(2)), FixedArgSig(ElementSig(30))], [])*/int _bitfield157;
}
...
struct TOUCHPAD_PARAMETERS_V2
{
    ...
    /*FIELD ATTR: NativeBitfieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(Reserved3)), FixedArgSig(ElementSig(3)), FixedArgSig(ElementSig(29))], [])*/int _bitfield158;
}
