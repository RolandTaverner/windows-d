...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dlgbox/cdn-initdone))], [])*/uint CDN_INITDONE = 0xfffffda7;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dlgbox/cdn-folderchange))], [])*/uint CDN_FOLDERCHANGE = 0xfffffda5;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dlgbox/cdn-typechange))], [])*/uint CDN_TYPECHANGE = 0xfffffda1;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dlgbox/cdm-setcontroltext))], [])*/uint CDM_SETCONTROLTEXT = 0x00000468;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dlgbox/cdm-setdefext))], [])*/uint CDM_SETDEFEXT = 0x0000046a;
...
enum uint PS_OPENTYPE_FONTTYPE = 0x00010000;
enum uint TT_OPENTYPE_FONTTYPE = 0x00020000;
enum uint TYPE1_FONTTYPE = 0x00040000;
...
enum uint DN_DEFAULTPRN = 0x00000001;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dlgbox/wm-psd-minmarginrect))], [])*/uint WM_PSD_MINMARGINRECT = 0x00000402;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/dlgbox/wm-psd-envstamprect))], [])*/uint WM_PSD_ENVSTAMPRECT = 0x00000405;
...
enum uint DLG_COLOR = 0x0000000a;
enum uint COLOR_HUESCROLL = 0x000002bc;
enum uint COLOR_SATSCROLL = 0x000002bd;
enum uint COLOR_LUMSCROLL = 0x000002be;

enum : uint
{
    COLOR_HUE        = 0x000002bf,
...
enum uint COLOR_BLUEACCEL = 0x000002d8;
...
enum uint NUM_BASIC_COLORS = 0x00000030;
