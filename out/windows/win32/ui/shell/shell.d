...
public import windows.win32.foundation.foundation : BOOL, BOOLEAN, BSTR, CHAR, COLORREF,
                                                    ...
                                                    HWND, LPARAM, LRESULT, NTSTATUS,
                                                    POINT, POINTL, PROPERTYKEY, PSTR,
                                                    PWSTR, RECT, RECTL, SHANDLE_PTR,
                                                    SIZE, SYSTEMTIME, VARIANT_BOOL,
                                                    WIN32_ERROR, WPARAM;
...
public import windows.win32.storage.filesystem : FILE_FLAGS_AND_ATTRIBUTES, WIN32_FIND_DATAA,
                                                 WIN32_FIND_DATAW;
public import windows.win32.system.com.com : BYTE_BLOB, DISPPARAMS, EXCEPINFO, FORMATETC,
                                             IBindCtx, IBindStatusCallback,
                                             IConnectionPoint, IDataObject, IDispatch,
                                             IEnumFORMATETC, IEnumGUID, IEnumString,
                                             IEnumUnknown, IMalloc, IMoniker,
                                             IPersist, IServiceProvider, IStream,
                                             IUnknown;
...
public import windows.win32.system.search.search : ICondition;
...
public import windows.win32.ui.controls.controls : HIMAGELIST, HPROPSHEETPAGE, LPFNSVADDPROPSHEETPAGE,
                                                   NMHDR, TBBUTTON;
...
enum : /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/wm-cpl-launch))], [])*/uint
{
...
enum : /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/cpl-init))], [])*/uint
{
    CPL_INIT     = 0x00000001U,
    CPL_GETCOUNT = 0x00000002U,
}

enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/cpl-inquire))], [])*/uint CPL_INQUIRE = 0x00000003U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/cpl-select))], [])*/uint CPL_SELECT = 0x00000004U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/cpl-dblclk))], [])*/uint CPL_DBLCLK = 0x00000005U;

enum : /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/cpl-stop))], [])*/uint
{
...
enum /*FIELD ATTR: NativeEncodingAttribute : CustomAttributeSig([FixedArgSig(ElementSig(ansi))], [])*/const(wchar)* STR_MYDOCS_CLSID = "{450D8FBA-AD25-11D0-98A8-0800361B1103}";
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/sfvm-rearrange))], [])*/uint SFVM_REARRANGE = 0x00000001U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/sfvm-addobject))], [])*/uint SFVM_ADDOBJECT = 0x00000003U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/sfvm-removeobject))], [])*/uint SFVM_REMOVEOBJECT = 0x00000006U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/sfvm-updateobject))], [])*/uint SFVM_UPDATEOBJECT = 0x00000007U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/sfvm-getselectedobjects))], [])*/uint SFVM_GETSELECTEDOBJECTS = 0x00000009U;

enum : /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/sfvm-setitempos))], [])*/uint
{
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/smc-initmenu))], [])*/uint SMC_INITMENU = 0x00000001U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/smc-create))], [])*/uint SMC_CREATE = 0x00000002U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/smc-exitmenu))], [])*/uint SMC_EXITMENU = 0x00000003U;

enum : /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/smc-getinfo))], [])*/uint
{
...
enum : /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/smc-sfexec))], [])*/uint
{
    SMC_SFEXEC       = 0x00000009U,
    SMC_SFSELECTITEM = 0x0000000aU,
}

enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/smc-refresh))], [])*/uint SMC_REFRESH = 0x00000010U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/smc-demote))], [])*/uint SMC_DEMOTE = 0x00000011U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/smc-promote))], [])*/uint SMC_PROMOTE = 0x00000012U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/smc-defaulticon))], [])*/uint SMC_DEFAULTICON = 0x00000016U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/smc-newitem))], [])*/uint SMC_NEWITEM = 0x00000017U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/smc-chevronexpand))], [])*/uint SMC_CHEVRONEXPAND = 0x00000019U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/smc-displaychevrontip))], [])*/uint SMC_DISPLAYCHEVRONTIP = 0x0000002aU;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/smc-setsfobject))], [])*/uint SMC_SETSFOBJECT = 0x0000002dU;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/smc-shchangenotify))], [])*/uint SMC_SHCHANGENOTIFY = 0x0000002eU;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/smc-chevrongettip))], [])*/uint SMC_CHEVRONGETTIP = 0x0000002fU;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/smc-sfddrestricted))], [])*/uint SMC_SFDDRESTRICTED = 0x00000030U;
...
enum : /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/abm-new))], [])*/uint
{
    ABM_NEW    = 0x00000000U,
    ABM_REMOVE = 0x00000001U,
}

enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/abm-querypos))], [])*/uint ABM_QUERYPOS = 0x00000002U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/abm-setpos))], [])*/uint ABM_SETPOS = 0x00000003U;

enum : /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/abm-getstate))], [])*/uint
{
    ABM_GETSTATE      = 0x00000004U,
    ABM_GETTASKBARPOS = 0x00000005U,
}

enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/abm-activate))], [])*/uint ABM_ACTIVATE = 0x00000006U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/abm-getautohidebar))], [])*/uint ABM_GETAUTOHIDEBAR = 0x00000007U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/abm-setautohidebar))], [])*/uint ABM_SETAUTOHIDEBAR = 0x00000008U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/abm-windowposchanged))], [])*/uint ABM_WINDOWPOSCHANGED = 0x00000009U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/abm-setstate))], [])*/uint ABM_SETSTATE = 0x0000000aU;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/abm-getautohidebarex))], [])*/uint ABM_GETAUTOHIDEBAREX = 0x0000000bU;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/abm-setautohidebarex))], [])*/uint ABM_SETAUTOHIDEBAREX = 0x0000000cU;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/abn-statechange))], [])*/uint ABN_STATECHANGE = 0x00000000U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/abn-poschanged))], [])*/uint ABN_POSCHANGED = 0x00000001U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/abn-fullscreenapp))], [])*/uint ABN_FULLSCREENAPP = 0x00000002U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/abn-windowarrange))], [])*/uint ABN_WINDOWARRANGE = 0x00000003U;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/ncm-getaddress))], [])*/uint NCM_GETADDRESS = 0x00000401U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/ncm-setallowtype))], [])*/uint NCM_SETALLOWTYPE = 0x00000402U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/ncm-getallowtype))], [])*/uint NCM_GETALLOWTYPE = 0x00000403U;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/shell/ncm-displayerrortip))], [])*/uint NCM_DISPLAYERRORTIP = 0x00000404U;
...
version(X86_64)
{
    struct DRAGINFOA
    {
        ...
        POINT pt;
        BOOL  fNC;
        /*FIELD ATTR: NullNullTerminatedAttribute : CustomAttributeSig([], [])*/PSTR lpFileList;
        uint  grfKeyState;
    }
}
...
version(X86_64)
{
    struct DRAGINFOW
    {
        ...
        POINT pt;
        BOOL  fNC;
        /*FIELD ATTR: NullNullTerminatedAttribute : CustomAttributeSig([], [])*/PWSTR lpFileList;
        uint  grfKeyState;
    }
}
...
version(X86_64)
{
    ...
    struct SHFILEOPSTRUCTW
    {
        HWND         hwnd;
        uint         wFunc;
        /*FIELD ATTR: NullNullTerminatedAttribute : CustomAttributeSig([], [])*/const(PWSTR) pFrom;
        /*FIELD ATTR: NullNullTerminatedAttribute : CustomAttributeSig([], [])*/const(PWSTR) pTo;
        ushort       fFlags;
        BOOL         fAnyOperationsAborted;
        void*        hNameMappings;
...
align (1):
    uint cbSize;
    uint dwSignature;
    /*FIELD ATTR: FlexibleArrayAttribute : CustomAttributeSig([], [])*/ubyte[1] abPropertyStorage;
}
...
{
    uint cItems;
    /*FIELD ATTR: FlexibleArrayAttribute : CustomAttributeSig([], [])*/NETRESOURCEA[1] nr;
}
...
align (1):
    uint cItems;
    /*FIELD ATTR: FlexibleArrayAttribute : CustomAttributeSig([], [])*/FILEDESCRIPTORW[1] fgd;
}
...
align (1):
    ...
    /*FIELD ATTR: FlexibleArrayAttribute : CustomAttributeSig([], [])*/uint[1] rgdwFileAttributes;
}
...
{
    /*FIELD ATTR: AssociatedEnumAttribute : CustomAttributeSig([FixedArgSig(ElementSig(SHDID_ID))], [])*/uint dwDescriptionId;
    GUID clsid;
}
...
align (1):
    ushort cLength;
    ushort nVersion;
    /*FIELD ATTR: NativeBitfieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(fUnusedFlags)), FixedArgSig(ElementSig(9)), FixedArgSig(ElementSig(7))], [])*/int _bitfield543;
...
{
    uint nMaxIds;
    /*FIELD ATTR: FlexibleArrayAttribute : CustomAttributeSig([], [])*/QCMINFO_IDMAP_PLACEMENT[1] pIdList;
}
...
{
align (1):
    /*FIELD ATTR: NativeBitfieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(fNoNetCrawling)), FixedArgSig(ElementSig(16)), FixedArgSig(ElementSig(1))], [])*/int _bitfield1;
    uint dwWin95Unused;
    uint uWin95Unused;
    int  lParamSort;
    int  iSortDirection;
...
{
align (1):
    /*FIELD ATTR: NativeBitfieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(fRestFlags)), FixedArgSig(ElementSig(15)), FixedArgSig(ElementSig(1))], [])*/int _bitfield544;
}
...
struct AASHELLMENUFILENAME
{
    ...
    /*FIELD ATTR: FlexibleArrayAttribute : CustomAttributeSig([], [])*/wchar[1] szFileName;
}
...
struct BASEBROWSERDATAXP
{
    ...
    /*FIELD ATTR: NativeBitfieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(_fCreatingViewWindow)), FixedArgSig(ElementSig(0)), FixedArgSig(ElementSig(1))], [])*/uint _bitfield545;
...
struct BASEBROWSERDATALH
{
    ...
    IShellService     _pautoSS;
    int               _eSecureLockIcon;
    /*FIELD ATTR: NativeBitfieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(_fCreatingViewWindow)), FixedArgSig(ElementSig(0)), FixedArgSig(ElementSig(1))], [])*/uint _bitfield546;
    uint              _uActivateState;
    ITEMIDLIST*       _pidlViewState;
    IOleCommandTarget _pctView;
    ITEMIDLIST*       _pidlCur;
