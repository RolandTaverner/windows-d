...
enum uint XUSER_MAX_COUNT = 0x00000004;
enum uint XUSER_INDEX_ANY = 0x000000ff;

// Structs


//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/xinput/ns-xinput-xinput_gamepad))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/xinput/ns-xinput-xinput_state))], [])
struct XINPUT_STATE
{
    uint           dwPacketNumber;
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/xinput/ns-xinput-xinput_vibration))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/xinput/ns-xinput-xinput_capabilities))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/xinput/ns-xinput-xinput_battery_information))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/xinput/ns-xinput-xinput_keystroke))], [])
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/xinput/nf-xinput-xinputgetstate))], [])
@DllImport("xinput1_4.dll")
uint XInputGetState(uint dwUserIndex, XINPUT_STATE* pState);

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/xinput/nf-xinput-xinputsetstate))], [])
@DllImport("xinput1_4.dll")
uint XInputSetState(uint dwUserIndex, XINPUT_VIBRATION* pVibration);

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/xinput/nf-xinput-xinputgetcapabilities))], [])
@DllImport("xinput1_4.dll")
uint XInputGetCapabilities(uint dwUserIndex, XINPUT_FLAG dwFlags, XINPUT_CAPABILITIES* pCapabilities);

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/xinput/nf-xinput-xinputenable))], [])
@DllImport("xinput1_4.dll")
void XInputEnable(BOOL enable);

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/xinput/nf-xinput-xinputgetaudiodeviceids))], [])
@DllImport("xinput1_4.dll")
uint XInputGetAudioDeviceIds(uint dwUserIndex, PWSTR pRenderDeviceId, uint* pRenderCount, PWSTR pCaptureDeviceId, 
                             uint* pCaptureCount);

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/xinput/nf-xinput-xinputgetbatteryinformation))], [])
@DllImport("xinput1_4.dll")
uint XInputGetBatteryInformation(uint dwUserIndex, BATTERY_DEVTYPE devType, 
                                 XINPUT_BATTERY_INFORMATION* pBatteryInformation);

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/xinput/nf-xinput-xinputgetkeystroke))], [])
@DllImport("xinput1_4.dll")
