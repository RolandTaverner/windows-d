...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/ne-uiribbon-ui_contextavailability
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/ne-uiribbon-ui_fontproperties
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/ne-uiribbon-ui_fontverticalposition
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/ne-uiribbon-ui_fontunderline
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/ne-uiribbon-ui_fontdeltasize
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/ne-uiribbon-ui_controldock
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/ne-uiribbon-ui_swatchcolortype
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/ne-uiribbon-ui_swatchcolormode
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/ne-uiribbon-ui_eventtype
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/ne-uiribbon-ui_eventlocation
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/ne-uiribbon-ui_invalidations
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/ne-uiribbon-ui_collectionchange
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/ne-uiribbon-ui_executionverb
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/ne-uiribbon-ui_commandtype
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/ne-uiribbon-ui_viewtype
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/ne-uiribbon-ui_viewverb
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/ne-uiribbon-ui_ownership
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/ns-uiribbon-ui_eventparams_command
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/ns-uiribbon-ui_eventparams
...
interface IUIRibbon : IUnknown
{
    ...
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/nf-uiribbon-iuiribbon-loadsettingsfromstream
    HRESULT LoadSettingsFromStream(IStream pStream);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/nf-uiribbon-iuiribbon-savesettingstostream
...
interface IUIFramework : IUnknown
{
    ...
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/nf-uiribbon-iuiframework-destroy
    HRESULT Destroy();
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/nf-uiribbon-iuiframework-loadui
    HRESULT LoadUI(HINSTANCE instance, const(PWSTR) resourceName);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/nf-uiribbon-iuiframework-getview
    HRESULT GetView(uint viewId, const(GUID)* riid, void** ppv);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/nf-uiribbon-iuiframework-getuicommandproperty
    HRESULT GetUICommandProperty(uint commandId, const(PROPERTYKEY)* key, PROPVARIANT* value);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/nf-uiribbon-iuiframework-setuicommandproperty
    HRESULT SetUICommandProperty(uint commandId, const(PROPERTYKEY)* key, const(PROPVARIANT)* value);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/nf-uiribbon-iuiframework-invalidateuicommand
    HRESULT InvalidateUICommand(uint commandId, UI_INVALIDATIONS flags, const(PROPERTYKEY)* key);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/nf-uiribbon-iuiframework-flushpendinginvalidations
    HRESULT FlushPendingInvalidations();
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/nf-uiribbon-iuiframework-setmodes
...
interface IUICollection : IUnknown
{
    ...
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/nf-uiribbon-iuicollection-getitem
    HRESULT GetItem(uint index, IUnknown* item);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/nf-uiribbon-iuicollection-add
    HRESULT Add(IUnknown item);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/nf-uiribbon-iuicollection-insert
    HRESULT Insert(uint index, IUnknown item);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/nf-uiribbon-iuicollection-removeat
    HRESULT RemoveAt(uint index);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/nf-uiribbon-iuicollection-replace
    HRESULT Replace(uint indexReplaced, IUnknown itemReplaceWith);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/nf-uiribbon-iuicollection-clear
    HRESULT Clear();
}
...
interface IUICommandHandler : IUnknown
{
    ...
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/nf-uiribbon-iuicommandhandler-updateproperty
...
interface IUIApplication : IUnknown
{
    ...
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/nf-uiribbon-iuiapplication-oncreateuicommand
    HRESULT OnCreateUICommand(uint commandId, UI_COMMANDTYPE typeID, IUICommandHandler* commandHandler);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/uiribbon/nf-uiribbon-iuiapplication-ondestroyuicommand
