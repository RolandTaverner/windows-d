...
enum uint POLYFILL_LAST = 0x00000002;
...
enum uint ASPECT_FILTERING = 0x00000001;
...
enum uint META_SETSTRETCHBLTMODE = 0x00000107;
...
enum uint META_OFFSETWINDOWORG = 0x0000020f;
enum uint META_SCALEWINDOWEXT = 0x00000410;
enum uint META_OFFSETVIEWPORTORG = 0x00000211;
...
enum uint META_INTERSECTCLIPRECT = 0x00000416;
...
enum uint META_OFFSETCLIPRGN = 0x00000220;
...
enum uint META_FILLREGION = 0x00000228;
enum uint META_FRAMEREGION = 0x00000429;
enum uint META_INVERTREGION = 0x0000012a;
...
enum uint META_EXTTEXTOUT = 0x00000a32;
...
enum uint META_REALIZEPALETTE = 0x00000035;
enum uint META_ANIMATEPALETTE = 0x00000436;
enum uint META_SETPALENTRIES = 0x00000037;
enum uint META_POLYPOLYGON = 0x00000538;
enum uint META_RESIZEPALETTE = 0x00000139;
...
enum uint META_STRETCHDIB = 0x00000f43;
enum uint META_EXTFLOODFILL = 0x00000548;
enum uint META_SETLAYOUT = 0x00000149;
...
enum uint NEWFRAME = 0x00000001;
enum uint ABORTDOC = 0x00000002;
enum uint NEXTBAND = 0x00000003;
enum uint SETCOLORTABLE = 0x00000004;
enum uint GETCOLORTABLE = 0x00000005;
enum uint FLUSHOUTPUT = 0x00000006;
enum uint DRAFTMODE = 0x00000007;
enum uint QUERYESCSUPPORT = 0x00000008;
enum uint SETABORTPROC = 0x00000009;
enum uint STARTDOC = 0x0000000a;
enum uint ENDDOC = 0x0000000b;
enum uint GETPHYSPAGESIZE = 0x0000000c;
enum uint GETPRINTINGOFFSET = 0x0000000d;
enum uint GETSCALINGFACTOR = 0x0000000e;
enum uint MFCOMMENT = 0x0000000f;
enum uint GETPENWIDTH = 0x00000010;
enum uint SETCOPYCOUNT = 0x00000011;
enum uint SELECTPAPERSOURCE = 0x00000012;
enum uint DEVICEDATA = 0x00000013;
...
enum uint SETMITERLIMIT = 0x00000017;
enum uint BANDINFO = 0x00000018;
enum uint DRAWPATTERNRECT = 0x00000019;
...
enum uint ENABLEDUPLEX = 0x0000001c;
...
enum uint ENUMPAPERBINS = 0x0000001f;
enum uint SETDIBSCALING = 0x00000020;
enum uint EPSPRINTING = 0x00000021;
enum uint ENUMPAPERMETRICS = 0x00000022;
enum uint GETSETPAPERMETRICS = 0x00000023;
...
enum uint MOUSETRAILS = 0x00000027;
enum uint GETDEVICEUNITS = 0x0000002a;
enum uint GETEXTENDEDTEXTMETRICS = 0x00000100;
enum uint GETEXTENTTABLE = 0x00000101;
enum uint GETPAIRKERNTABLE = 0x00000102;
enum uint GETTRACKKERNTABLE = 0x00000103;
enum uint EXTTEXTOUT = 0x00000200;
enum uint GETFACENAME = 0x00000201;
enum uint DOWNLOADFACE = 0x00000202;
enum uint ENABLERELATIVEWIDTHS = 0x00000300;
enum uint ENABLEPAIRKERNING = 0x00000301;
enum uint SETKERNTRACK = 0x00000302;
enum uint SETALLJUSTVALUES = 0x00000303;
enum uint SETCHARSET = 0x00000304;
enum uint STRETCHBLT = 0x00000800;
enum uint METAFILE_DRIVER = 0x00000801;
enum uint GETSETSCREENPARAMS = 0x00000c00;
enum uint QUERYDIBSUPPORT = 0x00000c01;
enum uint BEGIN_PATH = 0x00001000;
enum uint CLIP_TO_PATH = 0x00001001;
enum uint END_PATH = 0x00001002;
enum uint EXT_DEVICE_CAPS = 0x00001003;
enum uint RESTORE_CTM = 0x00001004;
enum uint SAVE_CTM = 0x00001005;
enum uint SET_ARC_DIRECTION = 0x00001006;
enum uint SET_BACKGROUND_COLOR = 0x00001007;
enum uint SET_POLY_MODE = 0x00001008;
enum uint SET_SCREEN_ANGLE = 0x00001009;
enum uint SET_SPREAD = 0x0000100a;
enum uint TRANSFORM_CTM = 0x0000100b;
enum uint SET_CLIP_BOX = 0x0000100c;
enum uint SET_BOUNDS = 0x0000100d;
enum uint SET_MIRROR_MODE = 0x0000100e;
enum uint OPENCHANNEL = 0x0000100e;
enum uint DOWNLOADHEADER = 0x0000100f;
enum uint CLOSECHANNEL = 0x00001010;
enum uint POSTSCRIPT_PASSTHROUGH = 0x00001013;
...
enum uint CHECKJPEGFORMAT = 0x00001017;
enum uint CHECKPNGFORMAT = 0x00001018;
enum uint GET_PS_FEATURESETTING = 0x00001019;
...
enum uint SPCLPASSTHROUGH2 = 0x000011d8;
...
enum uint PSINJECT_DLFONT = 0xdddddddd;
...
enum uint QDI_SETDIBITS = 0x00000001;
enum uint QDI_GETDIBITS = 0x00000002;
enum uint QDI_DIBTOSCREEN = 0x00000004;
enum uint QDI_STRETCHDIB = 0x00000008;
enum uint SP_NOTREPORTED = 0x00004000;
...
enum uint PR_JOBSTATUS = 0x00000000;
...
enum uint CM_OUT_OF_GAMUT = 0x000000ff;
...
enum uint LF_FACESIZE = 0x00000020;
enum uint LF_FULLFACESIZE = 0x00000040;
enum uint CLEARTYPE_NATURAL_QUALITY = 0x00000006;
...
enum uint PAN_FAMILYTYPE_INDEX = 0x00000000;
enum uint PAN_SERIFSTYLE_INDEX = 0x00000001;
enum uint PAN_PROPORTION_INDEX = 0x00000003;
enum uint PAN_STROKEVARIATION_INDEX = 0x00000005;
enum uint PAN_ARMSTYLE_INDEX = 0x00000006;
enum uint PAN_LETTERFORM_INDEX = 0x00000007;
enum uint PAN_CULTURE_LATIN = 0x00000000;
...
enum uint DT_CHARSTREAM = 0x00000004;
enum uint DT_METAFILE = 0x00000005;
enum uint DT_DISPFILE = 0x00000006;
...
enum uint CC_ELLIPSES = 0x00000008;
...
enum uint CC_WIDESTYLED = 0x00000040;
enum uint CC_INTERIORS = 0x00000080;
enum uint CC_ROUNDRECT = 0x00000100;
...
enum uint LC_MARKER = 0x00000004;
...
enum uint LC_WIDESTYLED = 0x00000040;
...
enum uint PC_RECTANGLE = 0x00000002;
enum uint PC_WINDPOLYGON = 0x00000004;
enum uint PC_TRAPEZOID = 0x00000004;
...
enum uint PC_WIDESTYLED = 0x00000040;
enum uint PC_INTERIORS = 0x00000080;
enum uint PC_POLYPOLYGON = 0x00000100;
...
enum uint RC_SCALING = 0x00000004;
...
enum uint RC_SAVEBITMAP = 0x00000040;
enum uint RC_DI_BITMAP = 0x00000080;
enum uint RC_PALETTE = 0x00000100;
enum uint RC_DIBTODEV = 0x00000200;
enum uint RC_BIGFONT = 0x00000400;
enum uint RC_STRETCHBLT = 0x00000800;
enum uint RC_FLOODFILL = 0x00001000;
enum uint RC_STRETCHDIB = 0x00002000;
enum uint RC_OP_DX_OUTPUT = 0x00004000;
...
enum uint SYSPAL_ERROR = 0x00000000;
enum int CBM_INIT = 0x00000004;
enum uint CCHFORMNAME = 0x00000020;
...
enum uint DMPAPER_A4_TRANSVERSE = 0x00000037;
...
enum uint DMPAPER_B5_TRANSVERSE = 0x0000003e;
...
enum uint DMPAPER_DBL_JAPANESE_POSTCARD = 0x00000045;
...
enum uint DMPAPER_JAPANESE_POSTCARD_ROTATED = 0x00000051;
...
enum uint DMICM_ABS_COLORIMETRIC = 0x00000004;
...
enum uint RDH_RECTANGLES = 0x00000001;
enum uint SYSRGN = 0x00000004;
enum uint TT_POLYGON_TYPE = 0x00000018;
...
enum uint GCPCLASS_NUMERICSEPARATOR = 0x00000008;
...
enum uint TT_AVAILABLE = 0x00000001;
enum uint TT_ENABLED = 0x00000002;
enum uint DC_BINADJUST = 0x00000013;
enum uint DC_EMF_COMPLIANT = 0x00000014;
enum uint DC_DATATYPE_PRODUCED = 0x00000015;
enum uint DC_MANUFACTURER = 0x00000017;
enum uint DC_MODEL = 0x00000018;
...
enum uint GDIREGISTERDDRAWPACKETVERSION = 0x00000001;
...
enum uint CA_LOG_FILTER = 0x00000002;
...
enum uint FONTMAPPER_MAX = 0x0000000a;
...
enum uint NEWTRANSPARENT = 0x00000003;
enum uint QUERYROPSUPPORT = 0x00000028;
enum uint SELECTDIB = 0x00000029;
...
enum uint TTFCFP_MS_PLATFORMID = 0x00000003;
...
enum uint ERR_GENERIC = 0x000003e8;
enum uint ERR_READOUTOFBOUNDS = 0x000003e9;
enum uint ERR_WRITEOUTOFBOUNDS = 0x000003ea;
enum uint ERR_READCONTROL = 0x000003eb;
enum uint ERR_WRITECONTROL = 0x000003ec;
...
enum uint ERR_WOULD_GROW = 0x000003ef;
enum uint ERR_VERSION = 0x000003f0;
enum uint ERR_NO_GLYPHS = 0x000003f1;
...
enum uint ERR_NOT_TTC = 0x000003f6;
...
enum uint TTEMBED_FAILIFVARIATIONSIMULATED = 0x00000010;
...
enum uint TTEMBED_VARIATIONSIMULATED = 0x00000001;
enum uint TTEMBED_EUDCEMBEDDED = 0x00000002;
enum uint TTEMBED_SUBSETCANCEL = 0x00000004;
...
enum uint TTDELETE_DONTREMOVEFONT = 0x00000001;
