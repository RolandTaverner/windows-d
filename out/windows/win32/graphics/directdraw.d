...
enum int DDSD_ZBUFFERBITDEPTH = 0x00000040;
enum int DDSD_ALPHABITDEPTH = 0x00000080;
enum int DDSD_LPSURFACE = 0x00000800;
...
enum int DDSD_MIPMAPCOUNT = 0x00020000;
enum int DDSD_REFRESHRATE = 0x00040000;
enum int DDSD_LINEARSIZE = 0x00080000;
...
enum int DDSCAPS_SYSTEMMEMORY = 0x00000800;
...
enum int DDSCAPS_STANDARDVGAMODE = 0x40000000;
...
enum int DDSCAPS2_MIPMAPSUBLEVEL = 0x00010000;
...
enum int DDSCAPS2_ENABLEALPHACHANNEL = 0x20000000;
enum int DDSCAPS2_EXTENDEDFORMATPRIMARY = 0x40000000;
enum int DDSCAPS2_ADDITIONALPRIMARY = 0x80000000;
...
enum int DDSCAPS3_READONLYRESOURCE = 0x00004000;
...
enum int DDCAPS2_CANDROPZ16BIT = 0x00000100;
...
enum int DDCAPS2_NOPAGELOCKREQUIRED = 0x00000800;
...
enum int DDCAPS2_TEXMANINNONLOCALVIDMEM = 0x01000000;
...
enum int DDCAPS2_DYNAMICTEXTURES = 0x20000000;
...
enum int DDSPD_IUNKNOWNPOINTER = 0x00000001;
...
enum int DDPF_RGBTOYUV = 0x00000100;
...
enum int DDPF_ALPHAPREMULT = 0x00008000;
...
enum int DDSDM_STANDARDVGAMODE = 0x00000001;
enum int DDEDM_REFRESHRATES = 0x00000001;
enum int DDEDM_STANDARDVGAMODES = 0x00000002;
enum int DDSCL_FULLSCREEN = 0x00000001;
enum int DDSCL_ALLOWREBOOT = 0x00000002;
...
enum int DDSCL_ALLOWMODEX = 0x00000040;
...
enum int DDSCL_CREATEDEVICEWINDOW = 0x00000200;
...
enum int DDBLT_PRESENTATION = 0x10000000;
...
enum int DDOVER_INTERLEAVED = 0x00800000;
enum int DDOVER_BOBHARDWARE = 0x01000000;
enum int DDOVER_ARGBSCALEFACTORS = 0x02000000;
...
enum int DDLOCK_SURFACEMEMORYPTR = 0x00000000;
...
enum int DDLOCK_DISCARDCONTENTS = 0x00002000;
...
enum int DDLOCK_NODIRTYUPDATE = 0x00010000;
...
enum int DDSGR_CALIBRATE = 0x00000001;
...
enum GUID GUID_VideoPortCaps = GUID("efd60cc3-49e7-11d0-889d-00aa00bbb76a");

enum : GUID
{
    GUID_D3DCallbacks2 = GUID("0ba584e1-70b6-11d0-889d-00aa00bbb76a"),
    GUID_D3DCallbacks3 = GUID("ddf41230-ec0a-11d0-a9b6-00aa00c0993e"),
}

enum GUID GUID_NonLocalVidMemCaps = GUID("86c4fa80-8d84-11d0-94e8-00c04fc34137");

enum : GUID
{
    GUID_KernelCallbacks = GUID("80863800-6b06-11d0-9b06-00a0c903a3b8"),
    GUID_KernelCaps      = GUID("ffaa7540-7aa8-11d0-9b06-00a0c903a3b8"),
}

enum GUID GUID_D3DExtendedCaps = GUID("7de41f80-9d93-11d0-89ab-00a0c9054129");
enum GUID GUID_ZPixelFormats = GUID("93869880-36cf-11d1-9b1b-00aa00bbb8ae");
enum GUID GUID_DDMoreSurfaceCaps = GUID("3b8a0466-f269-11d1-880b-00c04fd930c5");
enum GUID GUID_DDStereoMode = GUID("f828169c-a8e8-11d2-a1f2-00a0c983eaf6");

enum : GUID
{
    GUID_OptSurfaceKmodeInfo = GUID("e05c8472-51d4-11d1-8cce-00a0c90629a8"),
    GUID_OptSurfaceUmodeInfo = GUID("9d792804-5fa8-11d1-8cd0-00a0c90629a8"),
}

enum : GUID
{
    GUID_UserModeDriverInfo     = GUID("f0b0e8e2-5f97-11d1-8cd0-00a0c90629a8"),
    GUID_UserModeDriverPassword = GUID("97f861b6-60a1-11d1-8cd0-00a0c90629a8"),
}

enum GUID GUID_D3DParseUnknownCommandCallback = GUID("2e04ffa0-98e4-11d1-8ce1-00a0c90629a8");
enum GUID GUID_MotionCompCallbacks = GUID("b1122b40-5da5-11d1-8fcf-00c04fc29b4e");
enum GUID GUID_Miscellaneous2Callbacks = GUID("406b2f00-3e5a-11d1-b640-00aa00a1f96a");
enum int DDPF_NOVEL_TEXTURE_FORMAT = 0x00100000;
enum int DDPF_D3DFORMAT = 0x00200000;
...
enum int D3DFORMAT_OP_SAME_FORMAT_RENDERTARGET = 0x00000010;
...
enum int D3DFORMAT_OP_SAME_FORMAT_UP_TO_ALPHA_RENDERTARGET = 0x00000100;
...
enum : int
{
    D3DFORMAT_OP_SRGBWRITE            = 0x00100000,
...
enum int DDSCAPS3_VIDEO = 0x00000200;
...
enum : int
{
    DDHAL_PLEASEALLOC_BLOCKSIZE  = 0x00000002,
    DDHAL_PLEASEALLOC_LINEARSIZE = 0x00000003,
}

enum : int
{
    VIDMEM_ISLINEAR      = 0x00000001,
...
enum : int
{
    HEAPALIASINFO_MAPPEDREAL  = 0x00000001,
    HEAPALIASINFO_MAPPEDDUMMY = 0x00000002,
}

enum : int
{
    DDHAL_CB32_DESTROYDRIVER        = 0x00000001,
...
enum : int
{
    DDHAL_CB32_CANCREATESURFACE = 0x00000020,
...
enum : int
{
    DDHAL_PALCB32_DESTROYPALETTE = 0x00000001,
    DDHAL_PALCB32_SETENTRIES     = 0x00000002,
}

enum : int
{
    DDHAL_SURFCB32_DESTROYSURFACE     = 0x00000001,
...
enum : int
{
    DDHAL_MISCCB32_GETAVAILDRIVERMEMORY = 0x00000001,
...
enum : int
{
    DDHAL_MISC2CB32_CREATESURFACEEX = 0x00000002,
...
enum : int
{
    DDHAL_EXEBUFCB32_CANCREATEEXEBUF = 0x00000001,
...
enum : int
{
    DDHAL_VPORT32_CANCREATEVIDEOPORT = 0x00000001,
...
enum int DDHAL_COLOR_COLORCONTROL = 0x00000001;
...
enum : int
{
    DDHAL_DRIVER_NOTHANDLED = 0x00000000,
...
enum : int
{
    DDRAWISURFGBL_MEMFREE                 = 0x00000001,
...
enum : int
{
    DDRAWISURF_DATAISALIASED      = 0x00000040,
...
enum : int
{
    DDRAWISURF_HASPIXELFORMAT     = 0x00002000,
...
enum : int
{
    DDRAWISURF_DRIVERMANAGED = 0x40000000,
    DDRAWISURF_DCILOCK       = 0x80000000,
}

enum : int
{
    ROP_HAS_SOURCE  = 0x00000001,
    ROP_HAS_PATTERN = 0x00000002,
}
...
enum : int
{
    DDRAWILCL_CREATEDWINDOW     = 0x00000200,
...
enum : int
{
    DDRAWILCL_CURSORCLIPPED   = 0x00001000,
    DDRAWILCL_EXPLICITMONITOR = 0x00002000,
}

enum : int
{
    DDRAWILCL_MULTITHREADED       = 0x00004000,
...
enum : int
{
    DDRAWILCL_FPUPRESERVE = 0x00080000,
...
enum : int
{
    DDRAWI_NOHARDWARE  = 0x00000100,
    DDRAWI_PALETTEINIT = 0x00000200,
}

enum int DDRAWI_NOEMULATION = 0x00000400;
...
enum int DDRAWI_EMULATIONINITIALIZED = 0x00004000;
enum int DDRAWI_HASGDIPALETTE_EXCLUSIVE = 0x00008000;
enum int DDRAWI_MODEXILLEGAL = 0x00010000;
enum int DDRAWI_FLIPPEDTOGDI = 0x00020000;
enum int DDRAWI_NEEDSWIN16FORVRAMLOCK = 0x00040000;
enum int DDRAWI_PDEVICEVRAMBITCLEARED = 0x00080000;
enum int DDRAWI_STANDARDVGA = 0x00100000;
enum int DDRAWI_EXTENDEDALIGNMENT = 0x00200000;
enum int DDRAWI_CHANGINGMODE = 0x00400000;
...
enum int DDRAWI_UMODELOADED = 0x02000000;
enum int DDRAWI_DDRAWDATANOTFETCHED = 0x04000000;
enum int DDRAWI_SECONDARYDRIVERLOADED = 0x08000000;
enum int DDRAWI_TESTINGMODES = 0x10000000;
enum int DDRAWI_DRIVERINFO2 = 0x20000000;
...
enum int DDWAITVB_I_TESTVB = 0x80000006;
...
enum : GUID
{
    GUID_D3DCaps      = GUID("7bf06991-8794-11d0-9139-080036d2ef02"),
    GUID_D3DCallbacks = GUID("7bf06990-8794-11d0-9139-080036d2ef02"),
}

enum GUID GUID_DDMoreCaps = GUID("880baf30-b030-11d0-8ea7-00609797ea5b");
enum GUID GUID_NTCallbacks = GUID("6fe9ecde-df89-11d1-9db0-0060082771ba");
enum GUID GUID_GetHeapAlignment = GUID("42e02f16-7b41-11d2-8bff-00a0c983eaf6");
enum GUID GUID_UpdateNonLocalHeap = GUID("42e02f17-7b41-11d2-8bff-00a0c983eaf6");
enum GUID GUID_NTPrivateDriverCaps = GUID("fad16a23-7b66-11d2-83d7-00c04f7ce58c");
enum GUID GUID_VPE2Callbacks = GUID("52882147-2d47-469a-a0d1-03455890f6c8");
enum int DDSCAPS_COMMANDBUFFER = 0x00000400;
enum int DDHAL_PLEASEALLOC_USERMEM = 0x00000004;
enum int DDHAL_CB32_MAPMEMORY = 0x80000000;
enum int DDHAL_MISC2CB32_ALPHABLT = 0x00000001;
enum int DDHAL_CREATESURFACEEX_SWAPHANDLES = 0x00000001;

enum : int
{
    DDHAL_NTCB32_FREEDRIVERMEMORY = 0x00000001,
    DDHAL_NTCB32_SETEXCLUSIVEMODE = 0x00000002,
    DDHAL_NTCB32_FLIPTOGDISURFACE = 0x00000004,
}

enum int DDHAL_VPORT32_GETAUTOFLIPSURF = 0x00000040;
...
enum : int
{
    DDKERNELCAPS_FIELDPOLARITY    = 0x00000100,
    DDKERNELCAPS_CAPTURE_INVERTED = 0x00000200,
}

enum int DDIRQ_DISPLAY_VSYNC = 0x00000001;
enum int DDIRQ_RESERVED1 = 0x00000002;

enum : int
{
    DDIRQ_VPORT0_VSYNC = 0x00000004,
...
enum int SURFACEALIGN_DISCARDABLE = 0x00000001;
...
enum int DDVPD_FILTERQUALITY = 0x00000100;
...
enum : int
{
    DDVPCAPS_SYSTEMMEMORY           = 0x00001000,
    DDVPCAPS_VBIANDVIDEOINDEPENDENT = 0x00002000,
}

enum int DDVPCAPS_HARDWAREDEINTERLACE = 0x00004000;
...
enum : int
{
    DDVPFX_VBICONVERT     = 0x00010000,
    DDVPFX_VBINOSCALE     = 0x00020000,
    DDVPFX_IGNOREVBIXCROP = 0x00040000,
}

enum int DDVPFX_VBINOINTERLEAVE = 0x00080000;
enum int DDVP_AUTOFLIP = 0x00000001;

enum : int
{
    DDVP_CONVERT    = 0x00000002,
...
enum : int
{
    DDVP_MIRRORLEFTRIGHT = 0x00000010,
    DDVP_MIRRORUPDOWN    = 0x00000020,
}

enum int DDVP_PRESCALE = 0x00000040;
...
enum int DDVP_SYNCMASTER = 0x00000200;
...
enum int DDVP_OVERRIDEBOBWEAVE = 0x00001000;
enum int DDVP_IGNOREVBIXCROP = 0x00002000;
enum int DDVP_VBINOINTERLEAVE = 0x00004000;
enum int DDVP_HARDWAREDEINTERLACE = 0x00008000;

enum : int
{
    DDVPFORMAT_VIDEO = 0x00000001,
    DDVPFORMAT_VBI   = 0x00000002,
}

enum : int
{
    DDVPTARGET_VIDEO = 0x00000001,
    DDVPTARGET_VBI   = 0x00000002,
}

enum : int
{
    DDVPWAIT_BEGIN = 0x00000001,
...
enum : int
{
    DDVPFLIP_VIDEO = 0x00000001,
    DDVPFLIP_VBI   = 0x00000002,
}

enum : int
{
    DDVPSQ_NOSIGNAL = 0x00000001,
    DDVPSQ_SIGNALOK = 0x00000002,
}

enum int DDVPB_VIDEOPORT = 0x00000001;
...
enum : int
{
    DDVPCREATE_VBIONLY   = 0x00000001,
    DDVPCREATE_VIDEOONLY = 0x00000002,
}

enum : int
{
    DDVPSTATUS_VBIONLY   = 0x00000001,
    DDVPSTATUS_VIDEOONLY = 0x00000002,
}
