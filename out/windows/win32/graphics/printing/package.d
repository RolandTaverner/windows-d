...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/printdocs/mxdc-escape
enum uint MXDC_ESCAPE = 0x0000101aU;
...
struct PRINTER_NOTIFY_INFO
{
    ...
    uint Flags;
    uint Count;
    PRINTER_NOTIFY_INFO_DATA[1] aData; // Flexible array
}
...
struct BIDI_REQUEST_CONTAINER
{
    ...
    uint                 Flags;
    uint                 Count;
    BIDI_REQUEST_DATA[1] aData; // Flexible array
}
...
struct BIDI_RESPONSE_CONTAINER
{
    ...
    uint Flags;
    uint Count;
    BIDI_RESPONSE_DATA[1] aData; // Flexible array
}
...
align (1):
    uint     cbOutput;
    wchar[1] wszData; // Flexible array
}
...
struct DOCEVENT_FILTER
{
    ...
    uint[1] aDocEventCall; // Flexible array
}
...
struct WIDTHTABLE
{
    uint        dwSize;
    uint        dwRunNum;
    WIDTHRUN[1] WidthRun; // Flexible array
}
...
struct KERNDATA
{
    uint              dwSize;
    uint              dwKernPairNum;
    FD_KERNINGPAIR[1] KernPair; // Flexible array
}
...
struct MAPTABLE
{
    uint         dwSize;
    uint         dwGlyphNum;
    TRANSDATA[1] Trans; // Flexible array
}
...
struct PORT_DATA_LIST_1
{
    uint           dwVersion;
    uint           cPortData;
    PORT_DATA_2[1] pPortData; // Flexible array
}
...
struct BranchOfficeJobDataContainer
{
    ...
    BranchOfficeJobData[1] JobData; // Flexible array
}
