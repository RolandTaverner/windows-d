...
enum const(wchar)* DXC_ARG_AVOID_FLOW_CONTROL = "-Gfa";
...
enum const(wchar)* DXC_ARG_IEEE_STRICTNESS = "-Gis";
...
enum const(wchar)* DXC_ARG_WARNINGS_ARE_ERRORS = "-WX";
enum const(wchar)* DXC_ARG_RESOURCES_MAY_ALIAS = "-res_may_alias";
enum const(wchar)* DXC_ARG_ALL_RESOURCES_BOUND = "-all_resources_bound";
...
enum : GUID
{
    CLSID_DxcCompiler            = GUID("73e22d93-e6ce-47f3-b5bf-f0664f39c1b0"),
    CLSID_DxcLinker              = GUID("ef6a8087-b0ea-4d56-9e45-d07e1a8b7806"),
    CLSID_DxcDiaDataSource       = GUID("cd1f6b73-2ab0-484d-8edc-ebe7a43ca09f"),
    CLSID_DxcCompilerArgs        = GUID("3e56ae82-224d-470f-a1a1-fe3016ee9f9d"),
    CLSID_DxcLibrary             = GUID("6245d6af-66e0-48fd-80b4-4d271796748c"),
    CLSID_DxcValidator           = GUID("8ca3e215-f728-4cf3-8cdd-88af917587a1"),
    CLSID_DxcAssembler           = GUID("d728db68-f903-4f80-94cd-dccf76ec7151"),
    CLSID_DxcContainerReflection = GUID("b9f54489-55b8-400c-ba3a-1675e4728b91"),
}

enum : GUID
{
    CLSID_DxcOptimizer        = GUID("ae2cd79f-cc22-453f-9b6b-b124e7a5204c"),
    CLSID_DxcContainerBuilder = GUID("94134294-411f-4574-b4d0-8741e25240d2"),
}

enum GUID CLSID_DxcPdbUtils = GUID("54621dfb-f2ce-457e-ae8c-ec355faeec7c");
