...
public import windows.win32.foundation : BOOL, BSTR, FILETIME, HANDLE, HINSTANCE,
                                         HRESULT, HWND, LPARAM, LUID, POINT, PSTR,
                                         PWSTR, RECT, SIZE, VARIANT_BOOL, WPARAM;
...
public import windows.win32.system.com : BINDINFO, IBindCtx, IBindStatusCallback,
...
enum uint DISPID_BEFORENAVIGATE = 0x00000064;
enum uint DISPID_NAVIGATECOMPLETE = 0x00000065;
enum uint DISPID_STATUSTEXTCHANGE = 0x00000066;

enum : uint
{
    DISPID_QUIT             = 0x00000067,
    DISPID_DOWNLOADCOMPLETE = 0x00000068,
}

enum uint DISPID_COMMANDSTATECHANGE = 0x00000069;
enum uint DISPID_DOWNLOADBEGIN = 0x0000006a;

enum : uint
{
    DISPID_NEWWINDOW      = 0x0000006b,
    DISPID_PROGRESSCHANGE = 0x0000006c,
}

enum : uint
{
    DISPID_WINDOWMOVE     = 0x0000006d,
    DISPID_WINDOWRESIZE   = 0x0000006e,
    DISPID_WINDOWACTIVATE = 0x0000006f,
}

enum uint DISPID_PROPERTYCHANGE = 0x00000070;

enum : uint
{
    DISPID_TITLECHANGE     = 0x00000071,
    DISPID_TITLEICONCHANGE = 0x00000072,
}

enum : uint
{
    DISPID_FRAMEBEFORENAVIGATE   = 0x000000c8,
    DISPID_FRAMENAVIGATECOMPLETE = 0x000000c9,
    DISPID_FRAMENEWWINDOW        = 0x000000cc,
}

enum uint DISPID_BEFORENAVIGATE2 = 0x000000fa;

enum : uint
{
    DISPID_NEWWINDOW2        = 0x000000fb,
    DISPID_NAVIGATECOMPLETE2 = 0x000000fc,
}

enum : uint
{
    DISPID_ONQUIT       = 0x000000fd,
    DISPID_ONVISIBLE    = 0x000000fe,
    DISPID_ONTOOLBAR    = 0x000000ff,
    DISPID_ONMENUBAR    = 0x00000100,
    DISPID_ONSTATUSBAR  = 0x00000101,
    DISPID_ONFULLSCREEN = 0x00000102,
}

enum uint DISPID_DOCUMENTCOMPLETE = 0x00000103;

enum : uint
{
    DISPID_ONTHEATERMODE = 0x00000104,
    DISPID_ONADDRESSBAR  = 0x00000105,
}

enum : uint
{
    DISPID_WINDOWSETRESIZABLE = 0x00000106,
    DISPID_WINDOWCLOSING      = 0x00000107,
    DISPID_WINDOWSETLEFT      = 0x00000108,
    DISPID_WINDOWSETTOP       = 0x00000109,
    DISPID_WINDOWSETWIDTH     = 0x0000010a,
    DISPID_WINDOWSETHEIGHT    = 0x0000010b,
}

enum uint DISPID_CLIENTTOHOSTWINDOW = 0x0000010c;
enum uint DISPID_SETSECURELOCKICON = 0x0000010d;
enum uint DISPID_FILEDOWNLOAD = 0x0000010e;
enum uint DISPID_NAVIGATEERROR = 0x0000010f;
enum uint DISPID_PRIVACYIMPACTEDSTATECHANGE = 0x00000110;

enum : uint
{
    DISPID_NEWWINDOW3              = 0x00000111,
    DISPID_VIEWUPDATE              = 0x00000119,
    DISPID_SETPHISHINGFILTERSTATUS = 0x0000011a,
}

enum uint DISPID_WINDOWSTATECHANGED = 0x0000011b;

enum : uint
{
    DISPID_NEWPROCESS           = 0x0000011c,
    DISPID_THIRDPARTYURLBLOCKED = 0x0000011d,
}

enum uint DISPID_REDIRECTXDOMAINBLOCKED = 0x0000011e;

enum : uint
{
    DISPID_WEBWORKERSTARTED  = 0x00000120,
    DISPID_WEBWORKERFINISHED = 0x00000121,
}

enum uint DISPID_BEFORESCRIPTEXECUTE = 0x00000122;

enum : uint
{
    DISPID_PRINTTEMPLATEINSTANTIATION = 0x000000e1,
    DISPID_PRINTTEMPLATETEARDOWN      = 0x000000e2,
}

enum uint DISPID_UPDATEPAGESTATUS = 0x000000e3;

enum : uint
{
    DISPID_WINDOWREGISTERED = 0x000000c8,
    DISPID_WINDOWREVOKED    = 0x000000c9,
}

enum : uint
{
    DISPID_RESETFIRSTBOOTMODE    = 0x00000001,
    DISPID_RESETSAFEMODE         = 0x00000002,
    DISPID_REFRESHOFFLINEDESKTOP = 0x00000003,
}

enum : uint
{
    DISPID_ADDFAVORITE         = 0x00000004,
    DISPID_ADDCHANNEL          = 0x00000005,
    DISPID_ADDDESKTOPCOMPONENT = 0x00000006,
}

enum uint DISPID_ISSUBSCRIBED = 0x00000007;
enum uint DISPID_NAVIGATEANDFIND = 0x00000008;
enum uint DISPID_IMPORTEXPORTFAVORITES = 0x00000009;

enum : uint
{
    DISPID_AUTOCOMPLETESAVEFORM = 0x0000000a,
    DISPID_AUTOSCAN             = 0x0000000b,
    DISPID_AUTOCOMPLETEATTACH   = 0x0000000c,
}

enum uint DISPID_SHOWBROWSERUI = 0x0000000d;
enum uint DISPID_ADDSEARCHPROVIDER = 0x0000000e;
enum uint DISPID_RUNONCESHOWN = 0x0000000f;
enum uint DISPID_SKIPRUNONCE = 0x00000010;
enum uint DISPID_CUSTOMIZESETTINGS = 0x00000011;

enum : uint
{
    DISPID_SQMENABLED      = 0x00000012,
    DISPID_PHISHINGENABLED = 0x00000013,
}

enum uint DISPID_BRANDIMAGEURI = 0x00000014;
enum uint DISPID_SKIPTABSWELCOME = 0x00000015;
enum uint DISPID_DIAGNOSECONNECTION = 0x00000016;
enum uint DISPID_CUSTOMIZECLEARTYPE = 0x00000017;

enum : uint
{
    DISPID_ISSEARCHPROVIDERINSTALLED = 0x00000018,
    DISPID_ISSEARCHMIGRATED          = 0x00000019,
}

enum uint DISPID_DEFAULTSEARCHPROVIDER = 0x0000001a;
enum uint DISPID_RUNONCEREQUIREDSETTINGSCOMPLETE = 0x0000001b;
enum uint DISPID_RUNONCEHASSHOWN = 0x0000001c;
enum uint DISPID_SEARCHGUIDEURL = 0x0000001d;

enum : uint
{
    DISPID_ADDSERVICE         = 0x0000001e,
    DISPID_ISSERVICEINSTALLED = 0x0000001f,
}

enum uint DISPID_ADDTOFAVORITESBAR = 0x00000020;
enum uint DISPID_BUILDNEWTABPAGE = 0x00000021;
enum uint DISPID_SETRECENTLYCLOSEDVISIBLE = 0x00000022;
enum uint DISPID_SETACTIVITIESVISIBLE = 0x00000023;
enum uint DISPID_CONTENTDISCOVERYRESET = 0x00000024;
enum uint DISPID_INPRIVATEFILTERINGENABLED = 0x00000025;
enum uint DISPID_SUGGESTEDSITESENABLED = 0x00000026;
enum uint DISPID_ENABLESUGGESTEDSITES = 0x00000027;
enum uint DISPID_NAVIGATETOSUGGESTEDSITES = 0x00000028;

enum : uint
{
    DISPID_SHOWTABSHELP      = 0x00000029,
    DISPID_SHOWINPRIVATEHELP = 0x0000002a,
}

enum : uint
{
    DISPID_ISSITEMODE             = 0x0000002b,
    DISPID_SETSITEMODEICONOVERLAY = 0x0000002c,
}

enum uint DISPID_CLEARSITEMODEICONOVERLAY = 0x0000002d;
enum uint DISPID_UPDATETHUMBNAILBUTTON = 0x0000002e;
enum uint DISPID_SETTHUMBNAILBUTTONS = 0x0000002f;
enum uint DISPID_ADDTHUMBNAILBUTTONS = 0x00000030;
enum uint DISPID_ADDSITEMODE = 0x00000031;
enum uint DISPID_SETSITEMODEPROPERTIES = 0x00000032;

enum : uint
{
    DISPID_SITEMODECREATEJUMPLIST  = 0x00000033,
    DISPID_SITEMODEADDJUMPLISTITEM = 0x00000034,
    DISPID_SITEMODECLEARJUMPLIST   = 0x00000035,
    DISPID_SITEMODEADDBUTTONSTYLE  = 0x00000036,
    DISPID_SITEMODESHOWBUTTONSTYLE = 0x00000037,
    DISPID_SITEMODESHOWJUMPLIST    = 0x00000038,
}

enum uint DISPID_ADDTRACKINGPROTECTIONLIST = 0x00000039;
enum uint DISPID_SITEMODEACTIVATE = 0x0000003a;
enum uint DISPID_ISSITEMODEFIRSTRUN = 0x0000003b;
enum uint DISPID_TRACKINGPROTECTIONENABLED = 0x0000003c;
enum uint DISPID_ACTIVEXFILTERINGENABLED = 0x0000003d;
enum uint DISPID_PROVISIONNETWORKS = 0x0000003e;
enum uint DISPID_REPORTSAFEURL = 0x0000003f;

enum : uint
{
    DISPID_SITEMODEREFRESHBADGE = 0x00000040,
    DISPID_SITEMODECLEARBADGE   = 0x00000041,
}

enum uint DISPID_DIAGNOSECONNECTIONUILESS = 0x00000042;
enum uint DISPID_LAUNCHNETWORKCLIENTHELP = 0x00000043;
enum uint DISPID_CHANGEDEFAULTBROWSER = 0x00000044;
enum uint DISPID_STOPPERIODICUPDATE = 0x00000045;
enum uint DISPID_STARTPERIODICUPDATE = 0x00000046;
enum uint DISPID_CLEARNOTIFICATION = 0x00000047;
enum uint DISPID_ENABLENOTIFICATIONQUEUE = 0x00000048;
enum uint DISPID_PINNEDSITESTATE = 0x00000049;
enum uint DISPID_LAUNCHINTERNETOPTIONS = 0x0000004a;
enum uint DISPID_STARTPERIODICUPDATEBATCH = 0x0000004b;

enum : uint
{
    DISPID_ENABLENOTIFICATIONQUEUESQUARE = 0x0000004c,
    DISPID_ENABLENOTIFICATIONQUEUEWIDE   = 0x0000004d,
    DISPID_ENABLENOTIFICATIONQUEUELARGE  = 0x0000004e,
}

enum uint DISPID_SCHEDULEDTILENOTIFICATION = 0x0000004f;
enum uint DISPID_REMOVESCHEDULEDTILENOTIFICATION = 0x00000050;
enum uint DISPID_STARTBADGEUPDATE = 0x00000051;
enum uint DISPID_STOPBADGEUPDATE = 0x00000052;
enum uint DISPID_ISMETAREFERRERAVAILABLE = 0x00000053;
enum uint DISPID_SETEXPERIMENTALFLAG = 0x00000054;
enum uint DISPID_GETEXPERIMENTALFLAG = 0x00000055;
enum uint DISPID_SETEXPERIMENTALVALUE = 0x00000056;
enum uint DISPID_GETEXPERIMENTALVALUE = 0x00000057;
enum uint DISPID_HASNEEDIEAUTOLAUNCHFLAG = 0x00000058;
enum uint DISPID_GETNEEDIEAUTOLAUNCHFLAG = 0x00000059;
enum uint DISPID_SETNEEDIEAUTOLAUNCHFLAG = 0x0000005a;

enum : uint
{
    DISPID_LAUNCHIE               = 0x0000005b,
    DISPID_RESETEXPERIMENTALFLAGS = 0x0000005c,
}

enum : uint
{
    DISPID_GETCVLISTDATA      = 0x0000005d,
    DISPID_GETCVLISTLOCALDATA = 0x0000005e,
}

enum : uint
{
    DISPID_GETEMIELISTDATA      = 0x0000005f,
    DISPID_GETEMIELISTLOCALDATA = 0x00000060,
}

enum : uint
{
    DISPID_OPENFAVORITESPANE     = 0x00000061,
    DISPID_OPENFAVORITESSETTINGS = 0x00000062,
}

enum uint DISPID_LAUNCHINHVSI = 0x00000063;
enum uint DISPID_GETNEEDHVSIAUTOLAUNCHFLAG = 0x00000064;
enum uint DISPID_SETNEEDHVSIAUTOLAUNCHFLAG = 0x00000065;
enum uint DISPID_HASNEEDHVSIAUTOLAUNCHFLAG = 0x00000066;

enum : uint
{
    DISPID_GETOSSKU      = 0x00000067,
    DISPID_SETMSDEFAULTS = 0x00000068,
}

enum uint DISPID_SHELLUIHELPERLAST = 0x00000069;
enum uint DISPID_ADVANCEERROR = 0x0000000a;
enum uint DISPID_RETREATERROR = 0x0000000b;

enum : uint
{
    DISPID_CANADVANCEERROR = 0x0000000c,
    DISPID_CANRETREATERROR = 0x0000000d,
}

enum : uint
{
    DISPID_GETERRORLINE    = 0x0000000e,
    DISPID_GETERRORCHAR    = 0x0000000f,
    DISPID_GETERRORCODE    = 0x00000010,
    DISPID_GETERRORMSG     = 0x00000011,
    DISPID_GETERRORURL     = 0x00000012,
    DISPID_GETDETAILSSTATE = 0x00000013,
}

enum uint DISPID_SETDETAILSSTATE = 0x00000014;
enum uint DISPID_GETPERERRSTATE = 0x00000015;
enum uint DISPID_SETPERERRSTATE = 0x00000016;
enum uint DISPID_GETALWAYSSHOWLOCKSTATE = 0x00000017;
enum uint DISPID_FAVSELECTIONCHANGE = 0x00000001;
enum uint DISPID_SELECTIONCHANGE = 0x00000002;
enum uint DISPID_DOUBLECLICK = 0x00000003;
enum uint DISPID_INITIALIZED = 0x00000004;

enum : uint
{
    DISPID_MOVESELECTIONUP   = 0x00000001,
    DISPID_MOVESELECTIONDOWN = 0x00000002,
}

enum : uint
{
    DISPID_RESETSORT   = 0x00000003,
    DISPID_NEWFOLDER   = 0x00000004,
    DISPID_SYNCHRONIZE = 0x00000005,
}

enum : uint
{
    DISPID_IMPORT            = 0x00000006,
    DISPID_EXPORT            = 0x00000007,
    DISPID_INVOKECONTEXTMENU = 0x00000008,
}

enum uint DISPID_MOVESELECTIONTO = 0x00000009;
enum uint DISPID_SUBSCRIPTIONSENABLED = 0x0000000a;
enum uint DISPID_CREATESUBSCRIPTION = 0x0000000b;
enum uint DISPID_DELETESUBSCRIPTION = 0x0000000c;

enum : uint
{
    DISPID_SETROOT     = 0x0000000d,
    DISPID_ENUMOPTIONS = 0x0000000e,
}

enum uint DISPID_SELECTEDITEM = 0x0000000f;

enum : uint
{
    DISPID_ROOT           = 0x00000010,
    DISPID_DEPTH          = 0x00000011,
    DISPID_MODE           = 0x00000012,
    DISPID_FLAGS          = 0x00000013,
    DISPID_TVFLAGS        = 0x00000014,
    DISPID_NSCOLUMNS      = 0x00000015,
    DISPID_COUNTVIEWTYPES = 0x00000016,
}

enum : uint
{
    DISPID_SETVIEWTYPE   = 0x00000017,
    DISPID_SELECTEDITEMS = 0x00000018,
}

enum : uint
{
    DISPID_EXPAND      = 0x00000019,
    DISPID_UNSELECTALL = 0x0000001a,
}

enum uint TF_NAVIGATE = 0x7faeabac;
...
enum uint REGSTR_VAL_SMOOTHSCROLL_DEF = 0x00000001;
...
enum uint REGSTR_VAL_USEICM_DEF = 0x00000000;
...
enum uint MAX_SEARCH_FORMAT_STRING = 0x000000ff;
...
enum uint REGSTR_VAL_JAVAJIT_DEF = 0x00000000;
enum const(wchar)* REGSTR_VAL_JAVALOGGING = "EnableLogging";
enum uint REGSTR_VAL_JAVALOGGING_DEF = 0x00000000;
...
enum uint REGSTR_VAL_VISIBLEBANDS_DEF = 0x00000007;
enum uint TOOLSBAND = 0x00000001;
enum uint ADDRESSBAND = 0x00000002;
enum uint LINKSBAND = 0x00000004;
...
enum uint REGSTR_VAL_SCHANNELENABLEPROTOCOL_DEF = 0x00000001;
...
enum uint REGSTR_VAL_FONT_SIZE_DEF = 0x00000002;
...
enum uint IECMDID_CLEAR_AUTOCOMPLETE_FOR_FORMS = 0x00000000;
enum uint IECMDID_SETID_AUTOCOMPLETE_FOR_FORMS = 0x00000001;

enum : uint
{
    IECMDID_BEFORENAVIGATE_GETSHELLBROWSE   = 0x00000002,
    IECMDID_BEFORENAVIGATE_DOEXTERNALBROWSE = 0x00000003,
    IECMDID_BEFORENAVIGATE_GETIDLIST        = 0x00000004,
}

enum uint IECMDID_SET_INVOKE_DEFAULT_BROWSER_ON_NEW_WINDOW = 0x00000005;
enum uint IECMDID_GET_INVOKE_DEFAULT_BROWSER_ON_NEW_WINDOW = 0x00000006;

enum : uint
{
    IECMDID_ARG_CLEAR_FORMS_ALL               = 0x00000000,
    IECMDID_ARG_CLEAR_FORMS_ALL_BUT_PASSWORDS = 0x00000001,
    IECMDID_ARG_CLEAR_FORMS_PASSWORDS_ONLY    = 0x00000002,
}
...
enum : uint
{
    msoedmEnable   = 0x00000001,
    msoedmDisable  = 0x00000002,
    msoedmDontOpen = 0x00000003,
}

enum uint msoslUndefined = 0x00000000;

enum : uint
{
    msoslNone   = 0x00000001,
    msoslMedium = 0x00000002,
    msoslHigh   = 0x00000003,
}

enum : uint
{
    msodsvNoMacros      = 0x00000000,
    msodsvUnsigned      = 0x00000001,
    msodsvPassedTrusted = 0x00000002,
}

enum : uint
{
    msodsvFailed           = 0x00000003,
    msodsvLowSecurityLevel = 0x00000004,
}

enum uint msodsvPassedTrustedCert = 0x00000005;
...
enum : uint
{
    SURFACE_LOCK_EXCLUSIVE     = 0x00000001,
    SURFACE_LOCK_ALLOW_DISCARD = 0x00000002,
    SURFACE_LOCK_WAIT          = 0x00000004,
}
...
enum uint COLOR_NO_TRANSPARENT = 0xffffffff;

enum : uint
{
    IMGDECODE_EVENT_PROGRESS     = 0x00000001,
    IMGDECODE_EVENT_PALETTE      = 0x00000002,
    IMGDECODE_EVENT_BEGINBITS    = 0x00000004,
    IMGDECODE_EVENT_BITSCOMPLETE = 0x00000008,
    IMGDECODE_EVENT_USEDDRAW     = 0x00000010,
    IMGDECODE_HINT_TOPDOWN       = 0x00000001,
    IMGDECODE_HINT_BOTTOMUP      = 0x00000002,
    IMGDECODE_HINT_FULLWIDTH     = 0x00000004,
}

enum : uint
{
    MAPMIME_DEFAULT        = 0x00000000,
    MAPMIME_CLSID          = 0x00000001,
    MAPMIME_DISABLE        = 0x00000002,
    MAPMIME_DEFAULT_ALWAYS = 0x00000003,
}

enum : uint
{
    TIMERMODE_NORMAL          = 0x00000000,
    TIMERMODE_VISIBILITYAWARE = 0x00000001,
}
