...
enum uint XHR_PROP_ONDATA_ALWAYS = 0x00000000;
...
enum : uint
{
    DISPID_XMLNOTIFSINK            = 0x0001012c,
    DISPID_XMLNOTIFSINK_CHILDADDED = 0x0001012d,
}

enum : uint
{
    DISPID_XMLATTRIBUTE       = 0x00010190,
...
enum : uint
{
    DISPID_DOM_DOCUMENT                             = 0x00000025,
...
enum : uint
{
    DISPID_XMLDOM_DOCUMENT                    = 0x00000034,
...
enum : uint
{
    DISPID_DOM_NODELIST        = 0x00000048,
...
enum : uint
{
    DISPID_XMLDOM_NODELIST          = 0x0000004b,
...
enum : uint
{
    DISPID_DOM_NAMEDNODEMAP                 = 0x00000050,
...
enum : uint
{
    DISPID_XMLDOM_NAMEDNODEMAP                     = 0x00000056,
...
enum : uint
{
    DISPID_DOM_W3CWRAPPERS           = 0x0000005d,
...
enum : uint
{
    DISPID_DOM_NOTATION                  = 0x00000087,
...
enum uint DISPID_XMLDOMEVENT = 0x000000c5;
enum int DISPID_XMLDOMEVENT_ONREADYSTATECHANGE = 0xfffffd9f;

enum : uint
{
    DISPID_XMLDOMEVENT_ONDATAAVAILABLE           = 0x000000c6,
...
enum : uint
{
    DISPID_SAX_XMLREADER__MIN               = 0x00000501,
...
enum : uint
{
    DISPID_SAX_CONTENTHANDLER__BASE                 = 0x00000529,
...
enum : uint
{
    DISPID_SAX_DTDHANDLER__BASE              = 0x00000536,
...
enum : uint
{
    DISPID_SAX_ATTRIBUTES__BASE             = 0x0000053f,
...
enum : uint
{
    DISPID_SAX_DECLHANDLER__BASE              = 0x00000556,
...
enum : uint
{
    DISPID_MX_ATTRIBUTES__BASE                 = 0x0000055c,
...
enum : uint
{
    DISPID_MX_WRITER__BASE                 = 0x00000568,
...
enum : uint
{
    DISPID_MX_SCHEMADECLHANDLER__BASE             = 0x0000057a,
...
enum : uint
{
    DISPID_MX_NSMGR__BASE               = 0x0000057d,
...
enum : uint
{
    DISPID_SOM_EXCLUSIONS                  = 0x000005c0,
...
enum : uint
{
    DISPID_XMLDSIG_SETREFERENCEDATA = 0x00000006,
