...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/ne-msxml6-xhr_cookie_state
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/ne-msxml6-xhr_cookie_flag
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/ne-msxml6-xhr_cred_prompt
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/ne-msxml6-xhr_auth
alias XHR_AUTH = int;
enum : int
{
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/ne-msxml6-xhr_property
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/ne-msxml6-xhr_cert_ignore_flag
alias XHR_CERT_IGNORE_FLAG = uint;
enum : uint
{
    XHR_CERT_IGNORE_REVOCATION_FAILED = 0x00000080U,
    XHR_CERT_IGNORE_UNKNOWN_CA        = 0x00000100U,
    XHR_CERT_IGNORE_CERT_CN_INVALID   = 0x00001000U,
    XHR_CERT_IGNORE_CERT_DATE_INVALID = 0x00002000U,
    XHR_CERT_IGNORE_ALL_SERVER_ERRORS = 0x00003180U,
}

// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/ne-msxml6-xhr_cert_error_flag
alias XHR_CERT_ERROR_FLAG = uint;
enum : uint
{
    XHR_CERT_ERROR_REVOCATION_FAILED = 0x00800000U,
    XHR_CERT_ERROR_UNKNOWN_CA        = 0x01000000U,
    XHR_CERT_ERROR_CERT_CN_INVALID   = 0x02000000U,
    XHR_CERT_ERROR_CERT_DATE_INVALID = 0x04000000U,
    XHR_CERT_ERROR_ALL_SERVER_ERRORS = 0x07800000U,
}
...
enum uint XHR_PROP_ONDATA_ALWAYS = 0x00000000U;
enum ulong XHR_PROP_ONDATA_NEVER = 0xffffffffffffffffUL;

enum : uint
{
    DISPID_XOBJ_MIN                    = 0x00010000U,
    DISPID_XOBJ_MAX                    = 0x0001ffffU,
    DISPID_XOBJ_BASE                   = 0x00010000U,
    DISPID_XMLELEMENTCOLLECTION        = 0x00010000U,
    DISPID_XMLELEMENTCOLLECTION_LENGTH = 0x00010001U,
}

enum int DISPID_XMLELEMENTCOLLECTION_NEWENUM = 0xfffffffc;
enum uint DISPID_XMLELEMENTCOLLECTION_ITEM = 0x00010003U;

enum : uint
{
    DISPID_XMLDOCUMENT                  = 0x00010064U,
    DISPID_XMLDOCUMENT_ROOT             = 0x00010065U,
    DISPID_XMLDOCUMENT_FILESIZE         = 0x00010066U,
    DISPID_XMLDOCUMENT_FILEMODIFIEDDATE = 0x00010067U,
    DISPID_XMLDOCUMENT_FILEUPDATEDDATE  = 0x00010068U,
    DISPID_XMLDOCUMENT_URL              = 0x00010069U,
    DISPID_XMLDOCUMENT_MIMETYPE         = 0x0001006aU,
    DISPID_XMLDOCUMENT_READYSTATE       = 0x0001006bU,
    DISPID_XMLDOCUMENT_CREATEELEMENT    = 0x0001006cU,
    DISPID_XMLDOCUMENT_CHARSET          = 0x0001006dU,
    DISPID_XMLDOCUMENT_VERSION          = 0x0001006eU,
    DISPID_XMLDOCUMENT_DOCTYPE          = 0x0001006fU,
    DISPID_XMLDOCUMENT_DTDURL           = 0x00010070U,
    DISPID_XMLDOCUMENT_ASYNC            = 0x00010071U,
    DISPID_XMLDOCUMENT_CASEINSENSITIVE  = 0x00010072U,
    DISPID_XMLDOCUMENT_BASEURL          = 0x00010073U,
    DISPID_XMLDOCUMENT_XML              = 0x00010074U,
    DISPID_XMLDOCUMENT_LASTERROR        = 0x00010075U,
    DISPID_XMLDOCUMENT_TRIMWHITESPACE   = 0x00010076U,
    DISPID_XMLDOCUMENT_COMMIT           = 0x00010077U,
}

enum : uint
{
    DISPID_XMLELEMENT                 = 0x000100c8U,
    DISPID_XMLELEMENT_TAGNAME         = 0x000100c9U,
    DISPID_XMLELEMENT_PARENT          = 0x000100caU,
    DISPID_XMLELEMENT_SETATTRIBUTE    = 0x000100cbU,
    DISPID_XMLELEMENT_GETATTRIBUTE    = 0x000100ccU,
    DISPID_XMLELEMENT_REMOVEATTRIBUTE = 0x000100cdU,
    DISPID_XMLELEMENT_CHILDREN        = 0x000100ceU,
    DISPID_XMLELEMENT_TYPE            = 0x000100cfU,
    DISPID_XMLELEMENT_TEXT            = 0x000100d0U,
    DISPID_XMLELEMENT_ADDCHILD        = 0x000100d1U,
    DISPID_XMLELEMENT_REMOVECHILD     = 0x000100d2U,
    DISPID_XMLELEMENT_ATTRIBUTES      = 0x000100d3U,
}

enum : uint
{
    DISPID_XMLNOTIFSINK            = 0x0001012cU,
    DISPID_XMLNOTIFSINK_CHILDADDED = 0x0001012dU,
}

enum : uint
{
    DISPID_XMLATTRIBUTE       = 0x00010190U,
    DISPID_XMLATTRIBUTE_NAME  = 0x00010191U,
    DISPID_XMLATTRIBUTE_VALUE = 0x00010192U,
}

enum : uint
{
    DISPID_XMLERROR        = 0x00010190U,
    DISPID_XMLERROR_REASON = 0x00010191U,
    DISPID_XMLERROR_LINE   = 0x00010192U,
    DISPID_XMLERROR_POS    = 0x00010193U,
}

enum : uint
{
    DISPID_NODE                 = 0x000101f4U,
    DISPID_NODE_NAME            = 0x000101f5U,
    DISPID_NODE_PARENT          = 0x000101f6U,
    DISPID_NODE_TYPE            = 0x000101f7U,
    DISPID_NODE_VALUE           = 0x000101f8U,
    DISPID_NODE_SETATTRIBUTE    = 0x000101f9U,
    DISPID_NODE_GETATTRIBUTE    = 0x000101faU,
    DISPID_NODE_REMOVEATTRIBUTE = 0x000101fbU,
    DISPID_NODE_ATTRIBUTES      = 0x000101fcU,
    DISPID_NODE_ADD             = 0x000101fdU,
    DISPID_NODE_REMOVE          = 0x000101feU,
    DISPID_NODE_CHILDREN        = 0x000101ffU,
    DISPID_NODELIST             = 0x00010258U,
    DISPID_NODELIST_NEWENUM     = 0x00010259U,
    DISPID_NODELIST_NEXT        = 0x0001025aU,
    DISPID_NODELIST_CURRENT     = 0x0001025bU,
    DISPID_NODELIST_MOVE        = 0x0001025cU,
    DISPID_NODELIST_MOVETONODE  = 0x0001025dU,
    DISPID_NODELIST_LENGTH      = 0x0001025eU,
    DISPID_NODELIST_ITEM        = 0x0001025fU,
}

enum : uint
{
    DISPID_DOM_BASE                 = 0x00000001U,
    DISPID_DOM_COLLECTION_BASE      = 0x000f4240U,
    DISPID_DOM_COLLECTION_MAX       = 0x002dc6bfU,
    DISPID_DOM_NODE                 = 0x00000001U,
    DISPID_DOM_NODE_NODENAME        = 0x00000002U,
    DISPID_DOM_NODE_NODEVALUE       = 0x00000003U,
    DISPID_DOM_NODE_NODETYPE        = 0x00000004U,
    DISPID_DOM_NODE_NODETYPEENUM    = 0x00000005U,
    DISPID_DOM_NODE_PARENTNODE      = 0x00000006U,
    DISPID_DOM_NODE_CHILDNODES      = 0x00000007U,
    DISPID_DOM_NODE_FIRSTCHILD      = 0x00000008U,
    DISPID_DOM_NODE_LASTCHILD       = 0x00000009U,
    DISPID_DOM_NODE_PREVIOUSSIBLING = 0x0000000aU,
    DISPID_DOM_NODE_NEXTSIBLING     = 0x0000000bU,
    DISPID_DOM_NODE_ATTRIBUTES      = 0x0000000cU,
    DISPID_DOM_NODE_INSERTBEFORE    = 0x0000000dU,
    DISPID_DOM_NODE_REPLACECHILD    = 0x0000000eU,
    DISPID_DOM_NODE_REMOVECHILD     = 0x0000000fU,
    DISPID_DOM_NODE_APPENDCHILD     = 0x00000010U,
    DISPID_DOM_NODE_HASCHILDNODES   = 0x00000011U,
    DISPID_DOM_NODE_OWNERDOC        = 0x00000012U,
    DISPID_DOM_NODE_CLONENODE       = 0x00000013U,
}

enum : uint
{
    DISPID_XMLDOM_NODE                       = 0x00000014U,
    DISPID_XMLDOM_NODE_STRINGTYPE            = 0x00000015U,
    DISPID_XMLDOM_NODE_SPECIFIED             = 0x00000016U,
    DISPID_XMLDOM_NODE_DEFINITION            = 0x00000017U,
    DISPID_XMLDOM_NODE_TEXT                  = 0x00000018U,
    DISPID_XMLDOM_NODE_NODETYPEDVALUE        = 0x00000019U,
    DISPID_XMLDOM_NODE_DATATYPE              = 0x0000001aU,
    DISPID_XMLDOM_NODE_XML                   = 0x0000001bU,
    DISPID_XMLDOM_NODE_TRANSFORMNODE         = 0x0000001cU,
    DISPID_XMLDOM_NODE_SELECTNODES           = 0x0000001dU,
    DISPID_XMLDOM_NODE_SELECTSINGLENODE      = 0x0000001eU,
    DISPID_XMLDOM_NODE_PARSED                = 0x0000001fU,
    DISPID_XMLDOM_NODE_NAMESPACE             = 0x00000020U,
    DISPID_XMLDOM_NODE_PREFIX                = 0x00000021U,
    DISPID_XMLDOM_NODE_BASENAME              = 0x00000022U,
    DISPID_XMLDOM_NODE_TRANSFORMNODETOOBJECT = 0x00000023U,
    DISPID_XMLDOM_NODE__TOP                  = 0x00000024U,
}

enum : uint
{
    DISPID_DOM_DOCUMENT                             = 0x00000025U,
    DISPID_DOM_DOCUMENT_DOCTYPE                     = 0x00000026U,
    DISPID_DOM_DOCUMENT_IMPLEMENTATION              = 0x00000027U,
    DISPID_DOM_DOCUMENT_DOCUMENTELEMENT             = 0x00000028U,
    DISPID_DOM_DOCUMENT_CREATEELEMENT               = 0x00000029U,
    DISPID_DOM_DOCUMENT_CREATEDOCUMENTFRAGMENT      = 0x0000002aU,
    DISPID_DOM_DOCUMENT_CREATETEXTNODE              = 0x0000002bU,
    DISPID_DOM_DOCUMENT_CREATECOMMENT               = 0x0000002cU,
    DISPID_DOM_DOCUMENT_CREATECDATASECTION          = 0x0000002dU,
    DISPID_DOM_DOCUMENT_CREATEPROCESSINGINSTRUCTION = 0x0000002eU,
    DISPID_DOM_DOCUMENT_CREATEATTRIBUTE             = 0x0000002fU,
    DISPID_DOM_DOCUMENT_CREATEENTITY                = 0x00000030U,
    DISPID_DOM_DOCUMENT_CREATEENTITYREFERENCE       = 0x00000031U,
    DISPID_DOM_DOCUMENT_GETELEMENTSBYTAGNAME        = 0x00000032U,
    DISPID_DOM_DOCUMENT_TOP                         = 0x00000033U,
}

enum : uint
{
    DISPID_XMLDOM_DOCUMENT                    = 0x00000034U,
    DISPID_XMLDOM_DOCUMENT_DOCUMENTNODE       = 0x00000035U,
    DISPID_XMLDOM_DOCUMENT_CREATENODE         = 0x00000036U,
    DISPID_XMLDOM_DOCUMENT_CREATENODEEX       = 0x00000037U,
    DISPID_XMLDOM_DOCUMENT_NODEFROMID         = 0x00000038U,
    DISPID_XMLDOM_DOCUMENT_DOCUMENTNAMESPACES = 0x00000039U,
    DISPID_XMLDOM_DOCUMENT_LOAD               = 0x0000003aU,
    DISPID_XMLDOM_DOCUMENT_PARSEERROR         = 0x0000003bU,
    DISPID_XMLDOM_DOCUMENT_URL                = 0x0000003cU,
    DISPID_XMLDOM_DOCUMENT_ASYNC              = 0x0000003dU,
    DISPID_XMLDOM_DOCUMENT_ABORT              = 0x0000003eU,
    DISPID_XMLDOM_DOCUMENT_LOADXML            = 0x0000003fU,
    DISPID_XMLDOM_DOCUMENT_SAVE               = 0x00000040U,
    DISPID_XMLDOM_DOCUMENT_VALIDATE           = 0x00000041U,
    DISPID_XMLDOM_DOCUMENT_RESOLVENAMESPACE   = 0x00000042U,
    DISPID_XMLDOM_DOCUMENT_PRESERVEWHITESPACE = 0x00000043U,
    DISPID_XMLDOM_DOCUMENT_ONREADYSTATECHANGE = 0x00000044U,
    DISPID_XMLDOM_DOCUMENT_ONDATAAVAILABLE    = 0x00000045U,
    DISPID_XMLDOM_DOCUMENT_ONTRANSFORMNODE    = 0x00000046U,
    DISPID_XMLDOM_DOCUMENT__TOP               = 0x00000047U,
}

enum : uint
{
    DISPID_DOM_NODELIST        = 0x00000048U,
    DISPID_DOM_NODELIST_ITEM   = 0x00000049U,
    DISPID_DOM_NODELIST_LENGTH = 0x0000004aU,
}

enum : uint
{
    DISPID_XMLDOM_NODELIST          = 0x0000004bU,
    DISPID_XMLDOM_NODELIST_NEXTNODE = 0x0000004cU,
    DISPID_XMLDOM_NODELIST_RESET    = 0x0000004dU,
    DISPID_XMLDOM_NODELIST_NEWENUM  = 0x0000004eU,
    DISPID_XMLDOM_NODELIST__TOP     = 0x0000004fU,
}

enum : uint
{
    DISPID_DOM_NAMEDNODEMAP                 = 0x00000050U,
    DISPID_DOM_NAMEDNODEMAP_GETNAMEDITEM    = 0x00000053U,
    DISPID_DOM_NAMEDNODEMAP_SETNAMEDITEM    = 0x00000054U,
    DISPID_DOM_NAMEDNODEMAP_REMOVENAMEDITEM = 0x00000055U,
}

enum : uint
{
    DISPID_XMLDOM_NAMEDNODEMAP                     = 0x00000056U,
    DISPID_XMLDOM_NAMEDNODEMAP_GETQUALIFIEDITEM    = 0x00000057U,
    DISPID_XMLDOM_NAMEDNODEMAP_REMOVEQUALIFIEDITEM = 0x00000058U,
    DISPID_XMLDOM_NAMEDNODEMAP_NEXTNODE            = 0x00000059U,
    DISPID_XMLDOM_NAMEDNODEMAP_RESET               = 0x0000005aU,
    DISPID_XMLDOM_NAMEDNODEMAP_NEWENUM             = 0x0000005bU,
    DISPID_XMLDOM_NAMEDNODEMAP__TOP                = 0x0000005cU,
}

enum : uint
{
    DISPID_DOM_W3CWRAPPERS           = 0x0000005dU,
    DISPID_DOM_DOCUMENTFRAGMENT      = 0x0000005eU,
    DISPID_DOM_DOCUMENTFRAGMENT__TOP = 0x0000005fU,
}

enum : uint
{
    DISPID_DOM_ELEMENT                      = 0x00000060U,
    DISPID_DOM_ELEMENT_GETTAGNAME           = 0x00000061U,
    DISPID_DOM_ELEMENT_GETATTRIBUTES        = 0x00000062U,
    DISPID_DOM_ELEMENT_GETATTRIBUTE         = 0x00000063U,
    DISPID_DOM_ELEMENT_SETATTRIBUTE         = 0x00000064U,
    DISPID_DOM_ELEMENT_REMOVEATTRIBUTE      = 0x00000065U,
    DISPID_DOM_ELEMENT_GETATTRIBUTENODE     = 0x00000066U,
    DISPID_DOM_ELEMENT_SETATTRIBUTENODE     = 0x00000067U,
    DISPID_DOM_ELEMENT_REMOVEATTRIBUTENODE  = 0x00000068U,
    DISPID_DOM_ELEMENT_GETELEMENTSBYTAGNAME = 0x00000069U,
    DISPID_DOM_ELEMENT_NORMALIZE            = 0x0000006aU,
    DISPID_DOM_ELEMENT__TOP                 = 0x0000006bU,
    DISPID_DOM_DATA                         = 0x0000006cU,
    DISPID_DOM_DATA_DATA                    = 0x0000006dU,
    DISPID_DOM_DATA_LENGTH                  = 0x0000006eU,
    DISPID_DOM_DATA_SUBSTRING               = 0x0000006fU,
    DISPID_DOM_DATA_APPEND                  = 0x00000070U,
    DISPID_DOM_DATA_INSERT                  = 0x00000071U,
    DISPID_DOM_DATA_DELETE                  = 0x00000072U,
    DISPID_DOM_DATA_REPLACE                 = 0x00000073U,
    DISPID_DOM_DATA__TOP                    = 0x00000074U,
    DISPID_DOM_ATTRIBUTE                    = 0x00000075U,
    DISPID_DOM_ATTRIBUTE_GETNAME            = 0x00000076U,
    DISPID_DOM_ATTRIBUTE_SPECIFIED          = 0x00000077U,
    DISPID_DOM_ATTRIBUTE_VALUE              = 0x00000078U,
    DISPID_DOM_ATTRIBUTE__TOP               = 0x00000079U,
    DISPID_DOM_TEXT                         = 0x0000007aU,
    DISPID_DOM_TEXT_SPLITTEXT               = 0x0000007bU,
    DISPID_DOM_TEXT_JOINTEXT                = 0x0000007cU,
    DISPID_DOM_TEXT__TOP                    = 0x0000007dU,
    DISPID_DOM_PI                           = 0x0000007eU,
    DISPID_DOM_PI_TARGET                    = 0x0000007fU,
    DISPID_DOM_PI_DATA                      = 0x00000080U,
    DISPID_DOM_PI__TOP                      = 0x00000081U,
    DISPID_DOM_DOCUMENTTYPE                 = 0x00000082U,
    DISPID_DOM_DOCUMENTTYPE_NAME            = 0x00000083U,
    DISPID_DOM_DOCUMENTTYPE_ENTITIES        = 0x00000084U,
    DISPID_DOM_DOCUMENTTYPE_NOTATIONS       = 0x00000085U,
    DISPID_DOM_DOCUMENTTYPE__TOP            = 0x00000086U,
}

enum : uint
{
    DISPID_DOM_NOTATION                  = 0x00000087U,
    DISPID_DOM_NOTATION_PUBLICID         = 0x00000088U,
    DISPID_DOM_NOTATION_SYSTEMID         = 0x00000089U,
    DISPID_DOM_NOTATION__TOP             = 0x0000008aU,
    DISPID_DOM_ENTITY                    = 0x0000008bU,
    DISPID_DOM_ENTITY_PUBLICID           = 0x0000008cU,
    DISPID_DOM_ENTITY_SYSTEMID           = 0x0000008dU,
    DISPID_DOM_ENTITY_NOTATIONNAME       = 0x0000008eU,
    DISPID_DOM_ENTITY__TOP               = 0x0000008fU,
    DISPID_DOM_W3CWRAPPERS_TOP           = 0x0000008fU,
    DISPID_DOM_IMPLEMENTATION            = 0x00000090U,
    DISPID_DOM_IMPLEMENTATION_HASFEATURE = 0x00000091U,
    DISPID_DOM_IMPLEMENTATION__TOP       = 0x00000092U,
}

enum : uint
{
    DISPID_DOM__TOP                        = 0x000000b0U,
    DISPID_DOM_ERROR                       = 0x000000b1U,
    DISPID_DOM_ERROR_ERRORCODE             = 0x000000b2U,
    DISPID_DOM_ERROR_URL                   = 0x000000b3U,
    DISPID_DOM_ERROR_REASON                = 0x000000b4U,
    DISPID_DOM_ERROR_SRCTEXT               = 0x000000b5U,
    DISPID_DOM_ERROR_LINE                  = 0x000000b6U,
    DISPID_DOM_ERROR_LINEPOS               = 0x000000b7U,
    DISPID_DOM_ERROR_FILEPOS               = 0x000000b8U,
    DISPID_DOM_ERROR__TOP                  = 0x000000b9U,
    DISPID_DOM_ERROR2                      = 0x000000baU,
    DISPID_DOM_ERROR2_ALLERRORS            = 0x000000bbU,
    DISPID_DOM_ERROR2_ERRORPARAMETERS      = 0x000000bcU,
    DISPID_DOM_ERROR2_ERRORPARAMETERSCOUNT = 0x000000bdU,
    DISPID_DOM_ERROR2_ERRORXPATH           = 0x000000beU,
    DISPID_DOM_ERROR2__TOP                 = 0x000000bfU,
    DISPID_DOM_ERRORCOLLECTION             = 0x000000c0U,
    DISPID_DOM_ERRORCOLLECTION_LENGTH      = 0x000000c1U,
    DISPID_DOM_ERRORCOLLECTION_NEXT        = 0x000000c2U,
    DISPID_DOM_ERRORCOLLECTION_RESET       = 0x000000c3U,
    DISPID_DOM_ERRORCOLLECTION__TOP        = 0x000000c4U,
}

enum : uint
{
    DISPID_XTLRUNTIME                     = 0x000000baU,
    DISPID_XTLRUNTIME_UNIQUEID            = 0x000000bbU,
    DISPID_XTLRUNTIME_DEPTH               = 0x000000bcU,
    DISPID_XTLRUNTIME_CHILDNUMBER         = 0x000000bdU,
    DISPID_XTLRUNTIME_ANCESTORCHILDNUMBER = 0x000000beU,
    DISPID_XTLRUNTIME_ABSOLUTECHILDNUMBER = 0x000000bfU,
    DISPID_XTLRUNTIME_FORMATINDEX         = 0x000000c0U,
    DISPID_XTLRUNTIME_FORMATNUMBER        = 0x000000c1U,
    DISPID_XTLRUNTIME_FORMATDATE          = 0x000000c2U,
    DISPID_XTLRUNTIME_FORMATTIME          = 0x000000c3U,
    DISPID_XTLRUNTIME__TOP                = 0x000000c4U,
}

enum uint DISPID_XMLDOMEVENT = 0x000000c5U;
enum int DISPID_XMLDOMEVENT_ONREADYSTATECHANGE = 0xfffffd9f;

enum : uint
{
    DISPID_XMLDOMEVENT_ONDATAAVAILABLE           = 0x000000c6U,
    DISPID_XMLDOMEVENT__TOP                      = 0x000000c7U,
    DISPID_XMLDOM_DOCUMENT2                      = 0x000000c8U,
    DISPID_XMLDOM_DOCUMENT2_NAMESPACES           = 0x000000c9U,
    DISPID_XMLDOM_DOCUMENT2_SCHEMAS              = 0x000000caU,
    DISPID_XMLDOM_DOCUMENT2_VALIDATE             = 0x000000cbU,
    DISPID_XMLDOM_DOCUMENT2_SETPROPERTY          = 0x000000ccU,
    DISPID_XMLDOM_DOCUMENT2_GETPROPERTY          = 0x000000cdU,
    DISPID_XMLDOM_DOCUMENT2__TOP                 = 0x000000ceU,
    DISPID_XMLDOM_DOCUMENT3                      = 0x000000cfU,
    DISPID_XMLDOM_DOCUMENT3_VALIDATENODE         = 0x000000d0U,
    DISPID_XMLDOM_DOCUMENT3_IMPORTNODE           = 0x000000d1U,
    DISPID_XMLDOM_DOCUMENT3__TOP                 = 0x000000d2U,
    DISPID_XMLDOM_SCHEMACOLLECTION               = 0x00000002U,
    DISPID_XMLDOM_SCHEMACOLLECTION_ADD           = 0x00000003U,
    DISPID_XMLDOM_SCHEMACOLLECTION_GET           = 0x00000004U,
    DISPID_XMLDOM_SCHEMACOLLECTION_REMOVE        = 0x00000005U,
    DISPID_XMLDOM_SCHEMACOLLECTION_LENGTH        = 0x00000006U,
    DISPID_XMLDOM_SCHEMACOLLECTION_NAMESPACEURI  = 0x00000007U,
    DISPID_XMLDOM_SCHEMACOLLECTION_ADDCOLLECTION = 0x00000008U,
    DISPID_XMLDOM_SCHEMACOLLECTION__TOP          = 0x00000009U,
    DISPID_XMLDOM_SELECTION                      = 0x00000050U,
    DISPID_XMLDOM_SELECTION_EXPR                 = 0x00000051U,
    DISPID_XMLDOM_SELECTION_CONTEXT              = 0x00000052U,
    DISPID_XMLDOM_SELECTION_PEEKNODE             = 0x00000053U,
    DISPID_XMLDOM_SELECTION_MATCHES              = 0x00000054U,
    DISPID_XMLDOM_SELECTION_REMOVENEXT           = 0x00000055U,
    DISPID_XMLDOM_SELECTION_REMOVEALL            = 0x00000056U,
    DISPID_XMLDOM_SELECTION_CLONE                = 0x00000057U,
    DISPID_XMLDOM_SELECTION_GETPROPERTY          = 0x00000058U,
    DISPID_XMLDOM_SELECTION_SETPROPERTY          = 0x00000059U,
    DISPID_XMLDOM_SELECTION__TOP                 = 0x0000005aU,
    DISPID_XMLDOM_TEMPLATE                       = 0x00000001U,
    DISPID_XMLDOM_TEMPLATE_STYLESHEET            = 0x00000002U,
    DISPID_XMLDOM_TEMPLATE_CREATEPROCESSOR       = 0x00000003U,
    DISPID_XMLDOM_TEMPLATE__TOP                  = 0x00000004U,
    DISPID_XMLDOM_PROCESSOR                      = 0x00000001U,
    DISPID_XMLDOM_PROCESSOR_INPUT                = 0x00000002U,
    DISPID_XMLDOM_PROCESSOR_XSLTEMPLATE          = 0x00000003U,
    DISPID_XMLDOM_PROCESSOR_SETSTARTMODE         = 0x00000004U,
    DISPID_XMLDOM_PROCESSOR_STARTMODE            = 0x00000005U,
    DISPID_XMLDOM_PROCESSOR_STARTMODEURI         = 0x00000006U,
    DISPID_XMLDOM_PROCESSOR_OUTPUT               = 0x00000007U,
    DISPID_XMLDOM_PROCESSOR_TRANSFORM            = 0x00000008U,
    DISPID_XMLDOM_PROCESSOR_RESET                = 0x00000009U,
    DISPID_XMLDOM_PROCESSOR_READYSTATE           = 0x0000000aU,
    DISPID_XMLDOM_PROCESSOR_ADDPARAMETER         = 0x0000000bU,
    DISPID_XMLDOM_PROCESSOR_ADDOBJECT            = 0x0000000cU,
    DISPID_XMLDOM_PROCESSOR_STYLESHEET           = 0x0000000dU,
    DISPID_XMLDOM_PROCESSOR__TOP                 = 0x0000000eU,
}

enum : uint
{
    DISPID_XMLDSO                   = 0x00010000U,
    DISPID_XMLDSO_DOCUMENT          = 0x00010001U,
    DISPID_XMLDSO_JAVADSOCOMPATIBLE = 0x00010002U,
}

enum : uint
{
    DISPID_SAX_XMLREADER__MIN               = 0x00000501U,
    DISPID_SAX_XMLREADER__MAX               = 0x00010000U,
    DISPID_SAX_XMLREADER__BASE              = 0x00000501U,
    DISPID_SAX_XMLREADER                    = 0x00000501U,
    DISPID_SAX_XMLREADER_GETFEATURE         = 0x00000502U,
    DISPID_SAX_XMLREADER_PUTFEATURE         = 0x00000503U,
    DISPID_SAX_XMLREADER_GETPROPERTY        = 0x00000504U,
    DISPID_SAX_XMLREADER_PUTPROPERTY        = 0x00000505U,
    DISPID_SAX_XMLREADER_ENTITYRESOLVER     = 0x00000506U,
    DISPID_SAX_XMLREADER_CONTENTHANDLER     = 0x00000507U,
    DISPID_SAX_XMLREADER_DTDHANDLER         = 0x00000508U,
    DISPID_SAX_XMLREADER_ERRORHANDLER       = 0x00000509U,
    DISPID_SAX_XMLREADER_BASEURL            = 0x0000050aU,
    DISPID_SAX_XMLREADER_SECUREBASEURL      = 0x0000050bU,
    DISPID_SAX_XMLREADER_PARSE              = 0x0000050cU,
    DISPID_SAX_XMLREADER_PARSEURL           = 0x0000050dU,
    DISPID_SAX_XMLREADER_PARENT             = 0x0000050eU,
    DISPID_SAX_XMLREADER__TOP               = 0x0000050fU,
    DISPID_SAX_XMLFILTER__BASE              = 0x00000510U,
    DISPID_SAX_XMLFILTER                    = 0x00000510U,
    DISPID_SAX_XMLFILTER_GETFEATURE         = 0x00000511U,
    DISPID_SAX_XMLFILTER_PUTFEATURE         = 0x00000512U,
    DISPID_SAX_XMLFILTER_GETPROPERTY        = 0x00000513U,
    DISPID_SAX_XMLFILTER_PUTPROPERTY        = 0x00000514U,
    DISPID_SAX_XMLFILTER_ENTITYRESOLVER     = 0x00000515U,
    DISPID_SAX_XMLFILTER_CONTENTHANDLER     = 0x00000516U,
    DISPID_SAX_XMLFILTER_DTDHANDLER         = 0x00000517U,
    DISPID_SAX_XMLFILTER_ERRORHANDLER       = 0x00000518U,
    DISPID_SAX_XMLFILTER_BASEURL            = 0x00000519U,
    DISPID_SAX_XMLFILTER_SECUREBASEURL      = 0x0000051aU,
    DISPID_SAX_XMLFILTER_PARSE              = 0x0000051bU,
    DISPID_SAX_XMLFILTER_PARSEURL           = 0x0000051cU,
    DISPID_SAX_XMLFILTER_PARENT             = 0x0000051dU,
    DISPID_SAX_XMLFILTER__TOP               = 0x0000051fU,
    DISPID_SAX_LOCATOR__BASE                = 0x00000520U,
    DISPID_SAX_LOCATOR                      = 0x00000520U,
    DISPID_SAX_LOCATOR_COLUMNNUMBER         = 0x00000521U,
    DISPID_SAX_LOCATOR_LINENUMBER           = 0x00000522U,
    DISPID_SAX_LOCATOR_PUBLICID             = 0x00000523U,
    DISPID_SAX_LOCATOR_SYSTEMID             = 0x00000524U,
    DISPID_SAX_LOCATOR__TOP                 = 0x00000525U,
    DISPID_SAX_ENTITYRESOLVER__BASE         = 0x00000526U,
    DISPID_SAX_ENTITYRESOLVER               = 0x00000526U,
    DISPID_SAX_ENTITYRESOLVER_RESOLVEENTITY = 0x00000527U,
    DISPID_SAX_ENTITYRESOLVER__TOP          = 0x00000528U,
}

enum : uint
{
    DISPID_SAX_CONTENTHANDLER__BASE                 = 0x00000529U,
    DISPID_SAX_CONTENTHANDLER                       = 0x00000529U,
    DISPID_SAX_CONTENTHANDLER_DOCUMENTLOCATOR       = 0x0000052aU,
    DISPID_SAX_CONTENTHANDLER_STARTDOCUMENT         = 0x0000052bU,
    DISPID_SAX_CONTENTHANDLER_ENDDOCUMENT           = 0x0000052cU,
    DISPID_SAX_CONTENTHANDLER_STARTPREFIXMAPPING    = 0x0000052dU,
    DISPID_SAX_CONTENTHANDLER_ENDPREFIXMAPPING      = 0x0000052eU,
    DISPID_SAX_CONTENTHANDLER_STARTELEMENT          = 0x0000052fU,
    DISPID_SAX_CONTENTHANDLER_ENDELEMENT            = 0x00000530U,
    DISPID_SAX_CONTENTHANDLER_CHARACTERS            = 0x00000531U,
    DISPID_SAX_CONTENTHANDLER_IGNORABLEWHITESPACE   = 0x00000532U,
    DISPID_SAX_CONTENTHANDLER_PROCESSINGINSTRUCTION = 0x00000533U,
    DISPID_SAX_CONTENTHANDLER_SKIPPEDENTITY         = 0x00000534U,
    DISPID_SAX_CONTENTHANDLER__TOP                  = 0x00000535U,
}

enum : uint
{
    DISPID_SAX_DTDHANDLER__BASE              = 0x00000536U,
    DISPID_SAX_DTDHANDLER                    = 0x00000536U,
    DISPID_SAX_DTDHANDLER_NOTATIONDECL       = 0x00000537U,
    DISPID_SAX_DTDHANDLER_UNPARSEDENTITYDECL = 0x00000538U,
    DISPID_SAX_DTDHANDLER__TOP               = 0x00000539U,
    DISPID_SAX_ERRORHANDLER__BASE            = 0x0000053aU,
    DISPID_SAX_ERRORHANDLER                  = 0x0000053aU,
    DISPID_SAX_ERRORHANDLER_ERROR            = 0x0000053bU,
    DISPID_SAX_ERRORHANDLER_FATALERROR       = 0x0000053cU,
    DISPID_SAX_ERRORHANDLER_IGNORABLEWARNING = 0x0000053dU,
    DISPID_SAX_ERRORHANDLER__TOP             = 0x0000053eU,
}

enum : uint
{
    DISPID_SAX_ATTRIBUTES__BASE             = 0x0000053fU,
    DISPID_SAX_ATTRIBUTES                   = 0x0000053fU,
    DISPID_SAX_ATTRIBUTES_LENGTH            = 0x00000540U,
    DISPID_SAX_ATTRIBUTES_GETURI            = 0x00000541U,
    DISPID_SAX_ATTRIBUTES_GETLOCALNAME      = 0x00000542U,
    DISPID_SAX_ATTRIBUTES_GETQNAME          = 0x00000543U,
    DISPID_SAX_ATTRIBUTES_GETINDEXFROMNAME  = 0x00000544U,
    DISPID_SAX_ATTRIBUTES_GETINDEXFROMQNAME = 0x00000545U,
    DISPID_SAX_ATTRIBUTES_GETTYPE           = 0x00000546U,
    DISPID_SAX_ATTRIBUTES_GETTYPEFROMNAME   = 0x00000547U,
    DISPID_SAX_ATTRIBUTES_GETTYPEFROMQNAME  = 0x00000548U,
    DISPID_SAX_ATTRIBUTES_GETVALUE          = 0x00000549U,
    DISPID_SAX_ATTRIBUTES_GETVALUEFROMNAME  = 0x0000054aU,
    DISPID_SAX_ATTRIBUTES_GETVALUEFROMQNAME = 0x0000054bU,
    DISPID_SAX_ATTRIBUTES__TOP              = 0x0000054cU,
    DISPID_SAX_LEXICALHANDLER__BASE         = 0x0000054dU,
    DISPID_SAX_LEXICALHANDLER               = 0x0000054dU,
    DISPID_SAX_LEXICALHANDLER_STARTDTD      = 0x0000054eU,
    DISPID_SAX_LEXICALHANDLER_ENDDTD        = 0x0000054fU,
    DISPID_SAX_LEXICALHANDLER_STARTENTITY   = 0x00000550U,
    DISPID_SAX_LEXICALHANDLER_ENDENTITY     = 0x00000551U,
    DISPID_SAX_LEXICALHANDLER_STARTCDATA    = 0x00000552U,
    DISPID_SAX_LEXICALHANDLER_ENDCDATA      = 0x00000553U,
    DISPID_SAX_LEXICALHANDLER_COMMENT       = 0x00000554U,
    DISPID_SAX_LEXICALHANDLER__TOP          = 0x00000555U,
}

enum : uint
{
    DISPID_SAX_DECLHANDLER__BASE              = 0x00000556U,
    DISPID_SAX_DECLHANDLER                    = 0x00000556U,
    DISPID_SAX_DECLHANDLER_ELEMENTDECL        = 0x00000557U,
    DISPID_SAX_DECLHANDLER_ATTRIBUTEDECL      = 0x00000558U,
    DISPID_SAX_DECLHANDLER_INTERNALENTITYDECL = 0x00000559U,
    DISPID_SAX_DECLHANDLER_EXTERNALENTITYDECL = 0x0000055aU,
    DISPID_SAX_DECLHANDLER__TOP               = 0x0000055bU,
}

enum : uint
{
    DISPID_MX_ATTRIBUTES__BASE                 = 0x0000055cU,
    DISPID_MX_ATTRIBUTES                       = 0x0000055cU,
    DISPID_MX_ATTRIBUTES_ADDATTRIBUTE          = 0x0000055dU,
    DISPID_MX_ATTRIBUTES_CLEAR                 = 0x0000055eU,
    DISPID_MX_ATTRIBUTES_REMOVEATTRIBUTE       = 0x0000055fU,
    DISPID_MX_ATTRIBUTES_SETATTRIBUTE          = 0x00000560U,
    DISPID_MX_ATTRIBUTES_SETATTRIBUTES         = 0x00000561U,
    DISPID_MX_ATTRIBUTES_SETLOCALNAME          = 0x00000562U,
    DISPID_MX_ATTRIBUTES_SETQNAME              = 0x00000563U,
    DISPID_MX_ATTRIBUTES_SETTYPE               = 0x00000564U,
    DISPID_MX_ATTRIBUTES_SETURI                = 0x00000565U,
    DISPID_MX_ATTRIBUTES_SETVALUE              = 0x00000566U,
    DISPID_MX_ATTRIBUTES_ADDATTRIBUTEFROMINDEX = 0x00000567U,
    DISPID_MX_ATTRIBUTES__TOP                  = 0x00000567U,
}

enum : uint
{
    DISPID_MX_WRITER__BASE                 = 0x00000568U,
    DISPID_MX_WRITER                       = 0x00000568U,
    DISPID_MX_WRITER_OUTPUT                = 0x00000569U,
    DISPID_MX_WRITER_DESTINATION           = 0x0000056aU,
    DISPID_MX_WRITER_ENCODING              = 0x0000056bU,
    DISPID_MX_WRITER_BYTEORDERMARK         = 0x0000056cU,
    DISPID_MX_WRITER_INDENT                = 0x0000056dU,
    DISPID_MX_WRITER_STANDALONE            = 0x0000056eU,
    DISPID_MX_WRITER_OMITXMLDECLARATION    = 0x0000056fU,
    DISPID_MX_WRITER_VERSION               = 0x00000570U,
    DISPID_MX_WRITER_DISABLEOUTPUTESCAPING = 0x00000571U,
    DISPID_MX_WRITER_FLUSH                 = 0x00000572U,
    DISPID_MX_WRITER_RESET                 = 0x00000573U,
    DISPID_MX_WRITER__TOP                  = 0x00000574U,
    DISPID_MX_READER_CONTROL__BASE         = 0x00000575U,
    DISPID_MX_READER_CONTROL               = 0x00000575U,
    DISPID_MX_READER_CONTROL_ABORT         = 0x00000576U,
    DISPID_MX_READER_CONTROL_RESUME        = 0x00000577U,
    DISPID_MX_READER_CONTROL_SUSPEND       = 0x00000578U,
    DISPID_MX_READER_CONTROL__TOP          = 0x00000579U,
}

enum : uint
{
    DISPID_MX_SCHEMADECLHANDLER__BASE             = 0x0000057aU,
    DISPID_MX_SCHEMADECLHANDLER                   = 0x0000057aU,
    DISPID_MX_SCHEMADECLHANDLER_SCHEMAELEMENTDECL = 0x0000057bU,
    DISPID_MX_SCHEMADECLHANDLER__TOP              = 0x0000057cU,
}

enum : uint
{
    DISPID_MX_NSMGR__BASE               = 0x0000057dU,
    DISPID_MX_NSMGR                     = 0x0000057dU,
    DISPID_MX_NSMGR_ALLOWOVERRIDE       = 0x0000057eU,
    DISPID_MX_NSMGR_RESET               = 0x0000057fU,
    DISPID_MX_NSMGR_PUSHCONTEXT         = 0x00000580U,
    DISPID_MX_NSMGR_PUSHNODECONTEXT     = 0x00000581U,
    DISPID_MX_NSMGR_POPCONTEXT          = 0x00000582U,
    DISPID_MX_NSMGR_DECLAREPREFIX       = 0x00000583U,
    DISPID_MX_NSMGR_GETDECLAREDPREFIXES = 0x00000584U,
    DISPID_MX_NSMGR_GETPREFIXES         = 0x00000585U,
    DISPID_MX_NSMGR_GETURI              = 0x00000586U,
    DISPID_MX_NSMGR_GETURIFROMNODE      = 0x00000587U,
    DISPID_MX_NSMGR_LENGTH              = 0x00000588U,
    DISPID_MX_NSMGR__TOP                = 0x00000589U,
    DISPID_MXXML_FILTER__BASE           = 0x0000058aU,
    DISPID_MXXML_FILTER                 = 0x0000058aU,
    DISPID_MXXML_FILTER_CONTENTHANDLER  = 0x0000058bU,
    DISPID_MXXML_FILTER_DTDHANDLER      = 0x0000058cU,
    DISPID_MXXML_FILTER_ENTITYRESOLVER  = 0x0000058dU,
    DISPID_MXXML_FILTER_ERRORHANDLER    = 0x0000058eU,
    DISPID_MXXML_FILTER_GETFEATURE      = 0x0000058fU,
    DISPID_MXXML_FILTER_GETPROPERTY     = 0x00000590U,
    DISPID_MXXML_FILTER_PUTFEATURE      = 0x00000591U,
    DISPID_MXXML_FILTER_PUTPROPERTY     = 0x00000592U,
    DISPID_MXXML_FILTER__TOP            = 0x00000593U,
}

enum : uint
{
    DISPID_SOM                   = 0x0000058aU,
    DISPID_SOM_VALIDATE          = 0x0000058bU,
    DISPID_SOM_VALIDATEONLOAD    = 0x0000058cU,
    DISPID_SOM_GETSCHEMA         = 0x0000058dU,
    DISPID_SOM_GETDECLARATION    = 0x0000058eU,
    DISPID_SOM_ITEMBYNAME        = 0x0000058fU,
    DISPID_SOM_ITEMBYQNAME       = 0x00000590U,
    DISPID_SOM_ANYATTRIBUTE      = 0x00000591U,
    DISPID_SOM_ATTRIBUTEGROUPS   = 0x00000592U,
    DISPID_SOM_ATTRIBUTES        = 0x00000593U,
    DISPID_SOM_BASETYPES         = 0x00000594U,
    DISPID_SOM_CONTENTMODEL      = 0x00000595U,
    DISPID_SOM_CONTENTTYPE       = 0x00000596U,
    DISPID_SOM_DEFAULTVALUE      = 0x00000597U,
    DISPID_SOM_DERIVEDBY         = 0x00000598U,
    DISPID_SOM_DISALLOWED        = 0x00000599U,
    DISPID_SOM_ELEMENTS          = 0x0000059aU,
    DISPID_SOM_ENUMERATION       = 0x0000059bU,
    DISPID_SOM_FIELDS            = 0x0000059cU,
    DISPID_SOM_FINAL             = 0x0000059dU,
    DISPID_SOM_FIXEDVALUE        = 0x0000059eU,
    DISPID_SOM_FRACTIONDIGITS    = 0x0000059fU,
    DISPID_SOM_ID                = 0x000005a0U,
    DISPID_SOM_IDCONSTRAINTS     = 0x000005a1U,
    DISPID_SOM_ISABSTRACT        = 0x000005a2U,
    DISPID_SOM_ISNILLABLE        = 0x000005a3U,
    DISPID_SOM_ISREFERENCE       = 0x000005a4U,
    DISPID_SOM_ISVALID           = 0x000005a5U,
    DISPID_SOM_ITEMTYPE          = 0x000005a6U,
    DISPID_SOM_LENGTH            = 0x000005a7U,
    DISPID_SOM_MAXEXCLUSIVE      = 0x000005a8U,
    DISPID_SOM_MAXINCLUSIVE      = 0x000005a9U,
    DISPID_SOM_MAXLENGTH         = 0x000005aaU,
    DISPID_SOM_MAXOCCURS         = 0x000005abU,
    DISPID_SOM_MINEXCLUSIVE      = 0x000005acU,
    DISPID_SOM_MININCLUSIVE      = 0x000005adU,
    DISPID_SOM_MINLENGTH         = 0x000005aeU,
    DISPID_SOM_MINOCCURS         = 0x000005afU,
    DISPID_SOM_MODELGROUPS       = 0x000005b0U,
    DISPID_SOM_NAME              = 0x000005b1U,
    DISPID_SOM_NAMESPACES        = 0x000005b2U,
    DISPID_SOM_NAMESPACEURI      = 0x000005b3U,
    DISPID_SOM_NOTATIONS         = 0x000005b4U,
    DISPID_SOM_PARTICLES         = 0x000005b5U,
    DISPID_SOM_PATTERNS          = 0x000005b6U,
    DISPID_SOM_PROCESSCONTENTS   = 0x000005b7U,
    DISPID_SOM_PROHIBITED        = 0x000005b8U,
    DISPID_SOM_PUBLICIDENTIFIER  = 0x000005b9U,
    DISPID_SOM_REFERENCEDKEY     = 0x000005baU,
    DISPID_SOM_SCHEMA            = 0x000005bbU,
    DISPID_SOM_SCHEMALOCATIONS   = 0x000005bcU,
    DISPID_SOM_SCOPE             = 0x000005bdU,
    DISPID_SOM_SELECTOR          = 0x000005beU,
    DISPID_SOM_SUBSTITUTIONGROUP = 0x000005bfU,
}

enum : uint
{
    DISPID_SOM_EXCLUSIONS                  = 0x000005c0U,
    DISPID_SOM_SYSTEMIDENTIFIER            = 0x000005c1U,
    DISPID_SOM_TARGETNAMESPACE             = 0x000005c2U,
    DISPID_SOM_TOTALDIGITS                 = 0x000005c3U,
    DISPID_SOM_TYPE                        = 0x000005c4U,
    DISPID_SOM_TYPES                       = 0x000005c5U,
    DISPID_SOM_UNHANDLEDATTRS              = 0x000005c6U,
    DISPID_SOM_USE                         = 0x000005c7U,
    DISPID_SOM_VARIETY                     = 0x000005c8U,
    DISPID_SOM_VERSION                     = 0x000005c9U,
    DISPID_SOM_WHITESPACE                  = 0x000005caU,
    DISPID_SOM_WRITEANNOTATION             = 0x000005cbU,
    DISPID_SOM_TOP                         = 0x000005ccU,
    DISPID_XMLDSIG                         = 0x00000001U,
    DISPID_XMLDSIG_CREATEKEYFROMCSP        = 0x00000001U,
    DISPID_XMLDSIG_CREATEKEYFROMHMACSECRET = 0x00000002U,
    DISPID_XMLDSIG_CREATEKEYFROMNODE       = 0x00000003U,
    DISPID_XMLDSIG_CREATESAXPROXY          = 0x00000004U,
    DISPID_XMLDSIG_GETVERIFYINGCERTIFICATE = 0x00000005U,
}

enum : uint
{
    DISPID_XMLDSIG_SETREFERENCEDATA = 0x00000006U,
    DISPID_XMLDSIG_SIGN             = 0x00000007U,
    DISPID_XMLDSIG_SIGNATURE        = 0x00000008U,
    DISPID_XMLDSIG_STORE            = 0x00000009U,
    DISPID_XMLDSIG_VERIFY           = 0x0000000aU,
}
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/ns-msxml6-xhr_cookie
struct XHR_COOKIE
{
    PWSTR    pwszUrl;
    PWSTR    pwszName;
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/ns-msxml6-xhr_cert
struct XHR_CERT
{
    uint   cbCert;
    ubyte* pbCert;
...
interface IXMLElementCollection : IDispatch
{
    ...
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml/nf-msxml-ixmlelementcollection-get_length
    HRESULT get_length(int* p);
    HRESULT get__newEnum(IUnknown* ppUnk);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml/nf-msxml-ixmlelementcollection-item
...
interface IXMLHTTPRequest2Callback : IUnknown
{
    ...
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/nf-msxml6-ixmlhttprequest2callback-onheadersavailable
    HRESULT OnHeadersAvailable(IXMLHTTPRequest2 pXHR, uint dwStatus, const(PWSTR) pwszStatus);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/nf-msxml6-ixmlhttprequest2callback-ondataavailable
    HRESULT OnDataAvailable(IXMLHTTPRequest2 pXHR, ISequentialStream pResponseStream);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/nf-msxml6-ixmlhttprequest2callback-onresponsereceived
    HRESULT OnResponseReceived(IXMLHTTPRequest2 pXHR, ISequentialStream pResponseStream);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/nf-msxml6-ixmlhttprequest2callback-onerror
...
interface IXMLHTTPRequest2 : IUnknown
{
    ...
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/nf-msxml6-ixmlhttprequest2-send
    HRESULT Send(ISequentialStream pBody, ulong cbBody);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/nf-msxml6-ixmlhttprequest2-abort
    HRESULT Abort();
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/nf-msxml6-ixmlhttprequest2-setcookie
    HRESULT SetCookie(const(XHR_COOKIE)* pCookie, uint* pdwCookieState);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/nf-msxml6-ixmlhttprequest2-setcustomresponsestream
    HRESULT SetCustomResponseStream(ISequentialStream pSequentialStream);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/nf-msxml6-ixmlhttprequest2-setproperty
    HRESULT SetProperty(XHR_PROPERTY eProperty, ulong ullValue);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/nf-msxml6-ixmlhttprequest2-setrequestheader
    HRESULT SetRequestHeader(const(PWSTR) pwszHeader, const(PWSTR) pwszValue);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/nf-msxml6-ixmlhttprequest2-getallresponseheaders
    HRESULT GetAllResponseHeaders(ushort** ppwszHeaders);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/nf-msxml6-ixmlhttprequest2-getcookie
    HRESULT GetCookie(const(PWSTR) pwszUrl, const(PWSTR) pwszName, uint dwFlags, uint* pcCookies, 
                      XHR_COOKIE** ppCookies);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/nf-msxml6-ixmlhttprequest2-getresponseheader
...
interface IXMLHTTPRequest3Callback : IXMLHTTPRequest2Callback
{
    ...
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/api/msxml6/nf-msxml6-ixmlhttprequest3callback-onclientcertificaterequested
