...
enum uint TBS_CONTEXT_VERSION_ONE = 0x00000001;
enum uint TBS_SUCCESS = 0x00000000;

enum : uint
{
    TBS_OWNERAUTH_TYPE_FULL           = 0x00000001,
    TBS_OWNERAUTH_TYPE_ADMIN          = 0x00000002,
    TBS_OWNERAUTH_TYPE_USER           = 0x00000003,
    TBS_OWNERAUTH_TYPE_ENDORSEMENT    = 0x00000004,
    TBS_OWNERAUTH_TYPE_ENDORSEMENT_20 = 0x0000000c,
    TBS_OWNERAUTH_TYPE_STORAGE_20     = 0x0000000d,
}

enum uint TBS_CONTEXT_VERSION_TWO = 0x00000002;

enum : uint
{
    TPM_WNF_INFO_CLEAR_SUCCESSFUL     = 0x00000001,
    TPM_WNF_INFO_OWNERSHIP_SUCCESSFUL = 0x00000002,
}

enum uint TPM_WNF_INFO_NO_REBOOT_REQUIRED = 0x00000001;

enum : uint
{
    TPM_VERSION_UNKNOWN = 0x00000000,
...
enum : uint
{
    ...
    TPM_IFTYPE_SPB       = 0x00000005,
}

enum : uint
{
    TBS_TCGLOG_SRTM_CURRENT = 0x00000000,
    TBS_TCGLOG_DRTM_CURRENT = 0x00000001,
    TBS_TCGLOG_SRTM_BOOT    = 0x00000002,
    TBS_TCGLOG_SRTM_RESUME  = 0x00000003,
    TBS_TCGLOG_DRTM_BOOT    = 0x00000004,
    TBS_TCGLOG_DRTM_RESUME  = 0x00000005,
}

// Structs


//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/tbs/ns-tbs-tbs_context_params))], [])
struct TBS_CONTEXT_PARAMS
{
    uint version_;
}

//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/tbs/ns-tbs-tbs_context_params2))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/tbs/ns-tbs-tpm_device_info))], [])
