...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/wslapi/ne-wslapi-wsl_distribution_flags
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/wslapi/nf-wslapi-wslisdistributionregistered
@DllImport("Api-ms-win-wsl-api-l1-1-0.dll")
BOOL WslIsDistributionRegistered(const(PWSTR) distributionName);

// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/wslapi/nf-wslapi-wslregisterdistribution
@DllImport("Api-ms-win-wsl-api-l1-1-0.dll")
HRESULT WslRegisterDistribution(const(PWSTR) distributionName, const(PWSTR) tarGzFilename);

// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/wslapi/nf-wslapi-wslunregisterdistribution
@DllImport("Api-ms-win-wsl-api-l1-1-0.dll")
HRESULT WslUnregisterDistribution(const(PWSTR) distributionName);

// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/wslapi/nf-wslapi-wslconfiguredistribution
@DllImport("Api-ms-win-wsl-api-l1-1-0.dll")
HRESULT WslConfigureDistribution(const(PWSTR) distributionName, uint defaultUID, 
                                 WSL_DISTRIBUTION_FLAGS wslDistributionFlags);

// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/wslapi/nf-wslapi-wslgetdistributionconfiguration
@DllImport("Api-ms-win-wsl-api-l1-1-0.dll")
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/wslapi/nf-wslapi-wsllaunchinteractive
@DllImport("Api-ms-win-wsl-api-l1-1-0.dll")
HRESULT WslLaunchInteractive(const(PWSTR) distributionName, const(PWSTR) command, BOOL useCurrentWorkingDirectory, 
                             uint* exitCode);

// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/wslapi/nf-wslapi-wsllaunch
@DllImport("Api-ms-win-wsl-api-l1-1-0.dll")
