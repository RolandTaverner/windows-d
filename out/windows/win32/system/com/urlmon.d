...
enum uint FMFD_ENABLEMIMESNIFFING = 0x00000002;
enum uint FMFD_IGNOREMIMETEXTPLAIN = 0x00000004;
enum uint FMFD_SERVERMIME = 0x00000008;
enum uint FMFD_RESPECTTEXTPLAIN = 0x00000010;
enum uint FMFD_RETURNUPDATEDIMGMIMES = 0x00000020;
...
enum uint UAS_EXACTLEGACY = 0x00001000;
...
enum uint Uri_PUNYCODE_IDN_HOST = 0x00000002;
...
enum uint UriBuilder_USE_ORIGINAL_FLAGS = 0x00000001;
enum uint WININETINFO_OPTION_LOCK_HANDLE = 0x0000fffe;

enum : uint
{
    URLOSTRM_USECACHEDCOPY_ONLY = 0x00000001,
...
enum uint MUTZ_NOSAVEDFILECHECK = 0x00000001;
...
enum uint MUTZ_ENFORCERESTRICTED = 0x00000100;
...
enum uint MUTZ_FORCE_INTRANET_FLAGS = 0x00002000;
enum uint MUTZ_IGNORE_ZONE_MAPPINGS = 0x00004000;
enum uint MAX_SIZE_SECURITY_ID = 0x00000200;
...
enum uint URLPOLICY_ACTIVEX_CHECK_LIST = 0x00010000;
...
enum uint URLACTION_SCRIPT_OVERRIDE_SAFETY = 0x00001401;
...
enum uint URLACTION_CROSS_DOMAIN_DATA = 0x00001406;
...
enum uint URLACTION_PLUGGABLE_PROTOCOL_XHR = 0x0000140b;
...
enum uint URLACTION_HTML_REQUIRE_UTF8_DOCUMENT_CODEPAGE = 0x0000160c;
...
enum uint URLACTION_AUTHENTICATE_CLIENT = 0x00001a01;
...
enum uint URLACTION_CHANNEL_SOFTDIST_MAX = 0x00001eff;
...
enum uint URLPOLICY_BEHAVIOR_CHECK_LIST = 0x00010000;
...
enum uint URLACTION_WINDOWS_BROWSER_APPLICATIONS = 0x00002400;
...
enum uint URLACTION_ALLOW_RENDER_LEGACY_DXTFILTERS = 0x0000270b;
enum uint URLACTION_ALLOW_ANTIMALWARE_SCANNING_OF_ACTIVEX = 0x0000270c;
enum uint URLACTION_ALLOW_CSS_EXPRESSIONS = 0x0000270d;
...
enum : uint
{
    URLPOLICY_LOG_ON_ALLOW    = 0x00000040,
    URLPOLICY_LOG_ON_DISALLOW = 0x00000080,
}

enum uint URLPOLICY_MASK_PERMISSIONS = 0x0000000f;
enum uint URLPOLICY_DONTCHECKDLGBOX = 0x00000100;
enum uint URLZONE_ESC_FLAG = 0x00000100;
...
enum uint CONFIRMSAFETYACTION_LOADOBJECT = 0x00000001;
