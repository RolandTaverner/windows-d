...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/featurestagingapi/ne-featurestagingapi-feature_change_time))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/featurestagingapi/ne-featurestagingapi-feature_enabled_state))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/wldp/ne-wldp-wldp_host_id))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/wldp/ne-wldp-wldp_windows_lockdown_mode))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/wldp/ne-wldp-wldp_execution_policy))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/wldp/ne-wldp-wldp_execution_evaluation_options))], [])
...
enum uint WLDP_HOST_INFORMATION_REVISION = 0x00000001;
enum uint WLDP_FLAGS_SKIPSIGNATUREVALIDATION = 0x00000100;
enum uint MAX_TDI_ENTITIES = 0x00001000;
...
enum uint ENTITY_LIST_ID = 0x00000000;
enum int INVALID_ENTITY_INSTANCE = 0xffffffff;
enum uint CONTEXT_SIZE = 0x00000010;
enum uint ENTITY_TYPE_ID = 0x00000001;
...
enum uint IF_GENERIC = 0x00000200;
enum uint IF_MIB = 0x00000202;
enum uint IOCTL_TDI_TL_IO_CONTROL_ENDPOINT = 0x00210038;
enum uint DCI_VERSION = 0x00000100;
enum uint DCICREATEPRIMARYSURFACE = 0x00000001;
enum uint DCICREATEOFFSCREENSURFACE = 0x00000002;
enum uint DCICREATEOVERLAYSURFACE = 0x00000003;
enum uint DCIENUMSURFACE = 0x00000004;
enum uint DCIESCAPE = 0x00000005;
enum uint DCI_OK = 0x00000000;
...
enum uint DCI_SURFACE_TYPE = 0x0000000f;
enum uint DCI_PRIMARY = 0x00000000;
enum uint DCI_OFFSCREEN = 0x00000001;
enum uint DCI_OVERLAY = 0x00000002;
enum uint DCI_VISIBLE = 0x00000010;
enum uint DCI_CHROMAKEY = 0x00000020;
enum uint DCI_1632_ACCESS = 0x00000040;
...
enum uint DCI_WRITEONLY = 0x00000200;
...
enum uint FILE_FLAG_OPEN_REQUIRING_OPLOCK = 0x00040000;
enum uint FILE_FLAG_IGNORE_IMPERSONATED_DEVICEMAP = 0x00020000;
enum uint FILE_FLAG_DISALLOW_PATH_REDIRECTS = 0x00010000;
enum uint FAIL_FAST_GENERATE_EXCEPTION_ADDRESS = 0x00000001;
enum uint FAIL_FAST_NO_HARD_ERROR_DLG = 0x00000002;
enum uint SP_SERIALCOMM = 0x00000001;
enum uint PST_UNSPECIFIED = 0x00000000;
...
enum uint PST_NETWORK_BRIDGE = 0x00000100;
...
enum uint PST_X25 = 0x00000103;
enum uint PCF_DTRDSR = 0x00000001;
...
enum uint PCF_XONXOFF = 0x00000010;
enum uint PCF_SETXCHAR = 0x00000020;
enum uint PCF_TOTALTIMEOUTS = 0x00000040;
enum uint PCF_INTTIMEOUTS = 0x00000080;
enum uint PCF_SPECIALCHARS = 0x00000100;
enum uint PCF_16BITMODE = 0x00000200;
enum uint SP_PARITY = 0x00000001;
...
enum uint SP_STOPBITS = 0x00000008;
enum uint SP_HANDSHAKING = 0x00000010;
enum uint SP_PARITY_CHECK = 0x00000020;
enum uint SP_RLSD = 0x00000040;
...
enum uint COMMPROP_INITIALIZED = 0xe73cf52e;
...
enum uint GMEM_NOT_BANKED = 0x00001000;
...
enum uint GMEM_INVALID_HANDLE = 0x00008000;
enum uint GMEM_DISCARDED = 0x00004000;
enum uint GMEM_LOCKCOUNT = 0x000000ff;
enum uint THREAD_PRIORITY_ERROR_RETURN = 0x7fffffff;
...
enum uint DRIVE_REMOVABLE = 0x00000002;
...
enum uint CBR_256000 = 0x0003e800;
enum uint CE_TXFULL = 0x00000100;
...
enum uint RESETDEV = 0x00000007;
enum uint LPTx = 0x00000080;
enum uint S_QUEUEEMPTY = 0x00000000;
enum uint S_THRESHOLD = 0x00000001;
enum uint S_ALLTHRESHOLD = 0x00000002;
enum uint S_NORMAL = 0x00000000;
enum uint S_LEGATO = 0x00000001;
enum uint S_STACCATO = 0x00000002;
...
enum uint FS_CASE_IS_PRESERVED = 0x00000002;
enum uint FS_CASE_SENSITIVE = 0x00000001;
enum uint FS_UNICODE_STORED_ON_DISK = 0x00000004;
enum uint FS_PERSISTENT_ACLS = 0x00000008;
enum uint FS_VOL_IS_COMPRESSED = 0x00008000;
...
enum uint OFS_MAXPATHNAME = 0x00000080;
enum uint MAXINTATOM = 0x0000c000;
enum uint SCS_32BIT_BINARY = 0x00000000;
enum uint SCS_DOS_BINARY = 0x00000001;
enum uint SCS_WOW_BINARY = 0x00000002;
enum uint SCS_PIF_BINARY = 0x00000003;
enum uint SCS_POSIX_BINARY = 0x00000004;
enum uint SCS_OS216_BINARY = 0x00000005;
enum uint SCS_64BIT_BINARY = 0x00000006;
enum uint SCS_THIS_PLATFORM_BINARY = 0x00000006;
enum uint FIBER_FLAG_FLOAT_SWITCH = 0x00000001;
enum uint UMS_VERSION = 0x00000100;
enum uint FILE_SKIP_COMPLETION_PORT_ON_SUCCESS = 0x00000001;
enum uint FILE_SKIP_SET_EVENT_ON_HANDLE = 0x00000002;
enum uint CRITICAL_SECTION_NO_DEBUG_INFO = 0x01000000;
enum uint HINSTANCE_ERROR = 0x00000020;
enum uint FORMAT_MESSAGE_MAX_WIDTH_MASK = 0x000000ff;
enum uint FILE_ENCRYPTABLE = 0x00000000;
enum uint FILE_IS_ENCRYPTED = 0x00000001;
enum uint FILE_SYSTEM_ATTR = 0x00000002;
enum uint FILE_ROOT_DIR = 0x00000003;
enum uint FILE_SYSTEM_DIR = 0x00000004;
...
enum uint FILE_USER_DISALLOWED = 0x00000007;
enum uint FILE_READ_ONLY = 0x00000008;
enum uint FILE_DIR_DISALLOWED = 0x00000009;
enum uint EFS_USE_RECOVERY_KEYS = 0x00000001;
...
enum uint OVERWRITE_HIDDEN = 0x00000004;
enum uint EFSRPC_SECURE_ONLY = 0x00000008;
enum uint EFS_DROP_ALTERNATE_STREAMS = 0x00000010;
...
enum uint STREAM_CONTAINS_GHOSTED_FILE_EXTENTS = 0x00000010;
enum uint STARTF_HOLOGRAPHIC = 0x00040000;
enum uint SHUTDOWN_NORETRY = 0x00000001;
enum uint PROTECTION_LEVEL_SAME = 0xffffffff;
enum uint ATOM_FLAG_GLOBAL = 0x00000002;
...
enum uint EVENTLOG_FULL_INFO = 0x00000000;
enum uint OPERATION_API_VERSION = 0x00000001;
enum uint MAX_COMPUTERNAME_LENGTH = 0x0000000f;
...
enum uint LOGON_ZERO_PASSWORD_BUFFER = 0x80000000;
enum uint HW_PROFILE_GUIDLEN = 0x00000027;
...
enum uint TC_NORMAL = 0x00000000;
enum uint TC_HARDERR = 0x00000001;
enum uint TC_GP_TRAP = 0x00000002;
enum uint TC_SIGNAL = 0x00000003;
...
enum uint AC_LINE_UNKNOWN = 0x000000ff;
...
enum uint BATTERY_PERCENTAGE_UNKNOWN = 0x000000ff;
enum uint SYSTEM_STATUS_FLAG_POWER_SAVING_ON = 0x00000001;
...
enum uint ACTIVATION_CONTEXT_BASIC_INFORMATION_DEFINED = 0x00000001;
...
enum uint RESTART_MAX_CMD_LINE = 0x00000400;
enum uint RECOVERY_DEFAULT_PING_INTERVAL = 0x00001388;
...
enum uint STORAGE_INFO_OFFSET_UNKNOWN = 0xffffffff;
...
enum uint MICROSOFT_WINDOWS_WINBASE_H_DEFINE_INTERLOCKED_CPLUSPLUS_OVERLOADS = 0x00000000;
enum uint MICROSOFT_WINBASE_H_DEFINE_INTERLOCKED_CPLUSPLUS_OVERLOADS = 0x00000000;
...
enum uint FILE_VALID_MAILSLOT_OPTION_FLAGS = 0x00000032;
enum uint FILE_VALID_SET_FLAGS = 0x00000036;
...
enum uint RSC_FLAG_SETUPAPI = 0x00000400;
...
enum uint ALINF_BKINSTALL = 0x00000020;
...
enum uint ALINF_ROLLBKDOALL = 0x00000100;
enum uint ALINF_DELAYREGISTEROCX = 0x00000200;
enum uint AIF_WARNIFSKIP = 0x00000001;
...
enum uint AIF_FORCE_FILE_IN_USE = 0x00000008;
enum uint AIF_NOOVERWRITE = 0x00000010;
enum uint AIF_NO_VERSION_DIALOG = 0x00000020;
enum uint AIF_REPLACEONLY = 0x00000400;
enum uint AIF_NOLANGUAGECHECK = 0x10000000;
enum uint AIF_QUIET = 0x20000000;
enum uint IE4_RESTORE = 0x00000001;
enum uint IE4_BACKNEW = 0x00000002;
enum uint IE4_NODELETENEW = 0x00000004;
...
enum uint IE4_REGSECTION = 0x00000080;
enum uint IE4_FRDOALL = 0x00000100;
enum uint IE4_UPDREFCNT = 0x00000200;
enum uint IE4_USEREFCNT = 0x00000400;
enum uint IE4_EXTRAINCREFCNT = 0x00000800;
enum uint IE4_REMOVREGBKDATA = 0x00001000;
...
enum uint AFSR_EXTRAINCREFCNT = 0x00000800;
enum uint AADBE_ADD_ENTRY = 0x00000001;
enum uint AADBE_DEL_ENTRY = 0x00000002;
enum uint ADN_DEL_IF_EMPTY = 0x00000001;
...
enum uint ADN_DEL_UNC_PATHS = 0x00000008;
...
enum uint IME_MAXPROCESS = 0x00000020;
...
enum uint CP_LEVEL = 0x00000003;
enum uint MCW_DEFAULT = 0x00000000;
...
enum uint MCW_SCREEN = 0x00000004;
enum uint MCW_VERTICAL = 0x00000008;
enum uint MCW_HIDDEN = 0x00000010;
...
enum uint IME_GETIMECAPS = 0x00000003;
enum uint IME_SETOPEN = 0x00000004;
...
enum uint IME_SETCONVERSIONWINDOW = 0x00000008;
enum uint IME_MOVEIMEWINDOW = 0x00000008;
enum uint IME_SETCONVERSIONMODE = 0x00000010;
enum uint IME_GETCONVERSIONMODE = 0x00000011;
...
enum uint IME_ENTERWORDREGISTERMODE = 0x00000018;
enum uint IME_SETCONVERSIONFONTEX = 0x00000019;
enum uint IME_BANJAtoJUNJA = 0x00000013;
enum uint IME_JUNJAtoBANJA = 0x00000014;
enum uint IME_JOHABtoKS = 0x00000015;
enum uint IME_KStoJOHAB = 0x00000016;
...
enum uint IME_REQUEST_CONVERT = 0x00000001;
enum uint IME_ENABLE_CONVERT = 0x00000002;
enum uint INTERIM_WINDOW = 0x00000000;
enum uint MODE_WINDOW = 0x00000001;
enum uint HANJA_WINDOW = 0x00000002;
...
enum uint WM_IME_REPORT = 0x00000280;
...
enum uint IR_OPENCONVERT = 0x00000120;
enum uint IR_CHANGECONVERT = 0x00000121;
enum uint IR_CLOSECONVERT = 0x00000122;
enum uint IR_FULLCONVERT = 0x00000123;
enum uint IR_IMESELECT = 0x00000130;
enum uint IR_STRING = 0x00000140;
enum uint IR_DBCSCHAR = 0x00000160;
enum uint IR_UNDETERMINE = 0x00000170;
enum uint IR_STRINGEX = 0x00000180;
enum uint IR_MODEINFO = 0x00000190;
enum uint WM_WNT_CONVERTREQUESTEX = 0x00000109;
...
enum uint WM_INTERIM = 0x0000010c;
...
enum uint DELAYLOAD_GPA_FAILURE = 0x00000004;
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winbase/ns-winbase-hw_profile_infoa))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winbase/ns-winbase-hw_profile_infow))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/featurestagingapi/ns-featurestagingapi-feature_error))], [])
...
//STRUCT ATTR: AnsiAttribute : CustomAttributeSig([], [])
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/advpub/ns-advpub-strentrya))], [])
struct STRENTRYA
{
    PSTR pszName;
    PSTR pszValue;
...
//STRUCT ATTR: UnicodeAttribute : CustomAttributeSig([], [])
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/advpub/ns-advpub-strentryw))], [])
struct STRENTRYW
{
    PWSTR pszName;
    PWSTR pszValue;
...
//STRUCT ATTR: AnsiAttribute : CustomAttributeSig([], [])
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/advpub/ns-advpub-strtablea))], [])
struct STRTABLEA
{
    uint       cEntries;
    STRENTRYA* pse;
...
//STRUCT ATTR: UnicodeAttribute : CustomAttributeSig([], [])
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/advpub/ns-advpub-strtablew))], [])
struct STRTABLEW
{
    uint       cEntries;
    STRENTRYW* pse;
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ime/ns-ime-imestruct))], [])
struct IMESTRUCT
{
    uint   fnc;
    WPARAM wParam;
...
//STRUCT ATTR: StructSizeFieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(cbSize))], [])
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/capi/ns-capi-java_trust))], [])
struct JAVA_TRUST
{
    uint         cbSize;
    uint         flag;
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/tdiinfo/ns-tdiinfo-tdientityid))], [])
struct TDIEntityID
{
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/tdiinfo/ns-tdiinfo-tdiobjectid))], [])
struct TDIObjectID
{
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/tdiinfo/ns-tdiinfo-tcp_request_query_information_ex_xp))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/tdiinfo/ns-tdiinfo-tcp_request_query_information_ex_w2k))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/wldp/ns-wldp-wldp_host_information))], [])
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/stralign/nf-stralign-uaw_wcslen))], [])
@DllImport("KERNEL32.dll")
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/apiquery2/nf-apiquery2-isapisetimplemented))], [])
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winbase/nf-winbase-sethandlecount))], [])
@DllImport("KERNEL32.dll")
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winbase/nf-winbase-_lopen))], [])
@DllImport("KERNEL32.dll")
int _lopen(const(PSTR) lpPathName, int iReadWrite);

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winbase/nf-winbase-_lcreat))], [])
@DllImport("KERNEL32.dll")
int _lcreat(const(PSTR) lpPathName, int iAttribute);

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winbase/nf-winbase-_lread))], [])
@DllImport("KERNEL32.dll")
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winbase/nf-winbase-_lwrite))], [])
@DllImport("KERNEL32.dll")
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winbase/nf-winbase-_lclose))], [])
@DllImport("KERNEL32.dll")
int _lclose(int hFile);

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winbase/nf-winbase-_llseek))], [])
@DllImport("KERNEL32.dll")
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winbase/nf-winbase-getthreadenabledxstatefeatures))], [])
@DllImport("KERNEL32.dll")
ulong GetThreadEnabledXStateFeatures();

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winbase/nf-winbase-enableprocessoptionalxstatefeatures))], [])
@DllImport("KERNEL32.dll")
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winternl/nf-winternl-rtlisnamelegaldos8dot3))], [])
@DllImport("ntdll.dll")
BOOLEAN RtlIsNameLegalDOS8Dot3(UNICODE_STRING* Name, STRING* OemName, BOOLEAN* NameContainsSpaces);

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winternl/nf-winternl-rtllocaltimetosystemtime))], [])
@DllImport("ntdll.dll")
NTSTATUS RtlLocalTimeToSystemTime(long* LocalTime, long* SystemTime);

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winternl/nf-winternl-rtltimetosecondssince1970))], [])
@DllImport("ntdll.dll")
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winternl/nf-winternl-rtlinitstring))], [])
@DllImport("ntdll.dll")
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winternl/nf-winternl-rtluniform))], [])
@DllImport("ntdll.dll")
uint RtlUniform(uint* Seed);

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/featurestagingapi/nf-featurestagingapi-getfeatureenabledstate))], [])
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/featurestagingapi/nf-featurestagingapi-recordfeatureusage))], [])
@DllImport("api-ms-win-core-featurestaging-l1-1-0.dll")
void RecordFeatureUsage(uint featureId, uint kind, uint addend, const(PSTR) originName);

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/featurestagingapi/nf-featurestagingapi-recordfeatureerror))], [])
@DllImport("api-ms-win-core-featurestaging-l1-1-0.dll")
void RecordFeatureError(uint featureId, const(FEATURE_ERROR)* error);

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/featurestagingapi/nf-featurestagingapi-subscribefeaturestatechangenotification))], [])
@DllImport("api-ms-win-core-featurestaging-l1-1-0.dll")
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/featurestagingapi/nf-featurestagingapi-unsubscribefeaturestatechangenotification))], [])
@DllImport("api-ms-win-core-featurestaging-l1-1-0.dll")
void UnsubscribeFeatureStateChangeNotification(FEATURE_STATE_CHANGE_SUBSCRIPTION subscription);

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/featurestagingapi/nf-featurestagingapi-getfeaturevariant))], [])
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/ddrawgdi/nf-ddrawgdi-ddquerydisplaysettingsuniqueness))], [])
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/appcompatapi/nf-appcompatapi-apphelpcheckshellobject))], [])
@DllImport("APPHELP.dll")
BOOL ApphelpCheckShellObject(const(GUID)* ObjectCLSID, BOOL bShimIfNecessary, ulong* pullFlags);

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/wldp/nf-wldp-wldpgetlockdownpolicy))], [])
@DllImport("Wldp.dll")
HRESULT WldpGetLockdownPolicy(WLDP_HOST_INFORMATION* hostInformation, uint* lockdownState, uint lockdownFlags);

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/wldp/nf-wldp-wldpisclassinapprovedlist))], [])
@DllImport("Wldp.dll")
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/wldp/nf-wldp-wldpsetdynamiccodetrust))], [])
@DllImport("Wldp.dll")
HRESULT WldpSetDynamicCodeTrust(HANDLE fileHandle);

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/wldp/nf-wldp-wldpisdynamiccodepolicyenabled))], [])
@DllImport("Wldp.dll")
HRESULT WldpIsDynamicCodePolicyEnabled(BOOL* isEnabled);

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/wldp/nf-wldp-wldpquerydynamiccodetrust))], [])
@DllImport("Wldp.dll")
HRESULT WldpQueryDynamicCodeTrust(HANDLE fileHandle, 
                                  /*PARAM ATTR: MemorySizeAttribute : CustomAttributeSig([], [NamedArgSig("BytesParamIndex", FixedArgSig(ElementSig(2)))])*/void* baseImage, 
                                  uint imageSize);

//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/wldp/nf-wldp-wldpquerywindowslockdownmode))], [])
@DllImport("Wldp.dll")
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/wldp/nf-wldp-wldpcanexecutefile))], [])
@DllImport("Wldp.dll")
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/wldp/nf-wldp-wldpcanexecutebuffer))], [])
@DllImport("Wldp.dll")
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/wldp/nf-wldp-wldpcanexecutestream))], [])
@DllImport("Wldp.dll")
...
//INTERFACEF ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/camerauicontrol/nn-camerauicontrol-icamerauicontroleventcallback))], [])
interface ICameraUIControlEventCallback : IUnknown
{
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/camerauicontrol/nf-camerauicontrol-icamerauicontroleventcallback-onstartupcomplete))], [])
    void OnStartupComplete();
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/camerauicontrol/nf-camerauicontrol-icamerauicontroleventcallback-onsuspendcomplete))], [])
    void OnSuspendComplete();
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/camerauicontrol/nf-camerauicontrol-icamerauicontroleventcallback-onitemcaptured))], [])
    void OnItemCaptured(const(PWSTR) pszPath);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/camerauicontrol/nf-camerauicontrol-icamerauicontroleventcallback-onitemdeleted))], [])
    void OnItemDeleted(const(PWSTR) pszPath);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/camerauicontrol/nf-camerauicontrol-icamerauicontroleventcallback-onclosed))], [])
    void OnClosed();
}

@GUID("b8733adf-3d68-4b8f-bb08-e28a0bed0376")
//INTERFACEF ATTR: SupportedOSPlatformAttribute : CustomAttributeSig([FixedArgSig(ElementSig(windows8.0))], [])
//INTERFACEF ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/camerauicontrol/nn-camerauicontrol-icamerauicontrol))], [])
interface ICameraUIControl : IUnknown
{
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/camerauicontrol/nf-camerauicontrol-icamerauicontrol-show))], [])
...
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/camerauicontrol/nf-camerauicontrol-icamerauicontrol-close))], [])
    HRESULT Close();
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/camerauicontrol/nf-camerauicontrol-icamerauicontrol-suspend))], [])
    HRESULT Suspend(BOOL* pbDeferralRequired);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/camerauicontrol/nf-camerauicontrol-icamerauicontrol-resume))], [])
    HRESULT Resume();
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/camerauicontrol/nf-camerauicontrol-icamerauicontrol-getcurrentviewtype))], [])
    HRESULT GetCurrentViewType(CameraUIControlViewType* pViewType);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/camerauicontrol/nf-camerauicontrol-icamerauicontrol-getactiveitem))], [])
    HRESULT GetActiveItem(BSTR* pbstrActiveItemPath);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/camerauicontrol/nf-camerauicontrol-icamerauicontrol-getselecteditems))], [])
    HRESULT GetSelectedItems(SAFEARRAY** ppSelectedItemPaths);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/camerauicontrol/nf-camerauicontrol-icamerauicontrol-removecaptureditem))], [])
...
//INTERFACEF ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/editionupgradehelper/nn-editionupgradehelper-ieditionupgradehelper))], [])
interface IEditionUpgradeHelper : IUnknown
{
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/editionupgradehelper/nf-editionupgradehelper-ieditionupgradehelper-canupgrade))], [])
    HRESULT CanUpgrade(BOOL* isAllowed);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/editionupgradehelper/nf-editionupgradehelper-ieditionupgradehelper-updateoperatingsystem))], [])
    HRESULT UpdateOperatingSystem(const(PWSTR) contentId);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/editionupgradehelper/nf-editionupgradehelper-ieditionupgradehelper-showproductkeyui))], [])
    HRESULT ShowProductKeyUI();
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/editionupgradehelper/nf-editionupgradehelper-ieditionupgradehelper-getosproductcontentid))], [])
    HRESULT GetOsProductContentId(PWSTR* contentId);
//METH ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/editionupgradehelper/nf-editionupgradehelper-ieditionupgradehelper-getgenuinelocalstatus))], [])
