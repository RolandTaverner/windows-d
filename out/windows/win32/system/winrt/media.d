...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/windows.media.core.interop/nn-windows-media-core-interop-iaudioframenative
@GUID("20be1e2e-930f-4746-9335-3c332f255093")
interface IAudioFrameNative : IInspectable
{
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/WinRT/iaudioframenative-getdata
    HRESULT GetData(const(GUID)* riid, void** ppv);
}

// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/windows.media.core.interop/nn-windows-media-core-interop-ivideoframenative
@GUID("26ba702b-314a-4620-aaf6-7a51aa58fa18")
interface IVideoFrameNative : IInspectable
{
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/WinRT/ivideoframenative-getdata
    HRESULT GetData(const(GUID)* riid, void** ppv);
    // Microsoft documentation: https://learn.microsoft.com/windows/win32/WinRT/ivideoframenative-getdevice
    HRESULT GetDevice(const(GUID)* riid, void** ppv);
}

// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/windows.media.core.interop/nn-windows-media-core-interop-iaudioframenativefactory
...
// Microsoft documentation: https://learn.microsoft.com/windows/win32/api/windows.media.core.interop/nn-windows-media-core-interop-ivideoframenativefactory
