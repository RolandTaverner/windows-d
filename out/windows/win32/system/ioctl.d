...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ne-winioctl-storage_media_type))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ne-winioctl-storage_query_type))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ne-winioctl-storage_property_id))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ne-winioctl-storage_port_code_set))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ne-winioctl-storage_protocol_type))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ne-winioctl-storage_protocol_nvme_data_type))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ne-winioctl-storage_protocol_ata_data_type))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ne-winioctl-storage_device_form_factor))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ne-winioctl-storage_component_health_status))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ne-winioctl-write_cache_type))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ne-winioctl-write_cache_enable))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ne-winioctl-write_cache_change))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ne-winioctl-write_through))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ne-winioctl-storage_device_power_cap_units))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ne-winioctl-media_type))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ne-winioctl-partition_style))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ne-winioctl-element_type))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ne-winioctl-csv_control_op))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ne-winioctl-file_storage_tier_media_type))], [])
...
enum uint IOCTL_STORAGE_BASE = 0x0000002d;
enum uint IOCTL_SCMBUS_BASE = 0x00000059;
enum uint IOCTL_DISK_BASE = 0x00000007;
enum uint IOCTL_CHANGER_BASE = 0x00000030;
enum uint FILE_SPECIAL_ACCESS = 0x00000000;
enum uint FILE_DEVICE_UNKNOWN = 0x00000022;
...
enum uint IOCTL_STORAGE_MINIPORT_PASSTHROUGH_REQUEST = 0x002dd050;
...
enum uint IOCTL_STORAGE_GET_DEVICE_TELEMETRY_RAW = 0x002dd1cc;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-ioctl_storage_set_temperature_threshold))], [])*/uint IOCTL_STORAGE_SET_TEMPERATURE_THRESHOLD = 0x002dd200;
...
enum uint IOCTL_STORAGE_GET_LB_PROVISIONING_MAP_RESOURCES = 0x002d5408;
...
enum uint IOCTL_STORAGE_START_DATA_INTEGRITY_CHECK = 0x002dd884;
enum uint IOCTL_STORAGE_STOP_DATA_INTEGRITY_CHECK = 0x002dd888;
...
enum uint IOCTL_STORAGE_REMOVE_ELEMENT_AND_TRUNCATE = 0x002d1cc0;
enum uint IOCTL_STORAGE_GET_DEVICE_INTERNAL_LOG = 0x002d1cc4;
enum uint STORAGE_FEATURE_SUPPORT_V1 = 0x00000001;

enum : uint
{
    STORAGE_DEVICE_FLAGS_RANDOM_DEVICEGUID_REASON_CONFLICT = 0x00000001,
    STORAGE_DEVICE_FLAGS_RANDOM_DEVICEGUID_REASON_NOHWID   = 0x00000002,
    STORAGE_DEVICE_FLAGS_PAGE_83_DEVICEGUID                = 0x00000004,
}

enum uint RECOVERED_WRITES_VALID = 0x00000001;
enum uint UNRECOVERED_WRITES_VALID = 0x00000002;
enum uint RECOVERED_READS_VALID = 0x00000004;
enum uint UNRECOVERED_READS_VALID = 0x00000008;
enum uint WRITE_COMPRESSION_INFO_VALID = 0x00000010;
enum uint READ_COMPRESSION_INFO_VALID = 0x00000020;
...
enum uint MEDIA_ERASEABLE = 0x00000001;
enum uint MEDIA_WRITE_ONCE = 0x00000002;
...
enum uint MEDIA_WRITE_PROTECTED = 0x00000100;
enum uint MEDIA_CURRENTLY_MOUNTED = 0x80000000;
enum uint STORAGE_FAILURE_PREDICTION_CONFIG_V1 = 0x00000001;
enum uint SRB_TYPE_SCSI_REQUEST_BLOCK = 0x00000000;
enum uint SRB_TYPE_STORAGE_REQUEST_BLOCK = 0x00000001;
enum uint STORAGE_ADDRESS_TYPE_BTL8 = 0x00000000;
enum uint STORAGE_RPMB_DESCRIPTOR_VERSION_1 = 0x00000001;
enum uint STORAGE_RPMB_MINIMUM_RELIABLE_WRITE_SIZE = 0x00000200;

enum : uint
{
    STORAGE_CRYPTO_CAPABILITY_VERSION_1 = 0x00000001,
    STORAGE_CRYPTO_CAPABILITY_VERSION_2 = 0x00000002,
    STORAGE_CRYPTO_DESCRIPTOR_VERSION_1 = 0x00000001,
    STORAGE_CRYPTO_DESCRIPTOR_VERSION_2 = 0x00000002,
}

enum : uint
{
    STORAGE_HW_CRYPTO_CAPABILITY_VERSION_1 = 0x00000001,
    STORAGE_HW_CRYPTO_DESCRIPTOR_VERSION_1 = 0x00000001,
}

enum : uint
{
    STORAGE_TIER_NAME_LENGTH           = 0x00000100,
    STORAGE_TIER_DESCRIPTION_LENGTH    = 0x00000200,
...
enum uint STORAGE_PROTOCOL_DATA_DESCRIPTOR_EXT_VERSION = 0x00000001;

enum : uint
{
    STORAGE_TEMPERATURE_VALUE_NOT_REPORTED             = 0x00008000,
    STORAGE_TEMPERATURE_THRESHOLD_FLAG_ADAPTER_REQUEST = 0x00000001,
}
...
enum : uint
{
    STORAGE_ATTRIBUTE_BYTE_ADDRESSABLE_IO      = 0x00000001,
    STORAGE_ATTRIBUTE_BLOCK_IO                 = 0x00000002,
    STORAGE_ATTRIBUTE_DYNAMIC_PERSISTENCE      = 0x00000004,
    STORAGE_ATTRIBUTE_VOLATILE                 = 0x00000008,
    STORAGE_ATTRIBUTE_ASYNC_EVENT_NOTIFICATION = 0x00000010,
    STORAGE_ATTRIBUTE_PERF_SIZE_INDEPENDENT    = 0x00000020,
}

enum uint STORAGE_DEVICE_MAX_OPERATIONAL_STATUS = 0x00000010;
enum uint STORAGE_ADAPTER_SERIAL_NUMBER_V1_MAX_LENGTH = 0x00000080;
enum uint DeviceDsmActionFlag_NonDestructive = 0x80000000;
...
enum : uint
{
    STORAGE_OFFLOAD_MAX_TOKEN_LENGTH      = 0x00000200,
    STORAGE_OFFLOAD_TOKEN_ID_LENGTH       = 0x000001f8,
    STORAGE_OFFLOAD_TOKEN_TYPE_ZERO_DATA  = 0xffff0001,
    STORAGE_OFFLOAD_READ_RANGE_TRUNCATED  = 0x00000001,
    STORAGE_OFFLOAD_WRITE_RANGE_TRUNCATED = 0x00000001,
    STORAGE_OFFLOAD_TOKEN_INVALID         = 0x00000002,
}

enum uint DEVICE_DSM_FLAG_ALLOCATION_CONSOLIDATEABLE_ONLY = 0x40000000;
enum uint DEVICE_DSM_PARAMETERS_V1 = 0x00000001;
enum uint DEVICE_DATA_SET_LBP_STATE_PARAMETERS_VERSION_V1 = 0x00000001;
...
enum uint DEVICE_DSM_FLAG_PHYSICAL_ADDRESSES_OMIT_TOTAL_RANGES = 0x10000000;

enum : uint
{
    DEVICE_DSM_PHYSICAL_ADDRESSES_OUTPUT_V1         = 0x00000001,
    DEVICE_DSM_PHYSICAL_ADDRESSES_OUTPUT_VERSION_V1 = 0x00000001,
}

enum uint DEVICE_STORAGE_NO_ERRORS = 0x00000001;

enum : uint
{
    DEVICE_DSM_RANGE_ERROR_OUTPUT_V1       = 0x00000001,
    DEVICE_DSM_RANGE_ERROR_INFO_VERSION_V1 = 0x00000001,
}

enum uint IOCTL_STORAGE_BC_VERSION = 0x00000001;
enum uint STORAGE_PRIORITY_HINT_SUPPORTED = 0x00000001;
enum uint STORAGE_DIAGNOSTIC_FLAG_ADAPTER_REQUEST = 0x00000001;
enum uint ERROR_HISTORY_DIRECTORY_ENTRY_DEFAULT_COUNT = 0x00000008;
enum uint DEVICEDUMP_STRUCTURE_VERSION_V1 = 0x00000001;
enum uint DEVICEDUMP_MAX_IDSTRING = 0x00000020;
enum uint MAX_FW_BUCKET_ID_LENGTH = 0x00000084;
...
enum uint DDUMP_FLAG_DATA_READ_FROM_DEVICE = 0x00000001;
...
enum : uint
{
    TC_PUBLIC_DEVICEDUMP_CONTENT_SMART     = 0x00000001,
    TC_PUBLIC_DEVICEDUMP_CONTENT_GPLOG     = 0x00000002,
    TC_PUBLIC_DEVICEDUMP_CONTENT_GPLOG_MAX = 0x00000010,
}

enum uint TC_DEVICEDUMP_SUBSECTION_DESC_LENGTH = 0x00000010;
...
enum uint CDB_SIZE = 0x00000010;
enum uint TELEMETRY_COMMAND_SIZE = 0x00000010;
...
enum uint STORAGE_IDLE_POWERUP_REASON_VERSION_V1 = 0x00000001;
enum uint STORAGE_DEVICE_POWER_CAP_VERSION_V1 = 0x00000001;
enum uint STORAGE_EVENT_NOTIFICATION_VERSION_V1 = 0x00000001;
...
enum : uint
{
    ...
    READ_COPY_NUMBER_BYPASS_CACHE_FLAG = 0x00000100,
}
...
enum : uint
{
    ...
    STORAGE_HW_FIRMWARE_REQUEST_FLAG_SWITCH_TO_FIRMWARE_WITHOUT_RESET = 0x10000000,
    STORAGE_HW_FIRMWARE_REQUEST_FLAG_REPLACE_AND_SWITCH_UPON_RESET    = 0x20000000,
    STORAGE_HW_FIRMWARE_REQUEST_FLAG_REPLACE_EXISTING_IMAGE           = 0x40000000,
    STORAGE_HW_FIRMWARE_REQUEST_FLAG_SWITCH_TO_EXISTING_FIRMWARE      = 0x80000000,
}

enum : uint
{
    STORAGE_HW_FIRMWARE_INVALID_SLOT    = 0x000000ff,
    STORAGE_HW_FIRMWARE_REVISION_LENGTH = 0x00000010,
}

enum : uint
{
    STORAGE_PROTOCOL_STRUCTURE_VERSION            = 0x00000001,
    STORAGE_PROTOCOL_COMMAND_FLAG_ADAPTER_REQUEST = 0x80000000,
}

enum : uint
{
    STORAGE_PROTOCOL_STATUS_PENDING                = 0x00000000,
    STORAGE_PROTOCOL_STATUS_SUCCESS                = 0x00000001,
    STORAGE_PROTOCOL_STATUS_ERROR                  = 0x00000002,
    STORAGE_PROTOCOL_STATUS_INVALID_REQUEST        = 0x00000003,
    STORAGE_PROTOCOL_STATUS_NO_DEVICE              = 0x00000004,
    STORAGE_PROTOCOL_STATUS_BUSY                   = 0x00000005,
    STORAGE_PROTOCOL_STATUS_DATA_OVERRUN           = 0x00000006,
    STORAGE_PROTOCOL_STATUS_INSUFFICIENT_RESOURCES = 0x00000007,
    STORAGE_PROTOCOL_STATUS_THROTTLED_REQUEST      = 0x00000008,
    STORAGE_PROTOCOL_STATUS_NOT_SUPPORTED          = 0x000000ff,
    STORAGE_PROTOCOL_COMMAND_LENGTH_NVME           = 0x00000040,
    STORAGE_PROTOCOL_SPECIFIC_NVME_ADMIN_COMMAND   = 0x00000001,
    STORAGE_PROTOCOL_SPECIFIC_NVME_NVM_COMMAND     = 0x00000002,
}

enum : uint
{
    STORATTRIBUTE_NONE             = 0x00000000,
    STORATTRIBUTE_MANAGEMENT_STATE = 0x00000001,
}

enum : uint
{
    STORAGE_SUPPORTED_FEATURES_BYPASS_IO = 0x00000001,
    STORAGE_SUPPORTED_FEATURES_MASK      = 0x00000001,
}
...
enum uint FILE_DEVICE_I3C = 0x00000065;
...
enum : uint
{
    ...
    METHOD_DIRECT_TO_HARDWARE   = 0x00000001,
    METHOD_DIRECT_FROM_HARDWARE = 0x00000002,
}

enum uint FILE_ANY_ACCESS = 0x00000000;
enum uint FILE_READ_ACCESS = 0x00000001;
enum uint FILE_WRITE_ACCESS = 0x00000002;
enum uint STORAGE_DEVICE_NUMA_NODE_UNKNOWN = 0xffffffff;
enum uint IOCTL_SCMBUS_DEVICE_FUNCTION_BASE = 0x00000000;
enum uint IOCTL_SCM_LOGICAL_DEVICE_FUNCTION_BASE = 0x00000300;
enum uint IOCTL_SCM_PHYSICAL_DEVICE_FUNCTION_BASE = 0x00000600;
...
enum uint IOCTL_SCM_LD_GET_INTERLEAVE_SET = 0x00590c00;
...
enum uint SCM_MAX_SYMLINK_LEN_IN_CHARS = 0x00000100;
enum uint MAX_INTERFACE_CODES = 0x00000008;
enum uint SCM_PD_FIRMWARE_REVISION_LENGTH_BYTES = 0x00000020;
enum uint SCM_PD_PROPERTY_NAME_LENGTH_IN_CHARS = 0x00000080;
enum uint SCM_PD_MAX_OPERATIONAL_STATUS = 0x00000010;
enum uint SCM_PD_FIRMWARE_LAST_DOWNLOAD = 0x00000001;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-ioctl_disk_set_partition_info))], [])*/uint IOCTL_DISK_SET_PARTITION_INFO = 0x0007c008;
...
enum uint SMART_GET_VERSION = 0x00074080;
enum uint SMART_SEND_DRIVE_COMMAND = 0x0007c084;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-ioctl_disk_get_partition_info_ex))], [])*/uint IOCTL_DISK_GET_PARTITION_INFO_EX = 0x00070048;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-ioctl_disk_set_partition_info_ex))], [])*/uint IOCTL_DISK_SET_PARTITION_INFO_EX = 0x0007c04c;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-ioctl_disk_get_drive_layout_ex))], [])*/uint IOCTL_DISK_GET_DRIVE_LAYOUT_EX = 0x00070050;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-ioctl_disk_set_drive_layout_ex))], [])*/uint IOCTL_DISK_SET_DRIVE_LAYOUT_EX = 0x0007c054;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-ioctl_disk_reassign_blocks_ex))], [])*/uint IOCTL_DISK_REASSIGN_BLOCKS_EX = 0x0007c0a4;
enum uint IOCTL_DISK_UPDATE_DRIVE_SIZE = 0x0007c0c8;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-ioctl_disk_set_cache_information))], [])*/uint IOCTL_DISK_SET_CACHE_INFORMATION = 0x0007c0d8;
enum uint IOCTL_DISK_GET_WRITE_CACHE_STATE = 0x000740dc;
enum uint OBSOLETE_DISK_GET_WRITE_CACHE_STATE = 0x000740dc;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-ioctl_disk_delete_drive_layout))], [])*/uint IOCTL_DISK_DELETE_DRIVE_LAYOUT = 0x0007c100;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-ioctl_disk_update_properties))], [])*/uint IOCTL_DISK_UPDATE_PROPERTIES = 0x00070140;
...
enum : uint
{
    PARTITION_ENTRY_UNUSED    = 0x00000000,
    PARTITION_FAT_12          = 0x00000001,
    PARTITION_XENIX_1         = 0x00000002,
    PARTITION_XENIX_2         = 0x00000003,
    PARTITION_FAT_16          = 0x00000004,
    PARTITION_EXTENDED        = 0x00000005,
    PARTITION_HUGE            = 0x00000006,
    PARTITION_IFS             = 0x00000007,
    PARTITION_OS2BOOTMGR      = 0x0000000a,
    PARTITION_FAT32           = 0x0000000b,
    PARTITION_FAT32_XINT13    = 0x0000000c,
    PARTITION_XINT13          = 0x0000000e,
    PARTITION_XINT13_EXTENDED = 0x0000000f,
}

enum : uint
{
    PARTITION_MSFT_RECOVERY = 0x00000027,
    PARTITION_MAIN_OS       = 0x00000028,
}

enum uint PARTIITON_OS_DATA = 0x00000029;

enum : uint
{
    PARTITION_PRE_INSTALLED  = 0x0000002a,
    PARTITION_BSP            = 0x0000002b,
    PARTITION_DPP            = 0x0000002c,
    PARTITION_WINDOWS_SYSTEM = 0x0000002d,
    PARTITION_PREP           = 0x00000041,
    PARTITION_LDM            = 0x00000042,
    PARTITION_DM             = 0x00000054,
    PARTITION_EZDRIVE        = 0x00000055,
    PARTITION_UNIX           = 0x00000063,
    PARTITION_SPACES_DATA    = 0x000000d7,
    PARTITION_SPACES         = 0x000000e7,
    PARTITION_GPT            = 0x000000ee,
    PARTITION_SYSTEM         = 0x000000ef,
}

enum uint VALID_NTFT = 0x000000c0;
enum uint PARTITION_NTFT = 0x00000080;
...
enum ulong GPT_SPACES_ATTRIBUTE_NO_METADATA = 0x8000000000000000;
enum uint HIST_NO_OF_BUCKETS = 0x00000018;

enum : uint
{
    DISK_LOGGING_START = 0x00000000,
    DISK_LOGGING_STOP  = 0x00000001,
    DISK_LOGGING_DUMP  = 0x00000002,
}

enum uint DISK_BINNING = 0x00000003;

enum : uint
{
    CAP_ATA_ID_CMD   = 0x00000001,
    CAP_ATAPI_ID_CMD = 0x00000002,
}

enum uint CAP_SMART_CMD = 0x00000004;
enum uint ATAPI_ID_CMD = 0x000000a1;
enum uint ID_CMD = 0x000000ec;

enum : uint
{
    SMART_CMD             = 0x000000b0,
    SMART_CYL_LOW         = 0x0000004f,
    SMART_CYL_HI          = 0x000000c2,
    SMART_NO_ERROR        = 0x00000000,
    SMART_IDE_ERROR       = 0x00000001,
    SMART_INVALID_FLAG    = 0x00000002,
    SMART_INVALID_COMMAND = 0x00000003,
    SMART_INVALID_BUFFER  = 0x00000004,
    SMART_INVALID_DRIVE   = 0x00000005,
    SMART_INVALID_IOCTL   = 0x00000006,
}

enum uint SMART_ERROR_NO_MEM = 0x00000007;
enum uint SMART_INVALID_REGISTER = 0x00000008;

enum : uint
{
    SMART_NOT_SUPPORTED = 0x00000009,
    SMART_NO_IDE_DEVICE = 0x0000000a,
}

enum uint SMART_OFFLINE_ROUTINE_OFFLINE = 0x00000000;
enum uint SMART_SHORT_SELFTEST_OFFLINE = 0x00000001;
enum uint SMART_EXTENDED_SELFTEST_OFFLINE = 0x00000002;
enum uint SMART_ABORT_OFFLINE_SELFTEST = 0x0000007f;
enum uint SMART_SHORT_SELFTEST_CAPTIVE = 0x00000081;
enum uint SMART_EXTENDED_SELFTEST_CAPTIVE = 0x00000082;
enum uint READ_ATTRIBUTE_BUFFER_SIZE = 0x00000200;
enum uint IDENTIFY_BUFFER_SIZE = 0x00000200;
enum uint READ_THRESHOLD_BUFFER_SIZE = 0x00000200;
enum uint SMART_LOG_SECTOR_SIZE = 0x00000200;
enum uint READ_ATTRIBUTES = 0x000000d0;
enum uint READ_THRESHOLDS = 0x000000d1;
enum uint ENABLE_DISABLE_AUTOSAVE = 0x000000d2;
enum uint SAVE_ATTRIBUTE_VALUES = 0x000000d3;
enum uint EXECUTE_OFFLINE_DIAGS = 0x000000d4;

enum : uint
{
    SMART_READ_LOG  = 0x000000d5,
    SMART_WRITE_LOG = 0x000000d6,
}

enum uint ENABLE_SMART = 0x000000d8;
enum uint DISABLE_SMART = 0x000000d9;
enum uint RETURN_SMART_STATUS = 0x000000da;
enum uint ENABLE_DISABLE_AUTO_OFFLINE = 0x000000db;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-ioctl_disk_get_disk_attributes))], [])*/uint IOCTL_DISK_GET_DISK_ATTRIBUTES = 0x000700f0;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-ioctl_disk_set_disk_attributes))], [])*/uint IOCTL_DISK_SET_DISK_ATTRIBUTES = 0x0007c0f4;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-ioctl_disk_reset_snapshot_info))], [])*/uint IOCTL_DISK_RESET_SNAPSHOT_INFO = 0x0007c210;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-ioctl_changer_query_volume_tags))], [])*/uint IOCTL_CHANGER_QUERY_VOLUME_TAGS = 0x0030c02c;

enum : uint
{
    MAX_VOLUME_ID_SIZE       = 0x00000024,
    MAX_VOLUME_TEMPLATE_SIZE = 0x00000028,
}

enum uint VENDOR_ID_LENGTH = 0x00000008;
enum uint PRODUCT_ID_LENGTH = 0x00000010;
enum uint REVISION_LENGTH = 0x00000004;
enum uint SERIAL_NUMBER_LENGTH = 0x00000020;
enum uint CHANGER_RESERVED_BIT = 0x80000000;

enum : uint
{
    CHANGER_TO_TRANSPORT = 0x00000001,
    CHANGER_TO_SLOT      = 0x00000002,
    CHANGER_TO_IEPORT    = 0x00000004,
    CHANGER_TO_DRIVE     = 0x00000008,
}

enum : uint
{
    LOCK_UNLOCK_IEPORT = 0x00000001,
    LOCK_UNLOCK_DOOR   = 0x00000002,
    LOCK_UNLOCK_KEYPAD = 0x00000004,
}

enum uint LOCK_ELEMENT = 0x00000000;
enum uint UNLOCK_ELEMENT = 0x00000001;
enum uint EXTEND_IEPORT = 0x00000002;
enum uint RETRACT_IEPORT = 0x00000003;
...
enum uint ERROR_SLOT_NOT_PRESENT = 0x00000004;
enum uint ERROR_DRIVE_NOT_INSTALLED = 0x00000008;
enum uint ERROR_TRAY_MALFUNCTION = 0x00000010;
enum uint ERROR_INIT_STATUS_NEEDED = 0x00000011;
enum uint ERROR_UNHANDLED_ERROR = 0xffffffff;

enum : uint
{
    SEARCH_ALL        = 0x00000000,
    SEARCH_PRIMARY    = 0x00000001,
    SEARCH_ALTERNATE  = 0x00000002,
    SEARCH_ALL_NO_SEQ = 0x00000004,
    SEARCH_PRI_NO_SEQ = 0x00000005,
    SEARCH_ALT_NO_SEQ = 0x00000006,
}

enum : uint
{
    ASSERT_PRIMARY   = 0x00000008,
    ASSERT_ALTERNATE = 0x00000009,
}

enum : uint
{
    REPLACE_PRIMARY   = 0x0000000a,
    REPLACE_ALTERNATE = 0x0000000b,
}

enum : uint
{
    UNDEFINE_PRIMARY   = 0x0000000c,
    UNDEFINE_ALTERNATE = 0x0000000d,
}

enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-ioctl_serial_lsrmst_insert))], [])*/uint IOCTL_SERIAL_LSRMST_INSERT = 0x001b007c;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_oplock_break_acknowledge))], [])*/uint FSCTL_OPLOCK_BREAK_ACKNOWLEDGE = 0x0009000c;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_opbatch_ack_close_pending))], [])*/uint FSCTL_OPBATCH_ACK_CLOSE_PENDING = 0x00090010;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_oplock_break_notify))], [])*/uint FSCTL_OPLOCK_BREAK_NOTIFY = 0x00090014;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_lock_volume))], [])*/uint FSCTL_LOCK_VOLUME = 0x00090018;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_unlock_volume))], [])*/uint FSCTL_UNLOCK_VOLUME = 0x0009001c;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_dismount_volume))], [])*/uint FSCTL_DISMOUNT_VOLUME = 0x00090020;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_is_volume_mounted))], [])*/uint FSCTL_IS_VOLUME_MOUNTED = 0x00090028;
enum uint FSCTL_IS_PATHNAME_VALID = 0x0009002c;
enum uint FSCTL_MARK_VOLUME_DIRTY = 0x00090030;
enum uint FSCTL_QUERY_RETRIEVAL_POINTERS = 0x0009003b;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_get_compression))], [])*/uint FSCTL_GET_COMPRESSION = 0x0009003c;
...
enum uint FSCTL_MARK_AS_SYSTEM_HIVE = 0x0009004f;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_oplock_break_ack_no_2))], [])*/uint FSCTL_OPLOCK_BREAK_ACK_NO_2 = 0x00090050;
enum uint FSCTL_INVALIDATE_VOLUMES = 0x00090054;
enum uint FSCTL_QUERY_FAT_BPB = 0x00090058;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_request_filter_oplock))], [])*/uint FSCTL_REQUEST_FILTER_OPLOCK = 0x0009005c;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_filesystem_get_statistics))], [])*/uint FSCTL_FILESYSTEM_GET_STATISTICS = 0x00090060;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_move_file))], [])*/uint FSCTL_MOVE_FILE = 0x00090074;
enum uint FSCTL_IS_VOLUME_DIRTY = 0x00090078;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_allow_extended_dasd_io))], [])*/uint FSCTL_ALLOW_EXTENDED_DASD_IO = 0x00090083;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_find_files_by_sid))], [])*/uint FSCTL_FIND_FILES_BY_SID = 0x0009008f;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_set_object_id))], [])*/uint FSCTL_SET_OBJECT_ID = 0x00090098;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_get_object_id))], [])*/uint FSCTL_GET_OBJECT_ID = 0x0009009c;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_delete_object_id))], [])*/uint FSCTL_DELETE_OBJECT_ID = 0x000900a0;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_set_reparse_point))], [])*/uint FSCTL_SET_REPARSE_POINT = 0x000900a4;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_get_reparse_point))], [])*/uint FSCTL_GET_REPARSE_POINT = 0x000900a8;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_delete_reparse_point))], [])*/uint FSCTL_DELETE_REPARSE_POINT = 0x000900ac;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_enum_usn_data))], [])*/uint FSCTL_ENUM_USN_DATA = 0x000900b3;
enum uint FSCTL_SECURITY_ID_CHECK = 0x000940b7;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_read_usn_journal))], [])*/uint FSCTL_READ_USN_JOURNAL = 0x000900bb;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_set_object_id_extended))], [])*/uint FSCTL_SET_OBJECT_ID_EXTENDED = 0x000900bc;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_create_or_get_object_id))], [])*/uint FSCTL_CREATE_OR_GET_OBJECT_ID = 0x000900c0;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_query_allocated_ranges))], [])*/uint FSCTL_QUERY_ALLOCATED_RANGES = 0x000940cf;
enum uint FSCTL_ENABLE_UPGRADE = 0x000980d0;
enum uint FSCTL_SET_ENCRYPTION = 0x000900d7;
enum uint FSCTL_ENCRYPTION_FSCTL_IO = 0x000900db;
enum uint FSCTL_WRITE_RAW_ENCRYPTED = 0x000900df;
enum uint FSCTL_READ_RAW_ENCRYPTED = 0x000900e3;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_create_usn_journal))], [])*/uint FSCTL_CREATE_USN_JOURNAL = 0x000900e7;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_read_file_usn_data))], [])*/uint FSCTL_READ_FILE_USN_DATA = 0x000900eb;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_write_usn_close_record))], [])*/uint FSCTL_WRITE_USN_CLOSE_RECORD = 0x000900ef;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_extend_volume))], [])*/uint FSCTL_EXTEND_VOLUME = 0x000900f0;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_query_usn_journal))], [])*/uint FSCTL_QUERY_USN_JOURNAL = 0x000900f4;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_delete_usn_journal))], [])*/uint FSCTL_DELETE_USN_JOURNAL = 0x000900f8;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_mark_handle))], [])*/uint FSCTL_MARK_HANDLE = 0x000900fc;
...
enum uint FSCTL_FILE_PREFETCH = 0x00090120;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_make_media_compatible))], [])*/uint FSCTL_MAKE_MEDIA_COMPATIBLE = 0x00098130;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_set_defect_management))], [])*/uint FSCTL_SET_DEFECT_MANAGEMENT = 0x00098134;
...
enum uint FSCTL_SET_VOLUME_COMPRESSION_STATE = 0x00090140;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_txfs_write_backup_information))], [])*/uint FSCTL_TXFS_WRITE_BACKUP_INFORMATION = 0x00098164;
enum uint FSCTL_TXFS_CREATE_SECONDARY_RM = 0x00098168;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_txfs_savepoint_information))], [])*/uint FSCTL_TXFS_SAVEPOINT_INFORMATION = 0x00098178;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_txfs_create_miniversion))], [])*/uint FSCTL_TXFS_CREATE_MINIVERSION = 0x0009817c;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_txfs_transaction_active))], [])*/uint FSCTL_TXFS_TRANSACTION_ACTIVE = 0x0009418c;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_set_zero_on_deallocation))], [])*/uint FSCTL_SET_ZERO_ON_DEALLOCATION = 0x00090194;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_set_repair))], [])*/uint FSCTL_SET_REPAIR = 0x00090198;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_get_repair))], [])*/uint FSCTL_GET_REPAIR = 0x0009019c;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_wait_for_repair))], [])*/uint FSCTL_WAIT_FOR_REPAIR = 0x000901a0;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_initiate_repair))], [])*/uint FSCTL_INITIATE_REPAIR = 0x000901a8;
enum uint FSCTL_CSC_INTERNAL = 0x000901af;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_shrink_volume))], [])*/uint FSCTL_SHRINK_VOLUME = 0x000901b0;
enum uint FSCTL_SET_SHORT_NAME_BEHAVIOR = 0x000901b4;
enum uint FSCTL_DFSR_SET_GHOST_HANDLE_STATE = 0x000901b8;
...
enum uint FSCTL_QUERY_PAGEFILE_ENCRYPTION = 0x000901e8;
enum uint FSCTL_RESET_VOLUME_ALLOCATION_HINTS = 0x000901ec;
enum uint FSCTL_QUERY_DEPENDENT_VOLUME = 0x000901f0;
enum uint FSCTL_SD_GLOBAL_CHANGE = 0x000901f4;
enum uint FSCTL_TXFS_READ_BACKUP_INFORMATION2 = 0x000901f8;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_lookup_stream_from_cluster))], [])*/uint FSCTL_LOOKUP_STREAM_FROM_CLUSTER = 0x000901fc;
enum uint FSCTL_TXFS_WRITE_BACKUP_INFORMATION2 = 0x00090200;
enum uint FSCTL_FILE_TYPE_NOTIFICATION = 0x00090204;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_file_level_trim))], [])*/uint FSCTL_FILE_LEVEL_TRIM = 0x00098208;
...
enum uint FSCTL_SET_PERSISTENT_VOLUME_STATE = 0x00090238;
enum uint FSCTL_QUERY_PERSISTENT_VOLUME_STATE = 0x0009023c;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_request_oplock))], [])*/uint FSCTL_REQUEST_OPLOCK = 0x00090240;
enum uint FSCTL_CSV_TUNNEL_REQUEST = 0x00090244;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_is_csv_file))], [])*/uint FSCTL_IS_CSV_FILE = 0x00090248;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_query_file_system_recognition))], [])*/uint FSCTL_QUERY_FILE_SYSTEM_RECOGNITION = 0x0009024c;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_is_file_on_csv_volume))], [])*/uint FSCTL_IS_FILE_ON_CSV_VOLUME = 0x0009025c;
enum uint FSCTL_CORRUPTION_HANDLING = 0x00090260;
...
enum uint FSCTL_CSV_INTERNAL = 0x0009026c;
enum uint FSCTL_SET_PURGE_FAILURE_MODE = 0x00090270;
enum uint FSCTL_QUERY_FILE_LAYOUT = 0x00090277;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_is_volume_owned_bycsvfs))], [])*/uint FSCTL_IS_VOLUME_OWNED_BYCSVFS = 0x00090278;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_get_integrity_information))], [])*/uint FSCTL_GET_INTEGRITY_INFORMATION = 0x0009027c;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_set_integrity_information))], [])*/uint FSCTL_SET_INTEGRITY_INFORMATION = 0x0009c280;
enum uint FSCTL_QUERY_FILE_REGIONS = 0x00090284;
enum uint FSCTL_RKF_INTERNAL = 0x000902af;
enum uint FSCTL_SCRUB_DATA = 0x000902b0;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_repair_copies))], [])*/uint FSCTL_REPAIR_COPIES = 0x0009c2b4;
enum uint FSCTL_DISABLE_LOCAL_BUFFERING = 0x000902b8;
...
enum uint FSCTL_ADVANCE_FILE_ID = 0x000902c4;
enum uint FSCTL_CSV_SYNC_TUNNEL_REQUEST = 0x000902c8;
enum uint FSCTL_CSV_QUERY_VETO_FILE_DIRECT_IO = 0x000902cc;
enum uint FSCTL_WRITE_USN_REASON = 0x000902d0;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_csv_control))], [])*/uint FSCTL_CSV_CONTROL = 0x000902d4;
enum uint FSCTL_GET_REFS_VOLUME_DATA = 0x000902d8;
enum uint FSCTL_CSV_H_BREAKING_SYNC_TUNNEL_REQUEST = 0x000902e4;
...
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_usn_track_modified_ranges))], [])*/uint FSCTL_USN_TRACK_MODIFIED_RANGES = 0x000902f4;
enum uint FSCTL_QUERY_SHARED_VIRTUAL_DISK_SUPPORT = 0x00090300;
...
enum uint FSCTL_SET_EXTERNAL_BACKING = 0x0009030c;
enum uint FSCTL_GET_EXTERNAL_BACKING = 0x00090310;
enum uint FSCTL_DELETE_EXTERNAL_BACKING = 0x00090314;
...
enum uint FSCTL_ADD_OVERLAY = 0x00098330;
enum uint FSCTL_REMOVE_OVERLAY = 0x00098334;
enum uint FSCTL_UPDATE_OVERLAY = 0x00098338;
enum uint FSCTL_SHUFFLE_FILE = 0x0009c340;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_duplicate_extents_to_file))], [])*/uint FSCTL_DUPLICATE_EXTENTS_TO_FILE = 0x00098344;
enum uint FSCTL_SPARSE_OVERALLOCATE = 0x0009034c;
enum uint FSCTL_STORAGE_QOS_CONTROL = 0x00090350;
enum uint FSCTL_INITIATE_FILE_METADATA_OPTIMIZATION = 0x0009035c;
enum uint FSCTL_QUERY_FILE_METADATA_OPTIMIZATION = 0x00090360;
enum uint FSCTL_SVHDX_ASYNC_TUNNEL_REQUEST = 0x00090364;
enum uint FSCTL_GET_WOF_VERSION = 0x00090368;
enum uint FSCTL_HCS_SYNC_TUNNEL_REQUEST = 0x0009036c;
enum uint FSCTL_HCS_ASYNC_TUNNEL_REQUEST = 0x00090370;
enum uint FSCTL_QUERY_EXTENT_READ_CACHE_INFO = 0x00090377;
enum uint FSCTL_QUERY_REFS_VOLUME_COUNTER_INFO = 0x0009037b;
enum uint FSCTL_CLEAN_VOLUME_METADATA = 0x0009037c;
enum uint FSCTL_SET_INTEGRITY_INFORMATION_EX = 0x00090380;
enum uint FSCTL_SUSPEND_OVERLAY = 0x00090384;
enum uint FSCTL_VIRTUAL_STORAGE_QUERY_PROPERTY = 0x00090388;
enum /*FIELD ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ni-winioctl-fsctl_filesystem_get_statistics_ex))], [])*/uint FSCTL_FILESYSTEM_GET_STATISTICS_EX = 0x0009038c;
enum uint FSCTL_QUERY_VOLUME_CONTAINER_STATE = 0x00090390;
enum uint FSCTL_SET_LAYER_ROOT = 0x00090394;
enum uint FSCTL_QUERY_DIRECT_ACCESS_EXTENTS = 0x0009039b;
enum uint FSCTL_NOTIFY_STORAGE_SPACE_ALLOCATION = 0x0009039c;
enum uint FSCTL_SSDI_STORAGE_REQUEST = 0x000903a0;
enum uint FSCTL_QUERY_DIRECT_IMAGE_ORIGINAL_BASE = 0x000903a4;
enum uint FSCTL_READ_UNPRIVILEGED_USN_JOURNAL = 0x000903ab;
enum uint FSCTL_GHOST_FILE_EXTENTS = 0x000983ac;
enum uint FSCTL_QUERY_GHOSTED_FILE_EXTENTS = 0x000903b0;
enum uint FSCTL_UNMAP_SPACE = 0x000903b4;
enum uint FSCTL_HCS_SYNC_NO_WRITE_TUNNEL_REQUEST = 0x000903b8;
enum uint FSCTL_START_VIRTUALIZATION_INSTANCE = 0x000903c0;
enum uint FSCTL_GET_FILTER_FILE_IDENTIFIER = 0x000903c4;
...
enum uint FSCTL_GET_RETRIEVAL_POINTERS_AND_REFCOUNT = 0x000903d3;
enum uint FSCTL_QUERY_VOLUME_NUMA_INFO = 0x000903d4;
enum uint FSCTL_REFS_DEALLOCATE_RANGES = 0x000903d8;
enum uint FSCTL_QUERY_REFS_SMR_VOLUME_INFO = 0x000903dc;
enum uint FSCTL_SET_REFS_SMR_VOLUME_GC_PARAMETERS = 0x000903e0;
enum uint FSCTL_SET_REFS_FILE_STRICTLY_SEQUENTIAL = 0x000903e4;
enum uint FSCTL_DUPLICATE_EXTENTS_TO_FILE_EX = 0x000983e8;
enum uint FSCTL_QUERY_BAD_RANGES = 0x000903ec;
enum uint FSCTL_SET_DAX_ALLOC_ALIGNMENT_HINT = 0x000903f0;
enum uint FSCTL_DELETE_CORRUPTED_REFS_CONTAINER = 0x000903f4;
enum uint FSCTL_SCRUB_UNDISCOVERABLE_ID = 0x000903f8;
enum uint FSCTL_NOTIFY_DATA_CHANGE = 0x000903fc;
enum uint FSCTL_START_VIRTUALIZATION_INSTANCE_EX = 0x00090400;
enum uint FSCTL_ENCRYPTION_KEY_CONTROL = 0x00090404;
enum uint FSCTL_VIRTUAL_STORAGE_SET_BEHAVIOR = 0x00090408;
enum uint FSCTL_SET_REPARSE_POINT_EX = 0x0009040c;
enum uint FSCTL_REARRANGE_FILE = 0x0009c420;
enum uint FSCTL_VIRTUAL_STORAGE_PASSTHROUGH = 0x00090424;
enum uint FSCTL_GET_RETRIEVAL_POINTER_COUNT = 0x0009042b;
enum uint FSCTL_ENABLE_PER_IO_FLAGS = 0x0009042c;
enum uint FSCTL_QUERY_ASYNC_DUPLICATE_EXTENTS_STATUS = 0x00090430;
enum uint FSCTL_SMB_SHARE_FLUSH_AND_PURGE = 0x0009043c;
enum uint FSCTL_REFS_STREAM_SNAPSHOT_MANAGEMENT = 0x00090440;
enum uint FSCTL_MANAGE_BYPASS_IO = 0x00090448;
enum uint FSCTL_REFS_DEALLOCATE_RANGES_EX = 0x0009044c;
enum uint FSCTL_SET_CACHED_RUNS_STATE = 0x00090450;
enum uint FSCTL_REFS_SET_VOLUME_COMPRESSION_INFO = 0x00090454;
enum uint FSCTL_REFS_QUERY_VOLUME_COMPRESSION_INFO = 0x00090458;
enum uint FSCTL_DUPLICATE_CLUSTER = 0x0009045c;
enum uint FSCTL_CREATE_LCN_WEAK_REFERENCE = 0x00090460;
enum uint FSCTL_CLEAR_LCN_WEAK_REFERENCE = 0x00090464;
enum uint FSCTL_QUERY_LCN_WEAK_REFERENCE = 0x00090468;
enum uint FSCTL_CLEAR_ALL_LCN_WEAK_REFERENCES = 0x0009046c;
enum uint FSCTL_REFS_SET_VOLUME_DEDUP_INFO = 0x00090470;
enum uint FSCTL_REFS_QUERY_VOLUME_DEDUP_INFO = 0x00090474;
enum uint FSCTL_LMR_QUERY_INFO = 0x00090478;
enum uint FSCTL_REFS_CHECKPOINT_VOLUME = 0x0009047c;
enum uint FSCTL_REFS_QUERY_VOLUME_TOTAL_SHARED_LCNS = 0x00090480;
enum uint FSCTL_UPGRADE_VOLUME = 0x00090484;
enum uint FSCTL_REFS_SET_VOLUME_IO_METRICS_INFO = 0x00090488;
enum uint FSCTL_REFS_QUERY_VOLUME_IO_METRICS_INFO = 0x0009048c;
enum uint FSCTL_REFS_SET_ROLLBACK_PROTECTION_INFO = 0x00090490;
enum uint FSCTL_REFS_QUERY_ROLLBACK_PROTECTION_INFO = 0x00090494;
enum uint FSCTL_FILE_SOV_CHECK_RANGE = 0x00090498;
enum uint FSCTL_CASCADES_REFS_SET_FILE_REMOTE = 0x0009049c;
enum uint GET_VOLUME_BITMAP_FLAG_MASK_METADATA = 0x00000001;
enum uint FLAG_USN_TRACK_MODIFIED_RANGES_ENABLE = 0x00000001;
enum uint USN_PAGE_SIZE = 0x00001000;
...
enum uint USN_REASON_ENCRYPTION_CHANGE = 0x00040000;
...
enum uint USN_REASON_CLOSE = 0x80000000;
enum uint USN_DELETE_VALID_FLAGS = 0x00000003;
...
enum uint MARK_HANDLE_DISABLE_FILE_METADATA_OPTIMIZATION = 0x00001000;
enum uint MARK_HANDLE_ENABLE_USN_SOURCE_ON_PAGING_IO = 0x00002000;
enum uint MARK_HANDLE_SKIP_COHERENCY_SYNC_DISALLOW_WRITES = 0x00004000;
enum uint MARK_HANDLE_SUPPRESS_VOLUME_OPEN_FLUSH = 0x00008000;
enum uint MARK_HANDLE_ENABLE_CPU_CACHE = 0x10000000;
...
enum uint VOLUME_SESSION_OPEN = 0x00000004;

enum : uint
{
    FILE_PREFETCH_TYPE_FOR_CREATE     = 0x00000001,
    FILE_PREFETCH_TYPE_FOR_DIRENUM    = 0x00000002,
    FILE_PREFETCH_TYPE_FOR_CREATE_EX  = 0x00000003,
    FILE_PREFETCH_TYPE_FOR_DIRENUM_EX = 0x00000004,
    FILE_PREFETCH_TYPE_MAX            = 0x00000004,
}

enum uint FILESYSTEM_STATISTICS_TYPE_REFS = 0x00000004;
enum uint FILE_ZERO_DATA_INFORMATION_FLAG_PRESERVE_CACHED_DATA = 0x00000001;
enum uint FILE_SET_ENCRYPTION = 0x00000001;
enum uint FILE_CLEAR_ENCRYPTION = 0x00000002;
enum uint STREAM_SET_ENCRYPTION = 0x00000003;
enum uint STREAM_CLEAR_ENCRYPTION = 0x00000004;
enum uint MAXIMUM_ENCRYPTION_VALUE = 0x00000004;
enum uint ENCRYPTION_FORMAT_DEFAULT = 0x00000001;

enum : uint
{
    ENCRYPTED_DATA_INFO_SPARSE_FILE    = 0x00000001,
    ENCRYPTED_DATA_INFO_SPARSE_DATA    = 0x00000002,
    ENCRYPTED_DATA_INFO_4K_SPARSE_UNIT = 0x00000004,
}
...
enum uint SET_REPAIR_DISABLED_AND_BUGCHECK_ON_CORRUPT = 0x00000010;
enum uint SET_REPAIR_VALID_MASK = 0x00000019;

enum : ulong
{
    FILE_INITIATE_REPAIR_HINT1_FILE_RECORD_NOT_IN_USE             = 0x0000000000000001,
    FILE_INITIATE_REPAIR_HINT1_FILE_RECORD_REUSED                 = 0x0000000000000002,
    FILE_INITIATE_REPAIR_HINT1_FILE_RECORD_NOT_EXIST              = 0x0000000000000004,
    FILE_INITIATE_REPAIR_HINT1_FILE_RECORD_NOT_BASE_RECORD        = 0x0000000000000008,
    ...
    FILE_INITIATE_REPAIR_HINT1_RECURSIVELY_CORRUPTED              = 0x0000000000000100,
    ...
    FILE_INITIATE_REPAIR_HINT1_CLUSTERS_ALREADY_IN_USE            = 0x0000000000008000,
    ...
    FILE_INITIATE_REPAIR_HINT1_FILE_RECORD_NOT_ORPHAN             = 0x0000000000040000,
    FILE_INITIATE_REPAIR_HINT1_FILE_RECORD_IS_BASE_RECORD         = 0x0000000000080000,
    FILE_INITIATE_REPAIR_HINT1_INVALID_ARRAY_LENGTH_COUNT         = 0x0000000000100000,
    ...
    FILE_INITIATE_REPAIR_HINT1_PARENT_FILE_RECORD_NOT_IN_USE      = 0x0000000001000000,
    FILE_INITIATE_REPAIR_HINT1_PARENT_FILE_RECORD_REUSED          = 0x0000000002000000,
    FILE_INITIATE_REPAIR_HINT1_PARENT_FILE_RECORD_NOT_EXIST       = 0x0000000004000000,
    FILE_INITIATE_REPAIR_HINT1_PARENT_FILE_RECORD_NOT_BASE_RECORD = 0x0000000008000000,
    FILE_INITIATE_REPAIR_HINT1_PARENT_FILE_RECORD_NOT_INDEX       = 0x0000000010000000,
    FILE_INITIATE_REPAIR_HINT1_VALID_INDEX_ENTRY                  = 0x0000000020000000,
    FILE_INITIATE_REPAIR_HINT1_OUT_OF_GENERIC_NAMES               = 0x0000000040000000,
    ...
    FILE_INITIATE_REPAIR_HINT1_ATTRIBUTE_NON_RESIDENT             = 0x0000002000000000,
    FILE_INITIATE_REPAIR_HINT1_DENY_DEFRAG                        = 0x0000004000000000,
    FILE_INITIATE_REPAIR_HINT1_PREVIOUS_PARENT_STILL_VALID        = 0x0000008000000000,
    FILE_INITIATE_REPAIR_HINT1_INDEX_ENTRY_MISMATCH               = 0x0000010000000000,
    FILE_INITIATE_REPAIR_HINT1_INVALID_ORPHAN_RECOVERY_NAME       = 0x0000020000000000,
    FILE_INITIATE_REPAIR_HINT1_MULTIPLE_FILE_NAME_ATTRIBUTES      = 0x0000040000000000,
}

enum : uint
{
    TXFS_LOGGING_MODE_SIMPLE = 0x00000001,
    TXFS_LOGGING_MODE_FULL   = 0x00000002,
}

enum : uint
{
    TXFS_TRANSACTION_STATE_NONE      = 0x00000000,
    TXFS_TRANSACTION_STATE_ACTIVE    = 0x00000001,
    TXFS_TRANSACTION_STATE_PREPARED  = 0x00000002,
    TXFS_TRANSACTION_STATE_NOTACTIVE = 0x00000003,
}

enum : uint
{
    TXFS_RM_STATE_NOT_STARTED   = 0x00000000,
    TXFS_RM_STATE_STARTING      = 0x00000001,
    TXFS_RM_STATE_ACTIVE        = 0x00000002,
    TXFS_RM_STATE_SHUTTING_DOWN = 0x00000003,
}

enum : uint
{
    TXFS_ROLLFORWARD_REDO_FLAG_USE_LAST_REDO_LSN      = 0x00000001,
    TXFS_ROLLFORWARD_REDO_FLAG_USE_LAST_VIRTUAL_CLOCK = 0x00000002,
}
...
enum : uint
{
    ...
    PERSISTENT_VOLUME_STATE_GLOBAL_METADATA_NO_SEEK_PENALTY = 0x00000004,
    PERSISTENT_VOLUME_STATE_LOCAL_METADATA_NO_SEEK_PENALTY  = 0x00000008,
    ...
    PERSISTENT_VOLUME_STATE_REALLOCATE_ALL_DATA_WRITES      = 0x00000200,
    PERSISTENT_VOLUME_STATE_CHKDSK_RAN_ONCE                 = 0x00000400,
    PERSISTENT_VOLUME_STATE_MODIFIED_BY_CHKDSK              = 0x00000800,
    PERSISTENT_VOLUME_STATE_DAX_FORMATTED                   = 0x00001000,
    PERSISTENT_VOLUME_STATE_DEV_VOLUME                      = 0x00002000,
    PERSISTENT_VOLUME_STATE_TRUSTED_VOLUME                  = 0x00004000,
}
...
enum : uint
{
    REQUEST_OPLOCK_CURRENT_VERSION                      = 0x00000001,
    REQUEST_OPLOCK_OUTPUT_FLAG_ACK_REQUIRED             = 0x00000001,
    REQUEST_OPLOCK_OUTPUT_FLAG_MODES_PROVIDED           = 0x00000002,
    REQUEST_OPLOCK_OUTPUT_FLAG_WRITABLE_SECTION_PRESENT = 0x00000004,
}

enum : uint
{
    QUERY_DEPENDENT_VOLUME_REQUEST_FLAG_HOST_VOLUMES  = 0x00000001,
    QUERY_DEPENDENT_VOLUME_REQUEST_FLAG_GUEST_VOLUMES = 0x00000002,
}

enum : uint
{
    SD_GLOBAL_CHANGE_TYPE_MACHINE_SID = 0x00000001,
    SD_GLOBAL_CHANGE_TYPE_QUERY_STATS = 0x00010000,
    SD_GLOBAL_CHANGE_TYPE_ENUM_SDS    = 0x00020000,
}
...
enum uint CSV_MGMTLOCK_CHECK_VOLUME_REDIRECTED = 0x00000001;
enum uint CSV_INVALID_DEVICE_NUMBER = 0xffffffff;

enum : uint
{
    CSV_QUERY_MDS_PATH_V2_VERSION_1                           = 0x00000001,
    CSV_QUERY_MDS_PATH_FLAG_STORAGE_ON_THIS_NODE_IS_CONNECTED = 0x00000001,
    CSV_QUERY_MDS_PATH_FLAG_CSV_DIRECT_IO_ENABLED             = 0x00000002,
    CSV_QUERY_MDS_PATH_FLAG_SMB_BYPASS_CSV_ENABLED            = 0x00000004,
}
...
enum : uint
{
    ...
    QUERY_FILE_LAYOUT_INCLUDE_STREAMS_WITH_NO_CLUSTERS_ALLOCATED       = 0x00000020,
    QUERY_FILE_LAYOUT_INCLUDE_FULL_PATH_IN_NAMES                       = 0x00000040,
    QUERY_FILE_LAYOUT_INCLUDE_STREAM_INFORMATION                       = 0x00000080,
    QUERY_FILE_LAYOUT_INCLUDE_STREAM_INFORMATION_FOR_DSC_ATTRIBUTE     = 0x00000100,
    QUERY_FILE_LAYOUT_INCLUDE_STREAM_INFORMATION_FOR_TXF_ATTRIBUTE     = 0x00000200,
    QUERY_FILE_LAYOUT_INCLUDE_STREAM_INFORMATION_FOR_EFS_ATTRIBUTE     = 0x00000400,
    QUERY_FILE_LAYOUT_INCLUDE_ONLY_FILES_WITH_SPECIFIC_ATTRIBUTES      = 0x00000800,
    QUERY_FILE_LAYOUT_INCLUDE_FILES_WITH_DSC_ATTRIBUTE                 = 0x00001000,
    QUERY_FILE_LAYOUT_INCLUDE_STREAM_INFORMATION_FOR_DATA_ATTRIBUTE    = 0x00002000,
    QUERY_FILE_LAYOUT_INCLUDE_STREAM_INFORMATION_FOR_REPARSE_ATTRIBUTE = 0x00004000,
    QUERY_FILE_LAYOUT_INCLUDE_STREAM_INFORMATION_FOR_EA_ATTRIBUTE      = 0x00008000,
}

enum uint QUERY_FILE_LAYOUT_SINGLE_INSTANCED = 0x00000001;
...
enum : uint
{
    CHECKSUM_TYPE_NONE              = 0x00000000,
    CHECKSUM_TYPE_CRC32             = 0x00000001,
    CHECKSUM_TYPE_CRC64             = 0x00000002,
    CHECKSUM_TYPE_ECC               = 0x00000003,
    CHECKSUM_TYPE_SHA256            = 0x00000004,
    CHECKSUM_TYPE_XXH64             = 0x00000005,
    CHECKSUM_TYPE_FIRST_UNUSED_TYPE = 0x00000006,
}

enum uint FSCTL_INTEGRITY_FLAG_CHECKSUM_ENFORCEMENT_OFF = 0x00000001;
enum uint OFFLOAD_READ_FLAG_ALL_ZERO_BEYOND_CURRENT_RANGE = 0x00000001;
...
enum : uint
{
    ...
    FILE_REGION_USAGE_QUERY_ALIGNMENT      = 0x00000008,
}

enum : uint
{
    FILE_STORAGE_TIER_NAME_LENGTH           = 0x00000100,
    FILE_STORAGE_TIER_DESCRIPTION_LENGTH    = 0x00000200,
...
enum : uint
{
    QUERY_FILE_LAYOUT_REPARSE_DATA_INVALID = 0x00000001,
    QUERY_FILE_LAYOUT_REPARSE_TAG_INVALID  = 0x00000002,
}

enum : uint
{
    DUPLICATE_EXTENTS_DATA_EX_SOURCE_ATOMIC = 0x00000001,
    DUPLICATE_EXTENTS_DATA_EX_ASYNC         = 0x00000002,
}

enum : uint
{
    REFS_SMR_VOLUME_INFO_OUTPUT_VERSION_V0   = 0x00000000,
    REFS_SMR_VOLUME_INFO_OUTPUT_VERSION_V1   = 0x00000001,
    REFS_SMR_VOLUME_GC_PARAMETERS_VERSION_V1 = 0x00000001,
}

enum : uint
{
    STREAMS_INVALID_ID         = 0x00000000,
    STREAMS_MAX_ID             = 0x0000ffff,
    STREAMS_ASSOCIATE_ID_CLEAR = 0x00000001,
    STREAMS_ASSOCIATE_ID_SET   = 0x00000002,
}
...
enum uint WOF_CURRENT_VERSION = 0x00000001;
enum uint WOF_PROVIDER_CLOUD = 0x00000003;
...
enum uint CONTAINER_VOLUME_STATE_HOSTING_CONTAINER = 0x00000001;
...
enum : uint
{
    ...
    CONTAINER_ROOT_INFO_FLAG_BIND_DO_NOT_MAP_NAME          = 0x00000100,
    CONTAINER_ROOT_INFO_FLAG_UNION_LAYER_ROOT              = 0x00000200,
    CONTAINER_ROOT_INFO_VALID_FLAGS                        = 0x000003ff,
}

enum uint PROJFS_PROTOCOL_VERSION = 0x00000003;
enum uint EFS_TRACKED_OFFSET_HEADER_FLAG = 0x00000001;
enum uint SPACES_TRACKED_OFFSET_HEADER_FLAG = 0x00000002;
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-mark_handle_info32))], [])
//STRUCT ATTR: SupportedArchitectureAttribute : CustomAttributeSig([FixedArgSig(ElementSig(6))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_hotplug_info))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_device_number))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-prevent_media_removal))], [])
struct PREVENT_MEDIA_REMOVAL
{
    BOOLEAN PreventMediaRemoval;
}

//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-class_media_change_context))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-device_media_info))], [])
struct DEVICE_MEDIA_INFO
{
    _DeviceSpecific_e__Union DeviceSpecific;
}

//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-get_media_types))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_property_query))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_descriptor_header))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_device_descriptor))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_adapter_descriptor))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_access_alignment_descriptor))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_medium_product_type_descriptor))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_miniport_descriptor))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_device_id_descriptor))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-device_seek_penalty_descriptor))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-device_write_aggregation_descriptor))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-device_trim_descriptor))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-device_lb_provisioning_descriptor))], [])
struct DEVICE_LB_PROVISIONING_DESCRIPTOR
{
    uint     Version;
    uint     Size;
    /*FIELD ATTR: NativeBitfieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(MapSupported)), FixedArgSig(ElementSig(7)), FixedArgSig(ElementSig(1))], [])*/ubyte _bitfield107;
    ubyte[7] Reserved1;
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-device_power_descriptor))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-device_copy_offload_descriptor))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_device_resiliency_descriptor))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_rpmb_descriptor))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_protocol_specific_data))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_protocol_data_descriptor))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_temperature_info))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_temperature_data_descriptor))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_temperature_threshold))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_spec_version))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_physical_device_data))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_physical_adapter_data))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_physical_node_data))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_physical_topology_descriptor))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_device_io_capability_descriptor))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_device_attributes_descriptor))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-device_data_set_range))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-device_manage_data_set_attributes))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-device_manage_data_set_attributes_output))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-device_dsm_notification_parameters))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_offload_token))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-device_dsm_offload_read_parameters))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_offload_read_output))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-device_dsm_offload_write_parameters))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_offload_write_output))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-device_data_set_lb_provisioning_state))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-device_data_set_repair_parameters))], [])
...
struct STORAGE_REINITIALIZE_MEDIA
{
    ...
    _SanitizeOption_e__Struct SanitizeOption;
}
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/DevIO/storage-read-capacity))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_write_cache_property))], [])
...
struct STORAGE_IDLE_POWER
{
    uint Version;
    uint Size;
    /*FIELD ATTR: NativeBitfieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(Reserved)), FixedArgSig(ElementSig(2)), FixedArgSig(ElementSig(30))], [])*/uint _bitfield108;
    uint D3IdleTimeout;
}
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_device_power_cap))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_rpmb_data_frame))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/FileIO/storage-hw-firmware-info-query))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/FileIO/storage-hw-firmware-slot-info))], [])
struct STORAGE_HW_FIRMWARE_SLOT_INFO
{
    uint      Version;
    uint      Size;
    ubyte     SlotNumber;
    /*FIELD ATTR: NativeBitfieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(Reserved0)), FixedArgSig(ElementSig(1)), FixedArgSig(ElementSig(7))], [])*/ubyte _bitfield109;
    ubyte[6]  Reserved1;
    ubyte[16] Revision;
}

//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/FileIO/storage-hw-firmware-info))], [])
struct STORAGE_HW_FIRMWARE_INFO
{
    uint     Version;
    uint     Size;
    /*FIELD ATTR: NativeBitfieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(Reserved0)), FixedArgSig(ElementSig(1)), FixedArgSig(ElementSig(7))], [])*/ubyte _bitfield110;
    ubyte    SlotCount;
    ubyte    ActiveSlot;
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_hw_firmware_download))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_hw_firmware_activate))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-storage_protocol_command))], [])
...
struct SCM_PD_FIRMWARE_SLOT_INFO
{
    ...
    uint      Size;
    ubyte     SlotNumber;
    /*FIELD ATTR: NativeBitfieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(Reserved0)), FixedArgSig(ElementSig(1)), FixedArgSig(ElementSig(7))], [])*/ubyte _bitfield111;
    ubyte[6]  Reserved1;
    ubyte[32] Revision;
}
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-format_parameters))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-format_ex_parameters))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-disk_geometry))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-partition_information))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-set_partition_information))], [])
struct SET_PARTITION_INFORMATION
{
    ubyte PartitionType;
}

//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-drive_layout_information))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-verify_information))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-reassign_blocks))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-reassign_blocks_ex))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-partition_information_gpt))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-partition_information_mbr))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-create_disk_gpt))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-create_disk_mbr))], [])
struct CREATE_DISK_MBR
{
    uint Signature;
}

//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-create_disk))], [])
struct CREATE_DISK
{
    PARTITION_STYLE     PartitionStyle;
    _Anonymous_e__Union Anonymous;
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-get_length_information))], [])
struct GET_LENGTH_INFORMATION
{
    long Length;
}

//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-partition_information_ex))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-drive_layout_information_gpt))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-drive_layout_information_mbr))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-drive_layout_information_ex))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-disk_int13_info))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-disk_ex_int13_info))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-disk_detection_info))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-disk_partition_info))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-disk_geometry_ex))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-disk_cache_information))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-disk_grow_partition))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-disk_performance))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-get_disk_attributes))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-set_disk_attributes))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-changer_element))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-changer_element_list))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-get_changer_parameters))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-changer_product_data))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-changer_set_access))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-changer_read_element_status))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-changer_element_status))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-changer_element_status_ex))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-changer_initialize_element_status))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-changer_set_position))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-changer_exchange_medium))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-changer_move_medium))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-changer_send_volume_tag_information))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-read_element_address_info))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-ntfs_volume_data_buffer))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-ntfs_extended_volume_data))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-starting_lcn_input_buffer))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-volume_bitmap_buffer))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-starting_vcn_input_buffer))], [])
struct STARTING_VCN_INPUT_BUFFER
{
    long StartingVcn;
}

//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-retrieval_pointers_buffer))], [])
struct RETRIEVAL_POINTERS_BUFFER
{
    uint ExtentCount;
    long StartingVcn;
    /*FIELD ATTR: FlexibleArrayAttribute : CustomAttributeSig([], [])*/_Anonymous_e__Struct[1] Extents;
}
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-ntfs_file_record_input_buffer))], [])
struct NTFS_FILE_RECORD_INPUT_BUFFER
{
    long FileReferenceNumber;
}

//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-ntfs_file_record_output_buffer))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-move_file_data))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-find_by_sid_data))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-find_by_sid_output))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-mft_enum_data_v0))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-mft_enum_data_v1))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-create_usn_journal_data))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-read_file_usn_data))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-read_usn_journal_data_v0))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-read_usn_journal_data_v1))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-usn_track_modified_ranges))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-usn_range_track_output))], [])
struct USN_RANGE_TRACK_OUTPUT
{
    long Usn;
}

//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-usn_record_v2))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-usn_record_v3))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-usn_record_common_header))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-usn_record_extent))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-usn_record_v4))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-usn_journal_data_v0))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-usn_journal_data_v1))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-usn_journal_data_v2))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-delete_usn_journal_data))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-mark_handle_info))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-filesystem_statistics))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-fat_statistics))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-exfat_statistics))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-ntfs_statistics))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-filesystem_statistics_ex))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-ntfs_statistics_ex))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-file_objectid_buffer))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-file_set_sparse_buffer))], [])
struct FILE_SET_SPARSE_BUFFER
{
    BOOLEAN SetSparse;
}

//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-file_zero_data_information))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-file_allocated_range_buffer))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-plex_read_data_request))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-file_make_compatible_buffer))], [])
struct FILE_MAKE_COMPATIBLE_BUFFER
{
    BOOLEAN CloseDisc;
}

//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-file_set_defect_mgmt_buffer))], [])
struct FILE_SET_DEFECT_MGMT_BUFFER
{
    BOOLEAN Disable;
}

//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-file_query_sparing_buffer))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-file_query_on_disk_vol_info_buffer))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-shrink_volume_information))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-txfs_modify_rm))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-txfs_query_rm_information))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-txfs_get_metadata_info_out))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-txfs_list_transaction_locked_files_entry))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-txfs_list_transaction_locked_files))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-txfs_list_transactions_entry))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-txfs_list_transactions))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-txfs_read_backup_information_out))], [])
struct TXFS_READ_BACKUP_INFORMATION_OUT
{
    _Anonymous_e__Union Anonymous;
}

//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-txfs_write_backup_information))], [])
struct TXFS_WRITE_BACKUP_INFORMATION
{
    /*FIELD ATTR: FlexibleArrayAttribute : CustomAttributeSig([], [])*/ubyte[1] Buffer;
}

//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-txfs_get_transacted_version))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-txfs_savepoint_information))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-txfs_create_miniversion_info))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-txfs_transaction_active_info))], [])
struct TXFS_TRANSACTION_ACTIVE_INFO
{
    BOOLEAN TransactionsActiveAtSnapshot;
}

//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-boot_area_info))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-retrieval_pointer_base))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-file_system_recognition_information))], [])
struct FILE_SYSTEM_RECOGNITION_INFORMATION
{
    CHAR[9] FileSystem;
}

//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-request_oplock_input_buffer))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-request_oplock_output_buffer))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-lookup_stream_from_cluster_input))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-lookup_stream_from_cluster_output))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-lookup_stream_from_cluster_entry))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-csv_namespace_info))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-csv_control_param))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-csv_query_redirect_state))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-csv_query_file_revision))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-csv_query_mds_path))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-csv_query_veto_file_direct_io_output))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-csv_is_owned_by_csvfs))], [])
struct CSV_IS_OWNED_BY_CSVFS
{
    BOOLEAN OwnedByCSVFS;
}

//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-file_level_trim_range))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-file_level_trim))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-file_level_trim_output))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-fsctl_get_integrity_information_buffer))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-fsctl_set_integrity_information_buffer))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-repair_copies_input))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-repair_copies_output))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-file_storage_tier))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-fsctl_query_storage_classes_output))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-fsctl_query_region_info_input))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-file_storage_tier_region))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-fsctl_query_region_info_output))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-duplicate_extents_data))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-disk_extent))], [])
struct DISK_EXTENT
{
    uint DiskNumber;
    long StartingOffset;
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-volume_disk_extents))], [])
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/winioctl/ns-winioctl-volume_get_gpt_attributes_information))], [])
