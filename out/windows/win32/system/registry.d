...
enum const(wchar)* REG_KEY_INSTDEV = "Installed";
...
enum const(wchar)* REGSTR_DEFAULT_INSTANCE = "0000";
...
enum const(wchar)* REGSTR_VAL_DISPLAY = "display";
...
enum const(wchar)* REGSTR_KEY_CONTROL = "Control";
...
enum const(wchar)* REGSTR_VAL_REMOVAL_POLICY = "RemovalPolicy";
enum const(wchar)* REGSTR_KEY_FILTERS = "Filters";
enum const(wchar)* REGSTR_VAL_LOWER_FILTER_DEFAULT_LEVEL = "LowerFilterDefaultLevel";
enum const(wchar)* REGSTR_VAL_UPPER_FILTER_DEFAULT_LEVEL = "UpperFilterDefaultLevel";
enum const(wchar)* REGSTR_KEY_LOWER_FILTER_LEVEL_DEFAULT = "*Lower";
enum const(wchar)* REGSTR_KEY_UPPER_FILTER_LEVEL_DEFAULT = "*Upper";
enum const(wchar)* REGSTR_VAL_LOWER_FILTER_LEVELS = "LowerFilterLevels";
...
enum int DOSOPTGF_DEFCLEAN = 0x00000001;
...
enum int SUF_FIRSTTIME = 0x00000001;
enum int SUF_EXPRESS = 0x00000002;
enum int SUF_BATCHINF = 0x00000004;
...
enum int SUF_SBSCOPYOK = 0x00000100;
...
enum const(wchar)* REGSTR_VAL_BATSPINDOWNPREVIOUS = "BatSpinDownPrevious";
...
enum const(wchar)* REGSTR_VAL_PCMCIA_OPT = "Options";
...
enum const(wchar)* REGSTR_VAL_PCMCIA_MEM = "Memory";
...
enum const(wchar)* REGSTR_VAL_APMMENUSUSPEND = "APMMenuSuspend";
...
enum const(wchar)* REGSTR_KEY_OVERRIDE = "Override";
...
enum const(wchar)* REGSTR_VAL_PCSSDRIVER = "Driver";
...
enum const(wchar)* REGSTR_VAL_CUSTOMCOLORS = "CustomColors";
...
enum const(wchar)* REGSTR_PATH_NETWORK_USERSETTINGS = "Network";
...
enum const(wchar)* REGSTR_KEY_NETWORKPROVIDER = "\\NetworkProvider";
...
enum const(wchar)* REGSTR_PATH_CURRENT_CONTROL_SET = "System\\CurrentControlSet\\Control";
enum const(wchar)* REGSTR_VAL_CURRENT_USER = "Current User";
enum const(wchar)* REGSTR_PATH_PWDPROVIDER = "System\\CurrentControlSet\\Control\\PwdProvider";
...
enum const(wchar)* REGSTR_VAL_UNDOCK_WITHOUT_LOGON = "UndockWithoutLogon";
...
enum const(wchar)* REGSTR_PATH_WINLOGON = "Software\\Microsoft\\Windows\\CurrentVersion\\Winlogon";
...
enum const(wchar)* REGSTR_PATH_TIMEZONE = "System\\CurrentControlSet\\Control\\TimeZoneInformation";
...
enum const(wchar)* REGSTR_PATH_COMPUTRNAME = "System\\CurrentControlSet\\Control\\ComputerName\\ComputerName";
enum const(wchar)* REGSTR_VAL_COMPUTRNAME = "ComputerName";
enum const(wchar)* REGSTR_PATH_SHUTDOWN = "System\\CurrentControlSet\\Control\\Shutdown";
...
enum const(wchar)* REGSTR_PATH_AEDEBUG = "Software\\Microsoft\\Windows NT\\CurrentVersion\\AeDebug";
...
enum const(wchar)* REGSTR_PATH_GRPCONV = "Software\\Microsoft\\Windows\\CurrentVersion\\GrpConv";
