...
enum : uint
{
    MQSEC_DELETE_QUEUE             = 0x00010000U,
    MQSEC_GET_QUEUE_PERMISSIONS    = 0x00020000U,
    MQSEC_CHANGE_QUEUE_PERMISSIONS = 0x00040000U,
    MQSEC_TAKE_QUEUE_OWNERSHIP     = 0x00080000U,
    MQSEC_RECEIVE_MESSAGE          = 0x00000003U,
    MQSEC_RECEIVE_JOURNAL_MESSAGE  = 0x0000000aU,
    MQSEC_QUEUE_GENERIC_READ       = 0x0002002bU,
    MQSEC_QUEUE_GENERIC_WRITE      = 0x00020024U,
    MQSEC_QUEUE_GENERIC_ALL        = 0x000f003fU,
    MQSEC_DELETE_MESSAGE           = 0x00000001U,
    MQSEC_PEEK_MESSAGE             = 0x00000002U,
    MQSEC_WRITE_MESSAGE            = 0x00000004U,
    MQSEC_DELETE_JOURNAL_MESSAGE   = 0x00000008U,
    MQSEC_SET_QUEUE_PROPERTIES     = 0x00000010U,
    MQSEC_GET_QUEUE_PROPERTIES     = 0x00000020U,
    MQSEC_QUEUE_GENERIC_EXECUTE    = 0x00000000U,
}
...
enum : uint
{
    QUERY_SORTASCEND  = 0x00000000U,
    QUERY_SORTDESCEND = 0x00000001U,
}

enum uint MQ_MOVE_ACCESS = 0x00000004U;

enum : uint
{
    MQ_ACTION_RECEIVE      = 0x00000000U,
    MQ_ACTION_PEEK_CURRENT = 0x80000000U,
    MQ_ACTION_PEEK_NEXT    = 0x80000001U,
}

enum : uint
{
    MQ_LOOKUP_PEEK_CURRENT       = 0x40000010U,
    MQ_LOOKUP_PEEK_NEXT          = 0x40000011U,
    MQ_LOOKUP_PEEK_PREV          = 0x40000012U,
    MQ_LOOKUP_PEEK_FIRST         = 0x40000014U,
    MQ_LOOKUP_PEEK_LAST          = 0x40000018U,
    MQ_LOOKUP_RECEIVE_CURRENT    = 0x40000020U,
    MQ_LOOKUP_RECEIVE_NEXT       = 0x40000021U,
    MQ_LOOKUP_RECEIVE_PREV       = 0x40000022U,
    MQ_LOOKUP_RECEIVE_FIRST      = 0x40000024U,
    MQ_LOOKUP_RECEIVE_LAST       = 0x40000028U,
    MQ_LOOKUP_RECEIVE_ALLOW_PEEK = 0x40000120U,
}

enum : uint
{
    PROPID_M_BASE                = 0x00000000U,
    PROPID_M_CLASS               = 0x00000001U,
    PROPID_M_MSGID               = 0x00000002U,
    PROPID_M_CORRELATIONID       = 0x00000003U,
    PROPID_M_PRIORITY            = 0x00000004U,
    PROPID_M_DELIVERY            = 0x00000005U,
    PROPID_M_ACKNOWLEDGE         = 0x00000006U,
    PROPID_M_JOURNAL             = 0x00000007U,
    PROPID_M_APPSPECIFIC         = 0x00000008U,
    PROPID_M_BODY                = 0x00000009U,
    PROPID_M_BODY_SIZE           = 0x0000000aU,
    PROPID_M_LABEL               = 0x0000000bU,
    PROPID_M_LABEL_LEN           = 0x0000000cU,
    PROPID_M_TIME_TO_REACH_QUEUE = 0x0000000dU,
    PROPID_M_TIME_TO_BE_RECEIVED = 0x0000000eU,
}

enum : uint
{
    PROPID_M_RESP_QUEUE     = 0x0000000fU,
    PROPID_M_RESP_QUEUE_LEN = 0x00000010U,
}

enum : uint
{
    PROPID_M_ADMIN_QUEUE     = 0x00000011U,
    PROPID_M_ADMIN_QUEUE_LEN = 0x00000012U,
}

enum : uint
{
    PROPID_M_VERSION        = 0x00000013U,
    PROPID_M_SENDERID       = 0x00000014U,
    PROPID_M_SENDERID_LEN   = 0x00000015U,
    PROPID_M_SENDERID_TYPE  = 0x00000016U,
    PROPID_M_PRIV_LEVEL     = 0x00000017U,
    PROPID_M_AUTH_LEVEL     = 0x00000018U,
    PROPID_M_AUTHENTICATED  = 0x00000019U,
    PROPID_M_HASH_ALG       = 0x0000001aU,
    PROPID_M_ENCRYPTION_ALG = 0x0000001bU,
}

enum : uint
{
    PROPID_M_SENDER_CERT     = 0x0000001cU,
    PROPID_M_SENDER_CERT_LEN = 0x0000001dU,
    PROPID_M_SRC_MACHINE_ID  = 0x0000001eU,
    PROPID_M_SENTTIME        = 0x0000001fU,
    PROPID_M_ARRIVEDTIME     = 0x00000020U,
    PROPID_M_DEST_QUEUE      = 0x00000021U,
    PROPID_M_DEST_QUEUE_LEN  = 0x00000022U,
}

enum : uint
{
    PROPID_M_EXTENSION        = 0x00000023U,
    PROPID_M_EXTENSION_LEN    = 0x00000024U,
    PROPID_M_SECURITY_CONTEXT = 0x00000025U,
}

enum uint PROPID_M_CONNECTOR_TYPE = 0x00000026U;

enum : uint
{
    PROPID_M_XACT_STATUS_QUEUE     = 0x00000027U,
    PROPID_M_XACT_STATUS_QUEUE_LEN = 0x00000028U,
}

enum : uint
{
    PROPID_M_TRACE             = 0x00000029U,
    PROPID_M_BODY_TYPE         = 0x0000002aU,
    PROPID_M_DEST_SYMM_KEY     = 0x0000002bU,
    PROPID_M_DEST_SYMM_KEY_LEN = 0x0000002cU,
}

enum : uint
{
    PROPID_M_SIGNATURE        = 0x0000002dU,
    PROPID_M_SIGNATURE_LEN    = 0x0000002eU,
    PROPID_M_PROV_TYPE        = 0x0000002fU,
    PROPID_M_PROV_NAME        = 0x00000030U,
    PROPID_M_PROV_NAME_LEN    = 0x00000031U,
    PROPID_M_FIRST_IN_XACT    = 0x00000032U,
    PROPID_M_LAST_IN_XACT     = 0x00000033U,
    PROPID_M_XACTID           = 0x00000034U,
    PROPID_M_AUTHENTICATED_EX = 0x00000035U,
}

enum : uint
{
    PROPID_M_RESP_FORMAT_NAME     = 0x00000036U,
    PROPID_M_RESP_FORMAT_NAME_LEN = 0x00000037U,
}

enum : uint
{
    PROPID_M_DEST_FORMAT_NAME     = 0x0000003aU,
    PROPID_M_DEST_FORMAT_NAME_LEN = 0x0000003bU,
}

enum : uint
{
    PROPID_M_LOOKUPID          = 0x0000003cU,
    PROPID_M_SOAP_ENVELOPE     = 0x0000003dU,
    PROPID_M_SOAP_ENVELOPE_LEN = 0x0000003eU,
}

enum : uint
{
    PROPID_M_COMPOUND_MESSAGE      = 0x0000003fU,
    PROPID_M_COMPOUND_MESSAGE_SIZE = 0x00000040U,
}

enum : uint
{
    PROPID_M_SOAP_HEADER          = 0x00000041U,
    PROPID_M_SOAP_BODY            = 0x00000042U,
    PROPID_M_DEADLETTER_QUEUE     = 0x00000043U,
    PROPID_M_DEADLETTER_QUEUE_LEN = 0x00000044U,
}

enum : uint
{
    PROPID_M_ABORT_COUNT    = 0x00000045U,
    PROPID_M_MOVE_COUNT     = 0x00000046U,
    PROPID_M_LAST_MOVE_TIME = 0x0000004bU,
}

enum : uint
{
    PROPID_M_MSGID_SIZE         = 0x00000014U,
    PROPID_M_CORRELATIONID_SIZE = 0x00000014U,
}

enum uint PROPID_M_XACTID_SIZE = 0x00000014U;
enum uint MQMSG_PRIV_LEVEL_BODY_AES = 0x00000005U;
enum uint MQMSG_AUTHENTICATED_QM_MESSAGE = 0x0000000bU;
enum uint MQMSG_NOT_FIRST_IN_XACT = 0x00000000U;
enum uint MQMSG_FIRST_IN_XACT = 0x00000001U;
enum uint MQMSG_NOT_LAST_IN_XACT = 0x00000000U;
enum uint MQMSG_LAST_IN_XACT = 0x00000001U;

enum : uint
{
    PROPID_Q_BASE              = 0x00000064U,
    PROPID_Q_INSTANCE          = 0x00000065U,
    PROPID_Q_TYPE              = 0x00000066U,
    PROPID_Q_PATHNAME          = 0x00000067U,
    PROPID_Q_JOURNAL           = 0x00000068U,
    PROPID_Q_QUOTA             = 0x00000069U,
    PROPID_Q_BASEPRIORITY      = 0x0000006aU,
    PROPID_Q_JOURNAL_QUOTA     = 0x0000006bU,
    PROPID_Q_LABEL             = 0x0000006cU,
    PROPID_Q_CREATE_TIME       = 0x0000006dU,
    PROPID_Q_MODIFY_TIME       = 0x0000006eU,
    PROPID_Q_AUTHENTICATE      = 0x0000006fU,
    PROPID_Q_PRIV_LEVEL        = 0x00000070U,
    PROPID_Q_TRANSACTION       = 0x00000071U,
    PROPID_Q_PATHNAME_DNS      = 0x0000007cU,
    PROPID_Q_MULTICAST_ADDRESS = 0x0000007dU,
}

enum uint PROPID_Q_ADS_PATH = 0x0000007eU;
...
enum : uint
{
    PROPID_QM_BASE                   = 0x000000c8U,
    PROPID_QM_SITE_ID                = 0x000000c9U,
    PROPID_QM_MACHINE_ID             = 0x000000caU,
    PROPID_QM_PATHNAME               = 0x000000cbU,
    PROPID_QM_CONNECTION             = 0x000000ccU,
    PROPID_QM_ENCRYPTION_PK          = 0x000000cdU,
    PROPID_QM_ENCRYPTION_PK_BASE     = 0x000000e7U,
    PROPID_QM_ENCRYPTION_PK_ENHANCED = 0x000000e8U,
}

enum : uint
{
    PROPID_QM_PATHNAME_DNS      = 0x000000e9U,
    PROPID_QM_ENCRYPTION_PK_AES = 0x000000f4U,
}

enum : uint
{
    PROPID_PC_BASE       = 0x000016a8U,
    PROPID_PC_VERSION    = 0x000016a9U,
    PROPID_PC_DS_ENABLED = 0x000016aaU,
}

enum : uint
{
    PROPID_MGMT_MSMQ_BASE                = 0x00000000U,
    PROPID_MGMT_MSMQ_ACTIVEQUEUES        = 0x00000001U,
    PROPID_MGMT_MSMQ_PRIVATEQ            = 0x00000002U,
    PROPID_MGMT_MSMQ_DSSERVER            = 0x00000003U,
    PROPID_MGMT_MSMQ_CONNECTED           = 0x00000004U,
    PROPID_MGMT_MSMQ_TYPE                = 0x00000005U,
    PROPID_MGMT_MSMQ_BYTES_IN_ALL_QUEUES = 0x00000006U,
}
...
enum : uint
{
    PROPID_MGMT_QUEUE_BASE                  = 0x00000000U,
    PROPID_MGMT_QUEUE_PATHNAME              = 0x00000001U,
    PROPID_MGMT_QUEUE_FORMATNAME            = 0x00000002U,
    PROPID_MGMT_QUEUE_TYPE                  = 0x00000003U,
    PROPID_MGMT_QUEUE_LOCATION              = 0x00000004U,
    PROPID_MGMT_QUEUE_XACT                  = 0x00000005U,
    PROPID_MGMT_QUEUE_FOREIGN               = 0x00000006U,
    PROPID_MGMT_QUEUE_MESSAGE_COUNT         = 0x00000007U,
    PROPID_MGMT_QUEUE_BYTES_IN_QUEUE        = 0x00000008U,
    PROPID_MGMT_QUEUE_JOURNAL_MESSAGE_COUNT = 0x00000009U,
    PROPID_MGMT_QUEUE_BYTES_IN_JOURNAL      = 0x0000000aU,
    PROPID_MGMT_QUEUE_STATE                 = 0x0000000bU,
    PROPID_MGMT_QUEUE_NEXTHOPS              = 0x0000000cU,
    PROPID_MGMT_QUEUE_EOD_LAST_ACK          = 0x0000000dU,
    PROPID_MGMT_QUEUE_EOD_LAST_ACK_TIME     = 0x0000000eU,
    PROPID_MGMT_QUEUE_EOD_LAST_ACK_COUNT    = 0x0000000fU,
    PROPID_MGMT_QUEUE_EOD_FIRST_NON_ACK     = 0x00000010U,
    PROPID_MGMT_QUEUE_EOD_LAST_NON_ACK      = 0x00000011U,
    PROPID_MGMT_QUEUE_EOD_NEXT_SEQ          = 0x00000012U,
    PROPID_MGMT_QUEUE_EOD_NO_READ_COUNT     = 0x00000013U,
    PROPID_MGMT_QUEUE_EOD_NO_ACK_COUNT      = 0x00000014U,
    PROPID_MGMT_QUEUE_EOD_RESEND_TIME       = 0x00000015U,
    PROPID_MGMT_QUEUE_EOD_RESEND_INTERVAL   = 0x00000016U,
    PROPID_MGMT_QUEUE_EOD_RESEND_COUNT      = 0x00000017U,
    PROPID_MGMT_QUEUE_EOD_SOURCE_INFO       = 0x00000018U,
    PROPID_MGMT_QUEUE_CONNECTION_HISTORY    = 0x00000019U,
    PROPID_MGMT_QUEUE_SUBQUEUE_COUNT        = 0x0000001aU,
    PROPID_MGMT_QUEUE_SUBQUEUE_NAMES        = 0x0000001bU,
    PROPID_MGMT_QUEUE_USED_QUOTA            = 0x00000008U,
    PROPID_MGMT_QUEUE_JOURNAL_USED_QUOTA    = 0x0000000aU,
}
...
enum uint LONG_LIVED = 0xfffffffeU;
