...
enum uint WDK_NTDDI_VERSION = 0x0a000010;
enum uint OSVERSION_MASK = 0xffff0000;
enum uint SPVERSION_MASK = 0x0000ff00;
enum uint SUBVERSION_MASK = 0x000000ff;
enum uint NTDDI_VERSION = 0x0a000010;
...
{
    /*FIELD ATTR: NativeBitfieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(ReservedZero0)), FixedArgSig(ElementSig(21)), FixedArgSig(ElementSig(11))], [])*/uint _bitfield131;
}
