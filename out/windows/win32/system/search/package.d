...
enum : HRESULT
{
    INET_E_AGENT_CACHE_SIZE_EXCEEDED = HRESULT(0x800c0f82),
    INET_E_AGENT_CONNECTION_FAILED   = HRESULT(0x800c0f83),
}

enum : HRESULT
{
    INET_E_SCHEDULED_UPDATES_DISABLED   = HRESULT(0x800c0f84),
...
enum : int
{
    BMK_DURABILITY_ROWSET         = 0x00000000,
...
enum : int
{
    DBPROPVAL_RD_RESETALL        = 0xffffffff,
...
enum int MDPROPVAL_NL_SCHEMAONLY = 0x00000004;
...
enum int DBPROPVAL_CM_TRANSACTIONS = 0x00000001;
...
enum : int
{
    SQL_CACHE_DATA_NO  = 0x00000000,
    SQL_CACHE_DATA_YES = 0x00000001,
}

enum int SQL_RESET_YES = 0x00000001;
...
enum HRESULT DB_E_ROWLIMITEXCEEDED = HRESULT(0x80040e01);
enum HRESULT DB_E_READONLYACCESSOR = HRESULT(0x80040e02);
enum HRESULT DB_E_SCHEMAVIOLATION = HRESULT(0x80040e03);
enum HRESULT DB_E_BADROWHANDLE = HRESULT(0x80040e04);
enum HRESULT DB_E_OBJECTOPEN = HRESULT(0x80040e05);
enum HRESULT DB_E_BADCHAPTER = HRESULT(0x80040e06);
enum HRESULT DB_E_CANTCONVERTVALUE = HRESULT(0x80040e07);
enum HRESULT DB_E_BADBINDINFO = HRESULT(0x80040e08);
enum HRESULT DB_SEC_E_PERMISSIONDENIED = HRESULT(0x80040e09);
enum HRESULT DB_E_NOTAREFERENCECOLUMN = HRESULT(0x80040e0a);
enum HRESULT DB_E_LIMITREJECTED = HRESULT(0x80040e0b);
enum HRESULT DB_E_NOCOMMAND = HRESULT(0x80040e0c);
enum HRESULT DB_E_COSTLIMIT = HRESULT(0x80040e0d);
...
enum HRESULT DB_E_PARAMNOTOPTIONAL = HRESULT(0x80040e10);
...
enum HRESULT DB_E_ERRORSINCOMMAND = HRESULT(0x80040e14);
enum HRESULT DB_E_CANTCANCEL = HRESULT(0x80040e15);
enum HRESULT DB_E_DIALECTNOTSUPPORTED = HRESULT(0x80040e16);
enum HRESULT DB_E_DUPLICATEDATASOURCE = HRESULT(0x80040e17);
enum HRESULT DB_E_CANNOTRESTART = HRESULT(0x80040e18);
...
enum HRESULT DB_E_CANNOTFREE = HRESULT(0x80040e1a);
enum HRESULT DB_E_GOALREJECTED = HRESULT(0x80040e1c);
enum HRESULT DB_E_UNSUPPORTEDCONVERSION = HRESULT(0x80040e1d);
enum HRESULT DB_E_BADSTARTPOSITION = HRESULT(0x80040e1e);

enum : HRESULT
{
    DB_E_NOQUERY      = HRESULT(0x80040e1f),
    DB_E_NOTREENTRANT = HRESULT(0x80040e20),
}

enum HRESULT DB_E_ERRORSOCCURRED = HRESULT(0x80040e21);
enum HRESULT DB_E_NOAGGREGATION = HRESULT(0x80040e22);
enum HRESULT DB_E_DELETEDROW = HRESULT(0x80040e23);
enum HRESULT DB_E_CANTFETCHBACKWARDS = HRESULT(0x80040e24);
enum HRESULT DB_E_ROWSNOTRELEASED = HRESULT(0x80040e25);
...
enum HRESULT DB_E_CANTSCROLLBACKWARDS = HRESULT(0x80040e29);
enum HRESULT DB_E_BADREGIONHANDLE = HRESULT(0x80040e2a);
enum HRESULT DB_E_NONCONTIGUOUSRANGE = HRESULT(0x80040e2b);
enum HRESULT DB_E_INVALIDTRANSITION = HRESULT(0x80040e2c);
enum HRESULT DB_E_NOTASUBREGION = HRESULT(0x80040e2d);
enum HRESULT DB_E_MULTIPLESTATEMENTS = HRESULT(0x80040e2e);
enum HRESULT DB_E_INTEGRITYVIOLATION = HRESULT(0x80040e2f);
enum HRESULT DB_E_BADTYPENAME = HRESULT(0x80040e30);
enum HRESULT DB_E_ABORTLIMITREACHED = HRESULT(0x80040e31);
enum HRESULT DB_E_ROWSETINCOMMAND = HRESULT(0x80040e32);
enum HRESULT DB_E_CANTTRANSLATE = HRESULT(0x80040e33);
enum HRESULT DB_E_DUPLICATEINDEXID = HRESULT(0x80040e34);

enum : HRESULT
{
    DB_E_NOINDEX    = HRESULT(0x80040e35),
    DB_E_INDEXINUSE = HRESULT(0x80040e36),
}

enum : HRESULT
{
    DB_E_NOTABLE              = HRESULT(0x80040e37),
    DB_E_CONCURRENCYVIOLATION = HRESULT(0x80040e38),
}

enum : HRESULT
{
    DB_E_BADCOPY      = HRESULT(0x80040e39),
    DB_E_BADPRECISION = HRESULT(0x80040e3a),
    DB_E_BADSCALE     = HRESULT(0x80040e3b),
    DB_E_BADTABLEID   = HRESULT(0x80040e3c),
}

enum int DB_E_BADID = 0x80040e3c;
...
enum HRESULT DB_E_TABLEINUSE = HRESULT(0x80040e40);
enum HRESULT DB_E_NOLOCALE = HRESULT(0x80040e41);
enum HRESULT DB_E_BADRECORDNUM = HRESULT(0x80040e42);
enum HRESULT DB_E_BOOKMARKSKIPPED = HRESULT(0x80040e43);
enum HRESULT DB_E_BADPROPERTYVALUE = HRESULT(0x80040e44);
...
enum HRESULT DB_E_BADSTORAGEFLAGS = HRESULT(0x80040e47);
enum HRESULT DB_E_BYREFACCESSORNOTSUPPORTED = HRESULT(0x80040e48);
enum HRESULT DB_E_NULLACCESSORNOTSUPPORTED = HRESULT(0x80040e49);
enum HRESULT DB_E_NOTPREPARED = HRESULT(0x80040e4a);
enum HRESULT DB_E_BADACCESSORTYPE = HRESULT(0x80040e4b);
enum HRESULT DB_E_WRITEONLYACCESSOR = HRESULT(0x80040e4c);
enum HRESULT DB_SEC_E_AUTH_FAILED = HRESULT(0x80040e4d);
...
enum HRESULT DB_E_BADSOURCEHANDLE = HRESULT(0x80040e50);
enum HRESULT DB_E_PARAMUNAVAILABLE = HRESULT(0x80040e51);
enum HRESULT DB_E_ALREADYINITIALIZED = HRESULT(0x80040e52);
enum HRESULT DB_E_NOTSUPPORTED = HRESULT(0x80040e53);
enum HRESULT DB_E_MAXPENDCHANGESEXCEEDED = HRESULT(0x80040e54);
enum HRESULT DB_E_BADORDINAL = HRESULT(0x80040e55);
enum HRESULT DB_E_PENDINGCHANGES = HRESULT(0x80040e56);
enum HRESULT DB_E_DATAOVERFLOW = HRESULT(0x80040e57);

enum : HRESULT
{
    DB_E_BADHRESULT        = HRESULT(0x80040e58),
    DB_E_BADLOOKUPID       = HRESULT(0x80040e59),
    DB_E_BADDYNAMICERRORID = HRESULT(0x80040e5a),
}

enum HRESULT DB_E_PENDINGINSERT = HRESULT(0x80040e5b);
...
enum HRESULT DB_E_MULTIPLESTORAGE = HRESULT(0x80040e5e);
...
enum : HRESULT
{
    MD_E_BADTUPLE      = HRESULT(0x80040e61),
    MD_E_BADCOORDINATE = HRESULT(0x80040e62),
}

enum : HRESULT
{
    MD_E_INVALIDAXIS      = HRESULT(0x80040e63),
    MD_E_INVALIDCELLRANGE = HRESULT(0x80040e64),
}

enum HRESULT DB_E_NOCOLUMN = HRESULT(0x80040e65);
enum HRESULT DB_E_COMMANDNOTPERSISTED = HRESULT(0x80040e67);
enum HRESULT DB_E_DUPLICATEID = HRESULT(0x80040e68);
enum HRESULT DB_E_OBJECTCREATIONLIMITREACHED = HRESULT(0x80040e69);

enum : HRESULT
{
    DB_E_BADINDEXID    = HRESULT(0x80040e72),
    DB_E_BADINITSTRING = HRESULT(0x80040e73),
}

enum HRESULT DB_E_NOPROVIDERSREGISTERED = HRESULT(0x80040e74);
enum HRESULT DB_E_MISMATCHEDPROVIDER = HRESULT(0x80040e75);
enum HRESULT DB_E_BADCOMMANDID = HRESULT(0x80040e76);
enum int SEC_E_PERMISSIONDENIED = 0x80040e09;
enum HRESULT SEC_E_BADTRUSTEEID = HRESULT(0x80040e6a);
...
enum HRESULT SEC_E_INVALIDOBJECT = HRESULT(0x80040e6d);
...
enum : HRESULT
{
    DB_E_BADCONSTRAINTTYPE = HRESULT(0x80040e77),
    DB_E_BADCONSTRAINTFORM = HRESULT(0x80040e78),
}

enum HRESULT DB_E_BADDEFERRABILITY = HRESULT(0x80040e79);
...
enum : HRESULT
{
    DB_E_BADCONSTRAINTID = HRESULT(0x80040e8b),
    DB_E_BADCOMMANDFLAGS = HRESULT(0x80040e8c),
}

enum HRESULT DB_E_OBJECTMISMATCH = HRESULT(0x80040e8d);
enum HRESULT DB_E_NOSOURCEOBJECT = HRESULT(0x80040e91);
enum HRESULT DB_E_RESOURCELOCKED = HRESULT(0x80040e92);
enum HRESULT DB_E_NOTCOLLECTION = HRESULT(0x80040e93);
enum HRESULT DB_E_READONLY = HRESULT(0x80040e94);
enum HRESULT DB_E_ASYNCNOTSUPPORTED = HRESULT(0x80040e95);
enum HRESULT DB_E_CANNOTCONNECT = HRESULT(0x80040e96);
...
enum HRESULT DB_E_DROPRESTRICTED = HRESULT(0x80040e90);
enum HRESULT DB_E_DUPLICATECONSTRAINTID = HRESULT(0x80040e99);
enum HRESULT DB_E_OUTOFSPACE = HRESULT(0x80040e9a);
enum HRESULT DB_SEC_E_SAFEMODE_DENIED = HRESULT(0x80040e9b);
enum HRESULT DB_E_NOSTATISTIC = HRESULT(0x80040e9c);
enum HRESULT DB_E_ALTERRESTRICTED = HRESULT(0x80040e9d);
enum HRESULT DB_E_RESOURCENOTSUPPORTED = HRESULT(0x80040e9e);
enum HRESULT DB_E_NOCONSTRAINT = HRESULT(0x80040e9f);
enum HRESULT DB_E_COLUMNUNAVAILABLE = HRESULT(0x80040ea0);
enum HRESULT DB_S_ROWLIMITEXCEEDED = HRESULT(0x00040ec0);
enum HRESULT DB_S_COLUMNTYPEMISMATCH = HRESULT(0x00040ec1);
enum HRESULT DB_S_TYPEINFOOVERRIDDEN = HRESULT(0x00040ec2);
enum HRESULT DB_S_BOOKMARKSKIPPED = HRESULT(0x00040ec3);
enum HRESULT DB_S_NONEXTROWSET = HRESULT(0x00040ec5);
enum HRESULT DB_S_ENDOFROWSET = HRESULT(0x00040ec6);
enum HRESULT DB_S_COMMANDREEXECUTED = HRESULT(0x00040ec7);
enum HRESULT DB_S_BUFFERFULL = HRESULT(0x00040ec8);
enum HRESULT DB_S_NORESULT = HRESULT(0x00040ec9);
enum HRESULT DB_S_CANTRELEASE = HRESULT(0x00040eca);
enum HRESULT DB_S_GOALCHANGED = HRESULT(0x00040ecb);
enum HRESULT DB_S_UNWANTEDOPERATION = HRESULT(0x00040ecc);
enum HRESULT DB_S_DIALECTIGNORED = HRESULT(0x00040ecd);

enum : HRESULT
{
    DB_S_UNWANTEDPHASE  = HRESULT(0x00040ece),
    DB_S_UNWANTEDREASON = HRESULT(0x00040ecf),
}

enum HRESULT DB_S_ASYNCHRONOUS = HRESULT(0x00040ed0);
enum HRESULT DB_S_COLUMNSCHANGED = HRESULT(0x00040ed1);
enum HRESULT DB_S_ERRORSRETURNED = HRESULT(0x00040ed2);
enum HRESULT DB_S_BADROWHANDLE = HRESULT(0x00040ed3);
enum HRESULT DB_S_DELETEDROW = HRESULT(0x00040ed4);
enum HRESULT DB_S_TOOMANYCHANGES = HRESULT(0x00040ed5);
enum HRESULT DB_S_STOPLIMITREACHED = HRESULT(0x00040ed6);
enum HRESULT DB_S_LOCKUPGRADED = HRESULT(0x00040ed8);
enum HRESULT DB_S_PROPERTIESCHANGED = HRESULT(0x00040ed9);
enum HRESULT DB_S_ERRORSOCCURRED = HRESULT(0x00040eda);
enum HRESULT DB_S_PARAMUNAVAILABLE = HRESULT(0x00040edb);
enum HRESULT DB_S_MULTIPLECHANGES = HRESULT(0x00040edc);

enum : HRESULT
{
    DB_S_NOTSINGLETON         = HRESULT(0x00040ed7),
...
enum const(wchar)* MS_PERSIST_PROGID = "MSPersist";
enum GUID DBQUERYGUID = GUID("49691c90-7e17-101a-a91c-08002b2ecda9");
...
enum : int
{
    SQL_ATTR_CURSOR_SCROLLABLE  = 0xffffffff,
...
enum int SQL_AT_ADD_CONSTRAINT = 0x00000008;
...
enum int SQL_TXN_READ_COMMITTED = 0x00000002;
enum int SQL_TRANSACTION_READ_COMMITTED = 0x00000002;
enum int SQL_TXN_REPEATABLE_READ = 0x00000004;
enum int SQL_TRANSACTION_REPEATABLE_READ = 0x00000004;
enum int SQL_TXN_SERIALIZABLE = 0x00000008;
...
//CONST ATTR: NativeEncodingAttribute : CustomAttributeSig([FixedArgSig(ElementSig(ansi))], [])
enum const(wchar)* SQL_SPEC_STRING = "03.80";
...
//CONST ATTR: NativeEncodingAttribute : CustomAttributeSig([FixedArgSig(ElementSig(ansi))], [])
enum const(wchar)* SQL_OPT_TRACE_FILE_DEFAULT = "\\SQL.LOG";
...
enum int SQL_VARBINARY = 0xfffffffd;
enum int SQL_LONGVARBINARY = 0xfffffffc;
enum int SQL_BIGINT = 0xfffffffb;
...
enum : int
{
    SQL_TYPE_DRIVER_START = 0xffffffb0,
    SQL_TYPE_DRIVER_END   = 0xffffff9f,
}
...
enum : int
{
    SQL_C_INTERVAL_YEAR             = 0xffffffb0,
...
enum int SQL_ROW_NUMBER_UNKNOWN = 0xfffffffe;
enum int SQL_COLUMN_NUMBER_UNKNOWN = 0xfffffffe;
enum int SQL_DEFAULT_PARAM = 0xfffffffb;
enum int SQL_IGNORE = 0xfffffffa;
enum int SQL_COLUMN_IGNORE = 0xfffffffa;
enum int SQL_LEN_DATA_AT_EXEC_OFFSET = 0xffffff9c;
enum int SQL_LEN_BINARY_ATTR_OFFSET = 0xffffff9c;
...
enum int SQL_AT_SET_COLUMN_DEFAULT = 0x00000100;
...
enum int SQL_AT_ADD_TABLE_CONSTRAINT = 0x00001000;
...
enum int SQL_FN_TD_EXTRACT = 0x00100000;
...
enum int SQL_CA1_SELECT_FOR_UPDATE = 0x00008000;
...
enum int SQL_CA2_READ_ONLY_CONCURRENCY = 0x00000001;
enum int SQL_CA2_LOCK_CONCURRENCY = 0x00000002;
enum int SQL_CA2_OPT_ROWVER_CONCURRENCY = 0x00000004;
...
enum int SQL_TXN_VERSIONING = 0x00000010;
...
enum int SQL_OU_PRIVILEGE_DEFINITION = 0x00000010;
enum int SQL_SU_DML_STATEMENTS = 0x00000001;
enum int SQL_SU_PROCEDURE_INVOCATION = 0x00000002;
enum int SQL_SU_TABLE_DEFINITION = 0x00000004;
enum int SQL_SU_INDEX_DEFINITION = 0x00000008;
enum int SQL_SU_PRIVILEGE_DEFINITION = 0x00000010;
enum int SQL_QU_DML_STATEMENTS = 0x00000001;
enum int SQL_QU_PROCEDURE_INVOCATION = 0x00000002;
enum int SQL_QU_TABLE_DEFINITION = 0x00000004;
enum int SQL_QU_INDEX_DEFINITION = 0x00000008;
enum int SQL_QU_PRIVILEGE_DEFINITION = 0x00000010;
enum int SQL_CU_DML_STATEMENTS = 0x00000001;
enum int SQL_CU_PROCEDURE_INVOCATION = 0x00000002;
enum int SQL_CU_TABLE_DEFINITION = 0x00000004;
enum int SQL_CU_INDEX_DEFINITION = 0x00000008;
...
enum int SQL_BP_SCROLL = 0x00000040;
...
enum int SQL_SC_SQL92_ENTRY = 0x00000001;
...
enum int SQL_BS_SELECT_PROC = 0x00000004;
...
enum int SQL_ISV_REFERENTIAL_CONSTRAINTS = 0x00001000;
...
enum int SQL_ISV_USAGE_PRIVILEGES = 0x00080000;
...
enum int SQL_AD_CONSTRAINT_NAME_DEFINITION = 0x00000001;
enum int SQL_AD_ADD_DOMAIN_CONSTRAINT = 0x00000002;
enum int SQL_AD_DROP_DOMAIN_CONSTRAINT = 0x00000004;
enum int SQL_AD_ADD_DOMAIN_DEFAULT = 0x00000008;
enum int SQL_AD_DROP_DOMAIN_DEFAULT = 0x00000010;
...
enum int SQL_CS_CREATE_SCHEMA = 0x00000001;
enum int SQL_CS_AUTHORIZATION = 0x00000002;
enum int SQL_CS_DEFAULT_CHARACTER_SET = 0x00000004;
enum int SQL_CTR_CREATE_TRANSLATION = 0x00000001;
enum int SQL_CA_CREATE_ASSERTION = 0x00000001;
...
enum int SQL_CCS_CREATE_CHARACTER_SET = 0x00000001;
enum int SQL_CCS_COLLATE_CLAUSE = 0x00000002;
enum int SQL_CCS_LIMITED_COLLATION = 0x00000004;
enum int SQL_CCOL_CREATE_COLLATION = 0x00000001;
enum int SQL_CDO_CREATE_DOMAIN = 0x00000001;
...
enum int SQL_CT_GLOBAL_TEMPORARY = 0x00000008;
...
enum int SQL_CT_TABLE_CONSTRAINT = 0x00001000;
enum int SQL_CT_CONSTRAINT_NAME_DEFINITION = 0x00002000;
enum int SQL_DI_CREATE_INDEX = 0x00000001;
enum int SQL_DI_DROP_INDEX = 0x00000002;
enum int SQL_DC_DROP_COLLATION = 0x00000001;
...
enum int SQL_DS_DROP_SCHEMA = 0x00000001;
...
enum int SQL_DCS_DROP_CHARACTER_SET = 0x00000001;
...
enum int SQL_IS_SELECT_INTO = 0x00000004;
...
enum int SQL_SG_WITH_GRANT_OPTION = 0x00000010;
...
enum int SQL_SG_SELECT_TABLE = 0x00000400;
...
enum int SQL_SRJO_CORRESPONDING_CLAUSE = 0x00000001;
...
enum int SQL_SRJO_LEFT_OUTER_JOIN = 0x00000040;
...
enum int SQL_SRJO_UNION_JOIN = 0x00000200;
...
enum int SQL_SR_GRANT_OPTION_FOR = 0x00000010;
...
enum int SQL_SR_SELECT_TABLE = 0x00001000;
...
enum int SQL_SRVC_VALUE_EXPRESSION = 0x00000001;
...
enum int SQL_SCC_XOPEN_CLI_VERSION1 = 0x00000001;
enum int SQL_SCC_ISO92_CLI = 0x00000002;

enum : int
{
    SQL_US_UNION     = 0x00000001,
    SQL_US_UNION_ALL = 0x00000002,
}
...
enum int SQL_DTC_ENLIST_EXPENSIVE = 0x00000001;
...
enum : int
{
    SQL_SCROLL_FORWARD_ONLY  = 0x00000000,
...
enum : int
{
    EVENT_SSSEARCH_DROPPED_EVENTS                 = 0x800003f7,
...
enum int EVENT_SSSEARCH_CSM_SAVE_FAILED = 0xc00003fb;
enum int EVENT_CONFIG_SYNTAX = 0x80000414;
enum int EVENT_UNPRIVILEGED_SERVICE_ACCOUNT = 0x8000041c;
enum int EVENT_SYSTEM_EXCEPTION = 0x8000041d;
enum int EVENT_CONFIG_ERROR = 0xc0000bbb;
...
enum int EVENT_HASHMAP_INSERT = 0xc0000bc0;
...
enum int EVENT_HASHMAP_UPDATE = 0xc0000bc5;
enum int EVENT_GATHER_EXCEPTION = 0xc0000bc6;
enum int EVENT_TRANSACTION_READ = 0xc0000bc7;
...
enum int EVENT_TRANSLOG_CREATE = 0xc0000bd9;
enum int EVENT_REG_VERSION = 0xc0000bda;

enum : int
{
    EVENT_GATHER_CRAWL_SEED_FAILED      = 0x80000bdc,
    EVENT_GATHER_CRAWL_SEED_FAILED_INIT = 0x80000bdd,
}

enum : int
{
    EVENT_GATHER_REG_MISSING          = 0x80000bde,
...
enum : int
{
    EVENT_GATHER_NO_CRAWL_SEEDS         = 0x80000be6,
...
enum : int
{
    EVENT_GATHER_STOP_START           = 0x40000bec,
    EVENT_GATHER_START_CRAWL_IF_RESET = 0x80000bed,
}

enum : int
{
    EVENT_GATHER_DISK_FULL              = 0x80000bee,
    EVENT_GATHER_NO_SCHEMA              = 0x80000bef,
    EVENT_GATHER_AUTODESCENCODE_INVALID = 0x80000bf0,
}

enum int EVENT_GATHER_PLUGINMGR_INIT_FAILED = 0xc0000bf1;
enum int EVENT_GATHER_APP_INIT_FAILED = 0xc0000bf2;
enum int EVENT_FAILED_INITIALIZE_CRAWL = 0xc0000bf3;
enum int EVENT_CRAWL_SCHEDULED = 0x40000bf4;
enum int EVENT_FAILED_CREATE_GATHERER_LOG = 0x80000bf5;
enum int EVENT_WBREAKER_NOT_LOADED = 0x80000bf6;
enum int EVENT_LEARN_PROPAGATION_COPY_FAILED = 0x80000bf7;
...
enum int EVENT_GATHER_END_ADAPTIVE = 0x40000bfb;
enum int EVENT_USING_DIFFERENT_WORD_BREAKER = 0x80000bfc;

enum : int
{
    EVENT_GATHER_RESTORE_COMPLETE = 0x00000bfd,
    EVENT_GATHER_RESTORE_ERROR    = 0xc0000bfe,
}

enum int EVENT_AUTOCAT_PERFMON = 0xc0000bff;
...
enum : int
{
    EVENT_GATHER_RESTOREAPP_ERROR    = 0xc0000c02,
...
enum : int
{
    EVENT_NOTIFICATION_FAILURE                        = 0xc0000c07,
    EVENT_NOTIFICATION_FAILURE_SCOPE_EXCEEDED_LOGGING = 0x80000c08,
}

enum : int
{
    EVENT_NOTIFICATION_RESTORED                        = 0x40000c09,
    EVENT_NOTIFICATION_RESTORED_SCOPE_EXCEEDED_LOGGING = 0x80000c0a,
}

enum : int
{
    EVENT_GATHER_PROTOCOLHANDLER_LOAD_FAILED = 0xc0000c0b,
    EVENT_GATHER_PROTOCOLHANDLER_INIT_FAILED = 0xc0000c0c,
}

enum int EVENT_GATHER_INVALID_NETWORK_ACCESS_ACCOUNT = 0xc0000c0d;
...
enum int EVENT_GATHER_READ_CHECKPOINT_FAILED = 0xc0000c13;
...
enum int EVENT_STS_INIT_SECURITY_FAILED = 0x80000c16;
...
enum int EVENT_GATHERER_DATASOURCE = 0xc0000c19;
enum int EVENT_AUTOCAT_CANT_CREATE_FILE_SHARE = 0xc0000c1a;
enum int EVENT_NOTIFICATION_THREAD_EXIT_FAILED = 0xc0000c1b;
...
enum : int
{
    EVENT_FILTERPOOL_ADD_FAILED    = 0xc0000c1e,
    EVENT_FILTERPOOL_DELETE_FAILED = 0xc0000c1f,
}

enum int EVENT_ENUMERATE_SESSIONS_FAILED = 0xc0000c20;
enum int EVENT_DETAILED_FILTERPOOL_ADD_FAILED = 0xc0000c21;
enum int EVENT_AUDIENCECOMPUTATION_CANNOTSTART = 0xc0000e11;
...
enum : int
{
    EVENT_INDEXER_STARTED               = 0x40001b58,
...
enum : int
{
    EVENT_INDEXER_CI_LOAD_ERROR         = 0xc0001b7f,
...
enum : int
{
    EVENT_INDEXER_REG_ERROR            = 0xc0001b9c,
...
enum int EVENT_DSS_NOT_ENABLED = 0x80001ba4;
enum int EVENT_INDEXER_PROP_COMMIT_FAILED = 0xc0001ba5;
enum int JET_INIT_ERROR = 0xc0002328;
enum int JET_NEW_PROP_STORE_ERROR = 0xc0002329;
enum int JET_GET_PROP_STORE_ERROR = 0xc000232a;
enum int JET_MULTIINSTANCE_DISABLED = 0x8000232b;

enum : int
{
    EVENT_WARNING_CANNOT_UPGRADE_NOISE_FILES = 0x8000271d,
    EVENT_WARNING_CANNOT_UPGRADE_NOISE_FILE  = 0x8000271e,
}

enum int EVENT_WIN32_ERROR = 0x8000271f;
...
enum int EVENT_PROTOCOL_HOST_FORCE_TERMINATE = 0x80002727;
enum int EVENT_FILTER_HOST_FORCE_TERMINATE = 0x80002728;
enum int EVENT_INDEXER_OUT_OF_DATABASE_INSTANCE = 0xc0002729;
...
enum int MSS_E_INVALIDAPPNAME = 0x80042100;
...
enum int MSS_E_UNICODEFILEHEADERMISSING = 0x80042105;
...
enum int NET_E_INVALIDPARAMS = 0x80040308;
enum int NET_E_OPERATIONINPROGRESS = 0x80040309;
enum int SEC_E_INVALIDCONTEXT = 0x80041403;
enum int SEC_E_INITFAILED = 0x80041401;
enum int SEC_E_NOTINITIALIZED = 0x80041402;
enum int SEC_E_ACCESSDENIED = 0x800414ff;
enum int DS_E_NOMOREDATA = 0x80040400;
enum int DS_E_INVALIDDATASOURCE = 0x80040401;
enum int DS_E_DATASOURCENOTAVAILABLE = 0x80040402;
enum int DS_E_QUERYCANCELED = 0x80040403;
enum int DS_E_UNKNOWNREQUEST = 0x80040404;
enum int DS_E_BADREQUEST = 0x80040405;
enum int DS_E_SERVERCAPACITY = 0x80040406;
enum int DS_E_BADSEQUENCE = 0x80040407;
enum int DS_E_MESSAGETOOLONG = 0x80040408;
enum int DS_E_SERVERERROR = 0x80040409;
enum int DS_E_CONFIGBAD = 0x8004040a;
enum int DS_E_DATANOTPRESENT = 0x80040410;
enum int DS_E_SETSTATUSINPROGRESS = 0x80040411;
enum int DS_E_DUPLICATEID = 0x80040412;
enum int DS_E_TOOMANYDATASOURCES = 0x80040413;
enum int DS_E_REGISTRY = 0x80040414;
enum int DS_E_DATASOURCENOTDISABLED = 0x80040415;
...
enum int DS_E_CONFIGNOTRIGHTTYPE = 0x80040418;
enum int DS_E_PROTOCOLVERSION = 0x80040419;
enum int DS_E_ALREADYENABLED = 0x8004041a;
enum int DS_E_INDEXDIRECTORY = 0x8004041c;
enum int DS_E_VALUETOOLARGE = 0x8004041d;
enum int DS_E_UNKNOWNPARAM = 0x8004041e;
enum int DS_E_BUFFERTOOSMALL = 0x8004041f;
enum int DS_E_PARAMOUTOFRANGE = 0x80040420;
enum int DS_E_ALREADYDISABLED = 0x80040421;
enum int DS_E_QUERYHUNG = 0x80040422;
enum int DS_E_BADRESULT = 0x80040423;
...
enum int DS_E_SEARCHCATNAMECOLLISION = 0x80040426;
enum int DS_E_PROPVERSIONMISMATCH = 0x80040427;
enum int DS_E_MISSINGCATALOG = 0x80040428;
...
enum int COLL_E_BUFFERTOOSMALL = 0x80040504;
...
enum int COLL_E_DUPLICATEDBID = 0x80040508;
enum int COLL_E_TOOMANYMERGECOLUMNS = 0x80040509;
enum int COLL_E_NODEFAULTCATALOG = 0x8004050a;
...
enum int CM_E_NOQUERYCONNECTIONS = 0x80040603;
enum int CM_E_DATASOURCENOTAVAILABLE = 0x80040604;
enum int CM_E_CONNECTIONTIMEOUT = 0x80040605;
enum int CM_E_SERVERNOTFOUND = 0x80040606;
enum int CM_S_NODATASERVERS = 0x00040607;
enum int CM_E_REGISTRY = 0x80040608;
enum int CM_E_INVALIDDATASOURCE = 0x80040609;
...
enum int QRY_E_QUERYSYNTAX = 0x80040701;
enum int QRY_E_TYPEMISMATCH = 0x80040702;
enum int QRY_E_UNHANDLEDTYPE = 0x80040703;
...
enum int QRY_E_STARTHITTOBIG = 0x80040707;
enum int QRY_E_TOOMANYQUERYTERMS = 0x80040708;
enum int QRY_E_NODATASOURCES = 0x80040709;
...
enum int QRY_E_INVALIDCOLUMN = 0x8004070d;
enum int QRY_E_QUERYCORRUPT = 0x8004070e;
enum int QRY_E_PREFIXWILDCARD = 0x8004070f;
enum int QRY_E_INFIXWILDCARD = 0x80040710;
enum int QRY_E_WILDCARDPREFIXLENGTH = 0x80040711;
enum int QRY_S_TERMIGNORED = 0x00040712;
enum int QRY_E_ENGINEFAILED = 0x80040713;
enum int QRY_E_SEARCHTOOBIG = 0x80040714;
enum int QRY_E_NULLQUERY = 0x80040715;
enum int QRY_S_INEXACTRESULTS = 0x00040716;
enum int QRY_E_NOCOLUMNS = 0x80040717;
...
enum int QRY_E_SCOPECARDINALIDY = 0x8004071a;
enum int QRY_E_UNEXPECTED = 0x8004071b;
enum int QRY_E_INVALIDPATH = 0x8004071c;
enum int QRY_E_LMNOTINITIALIZED = 0x8004071d;
enum int QRY_E_INVALIDINTERVAL = 0x8004071e;
...
enum int SCHEMA_E_CANNOTCREATENOISEWORDFILE = 0x80040c0b;
...
enum int GTHR_E_DUPLICATE_OBJECT = 0x80040d02;
...
enum int GTHR_E_ERROR_OBJECT_NOT_FOUND = 0x80040d06;
...
enum int GTHR_E_DUPLICATE_URL = 0x80040d0d;
enum int GTHR_E_TOO_MANY_PLUGINS = 0x80040d0e;
enum int GTHR_E_INVALIDFUNCTION = 0x80040d0f;
...
enum int GTHR_E_UNSUPPORTED_PROPERTY_TYPE = 0x80040d13;
enum int GTHR_E_NAME_TOO_LONG = 0x80040d14;
enum int GTHR_E_NO_IDENTITY = 0x80040d15;
...
enum int GTHR_E_PRT_HNDLR_PROGID_MISSING = 0x80040d18;
enum int GTHR_E_FILTER_PROCESS_TERMINATED_QUOTA = 0x80040d19;
enum int GTHR_E_UNKNOWN_PROTOCOL = 0x80040d1a;
...
enum int GTHR_E_INVALID_PROJECT_NAME = 0x80040d22;
enum int GTHR_E_SHUTTING_DOWN = 0x80040d23;
enum int GTHR_S_END_STD_CHUNKS = 0x00040d24;
enum int GTHR_E_VALUE_NOT_AVAILABLE = 0x80040d25;
enum int GTHR_E_OUT_OF_DOC_ID = 0x80040d26;
enum int GTHR_E_NOTIFICATION_START_PAGE = 0x80040d27;
enum int GTHR_E_DUP_PROPERTY_MAPPING = 0x80040d2a;
enum int GTHR_S_NO_CRAWL_SEEDS = 0x00040d2b;
enum int GTHR_E_INVALID_ACCOUNT = 0x80040d2c;
enum int GTHR_E_FILTER_INIT = 0x80040d2e;
enum int GTHR_E_INVALID_ACCOUNT_SYNTAX = 0x80040d2f;
...
enum int GTHR_S_STATUS_STOP = 0x00040d33;
enum int GTHR_E_INVALID_PATH = 0x80040d34;
enum int GTHR_E_FILTER_NO_CODEPAGE = 0x80040d35;
enum int GTHR_S_STATUS_START = 0x00040d36;
enum int GTHR_E_NO_PRTCLHNLR = 0x80040d37;
...
enum int GTHR_E_INVALID_MAPPING = 0x80040d40;
enum int GTHR_E_USER_AGENT_NOT_SPECIFIED = 0x80040d41;
enum int GTHR_E_FROM_NOT_SPECIFIED = 0x80040d43;
...
enum int GTHR_E_DUPLICATE_PROJECT = 0x80040d52;
enum int GTHR_E_INVALID_DIRECTORY = 0x80040d53;
enum int GTHR_E_FILTER_INTERRUPTED = 0x80040d54;
enum int GTHR_E_INVALID_PROXY_PORT = 0x80040d55;
enum int GTHR_S_CONFIG_HAS_ACCOUNTS = 0x00040d56;
...
enum int GTHR_E_APPLICATION_NOT_FOUND = 0x80040d61;
enum int GTHR_E_CANNOT_REMOVE_PLUGINMGR = 0x80040d62;
enum int GTHR_E_INVALID_APPLICATION_NAME = 0x80040d63;
enum int GTHR_E_FILTER_FAULT = 0x80040d65;
enum int GTHR_E_NON_FIXED_DRIVE = 0x80040d66;
enum int GTHR_S_PROB_NOT_MODIFIED = 0x00040d67;
enum int GTHR_S_CRAWL_SCHEDULED = 0x00040d68;
enum int GTHR_S_TRANSACTION_IGNORED = 0x00040d69;
enum int GTHR_S_START_FILTER_FROM_PROTOCOL = 0x00040d6a;
enum int GTHR_E_FILTER_SINGLE_THREADED = 0x80040d6b;
enum int GTHR_S_BAD_FILE_LINK = 0x00040d6c;
enum int GTHR_E_URL_UNIDENTIFIED = 0x80040d6d;
enum int GTHR_S_NOT_ALL_PARTS = 0x00040d6e;
enum int GTHR_E_FORCE_NOTIFICATION_RESET = 0x80040d6f;
enum int GTHR_S_END_PROCESS_LOOP_NOTIFY_QUEUE = 0x00040d70;
enum int GTHR_S_START_FILTER_FROM_BODY = 0x00040d71;
enum int GTHR_E_CONTENT_ID_CONFLICT = 0x80040d72;
enum int GTHR_E_UNABLE_TO_READ_EXCHANGE_STORE = 0x80040d73;
enum int GTHR_E_RECOVERABLE_EXOLEDB_ERROR = 0x80040d74;
enum int GTHR_E_INVALID_CALL_FROM_WBREAKER = 0x80040d76;
enum int GTHR_E_PROPERTY_LIST_NOT_INITIALIZED = 0x80040d77;
enum int GTHR_S_MODIFIED_PARTS = 0x00040d78;
enum int GHTR_E_LOCAL_SERVER_UNAVAILABLE = 0x80040d79;
enum int GTHR_E_SCHEMA_ERRORS_OCCURRED = 0x80040d7a;
enum int GTHR_E_TIMEOUT = 0x80040d7b;
...
enum int GHTR_E_INSUFFICIENT_DISK_SPACE = 0x80040d8b;
enum int GTHR_E_INVALID_RESOURCE_ID = 0x80040d8d;
enum int GTHR_E_NESTED_HIERARCHICAL_START_ADDRESSES = 0x80040d8e;
...
enum int GTHR_S_OFFICE_CHILD = 0x00040d9a;
enum int GTHR_E_PLUGIN_NOT_REGISTERED = 0x80040d9b;
enum int GTHR_E_NOTIF_ACCESS_TOKEN_UPDATED = 0x80040d9c;
...
enum int GTHR_E_INVALID_PATH_SPEC = 0x80040da0;
...
enum int GTHR_E_AUTOCAT_UNEXPECTED = 0x80040da4;
enum int GTHR_E_SINGLE_THREADED_EMBEDDING = 0x80040da5;
enum int GTHR_S_CANNOT_WORDBREAK = 0x00040da6;
enum int GTHR_S_USE_MIME_FILTER = 0x00040da7;
enum int GTHR_E_FOLDER_CRAWLED_BY_ANOTHER_WORKSPACE = 0x80040da9;
...
enum int GTHR_E_CANNOT_ENABLE_CHECKPOINT = 0x80040dae;
enum int GTHR_E_SCOPES_EXCEEDED = 0x80040daf;
enum int GTHR_E_PROPERTIES_EXCEEDED = 0x80040db0;
enum int GTHR_E_INVALID_START_ADDRESS = 0x80040db2;
enum int GTHR_S_PAUSE_REASON_PROFILE_IMPORT = 0x00040db3;
enum int GTHR_E_PIPE_NOT_CONNECTTED = 0x80040db4;
enum int GTHR_E_BACKUP_VALIDATION_FAIL = 0x80040db6;
enum int GTHR_E_BAD_FILTER_HOST = 0x80040db7;
enum int GTHR_E_NTF_CLIENT_NOT_SUBSCRIBED = 0xc0040db9;
enum int GTHR_E_FILTERPOOL_NOTFOUND = 0x80040dba;
enum int GTHR_E_ADDLINKS_FAILED_WILL_RETRY_PARENT = 0x80040dbb;
enum int IDX_E_INVALIDTAG = 0x80041101;
enum int IDX_E_METAFILE_CORRUPT = 0x80041102;
enum int IDX_E_TOO_MANY_SEARCH_SERVERS = 0x80041103;
enum int IDX_E_SEARCH_SERVER_ALREADY_EXISTS = 0x80041104;
enum int IDX_E_BUILD_IN_PROGRESS = 0x80041105;
enum int IDX_E_IDXLSTFILE_CORRUPT = 0x80041106;
enum int IDX_E_REGISTRY_ENTRY = 0x80041107;
enum int IDX_E_OBJECT_NOT_FOUND = 0x80041108;
enum int IDX_E_SEARCH_SERVER_NOT_FOUND = 0x80041109;
enum int IDX_E_WB_NOTFOUND = 0x8004110a;
enum int IDX_E_NOISELIST_NOTFOUND = 0x8004110b;
enum int IDX_E_STEMMER_NOTFOUND = 0x8004110c;
...
enum int IDX_E_CORRUPT_INDEX = 0x80041110;
enum int IDX_E_PROPSTORE_INIT_FAILED = 0x80041112;
enum int IDX_E_PROP_STATE_CORRUPT = 0x80041113;
...
enum int IDX_E_NOT_LOADED = 0x80041117;
enum int IDX_E_PROP_MAJOR_VERSION_MISMATCH = 0x80041118;
enum int IDX_E_PROP_MINOR_VERSION_MISMATCH = 0x80041119;
enum int IDX_E_DSS_NOT_CONNECTED = 0x8004111a;
enum int IDX_E_DOCUMENT_ABORTED = 0x8004111b;
enum int IDX_E_CATALOG_DISMOUNTED = 0x8004111c;
enum int IDX_S_DSS_NOT_AVAILABLE = 0x0004111d;
enum int IDX_E_USE_DEFAULT_CONTENTCLASS = 0x8004111f;
enum int IDX_E_USE_APPGLOBAL_PROPTABLE = 0x80041120;
enum int JPS_E_JET_ERR = 0x8004117f;
enum int JPS_S_DUPLICATE_DOC_DETECTED = 0x00041180;
enum int JPS_E_CATALOG_DECSRIPTION_MISSING = 0x80041181;
enum int JPS_E_MISSING_INFORMATION = 0x80041182;
...
enum int JPS_E_SCHEMA_ERROR = 0x80041186;
...
enum int JPS_E_SHARING_VIOLATION = 0x8004118a;
...
enum int EXCI_E_ACCESS_DENIED = 0x800411a2;
enum int EXCI_E_INVALID_EXCHANGE_SERVER = 0x800411a3;
enum int EXCI_E_BADCONFIG_OR_ACCESSDENIED = 0x800411a4;
enum int EXCI_E_WRONG_SERVER_OR_ACCT = 0x800411a5;
enum int EXCI_E_NOT_ADMIN_OR_WRONG_SITE = 0x800411a6;
...
enum int PRTH_E_INTERNAL_ERROR = 0x80041204;
...
enum int PRTH_E_MIME_EXCLUDED = 0x8004120d;
...
enum int PRTH_E_NO_PROPERTY = 0x80041213;
enum int PRTH_S_USE_ROSEBUD = 0x00041214;
enum int PRTH_E_DATABASE_OPEN_ERROR = 0x80041215;
enum int PRTH_E_OPLOCK_BROKEN = 0x80041216;
enum int PRTH_E_LOAD_FAILED = 0x80041217;
enum int PRTH_E_INIT_FAILED = 0x80041218;
enum int PRTH_E_VOLUME_MOUNT_POINT = 0x80041219;
enum int PRTH_E_TRUNCATED = 0x8004121a;
enum int GTHR_E_LOCAL_GROUPS_EXPANSION_INTERNAL_ERROR = 0x8004121d;
...
enum int PRTH_S_TRY_IMPERSONATING = 0x00041225;
...
enum int NLADMIN_E_DUPLICATE_CATALOG = 0x80041901;
enum int NLADMIN_S_NOT_ALL_BUILD_CATALOGS_INITIALIZED = 0x00041902;
enum int NLADMIN_E_FAILED_TO_GIVE_ACCOUNT_PRIVILEGE = 0x80041903;
...
enum int SCRIPTPI_E_ALREADY_COMPLETED = 0x80042005;
...
enum int _MAPI_E_STRING_TOO_LONG = 0x80040105;
...
enum int _MAPI_E_SESSION_LIMIT = 0x80040112;
...
enum int _MAPI_E_NETWORK_ERROR = 0x80040115;
...
enum int _MAPI_E_UNCONFIGURED = 0x8004011c;
...
enum int _MAPI_E_ACCOUNT_DISABLED = 0x80040124;
enum int _MAPI_E_END_OF_SESSION = 0x80040200;
enum int _MAPI_E_UNKNOWN_ENTRYID = 0x80040201;
enum int _MAPI_E_MISSING_REQUIRED_COLUMN = 0x80040202;
enum int _MAPI_W_NO_SERVICE = 0x00040203;
...
enum int FLTRDMN_E_FILTER_INIT_FAILED = 0x80042404;
enum int FLTRDMN_E_ENCRYPTED_DOCUMENT = 0x80042405;
enum int FLTRDMN_E_CANNOT_DECRYPT_PASSWORD = 0x80042406;
enum int OLEDB_BINDER_CUSTOM_ERROR = 0x80042500;
enum int NOTESPH_E_UNEXPECTED_STATE = 0x80042601;
...
enum int NOTESPH_E_NOTESSETUP_ID_MAPPING_ERROR = 0x80042609;
enum int NOTESPH_S_LISTKNOWNFIELDS = 0x00042610;
enum int NOTESPH_E_FAIL = 0x80042611;
enum int STS_ABORTXMLPARSE = 0x80042614;
enum int STS_WS_ERROR = 0x80042616;
enum int SPS_WS_ERROR = 0x80042617;
enum int EXSTOREPH_E_UNEXPECTED = 0x80042701;
enum int CERT_E_NOT_FOUND_OR_NO_PERMISSSION = 0x80042801;
enum int SRCH_SCHEMA_CACHE_E_UNEXPECTED = 0x80043301;
...
enum int REXSPH_E_INVALID_CALL = 0x80043500;
enum int REXSPH_S_REDIRECTED = 0x00043501;
enum int REXSPH_E_REDIRECT_ON_SECURITY_UPDATE = 0x80043502;
enum int REXSPH_E_MULTIPLE_REDIRECT = 0x80043503;
enum int REXSPH_E_NO_PROPERTY_ON_ROW = 0x80043504;
enum int REXSPH_E_TYPE_MISMATCH_ON_READ = 0x80043505;
enum int REXSPH_E_UNEXPECTED_DATA_STATUS = 0x80043506;
...
enum int REXSPH_E_DUPLICATE_PROPERTY = 0x80043509;
...
enum int FTE_E_SECRET_NOT_FOUND = 0x80043602;
enum int FTE_E_PIPE_NOT_CONNECTED = 0x80043603;
enum int FTE_E_ADMIN_BLOB_CORRUPT = 0x80043604;
enum int FTE_E_FILTER_SINGLE_THREADED = 0x80043605;
enum int FTE_E_ERROR_WRITING_REGISTRY = 0x80043606;
...
enum int FTE_E_PIPE_DATA_CORRUPTED = 0x80043609;
enum int FTE_E_URB_TOO_BIG = 0x80043610;
enum int FTE_E_INVALID_DOCID = 0x80043611;
enum int FTE_E_PAUSE_EXTERNAL = 0x80043612;
enum int FTE_E_REJECTED_DUE_TO_PROJECT_STATUS = 0x80043613;
enum int FTE_E_FD_DID_NOT_CONNECT = 0x80043614;
enum int FTE_E_PROGID_REQUIRED = 0x80043616;
enum int FTE_E_STATIC_THREAD_INVALID_ARGUMENTS = 0x80043617;
enum int FTE_E_CATALOG_ALREADY_EXISTS = 0x80043618;
enum int FTE_S_RESOURCES_STARTING_TO_GET_LOW = 0x00043619;
enum int FTE_E_PATH_TOO_LONG = 0x8004361a;
enum int FTE_INVALID_ADMIN_CLIENT = 0x8004361b;
enum int FTE_E_COM_SIGNATURE_VALIDATION = 0x8004361c;
enum int FTE_E_AFFINITY_MASK = 0x8004361d;
enum int FTE_E_FD_OWNERSHIP_OBSOLETE = 0x8004361e;
enum int FTE_E_EXCEEDED_MAX_PLUGINS = 0x80043621;
enum int FTE_S_BEYOND_QUOTA = 0x00043622;
enum int FTE_E_DUPLICATE_OBJECT = 0x80043624;
enum int FTE_S_REDUNDANT = 0x00043625;
enum int FTE_E_REDUNDANT_TRAN_FAILURE = 0x80043626;
enum int FTE_E_DEPENDENT_TRAN_FAILED_TO_PERSIST = 0x80043627;
enum int FTE_E_FD_SHUTDOWN = 0x80043628;
enum int FTE_E_CATALOG_DOES_NOT_EXIST = 0x80043629;
enum int FTE_E_NO_PLUGINS = 0x8004362a;
enum int FTE_S_STATUS_CHANGE_REQUEST = 0x0004362b;
enum int FTE_E_BATCH_ABORTED = 0x8004362c;
enum int FTE_E_ANOTHER_STATUS_CHANGE_IS_ALREADY_ACTIVE = 0x8004362d;
enum int FTE_S_RESUME = 0x0004362e;
enum int FTE_E_NOT_PROCESSED_DUE_TO_PREVIOUS_ERRORS = 0x8004362f;
enum int FTE_E_FD_TIMEOUT = 0x80043630;
enum int FTE_E_RESOURCE_SHUTDOWN = 0x80043631;
enum int FTE_E_INVALID_PROPERTY = 0x80043632;
enum int FTE_E_NO_MORE_PROPERTIES = 0x80043633;
enum int FTE_E_UNKNOWN_PLUGIN = 0x80043634;
enum int FTE_E_LIBRARY_NOT_LOADED = 0x80043635;
enum int FTE_E_PERFMON_FULL = 0x80043636;
enum int FTE_E_FAILED_TO_CREATE_ACCESSOR = 0x80043637;
enum int FTE_E_INVALID_TYPE = 0x80043638;
enum int FTE_E_OUT_OF_RANGE = 0x80043639;
enum int FTE_E_CORRUPT_PROPERTY_STORE = 0x8004363a;
enum int FTE_E_PROPERTY_STORE_WORKID_NOTVALID = 0x8004363b;
enum int FTE_S_PROPERTY_STORE_END_OF_ENUMERATION = 0x0004363c;
enum int FTE_E_CORRUPT_GATHERER_HASH_MAP = 0x8004363d;
...
enum int FTE_E_STACK_CORRUPTED = 0x80043641;
enum int FTE_E_INVALID_PROG_ID = 0x80043642;
enum int FTE_E_SERIAL_STREAM_CORRUPT = 0x80043643;
enum int FTE_E_READONLY_CATALOG = 0x80043644;
enum int FTE_E_PERF_NOT_LOADED = 0x80043645;
enum int FTE_S_READONLY_CATALOG = 0x00043646;
enum int FTE_E_RETRY_HUGE_DOC = 0x80043648;
enum int FTE_E_UNKNOWN_FD_TYPE = 0x80043649;
enum int FTE_E_DOC_TOO_HUGE = 0x8004364a;
enum int FTE_E_DATATYPE_MISALIGNMENT = 0x8004364b;
enum int FTE_E_ALREADY_INITIALIZED = 0x8004364c;
enum int FTE_E_FD_USED_TOO_MUCH_MEMORY = 0x8004364d;
enum int FTE_E_UNEXPECTED_EXIT = 0x8004364e;
enum int FTE_E_HIGH_MEMORY_PRESSURE = 0x8004364f;
enum int FTE_E_INVALID_ISOLATE_ERROR_BATCH = 0x80043650;
enum int FTE_E_RETRY_SINGLE_DOC_PER_BATCH = 0x80043651;
enum int FTE_E_INVALID_PROJECT_ID = 0x80043652;
enum int FTE_E_FAILURE_TO_POST_SETCOMPLETION_STATUS = 0x80043653;
enum int FTE_E_INVALID_CODEPAGE = 0x80043654;
...
enum int FTE_S_TRY_TO_FLUSH = 0x00043657;
enum int FTE_S_CATALOG_BLOB_MISMATCHED = 0x00043658;
enum int FTE_S_PROPERTY_RESET = 0x00043659;
...
enum int FTE_E_CORRUPT_WORDLIST = 0x8004cb04;
enum int FTE_E_FD_NO_IPERSIST_INTERFACE = 0x8004fd00;
enum int FTE_E_FD_IFILTER_INIT_FAILED = 0x8004fd01;
...
enum int FTE_E_FD_DOC_UNEXPECTED_EXIT = 0x8004fd05;
...
enum : HRESULT
{
    QUERY_E_NO_RELDOC               = HRESULT(0x8004160e),
    QUERY_E_ALLNOISE_AND_NO_RELPROP = HRESULT(0x8004160f),
}

enum : HRESULT
{
    QUERY_E_NO_RELPROP                  = HRESULT(0x80041610),
    QUERY_E_REPEATED_RELDOC             = HRESULT(0x80041611),
    QUERY_E_RELDOC_SYNTAX_NOT_SUPPORTED = HRESULT(0x80041612),
}

enum HRESULT QUERY_E_INVALID_DOCUMENT_IDENTIFIER = HRESULT(0x80041613);
enum HRESULT QUERY_E_INCORRECT_VERSION = HRESULT(0x80041614);

enum : HRESULT
{
    QUERY_E_INVALIDSCOPE_COALESCE = HRESULT(0x80041615),
    QUERY_E_INVALIDSORT_COALESCE  = HRESULT(0x80041616),
    QUERY_E_INVALIDCOALESCE       = HRESULT(0x80041617),
}

enum HRESULT QUERY_E_UPGRADEINPROGRESS = HRESULT(0x80041618);
enum HRESULT QUERY_E_AGGREGATE_NOT_SUPPORTED = HRESULT(0x80041619);
enum HRESULT QUERY_E_TOP_LEVEL_IN_GROUP = HRESULT(0x8004161a);
enum HRESULT QUERY_E_DUPLICATE_RANGE_NAME = HRESULT(0x8004161b);
enum HRESULT CI_S_NEW_AUXMETADATA = HRESULT(0x00041829);
enum HRESULT CI_E_NO_AUXMETADATA = HRESULT(0x8004182a);
enum HRESULT CI_S_CLIENT_REQUESTED_ABORT = HRESULT(0x0004182b);
enum HRESULT CI_S_RETRY_DOCUMENT = HRESULT(0x0004182c);
enum HRESULT CI_E_CORRUPT_FWIDX = HRESULT(0xc004182d);
enum HRESULT CI_E_DIACRITIC_SETTINGS_DIFFER = HRESULT(0xc004182e);
enum HRESULT CI_E_INVALID_CATALOG_LIST_VERSION = HRESULT(0x8004182f);
enum HRESULT CI_S_CATALOG_RESET = HRESULT(0x00041830);
enum HRESULT CI_E_NO_CATALOG_MANAGER = HRESULT(0xc0041831);
enum HRESULT CI_E_INCONSISTENT_TRANSACTION = HRESULT(0xc0041832);
enum HRESULT CI_E_PROTECTED_CATALOG_NOT_AVAILABLE = HRESULT(0xc0041833);
enum HRESULT CI_E_NO_PROTECTED_USER = HRESULT(0xc0041834);
enum HRESULT CI_E_MULTIPLE_PROTECTED_USERS_UNSUPPORTED = HRESULT(0xc0041835);
...
enum : HRESULT
{
    CI_DATABASE_DECRYPTION_FAILED = HRESULT(0xc0041838),
    CI_DATABASE_ENCRYPTION_FAILED = HRESULT(0xc0041839),
}

enum HRESULT FILTER_E_NO_IMAGE_FRAMES = HRESULT(0x8004170e);
...
enum HRESULT MSG_CI_CORRUPT_INDEX_COMPONENT = HRESULT(0x4000102a);
...
enum HRESULT MSG_CI_CREATE_SEVER_ITEM_FAILED = HRESULT(0x80001048);
enum HRESULT NOT_N_PARSE_ERROR = HRESULT(0x0008092e);
enum HRESULT IDS_MON_DEFAULT_ERROR = HRESULT(0x0004092f);
enum HRESULT IDS_MON_ILLEGAL_PASSTHROUGH = HRESULT(0x00040930);

enum : HRESULT
{
    IDS_MON_PARSE_ERR_1_PARAM = HRESULT(0x00040931),
    IDS_MON_PARSE_ERR_2_PARAM = HRESULT(0x00040932),
}

enum : HRESULT
{
    IDS_MON_SEMI_COLON           = HRESULT(0x00040933),
    IDS_MON_ORDINAL_OUT_OF_RANGE = HRESULT(0x00040934),
}

enum HRESULT IDS_MON_VIEW_NOT_DEFINED = HRESULT(0x00040935);
enum HRESULT IDS_MON_COLUMN_NOT_DEFINED = HRESULT(0x00040936);
enum HRESULT IDS_MON_BUILTIN_VIEW = HRESULT(0x00040937);
enum HRESULT IDS_MON_OUT_OF_MEMORY = HRESULT(0x00040938);

enum : HRESULT
{
    IDS_MON_SELECT_STAR    = HRESULT(0x00040939),
    IDS_MON_OR_NOT         = HRESULT(0x0004093a),
    IDS_MON_CANNOT_CONVERT = HRESULT(0x0004093b),
}

enum HRESULT IDS_MON_OUT_OF_RANGE = HRESULT(0x0004093c);
enum HRESULT IDS_MON_RELATIVE_INTERVAL = HRESULT(0x0004093d);
enum HRESULT IDS_MON_NOT_COLUMN_OF_VIEW = HRESULT(0x0004093e);
enum HRESULT IDS_MON_BUILTIN_PROPERTY = HRESULT(0x0004093f);
enum HRESULT IDS_MON_WEIGHT_OUT_OF_RANGE = HRESULT(0x00040940);
enum HRESULT IDS_MON_MATCH_STRING = HRESULT(0x00040941);
enum HRESULT IDS_MON_PROPERTY_NAME_IN_VIEW = HRESULT(0x00040942);
enum HRESULT IDS_MON_VIEW_ALREADY_DEFINED = HRESULT(0x00040943);

enum : HRESULT
{
    IDS_MON_INVALID_CATALOG        = HRESULT(0x00040944),
    IDS_MON_INVALIDSELECT_COALESCE = HRESULT(0x00040945),
}

enum : HRESULT
{
    IDS_MON_CANNOT_CAST       = HRESULT(0x00040946),
    IDS_MON_DATE_OUT_OF_RANGE = HRESULT(0x00040947),
}

enum HRESULT IDS_MON_INVALID_IN_GROUP_CLAUSE = HRESULT(0x00040948);
...
enum GUID CLSID_DataShapeProvider = GUID("3449a1c8-c56c-11d0-ad72-00c04fc29863");

enum : GUID
{
    DBPROPSET_MSDSDBINIT  = GUID("55cb91a8-5c7a-11d1-adad-00c04fc29863"),
    DBPROPSET_MSDSSESSION = GUID("edf17536-afbf-11d1-8847-0000f879f98c"),
}

enum GUID CLSID_MSPersist = GUID("7c07e0d0-4418-11d2-9212-00c04fbbbfb3");
enum GUID DBPROPSET_PERSIST = GUID("4d7839a0-5b8e-11d1-a6b3-00a0c9138c66");
...
enum GUID DBSCHEMA_LINKEDSERVERS = GUID("9093caf4-2eac-11d1-9809-00c04fc2ad98");
