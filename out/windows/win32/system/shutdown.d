...
enum : uint
{
    MAX_REASON_NAME_LEN    = 0x00000040,
    MAX_REASON_DESC_LEN    = 0x00000100,
    MAX_REASON_BUGID_LEN   = 0x00000020,
    MAX_REASON_COMMENT_LEN = 0x00000200,
}

enum uint SHUTDOWN_TYPE_LEN = 0x00000020;

enum : uint
{
    POLICY_SHOWREASONUI_NEVER           = 0x00000000,
    POLICY_SHOWREASONUI_ALWAYS          = 0x00000001,
    POLICY_SHOWREASONUI_WORKSTATIONONLY = 0x00000002,
    POLICY_SHOWREASONUI_SERVERONLY      = 0x00000003,
}

enum : uint
{
    SNAPSHOT_POLICY_NEVER     = 0x00000000,
    SNAPSHOT_POLICY_ALWAYS    = 0x00000001,
    SNAPSHOT_POLICY_UNPLANNED = 0x00000002,
}

enum uint MAX_NUM_REASONS = 0x00000100;
