...
enum : /*FIELD ATTR: ConstantAttribute : CustomAttributeSig([FixedArgSig(ElementSig({2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153}, 1))], [])*/PROPERTYKEY
{
    SIDESHOW_CAPABILITY_DEVICE_ID               = /*FIELD ATTR: ConstantAttribute : CustomAttributeSig([FixedArgSig(ElementSig({2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153}, 1))], [])*/PROPERTYKEY(GUID("8ABC88A8-857B-4AD7-A35A-B5942F492B99"), 1),
    SIDESHOW_CAPABILITY_SCREEN_TYPE             = /*FIELD ATTR: ConstantAttribute : CustomAttributeSig([FixedArgSig(ElementSig({2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153}, 1))], [])*/PROPERTYKEY(GUID("8ABC88A8-857B-4AD7-A35A-B5942F492B99"), 2),
    SIDESHOW_CAPABILITY_SCREEN_WIDTH            = /*FIELD ATTR: ConstantAttribute : CustomAttributeSig([FixedArgSig(ElementSig({2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153}, 1))], [])*/PROPERTYKEY(GUID("8ABC88A8-857B-4AD7-A35A-B5942F492B99"), 3),
    SIDESHOW_CAPABILITY_SCREEN_HEIGHT           = /*FIELD ATTR: ConstantAttribute : CustomAttributeSig([FixedArgSig(ElementSig({2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153}, 1))], [])*/PROPERTYKEY(GUID("8ABC88A8-857B-4AD7-A35A-B5942F492B99"), 4),
    SIDESHOW_CAPABILITY_COLOR_DEPTH             = /*FIELD ATTR: ConstantAttribute : CustomAttributeSig([FixedArgSig(ElementSig({2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153}, 1))], [])*/PROPERTYKEY(GUID("8ABC88A8-857B-4AD7-A35A-B5942F492B99"), 5),
    SIDESHOW_CAPABILITY_COLOR_TYPE              = /*FIELD ATTR: ConstantAttribute : CustomAttributeSig([FixedArgSig(ElementSig({2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153}, 1))], [])*/PROPERTYKEY(GUID("8ABC88A8-857B-4AD7-A35A-B5942F492B99"), 6),
    SIDESHOW_CAPABILITY_DATA_CACHE              = /*FIELD ATTR: ConstantAttribute : CustomAttributeSig([FixedArgSig(ElementSig({2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153}, 1))], [])*/PROPERTYKEY(GUID("8ABC88A8-857B-4AD7-A35A-B5942F492B99"), 7),
    SIDESHOW_CAPABILITY_SUPPORTED_LANGUAGES     = /*FIELD ATTR: ConstantAttribute : CustomAttributeSig([FixedArgSig(ElementSig({2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153}, 1))], [])*/PROPERTYKEY(GUID("8ABC88A8-857B-4AD7-A35A-B5942F492B99"), 8),
    SIDESHOW_CAPABILITY_CURRENT_LANGUAGE        = /*FIELD ATTR: ConstantAttribute : CustomAttributeSig([FixedArgSig(ElementSig({2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153}, 1))], [])*/PROPERTYKEY(GUID("8ABC88A8-857B-4AD7-A35A-B5942F492B99"), 9),
    SIDESHOW_CAPABILITY_SUPPORTED_THEMES        = /*FIELD ATTR: ConstantAttribute : CustomAttributeSig([FixedArgSig(ElementSig({2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153}, 1))], [])*/PROPERTYKEY(GUID("8ABC88A8-857B-4AD7-A35A-B5942F492B99"), 10),
    SIDESHOW_CAPABILITY_SUPPORTED_IMAGE_FORMATS = /*FIELD ATTR: ConstantAttribute : CustomAttributeSig([FixedArgSig(ElementSig({2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153}, 1))], [])*/PROPERTYKEY(GUID("8ABC88A8-857B-4AD7-A35A-B5942F492B99"), 14),
    SIDESHOW_CAPABILITY_CLIENT_AREA_WIDTH       = /*FIELD ATTR: ConstantAttribute : CustomAttributeSig([FixedArgSig(ElementSig({2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153}, 1))], [])*/PROPERTYKEY(GUID("8ABC88A8-857B-4AD7-A35A-B5942F492B99"), 15),
    SIDESHOW_CAPABILITY_CLIENT_AREA_HEIGHT      = /*FIELD ATTR: ConstantAttribute : CustomAttributeSig([FixedArgSig(ElementSig({2327611560, 34171, 19159, 163, 90, 181, 148, 47, 73, 43, 153}, 1))], [])*/PROPERTYKEY(GUID("8ABC88A8-857B-4AD7-A35A-B5942F492B99"), 16),
}
...
align (1):
    ...
    uint dwEventId;
    uint cbEventData;
    /*FIELD ATTR: FlexibleArrayAttribute : CustomAttributeSig([], [])*/ubyte[1] bEventData;
}
