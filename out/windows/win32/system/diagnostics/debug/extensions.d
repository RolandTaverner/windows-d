...
module windows.win32.system.diagnostics.debug.extensions;
...
public import windows.win32.system.diagnostics.debug : CONTEXT, EXCEPTION_RECORD64,
                                                       IMAGE_NT_HEADERS64;
...
enum : uint
{
    ERROR_DBG_CANCELLED = 0xc00004c7,
    ERROR_DBG_TIMEOUT   = 0xc00005b4,
}
...
enum uint DEBUG_REQUEST_SOURCE_PATH_HAS_SOURCE_SERVER = 0x00000000;

enum : uint
{
    DEBUG_REQUEST_TARGET_EXCEPTION_CONTEXT = 0x00000001,
    DEBUG_REQUEST_TARGET_EXCEPTION_THREAD  = 0x00000002,
    DEBUG_REQUEST_TARGET_EXCEPTION_RECORD  = 0x00000003,
}

enum uint DEBUG_REQUEST_GET_ADDITIONAL_CREATE_OPTIONS = 0x00000004;
enum uint DEBUG_REQUEST_SET_ADDITIONAL_CREATE_OPTIONS = 0x00000005;
enum uint DEBUG_REQUEST_GET_WIN32_MAJOR_MINOR_VERSIONS = 0x00000006;
enum uint DEBUG_REQUEST_READ_USER_MINIDUMP_STREAM = 0x00000007;

enum : uint
{
    DEBUG_REQUEST_TARGET_CAN_DETACH               = 0x00000008,
    DEBUG_REQUEST_SET_LOCAL_IMPLICIT_COMMAND_LINE = 0x00000009,
}

enum uint DEBUG_REQUEST_GET_CAPTURED_EVENT_CODE_OFFSET = 0x0000000a;
enum uint DEBUG_REQUEST_READ_CAPTURED_EVENT_CODE_STREAM = 0x0000000b;

enum : uint
{
    DEBUG_REQUEST_EXT_TYPED_DATA_ANSI            = 0x0000000c,
    DEBUG_REQUEST_GET_EXTENSION_SEARCH_PATH_WIDE = 0x0000000d,
    DEBUG_REQUEST_GET_TEXT_COMPLETIONS_WIDE      = 0x0000000e,
    DEBUG_REQUEST_GET_CACHED_SYMBOL_INFO         = 0x0000000f,
}

enum uint DEBUG_REQUEST_ADD_CACHED_SYMBOL_INFO = 0x00000010;
enum uint DEBUG_REQUEST_REMOVE_CACHED_SYMBOL_INFO = 0x00000011;
enum uint DEBUG_REQUEST_GET_TEXT_COMPLETIONS_ANSI = 0x00000012;
enum uint DEBUG_REQUEST_CURRENT_OUTPUT_CALLBACKS_ARE_DML_AWARE = 0x00000013;

enum : uint
{
    DEBUG_REQUEST_GET_OFFSET_UNWIND_INFORMATION = 0x00000014,
    DEBUG_REQUEST_GET_DUMP_HEADER               = 0x00000015,
    DEBUG_REQUEST_SET_DUMP_HEADER               = 0x00000016,
    DEBUG_REQUEST_MIDORI                        = 0x00000017,
    DEBUG_REQUEST_PROCESS_DESCRIPTORS           = 0x00000018,
    DEBUG_REQUEST_MISC_INFORMATION              = 0x00000019,
    DEBUG_REQUEST_OPEN_PROCESS_TOKEN            = 0x0000001a,
    DEBUG_REQUEST_OPEN_THREAD_TOKEN             = 0x0000001b,
    DEBUG_REQUEST_DUPLICATE_TOKEN               = 0x0000001c,
    DEBUG_REQUEST_QUERY_INFO_TOKEN              = 0x0000001d,
    DEBUG_REQUEST_CLOSE_TOKEN                   = 0x0000001e,
    DEBUG_REQUEST_WOW_PROCESS                   = 0x0000001f,
    DEBUG_REQUEST_WOW_MODULE                    = 0x00000020,
}

enum uint DEBUG_LIVE_USER_NON_INVASIVE = 0x00000021;

enum : uint
{
    DEBUG_REQUEST_RESUME_THREAD            = 0x00000022,
    DEBUG_REQUEST_INLINE_QUERY             = 0x00000023,
    DEBUG_REQUEST_TL_INSTRUMENTATION_AWARE = 0x00000024,
}

enum : uint
{
    DEBUG_REQUEST_GET_INSTRUMENTATION_VERSION = 0x00000025,
    DEBUG_REQUEST_GET_MODULE_ARCHITECTURE     = 0x00000026,
    DEBUG_REQUEST_GET_IMAGE_ARCHITECTURE      = 0x00000027,
}

enum uint DEBUG_REQUEST_SET_PARENT_HWND = 0x00000028;

enum : uint
{
    DEBUG_SRCFILE_SYMBOL_TOKEN                     = 0x00000000,
    DEBUG_SRCFILE_SYMBOL_TOKEN_SOURCE_COMMAND_WIDE = 0x00000001,
    DEBUG_SRCFILE_SYMBOL_CHECKSUMINFO              = 0x00000002,
}

enum uint DEBUG_SYMINFO_BREAKPOINT_SOURCE_LINE = 0x00000000;

enum : uint
{
    DEBUG_SYMINFO_IMAGEHLP_MODULEW64                     = 0x00000001,
    DEBUG_SYMINFO_GET_SYMBOL_NAME_BY_OFFSET_AND_TAG_WIDE = 0x00000002,
}

enum uint DEBUG_SYMINFO_GET_MODULE_SYMBOL_NAMES_AND_OFFSETS = 0x00000003;

enum : uint
{
    DEBUG_SYSOBJINFO_THREAD_BASIC_INFORMATION = 0x00000000,
    DEBUG_SYSOBJINFO_THREAD_NAME_WIDE         = 0x00000001,
    DEBUG_SYSOBJINFO_CURRENT_PROCESS_COOKIE   = 0x00000002,
}
...
enum : uint
{
    DEBUG_BREAKPOINT_CODE          = 0x00000000,
    DEBUG_BREAKPOINT_DATA          = 0x00000001,
    DEBUG_BREAKPOINT_TIME          = 0x00000002,
    DEBUG_BREAKPOINT_INLINE        = 0x00000003,
...
enum : uint
{
    ...
    DEBUG_PROC_DESC_WITH_PACKAGEFAMILY = 0x00000040,
    DEBUG_PROC_DESC_WITH_ARCHITECTURE  = 0x00000080,
}
...
enum uint DEBUG_ATTACH_NONINVASIVE_ALLOW_PARTIAL = 0x00000020;
...
enum uint DEBUG_OUTPUT_IDENTITY_DEFAULT = 0x00000000;

enum : uint
{
    DEBUG_CLIENT_UNKNOWN = 0x00000000,
    DEBUG_CLIENT_VSINT   = 0x00000001,
    DEBUG_CLIENT_NTSD    = 0x00000002,
    DEBUG_CLIENT_NTKD    = 0x00000003,
    DEBUG_CLIENT_CDB     = 0x00000004,
    DEBUG_CLIENT_KD      = 0x00000005,
    DEBUG_CLIENT_WINDBG  = 0x00000006,
    DEBUG_CLIENT_WINIDE  = 0x00000007,
}
...
enum : uint
{
    ...
    DEBUG_FORMAT_USER_SMALL_NO_IGNORE_INACCESSIBLE_MEM = 0x04000000,
...
enum : uint
{
    DEBUG_STATUS_NO_CHANGE           = 0x00000000,
    DEBUG_STATUS_GO                  = 0x00000001,
    DEBUG_STATUS_GO_HANDLED          = 0x00000002,
    DEBUG_STATUS_GO_NOT_HANDLED      = 0x00000003,
    DEBUG_STATUS_STEP_OVER           = 0x00000004,
    DEBUG_STATUS_STEP_INTO           = 0x00000005,
    DEBUG_STATUS_BREAK               = 0x00000006,
    DEBUG_STATUS_NO_DEBUGGEE         = 0x00000007,
    DEBUG_STATUS_STEP_BRANCH         = 0x00000008,
    DEBUG_STATUS_IGNORE_EVENT        = 0x00000009,
    DEBUG_STATUS_RESTART_REQUESTED   = 0x0000000a,
    DEBUG_STATUS_REVERSE_GO          = 0x0000000b,
    DEBUG_STATUS_REVERSE_STEP_BRANCH = 0x0000000c,
    DEBUG_STATUS_REVERSE_STEP_OVER   = 0x0000000d,
    DEBUG_STATUS_REVERSE_STEP_INTO   = 0x0000000e,
    DEBUG_STATUS_OUT_OF_SYNC         = 0x0000000f,
    DEBUG_STATUS_WAIT_INPUT          = 0x00000010,
    DEBUG_STATUS_TIMEOUT             = 0x00000011,
    DEBUG_STATUS_MASK                = 0x0000001f,
}

enum : ulong
{
    DEBUG_STATUS_INSIDE_WAIT  = 0x0000000100000000,
    DEBUG_STATUS_WAIT_TIMEOUT = 0x0000000200000000,
}
...
enum : uint
{
    DEBUG_INTERRUPT_ACTIVE  = 0x00000000,
    DEBUG_INTERRUPT_PASSIVE = 0x00000001,
    DEBUG_INTERRUPT_EXIT    = 0x00000002,
}
...
enum : uint
{
    DEBUG_LEVEL_SOURCE   = 0x00000000,
    DEBUG_LEVEL_ASSEMBLY = 0x00000001,
}
...
enum uint DEBUG_ENGOPT_IGNORE_LOADER_EXCEPTIONS = 0x00000010;
...
enum uint DEBUG_ENGOPT_ALLOW_READ_ONLY_BREAKPOINTS = 0x00000400;
enum uint DEBUG_ENGOPT_SYNCHRONIZE_BREAKPOINTS = 0x00000800;
enum uint DEBUG_ENGOPT_DISALLOW_SHELL_COMMANDS = 0x00001000;
...
enum uint DEBUG_ENGOPT_DEBUGGING_SENSITIVE_DATA = 0x00400000;

enum : uint
{
    DEBUG_ENGOPT_PREFER_TRACE_FILES         = 0x00800000,
    DEBUG_ENGOPT_RESOLVE_SHADOWED_VARIABLES = 0x01000000,
}

enum uint DEBUG_ENGOPT_ALL = 0x01efffff;
enum uint DEBUG_ANY_ID = 0xffffffff;

enum : uint
{
    DBG_FRAME_DEFAULT       = 0x00000000,
    DBG_FRAME_IGNORE_INLINE = 0xffffffff,
}

enum : uint
{
    STACK_FRAME_TYPE_INIT   = 0x00000000,
    STACK_FRAME_TYPE_STACK  = 0x00000001,
    STACK_FRAME_TYPE_INLINE = 0x00000002,
    STACK_FRAME_TYPE_RA     = 0x00000080,
    STACK_FRAME_TYPE_IGNORE = 0x000000ff,
}
...
enum uint DEBUG_STACK_PARAMETERS_NEWLINE = 0x00000400;
...
enum : uint
{
    ...
    DEBUG_STACK_FRAME_ARCH    = 0x00004000,
}

enum : uint
{
    DEBUG_CLASS_UNINITIALIZED = 0x00000000,
    DEBUG_CLASS_KERNEL        = 0x00000001,
    DEBUG_CLASS_USER_WINDOWS  = 0x00000002,
    DEBUG_CLASS_IMAGE_FILE    = 0x00000003,
}

enum : uint
{
    DEBUG_DUMP_SMALL      = 0x00000400,
    DEBUG_DUMP_DEFAULT    = 0x00000401,
    DEBUG_DUMP_FULL       = 0x00000402,
    DEBUG_DUMP_IMAGE_FILE = 0x00000403,
    DEBUG_DUMP_TRACE_LOG  = 0x00000404,
    DEBUG_DUMP_WINDOWS_CE = 0x00000405,
    DEBUG_DUMP_ACTIVE     = 0x00000406,
}

enum : uint
{
    DEBUG_KERNEL_CONNECTION     = 0x00000000,
    DEBUG_KERNEL_LOCAL          = 0x00000001,
    DEBUG_KERNEL_EXDI_DRIVER    = 0x00000002,
    DEBUG_KERNEL_IDNA           = 0x00000003,
    DEBUG_KERNEL_INSTALL_DRIVER = 0x00000004,
    DEBUG_KERNEL_REPT           = 0x00000005,
    DEBUG_KERNEL_SMALL_DUMP     = 0x00000400,
    DEBUG_KERNEL_DUMP           = 0x00000401,
    DEBUG_KERNEL_ACTIVE_DUMP    = 0x00000406,
    DEBUG_KERNEL_FULL_DUMP      = 0x00000402,
    DEBUG_KERNEL_TRACE_LOG      = 0x00000404,
}

enum : uint
{
    DEBUG_USER_WINDOWS_PROCESS         = 0x00000000,
    DEBUG_USER_WINDOWS_PROCESS_SERVER  = 0x00000001,
    DEBUG_USER_WINDOWS_IDNA            = 0x00000002,
    DEBUG_USER_WINDOWS_REPT            = 0x00000003,
    DEBUG_USER_WINDOWS_SMALL_DUMP      = 0x00000400,
    DEBUG_USER_WINDOWS_DUMP            = 0x00000401,
    DEBUG_USER_WINDOWS_DUMP_WINDOWS_CE = 0x00000405,
}

enum uint DEBUG_EXTENSION_AT_ENGINE = 0x00000000;
...
enum : uint
{
    ...
    DEBUG_EXECUTE_USER_TYPED   = 0x00000008,
    DEBUG_EXECUTE_USER_CLICKED = 0x00000010,
    DEBUG_EXECUTE_EXTENSION    = 0x00000020,
    DEBUG_EXECUTE_INTERNAL     = 0x00000040,
    DEBUG_EXECUTE_SCRIPT       = 0x00000080,
    DEBUG_EXECUTE_TOOLBAR      = 0x00000100,
    DEBUG_EXECUTE_MENU         = 0x00000200,
    DEBUG_EXECUTE_HOTKEY       = 0x00000400,
    DEBUG_EXECUTE_EVENT        = 0x00000800,
}
...
enum uint DEBUG_WAIT_DEFAULT = 0x00000000;

enum : uint
{
    DEBUG_VALUE_INVALID   = 0x00000000,
    DEBUG_VALUE_INT8      = 0x00000001,
    DEBUG_VALUE_INT16     = 0x00000002,
    DEBUG_VALUE_INT32     = 0x00000003,
    DEBUG_VALUE_INT64     = 0x00000004,
    DEBUG_VALUE_FLOAT32   = 0x00000005,
    DEBUG_VALUE_FLOAT64   = 0x00000006,
    DEBUG_VALUE_FLOAT80   = 0x00000007,
    DEBUG_VALUE_FLOAT82   = 0x00000008,
    DEBUG_VALUE_FLOAT128  = 0x00000009,
    DEBUG_VALUE_VECTOR64  = 0x0000000a,
    DEBUG_VALUE_VECTOR128 = 0x0000000b,
    DEBUG_VALUE_TYPES     = 0x0000000c,
}

enum uint DEBUG_OUT_TEXT_REPL_DEFAULT = 0x00000000;
...
enum uint DEBUG_EXEC_FLAGS_NONBLOCK = 0x00000001;

enum : uint
{
    DEBUG_DATA_SPACE_VIRTUAL            = 0x00000000,
    DEBUG_DATA_SPACE_PHYSICAL           = 0x00000001,
    DEBUG_DATA_SPACE_CONTROL            = 0x00000002,
    DEBUG_DATA_SPACE_IO                 = 0x00000003,
    DEBUG_DATA_SPACE_MSR                = 0x00000004,
    DEBUG_DATA_SPACE_BUS_DATA           = 0x00000005,
    DEBUG_DATA_SPACE_DEBUGGER_DATA      = 0x00000006,
    DEBUG_DATA_SPACE_COUNT              = 0x00000007,
    DEBUG_DATA_KernBase                 = 0x00000018,
    DEBUG_DATA_BreakpointWithStatusAddr = 0x00000020,
}

enum : uint
{
    DEBUG_DATA_SavedContextAddr             = 0x00000028,
    DEBUG_DATA_KiCallUserModeAddr           = 0x00000038,
    DEBUG_DATA_KeUserCallbackDispatcherAddr = 0x00000040,
}

enum uint DEBUG_DATA_PsLoadedModuleListAddr = 0x00000048;
enum uint DEBUG_DATA_PsActiveProcessHeadAddr = 0x00000050;

enum : uint
{
    DEBUG_DATA_PspCidTableAddr            = 0x00000058,
    DEBUG_DATA_ExpSystemResourcesListAddr = 0x00000060,
}

enum uint DEBUG_DATA_ExpPagedPoolDescriptorAddr = 0x00000068;
enum uint DEBUG_DATA_ExpNumberOfPagedPoolsAddr = 0x00000070;

enum : uint
{
    DEBUG_DATA_KeTimeIncrementAddr            = 0x00000078,
    DEBUG_DATA_KeBugCheckCallbackListHeadAddr = 0x00000080,
}

enum uint DEBUG_DATA_KiBugcheckDataAddr = 0x00000088;
enum uint DEBUG_DATA_IopErrorLogListHeadAddr = 0x00000090;
enum uint DEBUG_DATA_ObpRootDirectoryObjectAddr = 0x00000098;
enum uint DEBUG_DATA_ObpTypeObjectTypeAddr = 0x000000a0;

enum : uint
{
    DEBUG_DATA_MmSystemCacheStartAddr    = 0x000000a8,
    DEBUG_DATA_MmSystemCacheEndAddr      = 0x000000b0,
    DEBUG_DATA_MmSystemCacheWsAddr       = 0x000000b8,
    DEBUG_DATA_MmPfnDatabaseAddr         = 0x000000c0,
    DEBUG_DATA_MmSystemPtesStartAddr     = 0x000000c8,
    DEBUG_DATA_MmSystemPtesEndAddr       = 0x000000d0,
    DEBUG_DATA_MmSubsectionBaseAddr      = 0x000000d8,
    DEBUG_DATA_MmNumberOfPagingFilesAddr = 0x000000e0,
}

enum uint DEBUG_DATA_MmLowestPhysicalPageAddr = 0x000000e8;
enum uint DEBUG_DATA_MmHighestPhysicalPageAddr = 0x000000f0;
enum uint DEBUG_DATA_MmNumberOfPhysicalPagesAddr = 0x000000f8;
enum uint DEBUG_DATA_MmMaximumNonPagedPoolInBytesAddr = 0x00000100;

enum : uint
{
    DEBUG_DATA_MmNonPagedSystemStartAddr    = 0x00000108,
    DEBUG_DATA_MmNonPagedPoolStartAddr      = 0x00000110,
    DEBUG_DATA_MmNonPagedPoolEndAddr        = 0x00000118,
    DEBUG_DATA_MmPagedPoolStartAddr         = 0x00000120,
    DEBUG_DATA_MmPagedPoolEndAddr           = 0x00000128,
    DEBUG_DATA_MmPagedPoolInformationAddr   = 0x00000130,
    DEBUG_DATA_MmPageSize                   = 0x00000138,
    DEBUG_DATA_MmSizeOfPagedPoolInBytesAddr = 0x00000140,
}

enum : uint
{
    DEBUG_DATA_MmTotalCommitLimitAddr    = 0x00000148,
    DEBUG_DATA_MmTotalCommittedPagesAddr = 0x00000150,
}

enum : uint
{
    DEBUG_DATA_MmSharedCommitAddr       = 0x00000158,
    DEBUG_DATA_MmDriverCommitAddr       = 0x00000160,
    DEBUG_DATA_MmProcessCommitAddr      = 0x00000168,
    DEBUG_DATA_MmPagedPoolCommitAddr    = 0x00000170,
    DEBUG_DATA_MmExtendedCommitAddr     = 0x00000178,
    DEBUG_DATA_MmZeroedPageListHeadAddr = 0x00000180,
}

enum uint DEBUG_DATA_MmFreePageListHeadAddr = 0x00000188;
enum uint DEBUG_DATA_MmStandbyPageListHeadAddr = 0x00000190;

enum : uint
{
    DEBUG_DATA_MmModifiedPageListHeadAddr        = 0x00000198,
    DEBUG_DATA_MmModifiedNoWritePageListHeadAddr = 0x000001a0,
}

enum : uint
{
    DEBUG_DATA_MmAvailablePagesAddr         = 0x000001a8,
    DEBUG_DATA_MmResidentAvailablePagesAddr = 0x000001b0,
}

enum uint DEBUG_DATA_PoolTrackTableAddr = 0x000001b8;
enum uint DEBUG_DATA_NonPagedPoolDescriptorAddr = 0x000001c0;
enum uint DEBUG_DATA_MmHighestUserAddressAddr = 0x000001c8;
enum uint DEBUG_DATA_MmSystemRangeStartAddr = 0x000001d0;
enum uint DEBUG_DATA_MmUserProbeAddressAddr = 0x000001d8;

enum : uint
{
    DEBUG_DATA_KdPrintCircularBufferAddr    = 0x000001e0,
    DEBUG_DATA_KdPrintCircularBufferEndAddr = 0x000001e8,
    DEBUG_DATA_KdPrintWritePointerAddr      = 0x000001f0,
    DEBUG_DATA_KdPrintRolloverCountAddr     = 0x000001f8,
}

enum uint DEBUG_DATA_MmLoadedUserImageListAddr = 0x00000200;

enum : uint
{
    DEBUG_DATA_NtBuildLabAddr       = 0x00000208,
    DEBUG_DATA_KiNormalSystemCall   = 0x00000210,
    DEBUG_DATA_KiProcessorBlockAddr = 0x00000218,
}

enum : uint
{
    DEBUG_DATA_MmUnloadedDriversAddr    = 0x00000220,
    DEBUG_DATA_MmLastUnloadedDriverAddr = 0x00000228,
}

enum uint DEBUG_DATA_MmTriageActionTakenAddr = 0x00000230;
enum uint DEBUG_DATA_MmSpecialPoolTagAddr = 0x00000238;
enum uint DEBUG_DATA_KernelVerifierAddr = 0x00000240;

enum : uint
{
    DEBUG_DATA_MmVerifierDataAddr          = 0x00000248,
    DEBUG_DATA_MmAllocatedNonPagedPoolAddr = 0x00000250,
}

enum : uint
{
    DEBUG_DATA_MmPeakCommitmentAddr          = 0x00000258,
    DEBUG_DATA_MmTotalCommitLimitMaximumAddr = 0x00000260,
}

enum uint DEBUG_DATA_CmNtCSDVersionAddr = 0x00000268;
enum uint DEBUG_DATA_MmPhysicalMemoryBlockAddr = 0x00000270;

enum : uint
{
    DEBUG_DATA_MmSessionBase           = 0x00000278,
    DEBUG_DATA_MmSessionSize           = 0x00000280,
    DEBUG_DATA_MmSystemParentTablePage = 0x00000288,
}

enum uint DEBUG_DATA_MmVirtualTranslationBase = 0x00000290;

enum : uint
{
    DEBUG_DATA_OffsetKThreadNextProcessor = 0x00000298,
    DEBUG_DATA_OffsetKThreadTeb           = 0x0000029a,
    DEBUG_DATA_OffsetKThreadKernelStack   = 0x0000029c,
    DEBUG_DATA_OffsetKThreadInitialStack  = 0x0000029e,
    DEBUG_DATA_OffsetKThreadApcProcess    = 0x000002a0,
    DEBUG_DATA_OffsetKThreadState         = 0x000002a2,
    DEBUG_DATA_OffsetKThreadBStore        = 0x000002a4,
    DEBUG_DATA_OffsetKThreadBStoreLimit   = 0x000002a6,
}

enum : uint
{
    DEBUG_DATA_SizeEProcess                     = 0x000002a8,
    DEBUG_DATA_OffsetEprocessPeb                = 0x000002aa,
    DEBUG_DATA_OffsetEprocessParentCID          = 0x000002ac,
    DEBUG_DATA_OffsetEprocessDirectoryTableBase = 0x000002ae,
}

enum : uint
{
    DEBUG_DATA_SizePrcb                     = 0x000002b0,
    DEBUG_DATA_OffsetPrcbDpcRoutine         = 0x000002b2,
    DEBUG_DATA_OffsetPrcbCurrentThread      = 0x000002b4,
    DEBUG_DATA_OffsetPrcbMhz                = 0x000002b6,
    DEBUG_DATA_OffsetPrcbCpuType            = 0x000002b8,
    DEBUG_DATA_OffsetPrcbVendorString       = 0x000002ba,
    DEBUG_DATA_OffsetPrcbProcessorState     = 0x000002bc,
    DEBUG_DATA_OffsetPrcbNumber             = 0x000002be,
    DEBUG_DATA_SizeEThread                  = 0x000002c0,
    DEBUG_DATA_KdPrintCircularBufferPtrAddr = 0x000002c8,
    DEBUG_DATA_KdPrintBufferSizeAddr        = 0x000002d0,
}

enum uint DEBUG_DATA_MmBadPagesDetected = 0x00000320;

enum : uint
{
    DEBUG_DATA_EtwpDebuggerData                = 0x00000330,
    DEBUG_DATA_PteBase                         = 0x00000360,
    DEBUG_DATA_PaeEnabled                      = 0x000186a0,
    DEBUG_DATA_SharedUserData                  = 0x000186a8,
    DEBUG_DATA_ProductType                     = 0x000186b0,
    DEBUG_DATA_SuiteMask                       = 0x000186b8,
    DEBUG_DATA_DumpWriterStatus                = 0x000186c0,
    DEBUG_DATA_DumpFormatVersion               = 0x000186c8,
    DEBUG_DATA_DumpWriterVersion               = 0x000186d0,
    DEBUG_DATA_DumpPowerState                  = 0x000186d8,
    DEBUG_DATA_DumpMmStorage                   = 0x000186e0,
    DEBUG_DATA_DumpAttributes                  = 0x000186e8,
    DEBUG_DATA_PagingLevels                    = 0x000186f0,
    DEBUG_DATA_KPCR_OFFSET                     = 0x00000000,
    DEBUG_DATA_KPRCB_OFFSET                    = 0x00000001,
    DEBUG_DATA_KTHREAD_OFFSET                  = 0x00000002,
    DEBUG_DATA_BASE_TRANSLATION_VIRTUAL_OFFSET = 0x00000003,
}

enum : uint
{
    DEBUG_DATA_PROCESSOR_IDENTIFICATION = 0x00000004,
    DEBUG_DATA_PROCESSOR_SPEED          = 0x00000005,
}

enum : uint
{
    DEBUG_HANDLE_DATA_TYPE_BASIC                 = 0x00000000,
    DEBUG_HANDLE_DATA_TYPE_TYPE_NAME             = 0x00000001,
    DEBUG_HANDLE_DATA_TYPE_OBJECT_NAME           = 0x00000002,
    DEBUG_HANDLE_DATA_TYPE_HANDLE_COUNT          = 0x00000003,
    DEBUG_HANDLE_DATA_TYPE_TYPE_NAME_WIDE        = 0x00000004,
    DEBUG_HANDLE_DATA_TYPE_OBJECT_NAME_WIDE      = 0x00000005,
    DEBUG_HANDLE_DATA_TYPE_MINI_THREAD_1         = 0x00000006,
    DEBUG_HANDLE_DATA_TYPE_MINI_MUTANT_1         = 0x00000007,
    DEBUG_HANDLE_DATA_TYPE_MINI_MUTANT_2         = 0x00000008,
    DEBUG_HANDLE_DATA_TYPE_PER_HANDLE_OPERATIONS = 0x00000009,
    DEBUG_HANDLE_DATA_TYPE_ALL_HANDLE_OPERATIONS = 0x0000000a,
    DEBUG_HANDLE_DATA_TYPE_MINI_PROCESS_1        = 0x0000000b,
    DEBUG_HANDLE_DATA_TYPE_MINI_PROCESS_2        = 0x0000000c,
    DEBUG_HANDLE_DATA_TYPE_MINI_EVENT_1          = 0x0000000d,
    DEBUG_HANDLE_DATA_TYPE_MINI_SECTION_1        = 0x0000000e,
    DEBUG_HANDLE_DATA_TYPE_MINI_SEMAPHORE_1      = 0x0000000f,
}

enum uint DEBUG_OFFSINFO_VIRTUAL_SOURCE = 0x00000001;
...
enum uint DEBUG_EVENT_SERVICE_EXCEPTION = 0x00002000;
...
enum : uint
{
    ...
    DEBUG_CDS_REFRESH_EVALUATE                 = 0x00000001,
    DEBUG_CDS_REFRESH_EXECUTE                  = 0x00000002,
    DEBUG_CDS_REFRESH_EXECUTECOMMANDFILE       = 0x00000003,
    DEBUG_CDS_REFRESH_ADDBREAKPOINT            = 0x00000004,
    DEBUG_CDS_REFRESH_REMOVEBREAKPOINT         = 0x00000005,
    DEBUG_CDS_REFRESH_WRITEVIRTUAL             = 0x00000006,
    DEBUG_CDS_REFRESH_WRITEVIRTUALUNCACHED     = 0x00000007,
    DEBUG_CDS_REFRESH_WRITEPHYSICAL            = 0x00000008,
    DEBUG_CDS_REFRESH_WRITEPHYSICAL2           = 0x00000009,
    DEBUG_CDS_REFRESH_SETVALUE                 = 0x0000000a,
    DEBUG_CDS_REFRESH_SETVALUE2                = 0x0000000b,
    DEBUG_CDS_REFRESH_SETSCOPE                 = 0x0000000c,
    DEBUG_CDS_REFRESH_SETSCOPEFRAMEBYINDEX     = 0x0000000d,
    DEBUG_CDS_REFRESH_SETSCOPEFROMJITDEBUGINFO = 0x0000000e,
    DEBUG_CDS_REFRESH_SETSCOPEFROMSTOREDEVENT  = 0x0000000f,
    DEBUG_CDS_REFRESH_INLINESTEP               = 0x00000010,
    DEBUG_CDS_REFRESH_INLINESTEP_PSEUDO        = 0x00000011,
}
...
enum uint DEBUG_CES_EXPRESSION_SYNTAX = 0x00002000;
enum uint DEBUG_CES_TEXT_REPLACEMENTS = 0x00004000;
...
enum : uint
{
    ...
    DEBUG_CSS_COLLAPSE_CHILDREN = 0x00000040,
}
...
enum : uint
{
    ...
    DEBUG_OUTCB_TEXT                     = 0x00000000,
    DEBUG_OUTCB_DML                      = 0x00000001,
    DEBUG_OUTCB_EXPLICIT_FLUSH           = 0x00000002,
...
enum : uint
{
    DEBUG_SYMTYPE_NONE             = 0x00000000,
    DEBUG_SYMTYPE_COFF             = 0x00000001,
    DEBUG_SYMTYPE_CODEVIEW         = 0x00000002,
    DEBUG_SYMTYPE_PDB              = 0x00000003,
    DEBUG_SYMTYPE_EXPORT           = 0x00000004,
    DEBUG_SYMTYPE_DEFERRED         = 0x00000005,
    DEBUG_SYMTYPE_SYM              = 0x00000006,
    DEBUG_SYMTYPE_DIA              = 0x00000007,
...
enum : uint
{
    ...
    DEBUG_FIND_SOURCE_WITH_CHECKSUM        = 0x00000010,
    DEBUG_FIND_SOURCE_WITH_CHECKSUM_STRICT = 0x00000020,
}
...
enum uint DEBUG_SOURCE_IS_STATEMENT = 0x00000001;
...
enum : uint
{
    DEBUG_FRAME_DEFAULT       = 0x00000000,
    DEBUG_FRAME_IGNORE_INLINE = 0x00000001,
}

enum uint DEBUG_COMMAND_EXCEPTION_ID = 0xdbe00dbe;

enum : uint
{
    DEBUG_CMDEX_INVALID             = 0x00000000,
    DEBUG_CMDEX_ADD_EVENT_STRING    = 0x00000001,
    DEBUG_CMDEX_RESET_EVENT_STRINGS = 0x00000002,
}

enum uint DEBUG_EXTINIT_HAS_COMMAND_HELP = 0x00000001;
...
enum : uint
{
    DEBUG_KNOWN_STRUCT_GET_NAMES              = 0x00000001,
    DEBUG_KNOWN_STRUCT_GET_SINGLE_LINE_OUTPUT = 0x00000002,
    DEBUG_KNOWN_STRUCT_SUPPRESS_TYPE_NAME     = 0x00000003,
}

enum : uint
{
    DEBUG_EXT_QVALUE_DEFAULT    = 0x00000000,
    DEBUG_EXT_PVALUE_DEFAULT    = 0x00000000,
    DEBUG_EXT_PVTYPE_IS_VALUE   = 0x00000000,
    DEBUG_EXT_PVTYPE_IS_POINTER = 0x00000001,
}

enum uint _EXTSAPI_VER_ = 0x0000000a;

enum : uint
{
    DUMP_HANDLE_FLAG_PRINT_OBJECT     = 0x00000002,
    DUMP_HANDLE_FLAG_PRINT_FREE_ENTRY = 0x00000004,
    DUMP_HANDLE_FLAG_KERNEL_TABLE     = 0x00000010,
    DUMP_HANDLE_FLAG_CID_TABLE        = 0x00000020,
}

enum uint KDEXTS_LOCK_CALLBACKROUTINE_DEFINED = 0x00000002;

enum : uint
{
    FAILURE_ANALYSIS_NO_DB_LOOKUP                   = 0x00000001,
    FAILURE_ANALYSIS_VERBOSE                        = 0x00000002,
    FAILURE_ANALYSIS_ASSUME_HANG                    = 0x00000004,
    FAILURE_ANALYSIS_IGNORE_BREAKIN                 = 0x00000008,
    FAILURE_ANALYSIS_SET_FAILURE_CONTEXT            = 0x00000010,
    FAILURE_ANALYSIS_EXCEPTION_AS_HANG              = 0x00000020,
    FAILURE_ANALYSIS_AUTOBUG_PROCESSING             = 0x00000040,
    FAILURE_ANALYSIS_XML_OUTPUT                     = 0x00000080,
    FAILURE_ANALYSIS_CALLSTACK_XML                  = 0x00000100,
    FAILURE_ANALYSIS_REGISTRY_DATA                  = 0x00000200,
    FAILURE_ANALYSIS_WMI_QUERY_DATA                 = 0x00000400,
    FAILURE_ANALYSIS_USER_ATTRIBUTES                = 0x00000800,
    FAILURE_ANALYSIS_MODULE_INFO_XML                = 0x00001000,
    FAILURE_ANALYSIS_NO_IMAGE_CORRUPTION            = 0x00002000,
    FAILURE_ANALYSIS_AUTOSET_SYMPATH                = 0x00004000,
    FAILURE_ANALYSIS_USER_ATTRIBUTES_ALL            = 0x00008000,
    FAILURE_ANALYSIS_USER_ATTRIBUTES_FRAMES         = 0x00010000,
    FAILURE_ANALYSIS_MULTI_TARGET                   = 0x00020000,
    FAILURE_ANALYSIS_SHOW_SOURCE                    = 0x00040000,
    FAILURE_ANALYSIS_SHOW_WCT_STACKS                = 0x00080000,
    FAILURE_ANALYSIS_CREATE_INSTANCE                = 0x00100000,
    FAILURE_ANALYSIS_LIVE_DEBUG_HOLD_CHECK          = 0x00200000,
    FAILURE_ANALYSIS_XML_FILE_OUTPUT                = 0x00400000,
    FAILURE_ANALYSIS_XSD_VERIFY                     = 0x00800000,
    FAILURE_ANALYSIS_CALLSTACK_XML_FULL_SOURCE_INFO = 0x01000000,
}

enum uint FAILURE_ANALYSIS_HEAP_CORRUPTION_BLAME_FUNCTION = 0x02000000;
enum uint FAILURE_ANALYSIS_PERMIT_HEAP_ACCESS_VIOLATIONS = 0x04000000;

enum : uint
{
    FAILURE_ANALYSIS_XSLT_FILE_INPUT  = 0x10000000,
    FAILURE_ANALYSIS_XSLT_FILE_OUTPUT = 0x20000000,
}
...
enum uint CROSS_PLATFORM_MAXIMUM_PROCESSORS = 0x00000800;
enum uint MAX_STACK_IN_BYTES = 0x00001000;

enum : uint
{
    TRIAGE_FOLLOWUP_FAIL    = 0x00000000,
    TRIAGE_FOLLOWUP_IGNORE  = 0x00000001,
    TRIAGE_FOLLOWUP_DEFAULT = 0x00000002,
    TRIAGE_FOLLOWUP_SUCCESS = 0x00000003,
}

enum : uint
{
    EXT_ANALYZER_FLAG_MOD = 0x00000001,
    EXT_ANALYZER_FLAG_ID  = 0x00000002,
}

enum : uint
{
    EXTDLL_DATA_QUERY_BUILD_BINDIR             = 0x00000001,
    EXTDLL_DATA_QUERY_BUILD_SYMDIR             = 0x00000002,
    EXTDLL_DATA_QUERY_BUILD_WOW64SYMDIR        = 0x00000003,
    EXTDLL_DATA_QUERY_BUILD_WOW64BINDIR        = 0x00000004,
    EXTDLL_DATA_QUERY_BUILD_BINDIR_SYMSRV      = 0x0000000b,
    EXTDLL_DATA_QUERY_BUILD_SYMDIR_SYMSRV      = 0x0000000c,
    EXTDLL_DATA_QUERY_BUILD_WOW64SYMDIR_SYMSRV = 0x0000000d,
    EXTDLL_DATA_QUERY_BUILD_WOW64BINDIR_SYMSRV = 0x0000000e,
}

enum : uint
{
    EXT_API_VERSION_NUMBER   = 0x00000005,
    EXT_API_VERSION_NUMBER32 = 0x00000005,
    EXT_API_VERSION_NUMBER64 = 0x00000006,
}

enum uint IG_KD_CONTEXT = 0x00000001;
enum uint IG_READ_CONTROL_SPACE = 0x00000002;
enum uint IG_WRITE_CONTROL_SPACE = 0x00000003;
enum uint IG_READ_IO_SPACE = 0x00000004;
enum uint IG_WRITE_IO_SPACE = 0x00000005;
enum uint IG_READ_PHYSICAL = 0x00000006;
enum uint IG_WRITE_PHYSICAL = 0x00000007;
enum uint IG_READ_IO_SPACE_EX = 0x00000008;
enum uint IG_WRITE_IO_SPACE_EX = 0x00000009;
enum uint IG_KSTACK_HELP = 0x0000000a;
enum uint IG_SET_THREAD = 0x0000000b;
enum uint IG_READ_MSR = 0x0000000c;
enum uint IG_WRITE_MSR = 0x0000000d;
enum uint IG_GET_DEBUGGER_DATA = 0x0000000e;
enum uint IG_GET_KERNEL_VERSION = 0x0000000f;
enum uint IG_RELOAD_SYMBOLS = 0x00000010;
enum uint IG_GET_SET_SYMPATH = 0x00000011;
enum uint IG_GET_EXCEPTION_RECORD = 0x00000012;
enum uint IG_IS_PTR64 = 0x00000013;
enum uint IG_GET_BUS_DATA = 0x00000014;
enum uint IG_SET_BUS_DATA = 0x00000015;
enum uint IG_DUMP_SYMBOL_INFO = 0x00000016;
enum uint IG_LOWMEM_CHECK = 0x00000017;
enum uint IG_SEARCH_MEMORY = 0x00000018;

enum : uint
{
    IG_GET_CURRENT_THREAD  = 0x00000019,
    IG_GET_CURRENT_PROCESS = 0x0000001a,
}

enum : uint
{
    IG_GET_TYPE_SIZE              = 0x0000001b,
    IG_GET_CURRENT_PROCESS_HANDLE = 0x0000001c,
}

enum : uint
{
    IG_GET_INPUT_LINE    = 0x0000001d,
    IG_GET_EXPRESSION_EX = 0x0000001e,
}

enum uint IG_TRANSLATE_VIRTUAL_TO_PHYSICAL = 0x0000001f;
enum uint IG_GET_CACHE_SIZE = 0x00000020;
enum uint IG_READ_PHYSICAL_WITH_FLAGS = 0x00000021;
enum uint IG_WRITE_PHYSICAL_WITH_FLAGS = 0x00000022;
enum uint IG_POINTER_SEARCH_PHYSICAL = 0x00000023;
enum uint IG_OBSOLETE_PLACEHOLDER_36 = 0x00000024;
enum uint IG_GET_THREAD_OS_INFO = 0x00000025;
enum uint IG_GET_CLR_DATA_INTERFACE = 0x00000026;
enum uint IG_MATCH_PATTERN_A = 0x00000027;
enum uint IG_FIND_FILE = 0x00000028;
enum uint IG_TYPED_DATA_OBSOLETE = 0x00000029;
enum uint IG_QUERY_TARGET_INTERFACE = 0x0000002a;
enum uint IG_TYPED_DATA = 0x0000002b;
enum uint IG_DISASSEMBLE_BUFFER = 0x0000002c;
enum uint IG_GET_ANY_MODULE_IN_RANGE = 0x0000002d;
enum uint IG_VIRTUAL_TO_PHYSICAL = 0x0000002e;
enum uint IG_PHYSICAL_TO_VIRTUAL = 0x0000002f;

enum : uint
{
    IG_GET_CONTEXT_EX  = 0x00000030,
    IG_GET_TEB_ADDRESS = 0x00000080,
}

enum uint IG_GET_PEB_ADDRESS = 0x00000081;

enum : uint
{
    PHYS_FLAG_DEFAULT        = 0x00000000,
    PHYS_FLAG_CACHED         = 0x00000001,
    PHYS_FLAG_UNCACHED       = 0x00000002,
    PHYS_FLAG_WRITE_COMBINED = 0x00000003,
}

enum : uint
{
    PTR_SEARCH_PHYS_ALL_HITS         = 0x00000001,
    PTR_SEARCH_PHYS_PTE              = 0x00000002,
    PTR_SEARCH_PHYS_RANGE_CHECK_ONLY = 0x00000004,
    PTR_SEARCH_PHYS_SIZE_SHIFT       = 0x00000003,
    PTR_SEARCH_NO_SYMBOL_CHECK       = 0x80000000,
}

enum uint EXT_FIND_FILE_ALLOW_GIVEN_PATH = 0x00000001;

enum : uint
{
    DEBUG_TYPED_DATA_IS_IN_MEMORY            = 0x00000001,
    DEBUG_TYPED_DATA_PHYSICAL_DEFAULT        = 0x00000002,
    DEBUG_TYPED_DATA_PHYSICAL_CACHED         = 0x00000004,
    DEBUG_TYPED_DATA_PHYSICAL_UNCACHED       = 0x00000006,
    DEBUG_TYPED_DATA_PHYSICAL_WRITE_COMBINED = 0x00000008,
    DEBUG_TYPED_DATA_PHYSICAL_MEMORY         = 0x0000000e,
}

enum : uint
{
    EXT_TDF_PHYSICAL_DEFAULT        = 0x00000002,
    EXT_TDF_PHYSICAL_CACHED         = 0x00000004,
    EXT_TDF_PHYSICAL_UNCACHED       = 0x00000006,
    EXT_TDF_PHYSICAL_WRITE_COMBINED = 0x00000008,
    EXT_TDF_PHYSICAL_MEMORY         = 0x0000000e,
}

enum : uint
{
    WDBGEXTS_ADDRESS_DEFAULT   = 0x00000000,
    WDBGEXTS_ADDRESS_SEG16     = 0x00000001,
    WDBGEXTS_ADDRESS_SEG32     = 0x00000002,
    WDBGEXTS_ADDRESS_RESERVED0 = 0x80000000,
}

enum : uint
{
    DBGKD_VERS_FLAG_MP          = 0x00000001,
    DBGKD_VERS_FLAG_DATA        = 0x00000002,
    DBGKD_VERS_FLAG_PTR64       = 0x00000004,
    DBGKD_VERS_FLAG_NOMM        = 0x00000008,
    DBGKD_VERS_FLAG_HSS         = 0x00000010,
    DBGKD_VERS_FLAG_PARTITIONS  = 0x00000020,
    DBGKD_VERS_FLAG_HAL_IN_NTOS = 0x00000040,
}

enum : uint
{
    KD_SECONDARY_VERSION_DEFAULT                  = 0x00000000,
    KD_SECONDARY_VERSION_AMD64_OBSOLETE_CONTEXT_1 = 0x00000000,
    KD_SECONDARY_VERSION_AMD64_OBSOLETE_CONTEXT_2 = 0x00000001,
    KD_SECONDARY_VERSION_AMD64_CONTEXT            = 0x00000002,
}

enum uint CURRENT_KD_SECONDARY_VERSION = 0x00000002;

enum : uint
{
    DBG_DUMP_NO_INDENT        = 0x00000001,
    DBG_DUMP_NO_OFFSET        = 0x00000002,
    DBG_DUMP_VERBOSE          = 0x00000004,
    DBG_DUMP_CALL_FOR_EACH    = 0x00000008,
    DBG_DUMP_LIST             = 0x00000020,
    DBG_DUMP_NO_PRINT         = 0x00000040,
    DBG_DUMP_GET_SIZE_ONLY    = 0x00000080,
    DBG_DUMP_COMPACT_OUT      = 0x00002000,
    DBG_DUMP_ARRAY            = 0x00008000,
    DBG_DUMP_ADDRESS_OF_FIELD = 0x00010000,
    DBG_DUMP_ADDRESS_AT_END   = 0x00020000,
}

enum uint DBG_DUMP_COPY_TYPE_DATA = 0x00040000;

enum : uint
{
    DBG_DUMP_READ_PHYSICAL   = 0x00080000,
    DBG_DUMP_FUNCTION_FORMAT = 0x00100000,
}

enum : uint
{
    DBG_DUMP_BLOCK_RECURSE = 0x00200000,
    DBG_DUMP_MATCH_SIZE    = 0x00400000,
}

enum : uint
{
    DBG_RETURN_TYPE        = 0x00000000,
    DBG_RETURN_SUBTYPES    = 0x00000000,
    DBG_RETURN_TYPE_VALUES = 0x00000000,
}

enum : uint
{
    DBG_DUMP_FIELD_CALL_BEFORE_PRINT = 0x00000001,
    DBG_DUMP_FIELD_NO_CALLBACK_REQ   = 0x00000002,
    DBG_DUMP_FIELD_RECUR_ON_THIS     = 0x00000004,
    DBG_DUMP_FIELD_FULL_NAME         = 0x00000008,
    DBG_DUMP_FIELD_ARRAY             = 0x00000010,
    DBG_DUMP_FIELD_COPY_FIELD_DATA   = 0x00000020,
    DBG_DUMP_FIELD_RETURN_ADDRESS    = 0x00001000,
    DBG_DUMP_FIELD_SIZE_IN_BITS      = 0x00002000,
    DBG_DUMP_FIELD_NO_PRINT          = 0x00004000,
    DBG_DUMP_FIELD_DEFAULT_STRING    = 0x00010000,
    DBG_DUMP_FIELD_WCHAR_STRING      = 0x00020000,
    DBG_DUMP_FIELD_MULTI_STRING      = 0x00040000,
    DBG_DUMP_FIELD_GUID_STRING       = 0x00080000,
    DBG_DUMP_FIELD_UTF32_STRING      = 0x00100000,
}

enum uint MEMORY_READ_ERROR = 0x00000001;

enum : uint
{
    SYMBOL_TYPE_INDEX_NOT_FOUND = 0x00000002,
    SYMBOL_TYPE_INFO_NOT_FOUND  = 0x00000003,
}

enum uint FIELDS_DID_NOT_MATCH = 0x00000004;
enum uint NULL_SYM_DUMP_PARAM = 0x00000005;
enum uint NULL_FIELD_NAME = 0x00000006;
enum uint INCORRECT_VERSION_INFO = 0x00000007;
enum uint EXIT_ON_CONTROLC = 0x00000008;
enum uint CANNOT_ALLOCATE_MEMORY = 0x00000009;
enum uint INSUFFICIENT_SPACE_TO_COPY = 0x0000000a;
enum uint ADDRESS_TYPE_INDEX_NOT_FOUND = 0x0000000b;
enum uint UNAVAILABLE_ERROR = 0x0000000c;
...
//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/WMP/location-attribute))], [])
struct Location
{
    ulong HostDefined;
    ulong Offset;
...
struct KDDEBUGGER_DATA32
{
    ...
    ushort NextCallback;
    ushort FramePointer;
    /*FIELD ATTR: NativeBitfieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(PaeEnabled)), FixedArgSig(ElementSig(0)), FixedArgSig(ElementSig(1))], [])*/ushort _bitfield99;
    uint   KiCallUserMode;
    uint   KeUserCallbackDispatcher;
    uint   PsLoadedModuleList;
...
struct KDDEBUGGER_DATA64
{
    ...
    ushort NextCallback;
    ushort FramePointer;
    /*FIELD ATTR: NativeBitfieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(PagingLevels)), FixedArgSig(ElementSig(2)), FixedArgSig(ElementSig(4))], [])*/ushort _bitfield100;
...
struct FIELD_INFO
{
    ...
    uint                BufferSize;
    _BitField           BitField;
    /*FIELD ATTR: NativeBitfieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(Reserved)), FixedArgSig(ElementSig(6)), FixedArgSig(ElementSig(26))], [])*/uint _bitfield101;
}
...
struct SYM_DUMP_PARAM
{
    ...
    uint                TypeSize;
    uint                BufferSize;
    /*FIELD ATTR: NativeBitfieldAttribute : CustomAttributeSig([FixedArgSig(ElementSig(Reserved)), FixedArgSig(ElementSig(5)), FixedArgSig(ElementSig(27))], [])*/uint _bitfield102;
}
...
struct DEBUG_DRIVER_OBJECT_INFO
{
    ...
    ulong DeviceObject;
    _DriverName_e__Struct DriverName;
}
...
struct EXT_CAB_XML_DATA
{
    ...
    uint         NumSubTags;
    /*FIELD ATTR: FlexibleArrayAttribute : CustomAttributeSig([], [])*/_SUBTAGS[1] SubTags;
}
