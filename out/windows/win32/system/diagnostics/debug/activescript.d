...
module windows.win32.system.diagnostics.debug.activescript;
...
public import windows.win32.system.com : DISPPARAMS, EXCEPINFO, IDispatch, ITypeInfo,
                                         IUnknown, TYPEDESC;
public import windows.win32.system.diagnostics.debug : IDebugProperty;
...
enum uint DEBUG_TEXT_ISNONUSERCODE = 0x00000040;
...
enum uint SCRIPTSTAT_TOTAL_TIME = 0x00000004;
...
enum uint SCRIPTPROP_SCRIPTSAREFULLYTRUSTED = 0x00001004;
...
enum uint SCRIPTPROP_ABBREVIATE_GLOBALNAME_RESOLUTION = 0x70000002;
enum uint SCRIPTPROP_HOSTKEEPALIVE = 0x70000004;
...
enum uint FACILITY_JsDEBUG = 0x00000dc7;
...
enum uint PROFILER_HEAP_OBJECT_NAME_ID_UNAVAILABLE = 0xffffffff;
enum uint fasaPreferInternalHandler = 0x00000001;
enum uint fasaSupportInternalHandler = 0x00000002;
enum uint fasaCaseSensitive = 0x00000004;

enum : uint
{
    SCRIPT_CMPL_NOLIST         = 0x00000000,
    SCRIPT_CMPL_MEMBERLIST     = 0x00000001,
    SCRIPT_CMPL_ENUMLIST       = 0x00000002,
    SCRIPT_CMPL_PARAMTIP       = 0x00000004,
    SCRIPT_CMPL_GLOBALLIST     = 0x00000008,
    SCRIPT_CMPL_ENUM_TRIGGER   = 0x00000001,
    SCRIPT_CMPL_MEMBER_TRIGGER = 0x00000002,
    SCRIPT_CMPL_PARAM_TRIGGER  = 0x00000003,
    SCRIPT_CMPL_COMMIT         = 0x00000004,
}

enum : uint
{
    GETATTRTYPE_NORMAL  = 0x00000000,
    GETATTRTYPE_DEPSCAN = 0x00000001,
}

enum : uint
{
    GETATTRFLAG_THIS      = 0x00000100,
    GETATTRFLAG_HUMANTEXT = 0x00008000,
}

enum : uint
{
    SOURCETEXT_ATTR_HUMANTEXT    = 0x00008000,
    SOURCETEXT_ATTR_IDENTIFIER   = 0x00000100,
    SOURCETEXT_ATTR_MEMBERLOOKUP = 0x00000200,
    SOURCETEXT_ATTR_THIS         = 0x00000400,
}
