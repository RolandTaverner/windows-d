...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/evcoll/ne-evcoll-ec_subscription_property_id))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/evcoll/ne-evcoll-ec_subscription_credentials_type))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/evcoll/ne-evcoll-ec_subscription_type))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/evcoll/ne-evcoll-ec_subscription_runtime_status_info_id))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/evcoll/ne-evcoll-ec_variant_type))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/evcoll/ne-evcoll-ec_subscription_configuration_mode))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/evcoll/ne-evcoll-ec_subscription_delivery_mode))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/evcoll/ne-evcoll-ec_subscription_content_format))], [])
...
//ENUM ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/evcoll/ne-evcoll-ec_subscription_runtime_status_active_status))], [])
...
enum : uint
{
    EC_VARIANT_TYPE_MASK  = 0x0000007f,
    EC_VARIANT_TYPE_ARRAY = 0x00000080,
}

enum uint EC_READ_ACCESS = 0x00000001;
enum uint EC_WRITE_ACCESS = 0x00000002;
enum uint EC_OPEN_ALWAYS = 0x00000000;
enum uint EC_CREATE_NEW = 0x00000001;
enum uint EC_OPEN_EXISTING = 0x00000002;

// Structs


//STRUCT ATTR: DocumentationAttribute : CustomAttributeSig([FixedArgSig(ElementSig(https://learn.microsoft.com/windows/win32/api/evcoll/ns-evcoll-ec_variant))], [])
struct EC_VARIANT
{
