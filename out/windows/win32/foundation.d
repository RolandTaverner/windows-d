...
enum : VARIANT_BOOL
{
    ...
    VARIANT_FALSE = VARIANT_BOOL(0x0000),
}

enum HANDLE INVALID_HANDLE_VALUE = HANDLE(0xffffffff);
...
enum uint SUCCESS = 0x00000000;
enum uint ERROR_ROUTER_STOPPED = 0x00000384;
enum uint ERROR_ALREADY_CONNECTED = 0x00000385;
enum uint ERROR_UNKNOWN_PROTOCOL_ID = 0x00000386;
enum uint ERROR_DDM_NOT_RUNNING = 0x00000387;
enum uint ERROR_INTERFACE_ALREADY_EXISTS = 0x00000388;
enum uint ERROR_NO_SUCH_INTERFACE = 0x00000389;
enum uint ERROR_INTERFACE_NOT_CONNECTED = 0x0000038a;
enum uint ERROR_PROTOCOL_STOP_PENDING = 0x0000038b;
enum uint ERROR_INTERFACE_CONNECTED = 0x0000038c;
enum uint ERROR_NO_INTERFACE_CREDENTIALS_SET = 0x0000038d;
enum uint ERROR_ALREADY_CONNECTING = 0x0000038e;
enum uint ERROR_UPDATE_IN_PROGRESS = 0x0000038f;
enum uint ERROR_INTERFACE_CONFIGURATION = 0x00000390;

enum : uint
{
    ERROR_NOT_CLIENT_PORT = 0x00000391,
    ERROR_NOT_ROUTER_PORT = 0x00000392,
}

enum uint ERROR_CLIENT_INTERFACE_ALREADY_EXISTS = 0x00000393;
enum uint ERROR_INTERFACE_DISABLED = 0x00000394;
enum uint ERROR_AUTH_PROTOCOL_REJECTED = 0x00000395;
enum uint ERROR_NO_AUTH_PROTOCOL_AVAILABLE = 0x00000396;
enum uint ERROR_PEER_REFUSED_AUTH = 0x00000397;
enum uint ERROR_REMOTE_NO_DIALIN_PERMISSION = 0x00000398;

enum : uint
{
    ERROR_REMOTE_PASSWD_EXPIRED         = 0x00000399,
    ERROR_REMOTE_ACCT_DISABLED          = 0x0000039a,
    ERROR_REMOTE_RESTRICTED_LOGON_HOURS = 0x0000039b,
}

enum uint ERROR_REMOTE_AUTHENTICATION_FAILURE = 0x0000039c;
enum uint ERROR_INTERFACE_HAS_NO_DEVICES = 0x0000039d;
enum uint ERROR_IDLE_DISCONNECTED = 0x0000039e;
enum uint ERROR_INTERFACE_UNREACHABLE = 0x0000039f;
enum uint ERROR_SERVICE_IS_PAUSED = 0x000003a0;
enum uint ERROR_INTERFACE_DISCONNECTED = 0x000003a1;
enum uint ERROR_AUTH_SERVER_TIMEOUT = 0x000003a2;
enum uint ERROR_PORT_LIMIT_REACHED = 0x000003a3;
enum uint ERROR_PPP_SESSION_TIMEOUT = 0x000003a4;
enum uint ERROR_MAX_LAN_INTERFACE_LIMIT = 0x000003a5;
enum uint ERROR_MAX_WAN_INTERFACE_LIMIT = 0x000003a6;
enum uint ERROR_MAX_CLIENT_INTERFACE_LIMIT = 0x000003a7;
enum uint ERROR_BAP_DISCONNECTED = 0x000003a8;
enum uint ERROR_USER_LIMIT = 0x000003a9;
enum uint ERROR_NO_RADIUS_SERVERS = 0x000003aa;
enum uint ERROR_INVALID_RADIUS_RESPONSE = 0x000003ab;
enum uint ERROR_DIALIN_HOURS_RESTRICTION = 0x000003ac;
enum uint ERROR_ALLOWED_PORT_TYPE_RESTRICTION = 0x000003ad;
enum uint ERROR_AUTH_PROTOCOL_RESTRICTION = 0x000003ae;
enum uint ERROR_BAP_REQUIRED = 0x000003af;
enum uint ERROR_DIALOUT_HOURS_RESTRICTION = 0x000003b0;
enum uint ERROR_ROUTER_CONFIG_INCOMPATIBLE = 0x000003b1;
enum uint WARNING_NO_MD5_MIGRATION = 0x000003b2;
enum uint ERROR_PROTOCOL_ALREADY_INSTALLED = 0x000003b4;

enum : uint
{
    ERROR_INVALID_SIGNATURE_LENGTH = 0x000003b5,
    ERROR_INVALID_SIGNATURE        = 0x000003b6,
}

enum uint ERROR_NO_SIGNATURE = 0x000003b7;
...
enum uint ERROR_AUTHENTICATOR_MISMATCH = 0x000003bb;
enum uint ERROR_REMOTEACCESS_NOT_CONFIGURED = 0x000003bc;
enum uint ROUTEBASEEND = 0x000003bd;
...
enum uint NTDDI_MAXVER = 0x00000a00;
...
enum uint WINVER_MAXVER = 0x00000a00;
